(function (root, factory) {
  ...
  protoOf(DomNodeWrapper).j2k = function () {
    return this.h2k_1;
  };
  protoOf(DomNodeWrapper).k2k = function (index, nodeWrapper) {
    var length = this.j2k().childNodes.length;
    if (index < length) {
      var tmp = this.j2k();
      var tmp_0 = nodeWrapper.j2k();
      // Inline function 'org.w3c.dom.get' call
      // Inline function 'kotlin.js.asDynamic' call
      var tmp$ret$1 = this.j2k().childNodes[index];
      tmp.insertBefore(tmp_0, ensureNotNull(tmp$ret$1));
    } else {
      this.j2k().appendChild(nodeWrapper.j2k());
    }
  };
  protoOf(DomNodeWrapper).p1b = function (index, count) {
  ...
  protoOf(DomNodeWrapper).q1b = function (from, to, count) {
    if (from === to) {
    ...
    if (inductionVariable < count)
      do {
        ...
        // Inline function 'org.w3c.dom.get' call
        // Inline function 'kotlin.js.asDynamic' call
        var tmp$ret$1 = this.j2k().childNodes[fromIndex];
        var child = tmp.removeChild(ensureNotNull(tmp$ret$1));
        var tmp_0 = this.j2k();
        // Inline function 'org.w3c.dom.get' call
        // Inline function 'kotlin.js.asDynamic' call
        var tmp$ret$3 = this.j2k().childNodes[toIndex];
  ...
  protoOf(DomApplier).p2k = function (index, instance) {
  };
  protoOf(DomApplier).n1b = function (index, instance) {
    return this.p2k(index, instance instanceof DomNodeWrapper ? instance : THROW_CCE());
  };
  protoOf(DomApplier).q2k = function (index, instance) {
    this.i1b().k2k(index, instance);
  };
  protoOf(DomApplier).o1b = function (index, instance) {
    return this.q2k(index, instance instanceof DomNodeWrapper ? instance : THROW_CCE());
  };
  protoOf(DomApplier).p1b = function (index, count) {
    this.i1b().p1b(index, count);
  };
  protoOf(DomApplier).q1b = function (from, to, count) {
    this.i1b().q1b(from, to, count);
  };
  function synchronize($this) {
    // Inline function 'kotlin.collections.forEach' call
    var tmp0_iterator = $this.w2k_1.l();
  ...
  function schedule($this, block) {
    ...
    if (!$this.x2k_1) {
      $this.x2k_1 = true;
      launch($this.u2k_1, VOID, VOID, GlobalSnapshotManager$schedule$slambda_0(null));
    }
  }
  function GlobalSnapshotManager$globalWriteObserver$lambda(it) {
    if (!GlobalSnapshotManager_getInstance().s2k_1) {
      GlobalSnapshotManager_getInstance().s2k_1 = true;
  ...
  function GlobalSnapshotManager$globalWriteObserver$lambda$lambda() {
    GlobalSnapshotManager_getInstance().s2k_1 = false;
    Companion_instance.j1x();
    return Unit_instance;
  }
  function GlobalSnapshotManager$schedule$slambda(resultContinuation) {
    CoroutineImpl.call(this, resultContinuation);
  }
  protoOf(GlobalSnapshotManager$schedule$slambda).b12 = function ($this$launch, $completion) {
    var tmp = this.c12($this$launch, $completion);
    tmp.ec_1 = Unit_instance;
    tmp.fc_1 = null;
    return tmp.oc();
  };
  protoOf(GlobalSnapshotManager$schedule$slambda).ad = function (p1, $completion) {
    return this.b12((!(p1 == null) ? isInterface(p1, CoroutineScope) : false) ? p1 : THROW_CCE(), $completion);
  };
  protoOf(GlobalSnapshotManager$schedule$slambda).oc = function () {
  ...
  protoOf(GlobalSnapshotManager$schedule$slambda).c12 = function ($this$launch, completion) {
  ...
  function GlobalSnapshotManager() {
    ...
    this.s2k_1 = false;
    this.t2k_1 = null;
    this.u2k_1 = CoroutineScope_0((new JsMicrotasksDispatcher()).cg(SupervisorJob()));
    var tmp = this;
    tmp.v2k_1 = GlobalSnapshotManager$globalWriteObserver$lambda;
    var tmp_0 = this;
  ...
  protoOf(GlobalSnapshotManager).i2l = function () {
    if (!this.r2k_1) {
      this.r2k_1 = true;
      this.t2k_1 = Companion_instance.e2f(this.v2k_1);
    }
  };
  ...
  protoOf(JsMicrotasksDispatcher).tm = function (context, block) {
  ...
  function renderComposable_0(root, monotonicFrameClock, content) {
    ...
    GlobalSnapshotManager_getInstance().i2l();
    ...
    composition.a1t(ComposableLambda$invoke$ref(composableLambdaInstance(-1520853124, true, renderComposable$lambda(content, scope))));
    return composition;
  }
  ...
  protoOf(renderComposable$slambda).b12 = function ($this$launch, $completion) {
    var tmp = this.c12($this$launch, $completion);
    tmp.ec_1 = Unit_instance;
    tmp.fc_1 = null;
    return tmp.oc();
  };
  protoOf(renderComposable$slambda).ad = function (p1, $completion) {
    return this.b12((!(p1 == null) ? isInterface(p1, CoroutineScope) : false) ? p1 : THROW_CCE(), $completion);
  };
  protoOf(renderComposable$slambda).oc = function () {
    var suspendResult = this.ec_1;
    $sm: do
      try {
        var tmp = this.cc_1;
        switch (tmp) {
          case 0:
            this.dc_1 = 2;
            this.cc_1 = 1;
            suspendResult = this.t2l_1.n20(this);
  ...
  protoOf(renderComposable$slambda).c12 = function ($this$launch, completion) {
