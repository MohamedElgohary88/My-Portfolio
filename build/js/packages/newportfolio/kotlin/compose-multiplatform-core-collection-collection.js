(function (root, factory) {
  ...
  var longArrayOf = kotlin_kotlin.$_$.t6;
  ...
  function initializeStorage($this, initialCapacity) {
    ...
    var newCapacity = tmp;
    $this.w18_1 = newCapacity;
    initializeMetadata($this, newCapacity);
    $this.u18_1 = new Int32Array(newCapacity);
    $this.v18_1 = new Int32Array(newCapacity);
  }
  function initializeMetadata($this, capacity) {
    ...
    var i = capacity >> 3;
    var b = (capacity & 7) << 3;
    data[i] = data[i].rb((new Long(255, 0)).ob(b).nb()).sb(value.ob(b));
    initializeGrowth($this);
  }
  function initializeGrowth($this) {
    $this.d19_1 = loadedCapacity($this.e19()) - $this.x18_1 | 0;
  }
  function findInsertIndex($this, key) {
    ...
    var probeMask = $this.w18_1;
    var probeOffset = hash1 & probeMask;
    var probeIndex = 0;
    $l$loop_0: while (true) {
      // Inline function 'androidx.collection.group' call
      var metadata = $this.t18_1;
      var offset = probeOffset;
      var i = offset >> 3;
      var b = (offset & 7) << 3;
      var g = metadata[i].qb(b).sb(metadata[i + 1 | 0].ob(64 - b | 0).rb(toLong(b).mb().pb(63)));
      // Inline function 'androidx.collection.match' call
      // Inline function 'kotlin.Long.times' call
      var tmp$ret$4 = get_BitmaskLsb().ba(toLong(hash2));
      var x = g.tb(tmp$ret$4);
      var m = x.ib(get_BitmaskLsb()).rb(x.nb()).rb(get_BitmaskMsb());
      $l$loop: while (true) {
        ...
        if ($this.u18_1[index] === key) {
          return index;
        }
        // Inline function 'androidx.collection.next' call
        var this_1 = m;
        m = this_1.rb(this_1.ib(new Long(1, 0)));
      }
      // Inline function 'androidx.collection.maskEmpty' call
      if (!g.rb(g.nb().ob(6)).rb(get_BitmaskMsb()).equals(new Long(0, 0))) {
        break $l$loop_0;
      }
    ...
    if ($this.d19_1 === 0) {
      ...
      tmp_0 = !$this.t18_1[offset_0 >> 3].pb((offset_0 & 7) << 3).rb(new Long(255, 0)).equals(get_Deleted());
    } else {
      tmp_0 = false;
    }
    if (tmp_0) {
    ...
    var tmp_1 = $this;
    var tmp_2 = $this.d19_1;
    var tmp_3;
    // Inline function 'androidx.collection.isEmpty' call
    // Inline function 'androidx.collection.readRawMetadata' call
    var offset_1 = index_0;
    if ($this.t18_1[offset_1 >> 3].pb((offset_1 & 7) << 3).rb(new Long(255, 0)).equals(get_Empty())) {
      tmp_3 = 1;
    } else {
      tmp_3 = 0;
    }
    tmp_1.d19_1 = tmp_2 - tmp_3 | 0;
  ...
  function findFirstAvailableSlot($this, hash1) {
    ...
    while (true) {
      ...
      var m = g.rb(g.nb().ob(7)).rb(get_BitmaskMsb());
      if (!m.equals(new Long(0, 0))) {
        var tmp = probeOffset;
        // Inline function 'androidx.collection.lowestBitSet' call
  ...
  function adjustStorage($this) {
    ...
    if ($this.w18_1 > get_GroupWidth()) {
      ...
      var this_2 = _ULong___init__impl__c78o9k(_ULong___get_data__impl__fggpzb(this_1).ba(_ULong___get_data__impl__fggpzb(other)));
      // Inline function 'kotlin.ULong.times' call
      // Inline function 'kotlin.toULong' call
      var this_3 = $this.w18_1;
      var this_4 = _ULong___init__impl__c78o9k(toLong(this_3));
      var other_0 = _ULong___init__impl__c78o9k(new Long(25, 0));
      var other_1 = _ULong___init__impl__c78o9k(_ULong___get_data__impl__fggpzb(this_4).ba(_ULong___get_data__impl__fggpzb(other_0)));
      tmp = ulongCompare(_ULong___get_data__impl__fggpzb(this_2), _ULong___get_data__impl__fggpzb(other_1)) <= 0;
    } else {
      tmp = false;
    }
    if (tmp) {
      resizeStorage($this, nextCapacity($this.w18_1));
    } else {
      resizeStorage($this, nextCapacity($this.w18_1));
    }
  }
  function resizeStorage($this, newCapacity) {
    var previousMetadata = $this.t18_1;
    var previousKeys = $this.u18_1;
    var previousValues = $this.v18_1;
    var previousCapacity = $this.w18_1;
    initializeStorage($this, newCapacity);
    var newKeys = $this.u18_1;
    var newValues = $this.v18_1;
    ...
    if (inductionVariable < previousCapacity)
      do {
        ...
        // Inline function 'androidx.collection.readRawMetadata' call
        if (previousMetadata[i >> 3].pb((i & 7) << 3).rb(new Long(255, 0)).ca(new Long(128, 0)) < 0) {
          ...
          var i_0 = index >> 3;
          var b = (index & 7) << 3;
          m[i_0] = m[i_0].rb((new Long(255, 0)).ob(b).nb()).sb(value.ob(b));
          var c = $this.w18_1;
          var cloneIndex = ((index - get_ClonedMetadataCount() | 0) & c) + (get_ClonedMetadataCount() & c) | 0;
          // Inline function 'androidx.collection.writeRawMetadata' call
          var i_1 = cloneIndex >> 3;
          var b_0 = (cloneIndex & 7) << 3;
          m[i_1] = m[i_1].rb((new Long(255, 0)).ob(b_0).nb()).sb(value.ob(b_0));
  ...
  protoOf(MutableIntIntMap).f19 = function (key, value) {
    var index = findInsertIndex(this, key);
    if (index < 0)
      index = ~index;
    this.u18_1[index] = key;
    this.v18_1[index] = value;
  };
  function IntIntMap() {
    this.t18_1 = get_EmptyGroup();
    this.u18_1 = get_EmptyIntArray();
    this.v18_1 = get_EmptyIntArray();
    this.w18_1 = 0;
    this.x18_1 = 0;
  }
  protoOf(IntIntMap).e19 = function () {
    return this.w18_1;
  };
  ...
  protoOf(IntIntMap).k = function (key) {
    var index = this.h19(key);
    if (index < 0) {
      throw NoSuchElementException_init_$Create$('Cannot find value for key ' + key);
    }
    return this.v18_1[index];
  };
  protoOf(IntIntMap).g19 = function (key) {
    return this.h19(key) >= 0;
  };
  ...
  protoOf(IntIntMap).toString = function () {
    ...
    var s = StringBuilder_init_$Create$().w5(_Char___init__impl__6a9atx(123));
    var i = 0;
    // Inline function 'androidx.collection.IntIntMap.forEach' call
    var k = this.u18_1;
    var v = this.v18_1;
            ...
            if (inductionVariable_0 < bitCount)
              do {
                ...
                if (slot.rb(new Long(255, 0)).ca(new Long(128, 0)) < 0) {
                  ...
                  i = i + 1 | 0;
                  if (i < this.x18_1) {
                    s.w5(_Char___init__impl__6a9atx(44)).w5(_Char___init__impl__6a9atx(32));
                  }
                }
                slot = slot.pb(8);
              }
    ...
    return s.w5(_Char___init__impl__6a9atx(125)).toString();
  };
  protoOf(IntIntMap).h19 = function (key) {
    // Inline function 'androidx.collection.hash' call
    var hash = imul(key, get_MurmurHashC1());
    var hash_0 = hash ^ hash << 16;
    // Inline function 'androidx.collection.h2' call
  ...
  var EmptyIntArray;
  function IntSet() {
    this.i19_1 = get_EmptyGroup();
    this.j19_1 = get_EmptyIntArray();
    this.k19_1 = 0;
    this.l19_1 = 0;
  }
  protoOf(IntSet).e19 = function () {
    return this.k19_1;
  };
  protoOf(IntSet).g19 = function (element) {
    var tmp$ret$9;
    $l$block: {
      ...
      // Inline function 'androidx.collection.h2' call
      var hash2 = hash_0 & 127;
      var probeMask = this.k19_1;
      // Inline function 'androidx.collection.h1' call
      var probeOffset = (hash_0 >>> 7 | 0) & probeMask;
      var probeIndex = 0;
      $l$loop_0: while (true) {
        // Inline function 'androidx.collection.group' call
        var metadata = this.i19_1;
        var offset = probeOffset;
        var i = offset >> 3;
        var b = (offset & 7) << 3;
        var g = metadata[i].qb(b).sb(metadata[i + 1 | 0].ob(64 - b | 0).rb(toLong(b).mb().pb(63)));
  ...
  protoOf(IntSet).m19 = function (separator, prefix, postfix, limit, truncated) {
  ...
  protoOf(IntSet).n19 = function (separator, prefix, postfix, limit, truncated, $super) {
    separator = separator === VOID ? ', ' : separator;
    prefix = prefix === VOID ? '' : prefix;
    postfix = postfix === VOID ? '' : postfix;
    limit = limit === VOID ? -1 : limit;
    truncated = truncated === VOID ? '...' : truncated;
    return $super === VOID ? this.m19(separator, prefix, postfix, limit, truncated) : $super.m19.call(this, separator, prefix, postfix, limit, truncated);
  };
  ...
  function initializeStorage_0($this, initialCapacity) {
    ...
    var newCapacity = tmp;
    $this.k19_1 = newCapacity;
    initializeMetadata_0($this, newCapacity);
    $this.j19_1 = new Int32Array(newCapacity);
  }
  ...
  function initializeGrowth_0($this) {
    $this.s19_1 = loadedCapacity($this.e19()) - $this.l19_1 | 0;
  }
  ...
  function initializeStorage_1($this, initialCapacity) {
    ...
    var newCapacity = tmp;
    $this.w19_1 = newCapacity;
    initializeMetadata_1($this, newCapacity);
    var tmp_0 = $this;
    // Inline function 'kotlin.arrayOfNulls' call
    tmp_0.u19_1 = fillArrayVal(Array(newCapacity), null);
    $this.v19_1 = new Int32Array(newCapacity);
  }
  ...
  function initializeGrowth_1($this) {
    $this.d1a_1 = loadedCapacity($this.e19()) - $this.x19_1 | 0;
  }
  function findIndex($this, key) {
    ...
    // Inline function 'androidx.collection.h2' call
    var hash2 = hash_0 & 127;
    var probeMask = $this.w19_1;
    var probeOffset = hash1 & probeMask;
    var probeIndex = 0;
    $l$loop_0: while (true) {
      // Inline function 'androidx.collection.group' call
      var metadata = $this.t19_1;
      var offset = probeOffset;
      var i = offset >> 3;
      var b = (offset & 7) << 3;
      var g = metadata[i].qb(b).sb(metadata[i + 1 | 0].ob(64 - b | 0).rb(toLong(b).mb().pb(63)));
      // Inline function 'androidx.collection.match' call
      // Inline function 'kotlin.Long.times' call
      var tmp$ret$5 = get_BitmaskLsb().ba(toLong(hash2));
      var x = g.tb(tmp$ret$5);
      var m = x.ib(get_BitmaskLsb()).rb(x.nb()).rb(get_BitmaskMsb());
      $l$loop: while (true) {
        // Inline function 'androidx.collection.hasNext' call
        if (!!m.equals(new Long(0, 0))) {
        ...
        var this_0 = m;
        var index = (tmp + (countTrailingZeroBits(this_0) >> 3) | 0) & probeMask;
        if (equals($this.u19_1[index], key)) {
          return index;
        }
        // Inline function 'androidx.collection.next' call
        var this_1 = m;
    ...
    if ($this.d1a_1 === 0) {
      ...
      // Inline function 'androidx.collection.readRawMetadata' call
      var offset_0 = index_0;
      tmp_0 = !$this.t19_1[offset_0 >> 3].pb((offset_0 & 7) << 3).rb(new Long(255, 0)).equals(get_Deleted());
    } else {
      tmp_0 = false;
    }
    if (tmp_0) {
    ...
    var tmp_1 = $this;
    var tmp_2 = $this.d1a_1;
    var tmp_3;
    // Inline function 'androidx.collection.isEmpty' call
    // Inline function 'androidx.collection.readRawMetadata' call
    var offset_1 = index_0;
    if ($this.t19_1[offset_1 >> 3].pb((offset_1 & 7) << 3).rb(new Long(255, 0)).equals(get_Empty())) {
      tmp_3 = 1;
    } else {
      tmp_3 = 0;
    }
    tmp_1.d1a_1 = tmp_2 - tmp_3 | 0;
  ...
  function adjustStorage_0($this) {
    ...
    if (tmp) {
      resizeStorage_0($this, nextCapacity($this.w19_1));
    } else {
      resizeStorage_0($this, nextCapacity($this.w19_1));
    }
  }
  function resizeStorage_0($this, newCapacity) {
    var previousMetadata = $this.t19_1;
    var previousKeys = $this.u19_1;
    var previousValues = $this.v19_1;
    var previousCapacity = $this.w19_1;
    initializeStorage_1($this, newCapacity);
    var newKeys = $this.u19_1;
    var newValues = $this.v19_1;
    var inductionVariable = 0;
    if (inductionVariable < previousCapacity)
      do {
        var i = inductionVariable;
  ...
  protoOf(MutableObjectIntMap).e1a = function (key, value, default_0) {
    var index = findIndex(this, key);
    var previous = default_0;
    if (index < 0) {
      index = ~index;
    } else {
      previous = this.v19_1[index];
    }
    this.u19_1[index] = key;
    this.v19_1[index] = value;
    return previous;
  };
  protoOf(MutableObjectIntMap).f1a = function (index) {
    this.x19_1 = this.x19_1 - 1 | 0;
    // Inline function 'androidx.collection.MutableObjectIntMap.writeMetadata' call
    ...
    var i = index >> 3;
    var b = (index & 7) << 3;
    m[i] = m[i].rb((new Long(255, 0)).ob(b).nb()).sb(value.ob(b));
    var c = this.w19_1;
    var cloneIndex = ((index - get_ClonedMetadataCount() | 0) & c) + (get_ClonedMetadataCount() & c) | 0;
    // Inline function 'androidx.collection.writeRawMetadata' call
    var i_0 = cloneIndex >> 3;
    var b_0 = (cloneIndex & 7) << 3;
    m[i_0] = m[i_0].rb((new Long(255, 0)).ob(b_0).nb()).sb(value.ob(b_0));
    this.u19_1[index] = null;
  };
  function ObjectIntMap() {
    this.t19_1 = get_EmptyGroup();
    this.u19_1 = get_EMPTY_OBJECTS();
    this.v19_1 = get_EmptyIntArray();
    this.w19_1 = 0;
    this.x19_1 = 0;
  }
  protoOf(ObjectIntMap).e19 = function () {
    return this.w19_1;
  };
  ...
  protoOf(ObjectIntMap).v2 = function (key) {
    var index = this.g1a(key);
    if (index < 0) {
  ...
  protoOf(ObjectIntMap).g1a = function (key) {
    // Inline function 'androidx.collection.hash' call
    // Inline function 'kotlin.hashCode' call
    var tmp1_elvis_lhs = key == null ? null : hashCode(key);
    var tmp$ret$0 = tmp1_elvis_lhs == null ? 0 : tmp1_elvis_lhs;
  ...
  function initializeStorage_2($this, initialCapacity) {
    ...
    var newCapacity = tmp;
    $this.k1a_1 = newCapacity;
    initializeMetadata_2($this, newCapacity);
    var tmp_0 = $this;
    // Inline function 'kotlin.arrayOfNulls' call
    tmp_0.i1a_1 = fillArrayVal(Array(newCapacity), null);
    var tmp_1 = $this;
    // Inline function 'kotlin.arrayOfNulls' call
    tmp_1.j1a_1 = fillArrayVal(Array(newCapacity), null);
  }
  ...
  function initializeGrowth_2($this) {
    $this.r1a_1 = loadedCapacity($this.e19()) - $this.l1a_1 | 0;
  }
  function findFirstAvailableSlot_1($this, hash1) {
    var probeMask = $this.k1a_1;
    var probeOffset = hash1 & probeMask;
    var probeIndex = 0;
    while (true) {
      // Inline function 'androidx.collection.group' call
      var metadata = $this.h1a_1;
      var offset = probeOffset;
      var i = offset >> 3;
      var b = (offset & 7) << 3;
      var g = metadata[i].qb(b).sb(metadata[i + 1 | 0].ob(64 - b | 0).rb(toLong(b).mb().pb(63)));
      // Inline function 'androidx.collection.maskEmptyOrDeleted' call
      var m = g.rb(g.nb().ob(7)).rb(new Long(-2139062144, -2139062144));
      if (!m.equals(new Long(0, 0))) {
        var tmp = probeOffset;
        // Inline function 'androidx.collection.lowestBitSet' call
        return (tmp + (countTrailingZeroBits(m) >> 3) | 0) & probeMask;
  ...
  function adjustStorage_1($this) {
    ...
    if (tmp) {
      resizeStorage_1($this, nextCapacity($this.k1a_1));
    } else {
      resizeStorage_1($this, nextCapacity($this.k1a_1));
    }
  }
  function resizeStorage_1($this, newCapacity) {
    var previousMetadata = $this.h1a_1;
    var previousKeys = $this.i1a_1;
    var previousValues = $this.j1a_1;
    var previousCapacity = $this.k1a_1;
    initializeStorage_2($this, newCapacity);
    var newKeys = $this.i1a_1;
    var newValues = $this.j1a_1;
    var inductionVariable = 0;
    if (inductionVariable < previousCapacity)
      do {
        var i = inductionVariable;
  ...
  protoOf(MutableScatterMap).s1a = function (key, value) {
    // Inline function 'kotlin.let' call
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'androidx.collection.MutableScatterMap.set.<anonymous>' call
    var index = this.t1a(key);
    var index_0 = index < 0 ? ~index : index;
    this.i1a_1[index_0] = key;
    this.j1a_1[index_0] = value;
  };
  protoOf(MutableScatterMap).n2 = function (key) {
    var tmp$ret$10;
    $l$block: {
      ...
      $l$loop_0: while (true) {
        ...
        // Inline function 'androidx.collection.match' call
        // Inline function 'kotlin.Long.times' call
        var tmp$ret$5 = (new Long(16843009, 16843009)).ba(toLong(hash2));
        var x = g.tb(tmp$ret$5);
        var m = x.ib(new Long(16843009, 16843009)).rb(x.nb()).rb(new Long(-2139062144, -2139062144));
        $l$loop: while (true) {
          // Inline function 'androidx.collection.hasNext' call
          if (!!m.equals(new Long(0, 0))) {
            break $l$loop;
          ...
          var this_0 = m;
          var index = (tmp + (countTrailingZeroBits(this_0) >> 3) | 0) & probeMask;
          if (equals(this.i1a_1[index], key)) {
            tmp$ret$10 = index;
            break $l$block;
          }
          // Inline function 'androidx.collection.next' call
        ...
        // Inline function 'androidx.collection.maskEmpty' call
        if (!g.rb(g.nb().ob(6)).rb(new Long(-2139062144, -2139062144)).equals(new Long(0, 0))) {
          break $l$loop_0;
        }
        probeIndex = probeIndex + 8 | 0;
        probeOffset = (probeOffset + probeIndex | 0) & probeMask;
    ...
    if (index_0 >= 0) {
      return this.u1a(index_0);
    }
    return null;
  };
  protoOf(MutableScatterMap).u1a = function (index) {
    ...
    var b_0 = (cloneIndex & 7) << 3;
    m[i_0] = m[i_0].rb((new Long(255, 0)).ob(b_0).nb()).sb(value.ob(b_0));
    this.i1a_1[index] = null;
    var oldValue = this.j1a_1[index];
    this.j1a_1[index] = null;
    return (oldValue == null ? true : !(oldValue == null)) ? oldValue : THROW_CCE();
  };
  protoOf(MutableScatterMap).t1a = function (key) {
    // Inline function 'androidx.collection.hash' call
    // Inline function 'kotlin.hashCode' call
    var tmp1_elvis_lhs = key == null ? null : hashCode(key);
    var tmp$ret$0 = tmp1_elvis_lhs == null ? 0 : tmp1_elvis_lhs;
    ...
    if (this.r1a_1 === 0) {
      ...
      // Inline function 'androidx.collection.readRawMetadata' call
      var offset_0 = index_0;
      tmp_0 = !this.h1a_1[offset_0 >> 3].pb((offset_0 & 7) << 3).rb(new Long(255, 0)).equals(new Long(254, 0));
    } else {
      tmp_0 = false;
    }
    if (tmp_0) {
    ...
    this.l1a_1 = this.l1a_1 + 1 | 0;
    var tmp_1 = this;
    var tmp_2 = this.r1a_1;
    var tmp_3;
    // Inline function 'androidx.collection.isEmpty' call
    // Inline function 'androidx.collection.readRawMetadata' call
    var offset_1 = index_0;
    if (this.h1a_1[offset_1 >> 3].pb((offset_1 & 7) << 3).rb(new Long(255, 0)).equals(new Long(128, 0))) {
      tmp_3 = 1;
    } else {
      tmp_3 = 0;
    }
    tmp_1.r1a_1 = tmp_2 - tmp_3 | 0;
    // Inline function 'androidx.collection.MutableScatterMap.writeMetadata' call
    var index_1 = index_0;
    var value = toLong(hash2);
    var m_0 = this.h1a_1;
  ...
  var Empty;
  function ScatterMap() {
    this.h1a_1 = get_EmptyGroup();
    this.i1a_1 = get_EMPTY_OBJECTS();
    this.j1a_1 = get_EMPTY_OBJECTS();
    this.k1a_1 = 0;
    this.l1a_1 = 0;
  }
  protoOf(ScatterMap).e19 = function () {
    return this.k1a_1;
  };
  ...
  protoOf(ScatterMap).v2 = function (key) {
    var tmp$ret$10;
    $l$block: {
      // Inline function 'androidx.collection.ScatterMap.findKeyIndex' call
      // Inline function 'androidx.collection.hash' call
    ...
    $l$block: {
      ...
      if (inductionVariable <= lastIndex)
        do {
          ...
          // Inline function 'androidx.collection.maskEmptyOrDeleted' call
          var this_0 = slot;
          if (!this_0.rb(this_0.nb().ob(7)).rb(new Long(-2139062144, -2139062144)).equals(new Long(-2139062144, -2139062144))) {
            var bitCount = 8 - (~(i - lastIndex | 0) >>> 31 | 0) | 0;
            var inductionVariable_0 = 0;
            if (inductionVariable_0 < bitCount)
              do {
            ...
            if (inductionVariable_0 < bitCount)
              do {
                ...
                if (slot.rb(new Long(255, 0)).ca(new Long(128, 0)) < 0) {
                  ...
                  if (value == null) {
                    if (!(o.v2(key) == null) ? true : !o.s2(key)) {
                      return false;
                    }
                  } else if (!equals(value, o.v2(key))) {
                    return false;
                  }
                }
                slot = slot.pb(8);
  ...
  function ScatterSet() {
    this.v1a_1 = get_EmptyGroup();
    this.w1a_1 = get_EMPTY_OBJECTS();
    this.x1a_1 = 0;
    this.y1a_1 = 0;
  }
  protoOf(ScatterSet).e19 = function () {
    return this.x1a_1;
  };
  ...
  protoOf(ScatterSet).o = function (element) {
    ...
    $l$block: {
      ...
      // Inline function 'androidx.collection.h2' call
      var hash2 = hash_0 & 127;
      var probeMask = this.x1a_1;
      // Inline function 'androidx.collection.h1' call
      var probeOffset = (hash_0 >>> 7 | 0) & probeMask;
      var probeIndex = 0;
      $l$loop_0: while (true) {
        // Inline function 'androidx.collection.group' call
        var metadata = this.v1a_1;
        var offset = probeOffset;
        var i = offset >> 3;
        var b = (offset & 7) << 3;
        var g = metadata[i].qb(b).sb(metadata[i + 1 | 0].ob(64 - b | 0).rb(toLong(b).mb().pb(63)));
        ...
        $l$loop: while (true) {
          ...
          var this_0 = m;
          var index = (tmp + (countTrailingZeroBits(this_0) >> 3) | 0) & probeMask;
          if (equals(this.w1a_1[index], element)) {
            tmp$ret$10 = index;
            break $l$block;
          }
          // Inline function 'androidx.collection.next' call
  ...
  protoOf(ScatterSet).z1a = function (separator, prefix, postfix, limit, truncated, transform) {
    // Inline function 'kotlin.text.buildString' call
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'kotlin.apply' call
    var this_0 = StringBuilder_init_$Create$();
  ...
  protoOf(ScatterSet).a1b = function (separator, prefix, postfix, limit, truncated, transform, $super) {
    separator = separator === VOID ? ', ' : separator;
    prefix = prefix === VOID ? '' : prefix;
    postfix = postfix === VOID ? '' : postfix;
    limit = limit === VOID ? -1 : limit;
    ...
    return $super === VOID ? this.z1a(separator, prefix, postfix, limit, truncated, transform) : $super.z1a.call(this, separator, prefix, postfix, limit, truncated, transform);
  };
  ...
  protoOf(ScatterSet).toString = function () {
    return this.a1b(VOID, '[', ']', VOID, VOID, ScatterSet$toString$lambda(this));
  };
  function initializeStorage_3($this, initialCapacity) {
    ...
    var newCapacity = tmp;
    $this.x1a_1 = newCapacity;
    initializeMetadata_3($this, newCapacity);
    var tmp_0 = $this;
    // Inline function 'kotlin.arrayOfNulls' call
    tmp_0.w1a_1 = fillArrayVal(Array(newCapacity), null);
  }
  ...
  function initializeGrowth_3($this) {
    $this.f1b_1 = loadedCapacity($this.e19()) - $this.y1a_1 | 0;
  }
  function findAbsoluteInsertIndex($this, element) {
    ...
    if ($this.f1b_1 === 0) {
      ...
      // Inline function 'androidx.collection.readRawMetadata' call
      var offset_0 = index_0;
      tmp_0 = !$this.v1a_1[offset_0 >> 3].pb((offset_0 & 7) << 3).rb(new Long(255, 0)).equals(get_Deleted());
    } else {
      tmp_0 = false;
    }
    if (tmp_0) {
    ...
    var tmp_1 = $this;
    var tmp_2 = $this.f1b_1;
    var tmp_3;
    // Inline function 'androidx.collection.isEmpty' call
    // Inline function 'androidx.collection.readRawMetadata' call
    var offset_1 = index_0;
    if ($this.v1a_1[offset_1 >> 3].pb((offset_1 & 7) << 3).rb(new Long(255, 0)).equals(get_Empty())) {
      tmp_3 = 1;
    } else {
      tmp_3 = 0;
    }
    tmp_1.f1b_1 = tmp_2 - tmp_3 | 0;
  ...
  function adjustStorage_2($this) {
    ...
    if (tmp) {
      resizeStorage_2($this, nextCapacity($this.x1a_1));
    } else {
      resizeStorage_2($this, nextCapacity($this.x1a_1));
    }
  }
  function resizeStorage_2($this, newCapacity) {
    var previousMetadata = $this.v1a_1;
    var previousElements = $this.w1a_1;
    var previousCapacity = $this.x1a_1;
    initializeStorage_3($this, newCapacity);
    var newElements = $this.w1a_1;
    var inductionVariable = 0;
    if (inductionVariable < previousCapacity)
      do {
        var i = inductionVariable;
  ...
  protoOf(MutableScatterSet).w = function (element) {
    var oldSize = this.j();
    var index = findAbsoluteInsertIndex(this, element);
    this.w1a_1[index] = element;
    return !(this.j() === oldSize);
  };
  protoOf(MutableScatterSet).g1b = function (element) {
    var index = findAbsoluteInsertIndex(this, element);
    this.w1a_1[index] = element;
  };
  protoOf(MutableScatterSet).x = function (element) {
    var tmp$ret$10;
    $l$block: {
      // Inline function 'androidx.collection.ScatterSet.findElementIndex' call
      // Inline function 'androidx.collection.hash' call
  ...
  protoOf(MutableScatterSet).h1b = function (index) {
    this.y1a_1 = this.y1a_1 - 1 | 0;
    // Inline function 'androidx.collection.MutableScatterSet.writeMetadata' call
    var value = get_Deleted();
    var m = this.v1a_1;
