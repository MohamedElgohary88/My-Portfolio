(function (root, factory) {
  ...
  var sortWith = kotlin_kotlin.$_$.s4;
  ...
  var flatten = kotlin_kotlin.$_$.q3;
  ...
  var AbstractMutableList = kotlin_kotlin.$_$.l2;
  var IllegalStateException_init_$Create$_0 = kotlin_kotlin.$_$.f1;
  var copyOfRange = kotlin_kotlin.$_$.e3;
  var indexOf = kotlin_kotlin.$_$.t3;
  var AbstractMap = kotlin_kotlin.$_$.k2;
  var AbstractSet = kotlin_kotlin.$_$.m2;
  var AbstractCollection = kotlin_kotlin.$_$.i2;
  var objectCreate = kotlin_kotlin.$_$.x6;
  var step = kotlin_kotlin.$_$.g7;
  var countOneBits = kotlin_kotlin.$_$.v9;
  ...
  protoOf(OffsetApplier).i1b = function () {
    return this.r1b_1.i1b();
  };
  protoOf(OffsetApplier).l1b = function (node) {
  ...
  protoOf(OffsetApplier).n1b = function (index, instance) {
    this.r1b_1.n1b(index + (this.t1b_1 === 0 ? this.s1b_1 : 0) | 0, instance);
  };
  protoOf(OffsetApplier).o1b = function (index, instance) {
    this.r1b_1.o1b(index + (this.t1b_1 === 0 ? this.s1b_1 : 0) | 0, instance);
  };
  protoOf(OffsetApplier).p1b = function (index, count) {
    this.r1b_1.p1b(index + (this.t1b_1 === 0 ? this.s1b_1 : 0) | 0, count);
  };
  protoOf(OffsetApplier).q1b = function (from, to, count) {
    var effectiveOffset = this.t1b_1 === 0 ? this.s1b_1 : 0;
    this.r1b_1.q1b(from + effectiveOffset | 0, to + effectiveOffset | 0, count);
  };
  function AbstractApplier(root) {
    this.u1b_1 = root;
    var tmp = this;
    // Inline function 'kotlin.collections.mutableListOf' call
    tmp.v1b_1 = ArrayList_init_$Create$();
    this.w1b_1 = this.u1b_1;
  }
  protoOf(AbstractApplier).x1b = function (_set____db54di) {
    this.w1b_1 = _set____db54di;
  };
  protoOf(AbstractApplier).i1b = function () {
    return this.w1b_1;
  };
  protoOf(AbstractApplier).y1b = function (node) {
    this.v1b_1.w(this.i1b());
    this.x1b(node);
  };
  protoOf(AbstractApplier).l1b = function (node) {
    return this.y1b((node == null ? true : !(node == null)) ? node : THROW_CCE());
  };
  protoOf(AbstractApplier).m1b = function () {
    ...
    this.x1b(this.v1b_1.j1(this.v1b_1.j() - 1 | 0));
  };
  function FrameAwaiter(onFrame, continuation) {
    this.z1b_1 = onFrame;
    this.a1c_1 = continuation;
  }
  protoOf(FrameAwaiter).b1c = function (timeNanos) {
    // Inline function 'kotlin.runCatching' call
    var tmp;
    try {
      // Inline function 'kotlin.Companion.success' call
      // Inline function 'androidx.compose.runtime.FrameAwaiter.resume.<anonymous>' call
      var value = this.z1b_1(timeNanos);
  ...
  function BroadcastFrameClock(onNewAwaiters) {
    ...
    this.c1c_1 = onNewAwaiters;
    this.d1c_1 = createSynchronizedObject();
    this.e1c_1 = null;
    var tmp = this;
    // Inline function 'kotlin.collections.mutableListOf' call
    tmp.f1c_1 = ArrayList_init_$Create$();
    var tmp_0 = this;
    // Inline function 'kotlin.collections.mutableListOf' call
    tmp_0.g1c_1 = ArrayList_init_$Create$();
  }
  protoOf(BroadcastFrameClock).h1c = function () {
    // Inline function 'androidx.compose.runtime.synchronized' call
    // Inline function 'kotlinx.atomicfu.locks.synchronized' call
    this.d1c_1;
  ...
  protoOf(BroadcastFrameClock).i1c = function (timeNanos) {
    // Inline function 'androidx.compose.runtime.synchronized' call
    // Inline function 'kotlinx.atomicfu.locks.synchronized' call
    this.d1c_1;
    var toResume = this.f1c_1;
    this.f1c_1 = this.g1c_1;
    this.g1c_1 = toResume;
    var inductionVariable = 0;
    var last = toResume.j();
    if (inductionVariable < last)
      do {
        ...
        inductionVariable = inductionVariable + 1 | 0;
        toResume.k(i).b1c(timeNanos);
      }
       while (inductionVariable < last);
    toResume.e1();
  };
  protoOf(BroadcastFrameClock).j1c = function (onFrame, $completion) {
    ...
    $l$block: {
      ...
      cancellable.kk(BroadcastFrameClock$withFrameNanos$lambda(this, awaiter));
      if (hasNewAwaiters ? !(this.c1c_1 == null) : false) {
        try {
          this.c1c_1();
        } catch ($p) {
          if ($p instanceof Error) {
  ...
  function Invalidation(scope, location, instances) {
    this.n1c_1 = scope;
    this.o1c_1 = location;
    this.p1c_1 = instances;
  }
  protoOf(Invalidation).q1c = function () {
    return this.n1c_1.z1c(this.p1c_1);
  };
  function startRoot($this) {
    $this.h1e_1 = $this.c1d_1.f1f();
    startGroup($this, 100);
    $this.b1d_1.g1f();
    $this.u1d_1 = $this.b1d_1.h1f();
    $this.x1d_1.k1f(asInt($this.w1d_1));
    $this.w1d_1 = $this.l1f($this.u1d_1);
    $this.l1e_1 = null;
    if (!$this.p1d_1) {
      $this.p1d_1 = $this.b1d_1.m1f();
    }
    if (!$this.c1e_1) {
      $this.c1e_1 = $this.b1d_1.n1f();
    }
    var tmp0_safe_receiver = read($this.u1d_1, get_LocalInspectionTables());
    if (tmp0_safe_receiver == null)
      null;
    else {
      // Inline function 'kotlin.let' call
      // Inline function 'kotlin.contracts.contract' call
      tmp0_safe_receiver.w($this.c1d_1);
      $this.b1d_1.o1f(tmp0_safe_receiver);
    }
    startGroup($this, $this.b1d_1.p1f());
  }
  ...
  function startGroup($this, key) {
    return start($this, key, null, Companion_getInstance_1().r1h_1, null);
  }
  function startGroup_0($this, key, dataKey) {
    return start($this, key, dataKey, Companion_getInstance_1().r1h_1, null);
  }
  function endGroup($this) {
    return end($this, false);
  }
  function skipGroup($this) {
    $this.l1d_1 = $this.l1d_1 + $this.h1e_1.u1h() | 0;
  }
  ...
  function currentCompositionLocalScope($this) {
    ...
    return currentCompositionLocalScope_0($this, $this.h1e_1.n1g_1);
  }
  function currentCompositionLocalScope_0($this, group) {
    if ($this.q1e_1 ? $this.k1e_1 : false) {
      var current = $this.j1e_1.m1h_1;
      while (current > 0) {
        if ($this.j1e_1.z1h(current) === 202 ? equals($this.j1e_1.y1h(current), get_compositionLocalMap()) : false) {
          var tmp = $this.j1e_1.x1h(current);
          var providers = (!(tmp == null) ? isInterface(tmp, PersistentCompositionLocalMap) : false) ? tmp : THROW_CCE();
          $this.l1e_1 = providers;
          return providers;
        }
        current = $this.j1e_1.a1i(current);
      }
    }
    if ($this.h1e_1.j() > 0) {
      var current_0 = group;
      while (current_0 > 0) {
        if ($this.h1e_1.z1h(current_0) === 202 ? equals($this.h1e_1.y1h(current_0), get_compositionLocalMap()) : false) {
          var tmp0_safe_receiver = $this.v1d_1;
          var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.k(current_0);
          var tmp_0;
          if (tmp1_elvis_lhs == null) {
            var tmp_1 = $this.h1e_1.x1h(current_0);
            tmp_0 = (!(tmp_1 == null) ? isInterface(tmp_1, PersistentCompositionLocalMap) : false) ? tmp_1 : THROW_CCE();
          } else {
            tmp_0 = tmp1_elvis_lhs;
          }
          var providers_0 = tmp_0;
          $this.l1e_1 = providers_0;
          return providers_0;
        }
        current_0 = $this.h1e_1.a1i(current_0);
      }
    }
    $this.l1e_1 = $this.u1d_1;
    return $this.u1d_1;
  }
  function recordProviderUpdate($this, providers) {
    ...
    if (tmp0_elvis_lhs == null) {
      ...
      $this.v1d_1 = newProviderUpdates;
      tmp = newProviderUpdates;
    } else {
      tmp = tmp0_elvis_lhs;
    }
    var providerUpdates = tmp;
    providerUpdates.c1i($this.h1e_1.l1g_1, providers);
  }
  function ensureWriter($this) {
    if ($this.j1e_1.n1h_1) {
      $this.j1e_1 = $this.i1e_1.d1i();
      $this.j1e_1.e1i();
      $this.k1e_1 = false;
      $this.l1e_1 = null;
    }
  ...
  function createFreshInsertTable($this) {
    runtimeCheck($this.j1e_1.n1h_1);
    $this.i1e_1 = new SlotTable();
    var tmp = $this;
    // Inline function 'kotlin.also' call
    var this_0 = $this.i1e_1.d1i();
    // Inline function 'kotlin.contracts.contract' call
  ...
  function startReaderGroup($this, isNode, data) {
    if (isNode) {
      ...
      if (!(data == null) ? !($this.h1e_1.g1i() === data) : false) {
        $this.n1e_1.f1i(data);
      }
      $this.h1e_1.h1i();
    }
  ...
  function start($this, key, objectKey, kind, data) {
    ...
    var isNode = !(_GroupKind___get_value__impl__cf5pqe(kind) === _GroupKind___get_value__impl__cf5pqe(Companion_getInstance_1().r1h_1));
    if ($this.q1e_1) {
      $this.h1e_1.j1i();
      var startIndex = $this.j1e_1.k1h_1;
      if (isNode) {
        $this.j1e_1.n1i(key, Companion_getInstance_0().k1i_1);
      } else if (!(data == null)) {
        var tmp = $this.j1e_1;
        tmp.m1i(key, objectKey == null ? Companion_getInstance_0().k1i_1 : objectKey, data);
      } else {
        var tmp_0 = $this.j1e_1;
        tmp_0.l1i(key, objectKey == null ? Companion_getInstance_0().k1i_1 : objectKey);
      }
      var tmp2_safe_receiver = $this.i1d_1;
      if (tmp2_safe_receiver == null)
        ...
        tmp2_safe_receiver.u1i(insertKeyInfo, $this.j1d_1 - tmp2_safe_receiver.p1i_1 | 0);
        tmp2_safe_receiver.v1i(insertKeyInfo);
      }
    ...
    if (!!(_GroupKind___get_value__impl__cf5pqe(kind) === _GroupKind___get_value__impl__cf5pqe(Companion_getInstance_1().s1h_1))) {
      tmp_1 = $this.y1d_1;
    } else {
      tmp_1 = false;
    }
    ...
    if ($this.i1d_1 == null) {
      var slotKey = $this.h1e_1.w1i();
      if ((!forceReplace ? slotKey === key : false) ? equals(objectKey, $this.h1e_1.y1i()) : false) {
        startReaderGroup($this, isNode, data);
      } else {
        $this.i1d_1 = new Pending($this.h1e_1.x1i(), $this.j1d_1);
      }
    }
    var pending = $this.i1d_1;
    var newPending = null;
    if (!(pending == null)) {
      var keyInfo = pending.z1i(key, objectKey);
      if (!forceReplace ? !(keyInfo == null) : false) {
        pending.v1i(keyInfo);
        var location = keyInfo.e1j_1;
        $this.j1d_1 = pending.h1j(keyInfo) + pending.p1i_1 | 0;
        var relativePosition = pending.i1j(keyInfo);
        var currentRelativePosition = relativePosition - pending.q1i_1 | 0;
        pending.j1j(relativePosition, pending.q1i_1);
        $this.n1e_1.k1j(location);
        $this.h1e_1.l1j(location);
        if (currentRelativePosition > 0) {
          $this.n1e_1.m1j(currentRelativePosition);
        }
        startReaderGroup($this, isNode, data);
      } else {
        $this.h1e_1.j1i();
        ...
        ensureWriter($this);
        $this.j1e_1.a1j();
        var startIndex_0 = $this.j1e_1.k1h_1;
        if (isNode) {
          $this.j1e_1.n1i(key, Companion_getInstance_0().k1i_1);
        } else if (!(data == null)) {
          var tmp_2 = $this.j1e_1;
          tmp_2.m1i(key, objectKey == null ? Companion_getInstance_0().k1i_1 : objectKey, data);
        } else {
          var tmp_3 = $this.j1e_1;
          tmp_3.l1i(key, objectKey == null ? Companion_getInstance_0().k1i_1 : objectKey);
        }
        $this.o1e_1 = $this.j1e_1.b1j(startIndex_0);
        var insertKeyInfo_0 = new KeyInfo(key, -1, insertedGroupVirtualIndex($this, startIndex_0), -1, 0);
        pending.u1i(insertKeyInfo_0, $this.j1d_1 - pending.p1i_1 | 0);
        pending.v1i(insertKeyInfo_0);
        // Inline function 'kotlin.collections.mutableListOf' call
        var tmp$ret$4 = ArrayList_init_$Create$();
        newPending = new Pending(tmp$ret$4, isNode ? 0 : $this.j1d_1);
      }
    }
    enterGroup($this, isNode, newPending);
  }
  function enterGroup($this, isNode, newPending) {
    $this.h1d_1.n1j($this.i1d_1);
    $this.i1d_1 = newPending;
    $this.k1d_1.k1f($this.j1d_1);
    if (isNode)
      $this.j1d_1 = 0;
    $this.m1d_1.k1f($this.l1d_1);
    $this.l1d_1 = 0;
  }
  function exitGroup($this, expectedNodeCount, inserting) {
    var previousPending = $this.h1d_1.o1j();
    if (!(previousPending == null) ? !inserting : false) {
      previousPending.q1i_1 = previousPending.q1i_1 + 1 | 0;
    }
    $this.i1d_1 = previousPending;
    $this.j1d_1 = $this.k1d_1.o1j() + expectedNodeCount | 0;
    $this.l1d_1 = $this.m1d_1.o1j() + expectedNodeCount | 0;
  }
  function end($this, isNode) {
    if ($this.q1e_1) {
      var parent = $this.j1e_1.m1h_1;
      updateCompoundKeyWhenWeExitGroup($this, $this.j1e_1.z1h(parent), $this.j1e_1.y1h(parent), $this.j1e_1.x1h(parent));
    } else {
      var parent_0 = $this.h1e_1.n1g_1;
      updateCompoundKeyWhenWeExitGroup($this, $this.h1e_1.z1h(parent_0), $this.h1e_1.y1h(parent_0), $this.h1e_1.x1h(parent_0));
    }
    var expectedNodeCount = $this.l1d_1;
    var pending = $this.i1d_1;
    if (!(pending == null) ? pending.o1i_1.j() > 0 : false) {
      var previous = pending.o1i_1;
      var current = pending.p1j();
      ...
      $l$loop_0: while (previousIndex < previousEnd) {
        ...
        if (!usedKeys.o(previousInfo)) {
          var deleteOffset = pending.h1j(previousInfo);
          $this.n1e_1.q1j(deleteOffset + pending.p1i_1 | 0, previousInfo.f1j_1);
          pending.r1j(previousInfo.e1j_1, 0);
          $this.n1e_1.k1j(previousInfo.e1j_1);
          $this.h1e_1.l1j(previousInfo.e1j_1);
          recordDelete($this);
          $this.h1e_1.u1h();
          removeRange($this.s1d_1, previousInfo.e1j_1, previousInfo.e1j_1 + $this.h1e_1.s1j(previousInfo.e1j_1) | 0);
        ...
        if (currentIndex < currentEnd) {
          ...
          if (!(currentInfo === previousInfo)) {
            var nodePosition = pending.h1j(currentInfo);
            placedKeys.w(currentInfo);
            if (!(nodePosition === nodeOffset)) {
              var updatedCount = pending.t1j(currentInfo);
              $this.n1e_1.u1j(nodePosition + pending.p1i_1 | 0, nodeOffset + pending.p1i_1 | 0, updatedCount);
              pending.v1j(nodePosition, nodeOffset, updatedCount);
            }
          } else {
            previousIndex = previousIndex + 1 | 0;
          }
          currentIndex = currentIndex + 1 | 0;
          nodeOffset = nodeOffset + pending.t1j(currentInfo) | 0;
        }
      }
      $this.n1e_1.w1j();
      if (previous.j() > 0) {
        $this.n1e_1.k1j($this.h1e_1.x1j());
        $this.h1e_1.e1i();
      }
    }
    var removeIndex = $this.j1d_1;
    while (!$this.h1e_1.y1j()) {
      var startSlot = $this.h1e_1.l1g_1;
      recordDelete($this);
      var nodesToRemove = $this.h1e_1.u1h();
      $this.n1e_1.q1j(removeIndex, nodesToRemove);
      removeRange($this.s1d_1, startSlot, $this.h1e_1.l1g_1);
    }
    var inserting = $this.q1e_1;
    if (inserting) {
      if (isNode) {
        $this.p1e_1.c1k();
        expectedNodeCount = 1;
      ...
      $this.h1e_1.d1k();
      var parentGroup = $this.j1e_1.m1h_1;
      $this.j1e_1.e1k();
      if (!$this.h1e_1.h1k()) {
        var virtualIndex = insertedGroupVirtualIndex($this, parentGroup);
        $this.j1e_1.f1k();
        $this.j1e_1.r1g();
        recordInsert($this, $this.o1e_1);
        $this.q1e_1 = false;
        if (!$this.c1d_1.g1k()) {
      ...
      $this.n1e_1.a1k();
      var parentGroup_0 = $this.h1e_1.n1g_1;
  ...
  function recomposeToGroupEnd($this) {
    var wasComposing = $this.f1e_1;
    $this.f1e_1 = true;
    var recomposed = false;
    var parent = $this.h1e_1.n1g_1;
    var end = parent + $this.h1e_1.s1j(parent) | 0;
    var recomposeIndex = $this.j1d_1;
    var recomposeCompoundKey = $this.r1e_1;
    var oldGroupNodeCount = $this.l1d_1;
    var oldGroup = parent;
    var firstInRange_0 = firstInRange($this.s1d_1, $this.h1e_1.l1g_1, end);
    while (!(firstInRange_0 == null)) {
      var location = firstInRange_0.o1c_1;
      removeLocation($this.s1d_1, location);
      if (firstInRange_0.q1c()) {
        recomposed = true;
        $this.h1e_1.l1j(location);
        var newGroup = $this.h1e_1.l1g_1;
        recordUpsAndDowns($this, oldGroup, newGroup, parent);
        oldGroup = newGroup;
        $this.j1d_1 = nodeIndexOf($this, location, newGroup, parent, recomposeIndex);
        $this.r1e_1 = compoundKeyOf($this, $this.h1e_1.a1i(newGroup), parent, recomposeCompoundKey);
        $this.l1e_1 = null;
        firstInRange_0.n1c_1.j1k($this);
        $this.l1e_1 = null;
        $this.h1e_1.k1k(parent);
      } else {
        $this.e1e_1.n1j(firstInRange_0.n1c_1);
        firstInRange_0.n1c_1.i1k();
        $this.e1e_1.o1j();
      }
      firstInRange_0 = firstInRange($this.s1d_1, $this.h1e_1.l1g_1, end);
    }
    if (recomposed) {
      recordUpsAndDowns($this, oldGroup, parent, parent);
      $this.h1e_1.e1i();
      var parentGroupNodes = updatedNodeCount($this, parent);
      $this.j1d_1 = recomposeIndex + parentGroupNodes | 0;
      $this.l1d_1 = oldGroupNodeCount + parentGroupNodes | 0;
    } else {
      skipReaderToGroupEnd($this);
    }
    $this.r1e_1 = recomposeCompoundKey;
    $this.f1e_1 = wasComposing;
  }
  ...
  function updateNodeCountOverrides($this, group, newCount) {
    ...
    if (!(currentCount === newCount)) {
      ...
      var current = group;
      var minPending = $this.h1d_1.j() - 1 | 0;
      $l$loop_0: while (!(current === -1)) {
        ...
        if (0 <= inductionVariable)
          $l$loop: do {
            ...
            inductionVariable = inductionVariable + -1 | 0;
            var pending = $this.h1d_1.l1k(pendingIndex);
            if (!(pending == null) ? pending.r1j(current, newCurrentNodes) : false) {
        ...
        if (current < 0) {
          current = $this.h1e_1.n1g_1;
        } else {
          if ($this.h1e_1.m1k(current))
            break $l$loop_0;
          current = $this.h1e_1.a1i(current);
        }
      }
    }
  }
  function nodeIndexOf($this, groupLocation, group, recomposeGroup, recomposeIndex) {
    var anchorGroup = $this.h1e_1.a1i(group);
    $l$loop: while (!(anchorGroup === recomposeGroup) && !$this.h1e_1.m1k(anchorGroup)) {
      anchorGroup = $this.h1e_1.a1i(anchorGroup);
    }
    var index = $this.h1e_1.m1k(anchorGroup) ? 0 : recomposeIndex;
    if (anchorGroup === group)
      return index;
    var current = anchorGroup;
    var nodeIndexLimit = index + (updatedNodeCount($this, anchorGroup) - $this.h1e_1.n1k(group) | 0) | 0;
    loop: while (index < nodeIndexLimit && current !== groupLocation) {
      current = current + 1 | 0;
      while (current < groupLocation) {
        var end = current + $this.h1e_1.s1j(current) | 0;
  ...
  function updatedNodeCount($this, group) {
    if (group < 0) {
      var tmp0_safe_receiver = $this.o1d_1;
      var tmp;
      if (tmp0_safe_receiver == null) {
        tmp = null;
      } else {
        ...
        tmp = tmp0_safe_receiver.g19(group) ? tmp0_safe_receiver.k(group) : 0;
      }
      var tmp1_elvis_lhs = tmp;
      return tmp1_elvis_lhs == null ? 0 : tmp1_elvis_lhs;
    }
    var nodeCounts = $this.n1d_1;
    if (!(nodeCounts == null)) {
      var override = nodeCounts[group];
      if (override >= 0)
        return override;
    }
    return $this.h1e_1.n1k(group);
  }
    ...
    if (!(updatedNodeCount($this, group) === count)) {
      if (group < 0) {
        ...
        if (tmp0_elvis_lhs == null) {
          ...
          $this.o1d_1 = newCounts;
          tmp = newCounts;
        } else {
          tmp = tmp0_elvis_lhs;
        }
        var virtualCounts = tmp;
        virtualCounts.f19(group, count);
      } else {
        var tmp1_elvis_lhs = $this.n1d_1;
        var tmp_0;
        if (tmp1_elvis_lhs == null) {
          // Inline function 'kotlin.run' call
          // Inline function 'kotlin.contracts.contract' call
          // Inline function 'androidx.compose.runtime.ComposerImpl.updateNodeCount.<anonymous>' call
          var newCounts_0 = new Int32Array($this.h1e_1.j());
          fill(newCounts_0, -1);
          $this.n1d_1 = newCounts_0;
          tmp_0 = newCounts_0;
        } else {
          tmp_0 = tmp1_elvis_lhs;
        }
  ...
  function recordUpsAndDowns($this, oldGroup, newGroup, commonRoot) {
    ...
    while (current > 0 ? !(current === nearestCommonRoot) : false) {
      if (reader.m1k(current)) {
        $this.n1e_1.z1j();
      }
      current = reader.a1i(current);
    }
  ...
  function doRecordDownsFor($this, group, nearestCommonRoot) {
    if (group > 0 ? !(group === nearestCommonRoot) : false) {
      doRecordDownsFor($this, $this.h1e_1.a1i(group), nearestCommonRoot);
      if ($this.h1e_1.m1k(group)) {
        $this.n1e_1.o1k(nodeAt($this.h1e_1, $this, group));
      }
    }
  }
  function compoundKeyOf($this, group, recomposeGroup, recomposeKey) {
    ...
    if (group === recomposeGroup) {
      ...
      var groupKey = groupCompoundKeyPart($this.h1e_1, $this, group);
      var tmp_0;
      if (groupKey === get_movableContentKey()) {
        tmp_0 = groupKey;
      } else {
        // Inline function 'androidx.compose.runtime.rol' call
        var this_0 = compoundKeyOf($this, $this.h1e_1.a1i(group), recomposeGroup, recomposeKey);
  ...
  function groupCompoundKeyPart(_this__u8e3s4, $this, group) {
    var tmp;
    if (_this__u8e3s4.p1k(group)) {
      var tmp0_safe_receiver = _this__u8e3s4.y1h(group);
      var tmp_0;
      if (tmp0_safe_receiver == null) {
        tmp_0 = null;
      } else {
      ...
      // Inline function 'kotlin.contracts.contract' call
      // Inline function 'androidx.compose.runtime.ComposerImpl.groupCompoundKeyPart.<anonymous>' call
      var it = _this__u8e3s4.z1h(group);
      var tmp_2;
      if (it === 207) {
        var tmp0_safe_receiver_0 = _this__u8e3s4.x1h(group);
        var tmp_3;
        if (tmp0_safe_receiver_0 == null) {
          ...
          tmp_3 = equals(tmp0_safe_receiver_0, Companion_getInstance_0().k1i_1) ? it : hashCode(tmp0_safe_receiver_0);
        }
  ...
  function addRecomposeScope($this) {
    if ($this.q1e_1) {
      ...
      $this.e1e_1.n1j(scope);
      $this.w1h(scope);
      scope.u1k($this.b1e_1);
    } else {
      var invalidation = removeLocation($this.s1d_1, $this.h1e_1.n1g_1);
      var slot = $this.h1e_1.b1();
      var tmp_0;
      if (equals(slot, Companion_getInstance_0().k1i_1)) {
      ...
      scope_0.t1k(tmp_2);
      $this.e1e_1.n1j(scope_0);
      scope_0.u1k($this.b1e_1);
    }
  }
  function invokeMovableContentLambda($this, content, locals, parameter, force) {
    $this.v1k(get_movableContentKey(), content);
    updateSlot($this, parameter);
    var savedCompoundKeyHash = $this.r1e_1;
    try {
      $this.r1e_1 = get_movableContentKey();
      if ($this.q1e_1) {
        $this.j1e_1.w1k();
      }
      var providersChanged = $this.q1e_1 ? false : !equals($this.h1e_1.g1i(), locals);
      if (providersChanged) {
        recordProviderUpdate($this, locals);
      }
      start($this, 202, get_compositionLocalMap(), Companion_getInstance_1().r1h_1, locals);
      $this.l1e_1 = null;
      if ($this.q1e_1 ? !force : false) {
        $this.k1e_1 = true;
        var anchor = $this.j1e_1.b1j($this.j1e_1.a1i($this.j1e_1.m1h_1));
        var reference = new MovableContentStateReference(content, parameter, $this.g1d_1, $this.i1e_1, anchor, emptyList(), currentCompositionLocalScope($this));
        $this.b1d_1.x1k(reference);
      } else {
        var savedProvidersInvalid = $this.w1d_1;
        $this.w1d_1 = providersChanged;
        ...
        $this.w1d_1 = savedProvidersInvalid;
      }
    }finally {
      endGroup($this);
      $this.l1e_1 = null;
      $this.r1e_1 = savedCompoundKeyHash;
      $this.y1k();
    }
  }
  function insertMovableContentGuarded($this, references) {
    ...
    var newChangeList = $this.f1d_1;
    var previousChangeList = this_0.s1f_1;
    try {
      this_0.s1f_1 = newChangeList;
      ...
      if (inductionVariable <= last)
        do {
          ...
          var from = item.me();
          var anchor = to.e1l_1;
          var location = to.d1l_1.h1l(anchor);
          var effectiveNodeIndex = new IntRef();
          $this.n1e_1.i1l(effectiveNodeIndex, anchor);
          if (from == null) {
            var toSlotTable = to.d1l_1;
            if (equals(toSlotTable, $this.i1e_1)) {
              createFreshInsertTable($this);
            }
            ...
            var reader = to.d1l_1.f1f();
            var tmp;
            try {
              reader.l1j(location);
              $this.n1e_1.n1l(location);
              ...
              $this.n1e_1.o1l(offsetChanges, effectiveNodeIndex);
              tmp = Unit_instance;
            }finally {
              reader.r1g();
            }
          } else {
            var resolvedState = $this.b1d_1.j1l(from);
            var tmp1_elvis_lhs = resolvedState == null ? null : resolvedState.k1l_1;
            var fromTable = tmp1_elvis_lhs == null ? from.d1l_1 : tmp1_elvis_lhs;
            var tmp3_safe_receiver = resolvedState == null ? null : resolvedState.k1l_1;
            var tmp4_elvis_lhs = tmp3_safe_receiver == null ? null : tmp3_safe_receiver.b1j(0);
            var fromAnchor = tmp4_elvis_lhs == null ? from.e1l_1 : tmp4_elvis_lhs;
            var nodesToInsert = collectNodesFrom(fromTable, fromAnchor);
            // Inline function 'kotlin.collections.isNotEmpty' call
            if (!nodesToInsert.q()) {
              $this.n1e_1.l1l(nodesToInsert, effectiveNodeIndex);
              if (equals(to.d1l_1, $this.c1d_1)) {
                var group = $this.c1d_1.h1l(anchor);
                updateNodeCount($this, group, updatedNodeCount($this, group) + nodesToInsert.j() | 0);
              }
            }
            $this.n1e_1.m1l(resolvedState, $this.b1d_1, from, to);
            // Inline function 'androidx.compose.runtime.SlotTable.read' call
            // Inline function 'kotlin.let' call
            // Inline function 'kotlin.contracts.contract' call
            // Inline function 'androidx.compose.runtime.SlotTable.read.<anonymous>' call
            var reader_0 = fromTable.f1f();
            var tmp_0;
            try {
              $l$block: {
                // Inline function 'androidx.compose.runtime.ComposerImpl.withReader' call
                var savedReader = $this.h1e_1;
                var savedCountOverrides = $this.n1d_1;
                var savedProviderUpdates = $this.v1d_1;
                $this.n1d_1 = null;
                $this.v1d_1 = null;
                try {
                  $this.h1e_1 = reader_0;
                  var newLocation = fromTable.h1l(fromAnchor);
                  reader_0.l1j(newLocation);
                  $this.n1e_1.n1l(newLocation);
                  var offsetChanges_0 = new ChangeList();
                  // Inline function 'androidx.compose.runtime.changelist.ComposerChangeListWriter.withChangeList' call
                  var this_1 = $this.n1e_1;
                  var previousChangeList_0 = this_1.s1f_1;
                  try {
                    this_1.s1f_1 = offsetChanges_0;
                    ...
                    var this_2 = $this.n1e_1;
                    var previousImplicitRootStart = this_2.v1f_1;
                    try {
                      this_2.v1f_1 = false;
                      ...
                      var tmp_1 = reader_0.l1g_1;
                      var tmp_2 = from.f1l_1;
                      recomposeMovableContent($this, from.c1l_1, to.c1l_1, tmp_1, tmp_2, ComposerImpl$insertMovableContentGuarded$lambda_0($this, to));
                    }finally {
                      this_2.v1f_1 = previousImplicitRootStart;
                    }
                  }finally {
                    this_1.s1f_1 = previousChangeList_0;
                  }
                  $this.n1e_1.o1l(offsetChanges_0, effectiveNodeIndex);
                  break $l$block;
                }finally {
                  $this.h1e_1 = savedReader;
                  $this.n1d_1 = savedCountOverrides;
                  $this.v1d_1 = savedProviderUpdates;
                }
              }
              tmp_0 = Unit_instance;
            }finally {
      ...
      this_0.s1f_1 = previousChangeList;
    }
  }
  function recomposeMovableContent($this, from, to, index, invalidations, block) {
    var savedIsComposing = $this.f1e_1;
    var savedNodeIndex = $this.j1d_1;
    try {
      $this.f1e_1 = true;
      $this.j1d_1 = 0;
      // Inline function 'androidx.compose.runtime.snapshots.fastForEach' call
      ...
      if (from == null) {
        ...
        tmp_0 = from.u1l(to, index == null ? -1 : index, block);
      }
      var tmp2_elvis_lhs = tmp_0;
      return tmp2_elvis_lhs == null ? block() : tmp2_elvis_lhs;
    }finally {
      $this.f1e_1 = savedIsComposing;
      $this.j1d_1 = savedNodeIndex;
    }
  }
  ...
  function doCompose($this, invalidationsRequested, content) {
    ...
    $l$block: {
      ...
      var token = Trace_instance.v1l(sectionName);
      try {
        $this.b1e_1 = currentSnapshot().a1m();
        $this.v1d_1 = null;
        // Inline function 'androidx.compose.runtime.collection.IdentityArrayMap.forEach' call
        var inductionVariable = 0;
        var last = invalidationsRequested.d1m_1;
        if (inductionVariable < last)
          do {
            var index = inductionVariable;
            inductionVariable = inductionVariable + 1 | 0;
            // Inline function 'androidx.compose.runtime.ComposerImpl.doCompose.<anonymous>.<anonymous>' call
            var tmp = invalidationsRequested.b1m_1[index];
            var scope = !(tmp == null) ? tmp : THROW_CCE();
            var tmp_0 = invalidationsRequested.c1m_1[index];
            var set = (tmp_0 == null ? true : !(tmp_0 == null)) ? tmp_0 : THROW_CCE();
            var tmp0_safe_receiver = scope.t1c_1;
            var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.e1m_1;
            var tmp_1;
            if (tmp1_elvis_lhs == null) {
              return Unit_instance;
            } else {
            ...
            var location = tmp_1;
            $this.s1d_1.w(new Invalidation(scope, location, set));
          }
           while (inductionVariable < last);
        sortWith($this.s1d_1, get_InvalidationLocationAscending());
        $this.j1d_1 = 0;
        var complete = false;
        $this.f1e_1 = true;
        var tmp_2;
        try {
          startRoot($this);
          var savedContent = $this.v1h();
          if (!(savedContent === content) ? !(content == null) : false) {
            $this.w1h((content == null ? true : !(content == null)) ? content : THROW_CCE());
          }
          // Inline function 'androidx.compose.runtime.observeDerivedStateRecalculations' call
          var observer = $this.d1e_1;
          var observers = derivedStateObservers_0();
          try {
            observers.i1m(observer);
            // Inline function 'androidx.compose.runtime.ComposerImpl.doCompose.<anonymous>.<anonymous>' call
            if (!(content == null)) {
              startGroup_0($this, 200, get_invocation());
              invokeComposable($this, content);
              endGroup($this);
            } else if ((($this.q1d_1 ? true : $this.w1d_1) ? !(savedContent == null) : false) ? !equals(savedContent, Companion_getInstance_0().k1i_1) : false) {
              startGroup_0($this, 200, get_invocation());
            ...
            var tmp$ret$1 = observers.h1m_1 - 1 | 0;
            observers.j1(tmp$ret$1);
          }
          endRoot($this);
          complete = true;
          tmp_2 = Unit_instance;
        ...
        Trace_instance.k1m(token);
      }
    }
  }
  function _get_node__db0vwp(_this__u8e3s4, $this) {
    return _this__u8e3s4.l1m(_this__u8e3s4.n1g_1);
  }
  function nodeAt(_this__u8e3s4, $this, index) {
    return _this__u8e3s4.l1m(index);
  }
  ...
  function recordInsert($this, anchor) {
    if ($this.p1e_1.q()) {
      $this.n1e_1.n1m(anchor, $this.i1e_1);
    } else {
      $this.n1e_1.m1m(anchor, $this.i1e_1, $this.p1e_1);
      $this.p1e_1 = new FixupList();
    }
  }
  function recordDelete($this) {
    reportFreeMovableContent($this, $this.h1e_1.l1g_1);
    $this.n1e_1.o1m();
  }
  ...
  function updateCompoundKeyWhenWeEnterGroup($this, groupKey, dataKey, data) {
    if (dataKey == null)
      if ((!(data == null) ? groupKey === 207 : false) ? !equals(data, Companion_getInstance_0().k1i_1) : false) {
      ...
      if (dataKey instanceof Enum) {
        updateCompoundKeyWhenWeEnterGroupKeyHash($this, dataKey.y9_1);
      } else {
  ...
  function updateCompoundKeyWhenWeEnterGroupKeyHash($this, keyHash) {
    var tmp = $this;
    // Inline function 'androidx.compose.runtime.rol' call
    var this_0 = $this.r1e_1;
    tmp.r1e_1 = rotateLeft(this_0, 3) ^ keyHash;
  }
  function updateCompoundKeyWhenWeExitGroup($this, groupKey, dataKey, data) {
    if (dataKey == null)
      ...
      if (dataKey instanceof Enum) {
        updateCompoundKeyWhenWeExitGroupKeyHash($this, dataKey.y9_1);
      } else {
  ...
  function updateCompoundKeyWhenWeExitGroupKeyHash($this, groupKey) {
    ...
    var this_0 = $this.r1e_1 ^ groupKey;
    tmp.r1e_1 = rotateRight(this_0, 3);
  }
  function reportFreeMovableContent$reportGroup(this$0, group, needsNodeDelete, nodeIndex) {
    var reader = this$0.h1e_1;
    var tmp;
    if (reader.j1n(group)) {
      var key = reader.z1h(group);
      var objectKey = reader.y1h(group);
      var tmp_0;
      var tmp_1;
      ...
      if (tmp_1) {
        ...
        var parameter = reader.u1m(group, 0);
        var anchor = reader.b1j(group);
        var end = group + reader.s1j(group) | 0;
        // Inline function 'androidx.compose.runtime.snapshots.fastMap' call
        var this_0 = filterToRange(this$0.s1d_1, group, end);
        // Inline function 'kotlin.contracts.contract' call
        ...
        if (inductionVariable <= last)
          do {
            ...
            var element = to(item.n1c_1, item.p1c_1);
            target.w(element);
          }
           while (inductionVariable <= last);
        var invalidations = target;
        var reference = new MovableContentStateReference(movableContent, parameter, this$0.g1d_1, this$0.c1d_1, anchor, invalidations, currentCompositionLocalScope_0(this$0, group));
        this$0.b1d_1.f1n(reference);
        this$0.n1e_1.g1n();
        this$0.n1e_1.h1n(this$0.g1d_1, this$0.b1d_1, reference);
        var tmp_2;
        if (needsNodeDelete) {
          this$0.n1e_1.i1n(nodeIndex, group);
          tmp_2 = 0;
        } else {
          tmp_2 = reader.n1k(group);
        }
        tmp_0 = tmp_2;
      } else {
        if (key === 206 ? equals(objectKey, get_reference()) : false) {
          var tmp_3 = reader.u1m(group, 0);
          var contextHolder = tmp_3 instanceof CompositionContextHolder ? tmp_3 : null;
          if (!(contextHolder == null)) {
            var compositionContext = contextHolder.v1m_1;
            // Inline function 'kotlin.collections.forEach' call
            var tmp0_iterator = compositionContext.b1n_1.l();
            while (tmp0_iterator.z()) {
              var element_0 = tmp0_iterator.b1();
              // Inline function 'androidx.compose.runtime.ComposerImpl.reportFreeMovableContent.reportGroup.<anonymous>' call
              reportAllMovableContent(element_0);
              this$0.b1d_1.e1n(element_0.g1d_1);
            }
          }
          tmp_0 = reader.n1k(group);
        } else {
          if (reader.m1k(group)) {
            tmp_0 = 1;
          } else {
      ...
      tmp = tmp_0;
    } else if (reader.t1m(group)) {
      var size = reader.s1j(group);
      var end_0 = group + size | 0;
      var current = group + 1 | 0;
      var runningNodeCount = 0;
      while (current < end_0) {
        var isNode = reader.m1k(current);
        if (isNode) {
          this$0.n1e_1.w1j();
          this$0.n1e_1.o1k(reader.l1m(current));
        }
        ...
        current = current + reader.s1j(current) | 0;
      }
      tmp = reader.m1k(group) ? 1 : runningNodeCount;
    } else if (reader.m1k(group)) {
      tmp = 1;
    } else {
      tmp = reader.n1k(group);
    }
    return tmp;
  }
  ...
  function ComposerImpl$invokeMovableContentLambda$lambda($content, $parameter) {
    return function ($composer, $changed) {
      ...
      if (!(($changed & 11) === 2) ? true : !$composer_0.n1n()) {
        ...
        $content.m1n_1($parameter, $composer_0, 8);
        var tmp_0;
        if (isTraceInProgress()) {
          traceEventEnd();
          tmp_0 = Unit_instance;
    ...
    return function () {
      ...
      try {
        ...
        $l$block: {
          ...
          var this_1 = this$0;
          var reader = $reader;
          var savedReader = this_1.h1e_1;
          var savedCountOverrides = this_1.n1d_1;
          var savedProviderUpdates = this_1.v1d_1;
          this_1.n1d_1 = null;
          this_1.v1d_1 = null;
          try {
            this_1.h1e_1 = reader;
            var this_2 = this$0.n1e_1;
            var previousImplicitRootStart = this_2.v1f_1;
            var tmp_0;
            try {
              this_2.v1f_1 = false;
              invokeMovableContentLambda(this$0, $to.a1l_1, $to.g1l_1, $to.b1l_1, true);
              tmp_0 = Unit_instance;
            }finally {
              this_2.v1f_1 = previousImplicitRootStart;
            }
            ...
            this_1.h1e_1 = savedReader;
            this_1.n1d_1 = savedCountOverrides;
            this_1.v1d_1 = savedProviderUpdates;
          }
        }
        tmp = tmp_0;
      }finally {
  ...
  function ComposerImpl(applier, parentContext, slotTable, abandonSet, changes, lateChanges, composition) {
    this.a1d_1 = applier;
    this.b1d_1 = parentContext;
    this.c1d_1 = slotTable;
    this.d1d_1 = abandonSet;
    this.e1d_1 = changes;
    this.f1d_1 = lateChanges;
    this.g1d_1 = composition;
    this.h1d_1 = new Stack();
    this.i1d_1 = null;
    this.j1d_1 = 0;
    this.k1d_1 = new IntStack();
    this.l1d_1 = 0;
    ...
    var tmp = this;
    // Inline function 'kotlin.collections.mutableListOf' call
    tmp.s1d_1 = ArrayList_init_$Create$();
    this.t1d_1 = new IntStack();
    this.u1d_1 = persistentCompositionLocalHashMapOf();
    this.v1d_1 = null;
    this.w1d_1 = false;
    this.x1d_1 = new IntStack();
    this.y1d_1 = false;
    this.z1d_1 = -1;
    this.a1e_1 = 0;
    this.b1e_1 = 0;
    this.c1e_1 = false;
    var tmp_0 = this;
    tmp_0.d1e_1 = new ComposerImpl$derivedStateObserver$1(this);
    this.e1e_1 = new Stack();
    this.f1e_1 = false;
    this.g1e_1 = false;
    var tmp_1 = this;
    // Inline function 'kotlin.also' call
    var this_0 = this.c1d_1.f1f();
    // Inline function 'kotlin.contracts.contract' call
    ...
    this.l1e_1 = null;
    this.m1e_1 = null;
    this.n1e_1 = new ComposerChangeListWriter(this, this.e1d_1);
    var tmp_3 = this;
    // Inline function 'androidx.compose.runtime.SlotTable.read' call
    // Inline function 'kotlin.let' call
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'androidx.compose.runtime.SlotTable.read.<anonymous>' call
    var reader = this.i1e_1.f1f();
    var tmp_4;
    try {
    ...
    this.s1e_1 = false;
    this.t1e_1 = true;
    this.u1e_1 = new IntStack();
  }
  protoOf(ComposerImpl).o1n = function () {
    return this.a1d_1;
  };
  protoOf(ComposerImpl).p1n = function () {
    return this.a1e_1 > 0;
  };
  protoOf(ComposerImpl).q1n = function () {
    return this.b1d_1.r1n();
  };
  protoOf(ComposerImpl).s1n = function (key) {
    return start(this, key, null, Companion_getInstance_1().r1h_1, null);
  };
  protoOf(ComposerImpl).t1n = function () {
    return endGroup(this);
  };
  protoOf(ComposerImpl).u1n = function () {
    return start(this, -127, null, Companion_getInstance_1().r1h_1, null);
  };
  protoOf(ComposerImpl).v1n = function () {
    endGroup(this);
    var scope = this.w1n();
    if (!(scope == null) ? scope.p1j() : false) {
      scope.x1n(true);
    }
  };
  protoOf(ComposerImpl).y1n = function () {
    var tmp;
    if (!this.n1n() ? true : this.w1d_1) {
      tmp = true;
    } else {
      var tmp0_safe_receiver = this.w1n();
      tmp = (tmp0_safe_receiver == null ? null : tmp0_safe_receiver.y1n()) === true;
    }
    return tmp;
  };
  protoOf(ComposerImpl).v1k = function (key, dataKey) {
    return start(this, key, dataKey, Companion_getInstance_1().r1h_1, null);
  };
  protoOf(ComposerImpl).y1k = function () {
    return endGroup(this);
  };
  protoOf(ComposerImpl).z1n = function () {
    this.v1d_1 = null;
  };
  protoOf(ComposerImpl).a1o = function () {
    return this.q1e_1;
  };
  protoOf(ComposerImpl).n1n = function () {
    var tmp;
    var tmp_0;
    if ((!this.q1e_1 ? !this.y1d_1 : false) ? !this.w1d_1 : false) {
      var tmp0_safe_receiver = this.w1n();
      tmp_0 = (tmp0_safe_receiver == null ? null : tmp0_safe_receiver.b1o()) === false;
    } else {
      tmp_0 = false;
    }
    if (tmp_0) {
  ...
  protoOf(ComposerImpl).i1i = function () {
    start(this, 125, null, Companion_getInstance_1().s1h_1, null);
    this.r1d_1 = true;
  };
  protoOf(ComposerImpl).c1o = function (factory) {
    ...
    var insertIndex = this.k1d_1.d1o();
    var groupAnchor = this.j1e_1.b1j(this.j1e_1.m1h_1);
    this.l1d_1 = this.l1d_1 + 1 | 0;
    this.p1e_1.e1o(factory, insertIndex, groupAnchor);
  };
  protoOf(ComposerImpl).f1o = function () {
    validateNodeExpected(this);
    // Inline function 'androidx.compose.runtime.runtimeCheck' call
    if (!!this.q1e_1) {
    ...
    var node = _get_node__db0vwp(this.h1e_1, this);
    this.n1e_1.o1k(node);
    var tmp;
    if (this.y1d_1) {
  ...
  protoOf(ComposerImpl).h1o = function () {
    return end(this, true);
  };
  protoOf(ComposerImpl).i1o = function (value, block) {
    if (this.q1e_1) {
      this.p1e_1.k1o(value, block);
    } else {
      this.n1e_1.j1o(value, block);
    }
  };
  protoOf(ComposerImpl).v1h = function () {
    var tmp;
    if (this.q1e_1) {
      validateNodeNotExpected(this);
      tmp = Companion_getInstance_0().k1i_1;
    } else {
      // Inline function 'kotlin.let' call
      // Inline function 'kotlin.contracts.contract' call
      // Inline function 'androidx.compose.runtime.ComposerImpl.nextSlot.<anonymous>' call
      var it = this.h1e_1.b1();
      var tmp_0;
      var tmp_1;
      if (this.y1d_1) {
      ...
      if (tmp_1) {
        tmp_0 = Companion_getInstance_0().k1i_1;
      } else {
        tmp_0 = it;
      }
      tmp = tmp_0;
  ...
  protoOf(ComposerImpl).l1f = function (value) {
    var tmp;
    if (!equals(this.v1h(), value)) {
      this.w1h(value);
      tmp = true;
    } else {
      tmp = false;
  ...
  protoOf(ComposerImpl).n1o = function (value) {
    var tmp;
    if (!(this.v1h() === value)) {
      this.w1h(value);
      tmp = true;
  ...
  protoOf(ComposerImpl).o1o = function (value) {
    var next = this.v1h();
  ...
  protoOf(ComposerImpl).p1o = function (value) {
    var next = this.v1h();
  ...
  protoOf(ComposerImpl).w1h = function (value) {
    if (this.q1e_1) {
      this.j1e_1.s1o(value);
    } else {
      var groupSlotIndex = this.h1e_1.q1o() - 1 | 0;
      this.n1e_1.r1o(value, groupSlotIndex);
    }
  };
  protoOf(ComposerImpl).t1o = function (value) {
    var tmp;
    if (!(value == null) ? isInterface(value, RememberObserver) : false) {
      if (this.q1e_1) {
        this.n1e_1.u1o(value);
      }
      this.d1d_1.w(value);
  ...
  protoOf(ComposerImpl).v1o = function (effect) {
    this.n1e_1.w1o(effect);
  };
  protoOf(ComposerImpl).x1o = function (value) {
    ...
    var invalid;
    if (this.q1e_1) {
      providers = parentScope.f1p(local, state);
      invalid = false;
      this.k1e_1 = true;
    } else {
      var tmp_1 = this.h1e_1.x1h(this.h1e_1.l1g_1);
      var oldScope = (!(tmp_1 == null) ? isInterface(tmp_1, PersistentCompositionLocalMap) : false) ? tmp_1 : THROW_CCE();
      providers = ((!this.n1n() ? true : change) ? value.b1p_1 ? true : !contains_0(parentScope, local) : false) ? parentScope.f1p(local, state) : oldScope;
      invalid = this.y1d_1 ? true : !(oldScope === providers);
    }
    if (invalid ? !this.q1e_1 : false) {
      recordProviderUpdate(this, providers);
    }
    this.x1d_1.k1f(asInt(this.w1d_1));
    this.w1d_1 = invalid;
    this.l1e_1 = providers;
    start(this, 202, get_compositionLocalMap(), Companion_getInstance_1().r1h_1, providers);
  };
  protoOf(ComposerImpl).g1p = function () {
    endGroup(this);
    endGroup(this);
    this.w1d_1 = asBool(this.x1d_1.o1j());
    this.l1e_1 = null;
  };
  protoOf(ComposerImpl).h1p = function (key) {
    return read(currentCompositionLocalScope(this), key);
  };
  protoOf(ComposerImpl).w1n = function () {
    // Inline function 'kotlin.let' call
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'androidx.compose.runtime.ComposerImpl.<get-currentRecomposeScope>.<anonymous>' call
    var it = this.e1e_1;
    return (this.a1e_1 === 0 ? it.i1p() : false) ? it.d1o() : null;
  };
  protoOf(ComposerImpl).r1l = function (scope, instance) {
    var tmp0_elvis_lhs = scope.t1c_1;
    var tmp;
    if (tmp0_elvis_lhs == null) {
      return false;
    } else {
    ...
    var anchor = tmp;
    var slotTable = this.h1e_1.e1g_1;
    var location = anchor.j1p(slotTable);
    if (this.f1e_1 ? location >= this.h1e_1.l1g_1 : false) {
      insertIfMissing(this.s1d_1, location, scope, instance);
      return true;
    }
    return false;
  };
  protoOf(ComposerImpl).j1m = function () {
    if (this.s1d_1.q()) {
      skipGroup(this);
    } else {
      var reader = this.h1e_1;
      var key = reader.w1i();
      var dataKey = reader.y1i();
      var aux = reader.g1i();
      updateCompoundKeyWhenWeEnterGroup(this, key, dataKey, aux);
      startReaderGroup(this, reader.k1p(), null);
      recomposeToGroupEnd(this);
      reader.b1k();
      updateCompoundKeyWhenWeExitGroup(this, key, dataKey, aux);
    }
  };
  protoOf(ComposerImpl).e1i = function () {
    // Inline function 'androidx.compose.runtime.runtimeCheck' call
    if (!(this.l1d_1 === 0)) {
  ...
  protoOf(ComposerImpl).m1p = function (key) {
    start(this, key, null, Companion_getInstance_1().r1h_1, null);
    addRecomposeScope(this);
    return this;
  };
  protoOf(ComposerImpl).n1p = function () {
    var scope = this.e1e_1.i1p() ? this.e1e_1.o1j() : null;
    if (scope != null) {
      scope.t1k(false);
    }
    var tmp2_safe_receiver = scope == null ? null : scope.o1p(this.b1e_1);
    if (tmp2_safe_receiver == null)
      null;
    else {
      // Inline function 'kotlin.let' call
      // Inline function 'kotlin.contracts.contract' call
      this.n1e_1.p1p(tmp2_safe_receiver, this.g1d_1);
    }
    var tmp;
    if ((!(scope == null) ? !scope.r1p() : false) ? scope.p1j() ? true : this.p1d_1 : false) {
      if (scope.t1c_1 == null) {
        var tmp_0 = scope;
        var tmp_1;
        if (this.q1e_1) {
          tmp_1 = this.j1e_1.b1j(this.j1e_1.m1h_1);
        } else {
          tmp_1 = this.h1e_1.b1j(this.h1e_1.n1g_1);
        }
        tmp_0.t1c_1 = tmp_1;
      }
      scope.q1p(false);
  ...
  protoOf(ComposerImpl).s1p = function (references) {
    var completed = false;
    try {
  ...
  protoOf(ComposerImpl).t1p = function (sourceInformation) {
    if (this.q1e_1 ? this.c1e_1 : false) {
      this.j1e_1.u1p(sourceInformation);
    }
  };
  protoOf(ComposerImpl).v1p = function (key, sourceInformation) {
    if (this.q1e_1 ? this.c1e_1 : false) {
      this.j1e_1.w1p(key, sourceInformation);
    }
  };
  protoOf(ComposerImpl).x1p = function () {
    if (this.q1e_1 ? this.c1e_1 : false) {
      this.j1e_1.y1p();
    }
  };
  protoOf(ComposerImpl).z1p = function (invalidationsRequested, content) {
    // Inline function 'androidx.compose.runtime.runtimeCheck' call
    if (!this.e1d_1.q()) {
  ...
  protoOf(ComposerImpl).b1q = function (block) {
    // Inline function 'androidx.compose.runtime.runtimeCheck' call
    if (!!this.f1e_1) {
  ...
  protoOf(ComposerImpl).c1q = function (invalidationsRequested) {
    // Inline function 'androidx.compose.runtime.runtimeCheck' call
    if (!this.e1d_1.q()) {
    ...
    if (tmp) {
      ...
      return this.e1d_1.i1p();
    }
    return false;
  };
  protoOf(ComposerImpl).d1q = function () {
    return this.w1n();
  };
  protoOf(ComposerImpl).y1o = function () {
    return this.l1o();
  };
  protoOf(ComposerImpl).e1p = function (value) {
    return this.t1o(value);
  };
  protoOf(ComposerImpl).e1q = function (scope) {
    var tmp0_safe_receiver = scope instanceof RecomposeScopeImpl ? scope : null;
    if (tmp0_safe_receiver != null) {
      tmp0_safe_receiver.f1q(true);
    }
  };
  ...
  function Companion() {
    ...
    var tmp = this;
    tmp.k1i_1 = new Composer$Companion$Empty$1();
  }
  ...
  function removeCurrentGroup(_this__u8e3s4, rememberManager) {
    ...
    var tmp0_iterator = _this__u8e3s4.g1q();
    while (tmp0_iterator.z()) {
      var slot = tmp0_iterator.b1();
      if (!(slot == null) ? isInterface(slot, ComposeNodeLifecycleCallback) : false) {
        rememberManager.h1q(slot);
      }
      if (slot instanceof RememberObserverHolder) {
        rememberManager.i1q(slot.m1o_1);
      }
  ...
  function MovableContentStateReference(content, parameter, composition, slotTable, anchor, invalidations, locals) {
    this.a1l_1 = content;
    this.b1l_1 = parameter;
    this.c1l_1 = composition;
    this.d1l_1 = slotTable;
    this.e1l_1 = anchor;
    this.f1l_1 = invalidations;
    this.g1l_1 = locals;
  }
  ...
  function traceEventStart(key, dirty1, dirty2, info) {
    ...
    if (tmp0_safe_receiver == null)
      ...
      tmp0_safe_receiver.l1q(key, dirty1, dirty2, info);
    }
  }
  ...
  protoOf(ComposeRuntimeError).u6 = function () {
    return this.n1q_1;
  };
  ...
  function Pending$keyMap$delegate$lambda(this$0) {
    return function () {
      ...
      var inductionVariable = 0;
      var last = this$0.o1i_1.j();
      if (inductionVariable < last)
        do {
          var index = inductionVariable;
          inductionVariable = inductionVariable + 1 | 0;
          var keyInfo = this$0.o1i_1.k(index);
  ...
  function Pending(keyInfos, startIndex) {
    ...
    var tmp = this;
    // Inline function 'kotlin.collections.mutableListOf' call
    tmp.r1i_1 = ArrayList_init_$Create$();
    var tmp_0 = this;
    // Inline function 'kotlin.run' call
    // Inline function 'kotlin.contracts.contract' call
    ...
    var inductionVariable = 0;
    var last = this.o1i_1.j();
    if (inductionVariable < last)
      do {
        var index = inductionVariable;
        inductionVariable = inductionVariable + 1 | 0;
        var keyInfo = this.o1i_1.k(index);
        // Inline function 'kotlin.collections.set' call
        var key = keyInfo.e1j_1;
        var value = new GroupInfo(index, runningNodeIndex, keyInfo.f1j_1);
        result.m2(key, value);
        runningNodeIndex = runningNodeIndex + keyInfo.f1j_1 | 0;
      }
       while (inductionVariable < last);
    tmp_0.s1i_1 = result;
    var tmp_1 = this;
    tmp_1.t1i_1 = lazy(Pending$keyMap$delegate$lambda(this));
  }
  protoOf(Pending).o1q = function () {
    // Inline function 'kotlin.getValue' call
    var this_0 = this.t1i_1;
    keyMap$factory();
    return this_0.p2();
  };
  protoOf(Pending).z1i = function (key, dataKey) {
    var joinedKey = !(dataKey == null) ? new JoinedKey(key, dataKey) : key;
    return pop(this.o1q(), joinedKey);
  };
  protoOf(Pending).v1i = function (keyInfo) {
    return this.r1i_1.w(keyInfo);
  };
  protoOf(Pending).p1j = function () {
    return this.r1i_1;
  };
  protoOf(Pending).j1j = function (from, to) {
    if (from > to) {
      // Inline function 'kotlin.collections.forEach' call
      var tmp0_iterator = this.s1i_1.k2().l();
      while (tmp0_iterator.z()) {
        var element = tmp0_iterator.b1();
        // Inline function 'androidx.compose.runtime.Pending.registerMoveSlot.<anonymous>' call
        var position = element.p1q_1;
        if (position === from)
          element.p1q_1 = to;
        else if (to <= position ? position < from : false)
          element.p1q_1 = position + 1 | 0;
      }
    } else if (to > from) {
      // Inline function 'kotlin.collections.forEach' call
      var tmp0_iterator_0 = this.s1i_1.k2().l();
      while (tmp0_iterator_0.z()) {
        var element_0 = tmp0_iterator_0.b1();
        // Inline function 'androidx.compose.runtime.Pending.registerMoveSlot.<anonymous>' call
        var position_0 = element_0.p1q_1;
        if (position_0 === from)
          element_0.p1q_1 = to;
        else if ((from + 1 | 0) <= position_0 ? position_0 < to : false)
          element_0.p1q_1 = position_0 - 1 | 0;
      }
    }
  };
  protoOf(Pending).v1j = function (from, to, count) {
    if (from > to) {
      // Inline function 'kotlin.collections.forEach' call
      var tmp0_iterator = this.s1i_1.k2().l();
      while (tmp0_iterator.z()) {
        ...
        var position = element.q1q_1;
        if (from <= position ? position < (from + count | 0) : false)
          element.q1q_1 = to + (position - from | 0) | 0;
        else if (to <= position ? position < from : false)
          element.q1q_1 = position + count | 0;
      }
    } else if (to > from) {
      // Inline function 'kotlin.collections.forEach' call
      var tmp0_iterator_0 = this.s1i_1.k2().l();
      while (tmp0_iterator_0.z()) {
        var element_0 = tmp0_iterator_0.b1();
        // Inline function 'androidx.compose.runtime.Pending.registerMoveNode.<anonymous>' call
        var position_0 = element_0.q1q_1;
        if (from <= position_0 ? position_0 < (from + count | 0) : false)
          element_0.q1q_1 = to + (position_0 - from | 0) | 0;
        else if ((from + 1 | 0) <= position_0 ? position_0 < to : false)
          element_0.q1q_1 = position_0 - count | 0;
      }
    }
  };
  protoOf(Pending).u1i = function (keyInfo, insertIndex) {
    // Inline function 'kotlin.collections.set' call
  ...
  protoOf(Pending).r1j = function (group, newCount) {
    var groupInfo = this.s1i_1.v2(group);
    if (!(groupInfo == null)) {
      var index = groupInfo.q1q_1;
      var difference = newCount - groupInfo.r1q_1 | 0;
      groupInfo.r1q_1 = newCount;
      if (!(difference === 0)) {
        // Inline function 'kotlin.collections.forEach' call
        var tmp0_iterator = this.s1i_1.k2().l();
        while (tmp0_iterator.z()) {
          ...
          if (element.q1q_1 >= index ? !equals(element, groupInfo) : false) {
            var newIndex = element.q1q_1 + difference | 0;
            if (newIndex >= 0)
              element.q1q_1 = newIndex;
          }
        }
      }
      return true;
  ...
  protoOf(Pending).i1j = function (keyInfo) {
    var tmp0_safe_receiver = this.s1i_1.v2(keyInfo.e1j_1);
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.p1q_1;
    return tmp1_elvis_lhs == null ? -1 : tmp1_elvis_lhs;
  };
  protoOf(Pending).h1j = function (keyInfo) {
    var tmp0_safe_receiver = this.s1i_1.v2(keyInfo.e1j_1);
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.q1q_1;
    return tmp1_elvis_lhs == null ? -1 : tmp1_elvis_lhs;
  };
  protoOf(Pending).t1j = function (keyInfo) {
    var tmp0_safe_receiver = this.s1i_1.v2(keyInfo.e1j_1);
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.r1q_1;
    return tmp1_elvis_lhs == null ? keyInfo.f1j_1 : tmp1_elvis_lhs;
  };
  ...
  function Companion_0() {
    ...
    this.r1h_1 = _GroupKind___init__impl__iwqg06(0);
    this.s1h_1 = _GroupKind___init__impl__iwqg06(1);
    this.t1h_1 = _GroupKind___init__impl__iwqg06(2);
  }
  ...
  function ProvidedValue(compositionLocal, value, canOverride) {
    this.z1o_1 = compositionLocal;
    this.a1p_1 = value;
    this.b1p_1 = canOverride;
  }
  ...
  function removeRange(_this__u8e3s4, start, end) {
    ...
    $l$loop: while (index < _this__u8e3s4.j()) {
      ...
      if (validation.o1c_1 < end) {
        _this__u8e3s4.j1(index);
      } else
        break $l$loop;
    }
  }
  function firstInRange(_this__u8e3s4, start, end) {
    ...
    if (index < _this__u8e3s4.j()) {
      ...
      if (firstInvalidation.o1c_1 < end)
  ...
  function removeLocation(_this__u8e3s4, location) {
    ...
    return index >= 0 ? _this__u8e3s4.j1(index) : null;
  }
  function nearestCommonRootOf(_this__u8e3s4, a, b, common) {
    ...
    if (a === common ? true : b === common)
      return common;
    if (_this__u8e3s4.a1i(a) === b)
      return b;
    if (_this__u8e3s4.a1i(b) === a)
      return a;
    if (_this__u8e3s4.a1i(a) === _this__u8e3s4.a1i(b))
      return _this__u8e3s4.a1i(a);
    var currentA = a;
    var currentB = b;
    ...
    if (inductionVariable < times)
      do {
        ...
        currentA = _this__u8e3s4.a1i(currentA);
      }
    ...
    if (inductionVariable_0 < times_0)
      do {
        ...
        inductionVariable_0 = inductionVariable_0 + 1 | 0;
        // Inline function 'androidx.compose.runtime.nearestCommonRootOf.<anonymous>' call
        currentB = _this__u8e3s4.a1i(currentB);
      }
  ...
  function insertIfMissing(_this__u8e3s4, location, scope, instance) {
    ...
    if (index < 0) {
      ...
      if (instance == null) {
        _this__u8e3s4.k(index).p1c_1 = null;
      } else {
        var tmp1_safe_receiver = _this__u8e3s4.k(index).p1c_1;
        if (tmp1_safe_receiver == null)
          null;
        else
          tmp1_safe_receiver.s1q(instance);
      }
    }
  }
  function collectNodesFrom(_this__u8e3s4, anchor) {
    ...
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'androidx.compose.runtime.SlotTable.read.<anonymous>' call
    var reader = _this__u8e3s4.f1f();
    var tmp;
    try {
      var index = _this__u8e3s4.h1l(anchor);
  ...
  function filterToRange(_this__u8e3s4, start, end) {
    ...
    $l$loop: while (index < _this__u8e3s4.j()) {
      ...
      if (invalidation.o1c_1 < end) {
        result.w(invalidation);
      } else
        break $l$loop;
      index = index + 1 | 0;
    }
  ...
  function get_joinedKey(_this__u8e3s4) {
    _init_properties_Composer_kt__bmp4g0();
    return !(_this__u8e3s4.d1j_1 == null) ? new JoinedKey(_this__u8e3s4.c1j_1, _this__u8e3s4.d1j_1) : _this__u8e3s4.c1j_1;
  }
  function multiMap() {
    _init_properties_Composer_kt__bmp4g0();
  ...
  function pop(_this__u8e3s4, key) {
    _init_properties_Composer_kt__bmp4g0();
    var tmp0_safe_receiver = _this__u8e3s4.v2(key);
  ...
  function findLocation(_this__u8e3s4, location) {
    ...
    while (low <= high) {
      ...
      var cmp = compareTo(midVal.o1c_1, location);
      if (cmp < 0)
        low = mid + 1 | 0;
      else if (cmp > 0)
        high = mid - 1 | 0;
  ...
  function distanceFrom(_this__u8e3s4, index, root) {
    ...
    while (current > 0 ? !(current === root) : false) {
      current = _this__u8e3s4.a1i(current);
      count = count + 1 | 0;
    }
    return count;
  }
  ...
  function sourceInformationMarkerStart(composer, key, sourceInformation) {
    _init_properties_Composer_kt__bmp4g0();
    composer.v1p(key, sourceInformation);
  }
  ...
  function Updater__set_impl_v7kwss($this, value, block) {
    ...
    var tmp;
    if ($this$with.a1o() ? true : !equals($this$with.y1o(), value)) {
      $this$with.e1p(value);
      _Updater___get_composer__impl__9ty7av($this).i1o(value, block);
      tmp = Unit_instance;
    }
    return tmp;
  }
  ...
  protoOf(sam$kotlin_Comparator$0).u1q = function (a, b) {
  ...
  function InvalidationLocationAscending$lambda(i1, i2) {
    _init_properties_Composer_kt__bmp4g0();
    return compareTo(i1.o1c_1, i2.o1c_1);
  }
  ...
  function composeInitial($this, content) {
    ...
    $this.q1r_1 = content;
    $this.v1q_1.r1r($this, $this.q1r_1);
  }
  function drainPendingModificationsForCompositionLocked($this) {
    var toRecord = $this.x1q_1.t1r(get_PendingApplyNoModifications());
    if (toRecord != null) {
      if (equals(toRecord, get_PendingApplyNoModifications())) {
        ...
        if (!(toRecord == null) ? isInterface(toRecord, Set) : false) {
          ...
          if (!(toRecord == null) ? isArray(toRecord) : false) {
            ...
            composeRuntimeError('corrupt pendingModifications drain: ' + $this.x1q_1);
          }
        }
      }
    }
  ...
  function drainPendingModificationsLocked($this) {
    var toRecord = $this.x1q_1.t1r(null);
    if (!equals(toRecord, get_PendingApplyNoModifications())) {
      if (!(toRecord == null) ? isInterface(toRecord, Set) : false) {
  ...
  function addPendingInvalidationsLocked(_this__u8e3s4, $this, value, forgetConditionalScopes) {
    ...
    var value_0 = $this.b1r_1.u1r_1.v2(value);
    if (value_0 != null) {
      if (value_0 instanceof MutableScatterSet) {
        ...
        $l$block: {
          ...
          if (inductionVariable <= lastIndex)
            do {
              ...
              var this_1 = slot;
              if (!this_1.rb(this_1.nb().ob(7)).rb(get_BitmaskMsb()).equals(get_BitmaskMsb())) {
                ...
                if (inductionVariable_0 < bitCount)
                  do {
                    ...
                    if (slot.rb(new Long(255, 0)).ca(new Long(128, 0)) < 0) {
                      var index = (i << 3) + j | 0;
                      ...
                      if (!$this.g1r_1.x1r(value, scope) ? !scope.w1r(value).equals(InvalidationResult_IGNORED_getInstance()) : false) {
                        if (scope.v1r() ? !forgetConditionalScopes : false) {
                          $this.c1r_1.w(scope);
                        } else {
                          if (set == null)
        ...
        if (!$this.g1r_1.x1r(value, scope_0) ? !scope_0.w1r(value).equals(InvalidationResult_IGNORED_getInstance()) : false) {
          if (scope_0.v1r() ? !forgetConditionalScopes : false) {
            $this.c1r_1.w(scope_0);
          } else {
            if (set == null)
              set = HashSet_init_$Create$();
            ...
            if (tmp0_safe_receiver_0 == null)
              ...
              tmp0_safe_receiver_0.w(scope_0);
          }
        }
      }
    }
  ...
  function addPendingInvalidationsLocked_0($this, values, forgetConditionalScopes) {
    ...
    if (values instanceof IdentityArraySet) {
      // Inline function 'androidx.compose.runtime.collection.IdentityArraySet.fastForEach' call
      // Inline function 'kotlin.contracts.contract' call
      var values_0 = values.t1l_1;
      var inductionVariable = 0;
      var last = values.s1l_1;
      if (inductionVariable < last)
        do {
          var i = inductionVariable;
          inductionVariable = inductionVariable + 1 | 0;
          ...
          if (value instanceof RecomposeScopeImpl) {
            ...
            // Inline function 'androidx.compose.runtime.collection.ScopeMap.forEachScopeOf' call
            var value_0 = $this.d1r_1.u1r_1.v2(value);
            if (value_0 != null) {
              if (value_0 instanceof MutableScatterSet) {
                // Inline function 'androidx.collection.ScatterSet.forEach' call
                var this_0 = value_0 instanceof MutableScatterSet ? value_0 : THROW_CCE();
              ...
              $l$block_0: {
                ...
                if (inductionVariable_2 <= lastIndex_0)
                  do {
                    ...
                    // Inline function 'androidx.collection.maskEmptyOrDeleted' call
                    var this_3 = slot_0;
                    if (!this_3.rb(this_3.nb().ob(7)).rb(get_BitmaskMsb()).equals(get_BitmaskMsb())) {
                      ...
                      if (inductionVariable_3 < bitCount_0)
                        do {
                          ...
                          // Inline function 'androidx.collection.isFull' call
                          if (slot_0.rb(new Long(255, 0)).ca(new Long(128, 0)) < 0) {
    ...
    if (tmp_2) {
      ...
      var this_4 = $this.b1r_1.u1r_1;
      $l$block_2: {
        // Inline function 'androidx.collection.ScatterMap.forEachIndexed' call
        var m_1 = this_4.h1a_1;
        ...
        if (inductionVariable_4 <= lastIndex_1)
          do {
            ...
            // Inline function 'androidx.collection.maskEmptyOrDeleted' call
            var this_5 = slot_1;
            if (!this_5.rb(this_5.nb().ob(7)).rb(get_BitmaskMsb()).equals(get_BitmaskMsb())) {
              ...
              if (inductionVariable_5 < bitCount_1)
                do {
                  ...
                  // Inline function 'androidx.collection.isFull' call
                  if (slot_1.rb(new Long(255, 0)).ca(new Long(128, 0)) < 0) {
                    ...
                    var tmp_3 = this_4.i1a_1[index_1];
                    (tmp_3 == null ? true : !(tmp_3 == null)) || THROW_CCE();
                    var tmp_4 = this_4.j1a_1[index_1];
                      ...
                      $l$block_1: {
                        ...
                        if (inductionVariable_6 <= lastIndex_2)
                          do {
                            ...
                            // Inline function 'androidx.collection.maskEmptyOrDeleted' call
                            var this_6 = slot_2;
                            if (!this_6.rb(this_6.nb().ob(7)).rb(get_BitmaskMsb()).equals(get_BitmaskMsb())) {
                              ...
                              if (inductionVariable_7 < bitCount_2)
                                do {
                                  ...
                                  // Inline function 'androidx.collection.isFull' call
                                  if (slot_2.rb(new Long(255, 0)).ca(new Long(128, 0)) < 0) {
      ...
      if (tmp0_safe_receiver_1 == null)
        ...
        // Inline function 'androidx.compose.runtime.collection.ScopeMap.removeScopeIf' call
        // Inline function 'androidx.collection.MutableScatterMap.removeIf' call
        var this_7 = $this.b1r_1.u1r_1;
        $l$block_4: {
          // Inline function 'androidx.collection.ScatterMap.forEachIndexed' call
          var m_3 = this_7.h1a_1;
          ...
          if (inductionVariable_8 <= lastIndex_3)
            do {
              ...
              // Inline function 'androidx.collection.maskEmptyOrDeleted' call
              var this_8 = slot_3;
              if (!this_8.rb(this_8.nb().ob(7)).rb(get_BitmaskMsb()).equals(get_BitmaskMsb())) {
                ...
                if (inductionVariable_9 < bitCount_3)
                  do {
                    ...
                    // Inline function 'androidx.collection.isFull' call
                    if (slot_3.rb(new Long(255, 0)).ca(new Long(128, 0)) < 0) {
                      var index_3 = (i_4 << 3) + j_3 | 0;
                      // Inline function 'androidx.collection.MutableScatterMap.removeIf.<anonymous>' call
                      // Inline function 'androidx.compose.runtime.collection.ScopeMap.removeScopeIf.<anonymous>' call
                      var tmp_11 = this_7.i1a_1[index_3];
                      (tmp_11 == null ? true : !(tmp_11 == null)) || THROW_CCE();
                      var tmp_12 = this_7.j1a_1[index_3];
                        ...
                        $l$block_3: {
                          ...
                          if (inductionVariable_10 <= lastIndex_4)
                            do {
                              ...
                              // Inline function 'androidx.collection.maskEmptyOrDeleted' call
                              var this_9 = slot_4;
                              if (!this_9.rb(this_9.nb().ob(7)).rb(get_BitmaskMsb()).equals(get_BitmaskMsb())) {
                                ...
                                if (inductionVariable_11 < bitCount_4)
                                  do {
                                    ...
                                    // Inline function 'androidx.collection.isFull' call
                                    if (slot_4.rb(new Long(255, 0)).ca(new Long(128, 0)) < 0) {
            ...
            if (inductionVariable_0 < bitCount)
              do {
                ...
                if (slot.rb(new Long(255, 0)).ca(new Long(128, 0)) < 0) {
                  ...
                  // Inline function 'androidx.collection.MutableScatterMap.removeIf.<anonymous>' call
                  // Inline function 'androidx.compose.runtime.collection.ScopeMap.removeScopeIf.<anonymous>' call
                  var tmp = this_0.i1a_1[index];
                  (tmp == null ? true : !(tmp == null)) || THROW_CCE();
                  var tmp_0 = this_0.j1a_1[index];
                  ...
                  if (value instanceof MutableScatterSet) {
                    ...
                    $l$block: {
                      ...
                      if (inductionVariable_1 <= lastIndex_0)
                        do {
                          ...
                          // Inline function 'androidx.collection.maskEmptyOrDeleted' call
                          var this_2 = slot_0;
                          if (!this_2.rb(this_2.nb().ob(7)).rb(get_BitmaskMsb()).equals(get_BitmaskMsb())) {
                            ...
                            if (inductionVariable_2 < bitCount_0)
                              do {
                                ...
                                if (slot_0.rb(new Long(255, 0)).ca(new Long(128, 0)) < 0) {
                                  ...
                                  if (!$this.b1r_1.y1r(derivedState)) {
                                    set.h1b(index_0);
                                  }
                                }
                                slot_0 = slot_0.pb(8);
                    ...
                    tmp_1 = !$this.b1r_1.y1r(derivedState_0);
                  }
                  if (tmp_1) {
                    this_0.u1a(index);
                  }
  ...
  function invalidateScopeOfLocked($this, value) {
    ...
    if (value_0 != null) {
      if (value_0 instanceof MutableScatterSet) {
                ...
                if (inductionVariable_0 < bitCount)
                  do {
                    ...
                    if (slot.rb(new Long(255, 0)).ca(new Long(128, 0)) < 0) {
                      ...
                      var tmp = k[index];
                      var scope = (tmp == null ? true : !(tmp == null)) ? tmp : THROW_CCE();
                      if (scope.w1r(value).equals(InvalidationResult_IMMINENT_getInstance())) {
                        $this.g1r_1.z1r(value, scope);
                      }
                    }
                    slot = slot.pb(8);
                  }
        ...
        // Inline function 'androidx.compose.runtime.CompositionImpl.invalidateScopeOfLocked.<anonymous>' call
        var scope_0 = !(value_0 == null) ? value_0 : THROW_CCE();
        if (scope_0.w1r(value).equals(InvalidationResult_IMMINENT_getInstance())) {
          $this.g1r_1.z1r(value, scope_0);
        }
      }
    }
  }
  function applyChangesInLocked($this, changes) {
    var manager = new RememberEventDispatcher($this.z1q_1);
    try {
      if (changes.q())
        return Unit_instance;
      $l$block: {
        ...
        try {
          ...
          var writer = $this.a1r_1.d1i();
          var tmp;
          try {
            changes.a1s($this.w1q_1, writer, manager);
            tmp = Unit_instance;
          }finally {
            writer.r1g();
          }
      ...
      if ($this.i1r_1) {
        $l$block_2: {
          ...
          var token_0 = Trace_instance.v1l(sectionName_0);
          try {
            $this.i1r_1 = false;
            // Inline function 'androidx.compose.runtime.collection.ScopeMap.removeScopeIf' call
            // Inline function 'androidx.collection.MutableScatterMap.removeIf' call
            var this_0 = $this.b1r_1.u1r_1;
            $l$block_1: {
              // Inline function 'androidx.collection.ScatterMap.forEachIndexed' call
              var m = this_0.h1a_1;
              var lastIndex = m.length - 2 | 0;
                    ...
                    if (inductionVariable_0 < bitCount)
                      do {
                        ...
                        if (slot.rb(new Long(255, 0)).ca(new Long(128, 0)) < 0) {
                          ...
                          // Inline function 'androidx.collection.MutableScatterMap.removeIf.<anonymous>' call
                          // Inline function 'androidx.compose.runtime.collection.ScopeMap.removeScopeIf.<anonymous>' call
                          var tmp_0 = this_0.i1a_1[index];
                          (tmp_0 == null ? true : !(tmp_0 == null)) || THROW_CCE();
                          var tmp_1 = this_0.j1a_1[index];
                          ...
                          if (value instanceof MutableScatterSet) {
                                    ...
                                    if (inductionVariable_2 < bitCount_0)
                                      do {
                                        ...
                                        if (slot_0.rb(new Long(255, 0)).ca(new Long(128, 0)) < 0) {
                                          ...
                                          if (!((tmp_3 == null ? true : !(tmp_3 == null)) ? tmp_3 : THROW_CCE()).i1s()) {
                                            set.h1b(index_0);
                                          }
                                        }
                                        slot_0 = slot_0.pb(8);
                            ...
                            // Inline function 'androidx.compose.runtime.CompositionImpl.applyChangesInLocked.<anonymous>.<anonymous>' call
                            tmp_2 = !(!(value == null) ? value : THROW_CCE()).i1s();
                          }
                          if (tmp_2) {
                            this_0.u1a(index);
                          }
  ...
  function tryImminentInvalidation($this, scope, instance) {
    return $this.l1s() ? $this.m1r_1.r1l(scope, instance) : false;
  }
  function invalidateChecked($this, scope, anchor, instance) {
    ...
    var tmp0_safe_receiver = $this.j1r_1;
    var tmp;
    if (tmp0_safe_receiver == null) {
      tmp = null;
    } else {
      ...
      var tmp_0;
      if ($this.a1r_1.m1s($this.k1r_1, anchor)) {
    ...
    if (delegate == null) {
      ...
      if (instance == null) {
        $this.h1r_1.n1s(scope, null);
      } else {
        addValue($this.h1r_1, scope, instance);
      }
    }
    ...
    $this.v1q_1.o1s($this);
    return $this.l1s() ? InvalidationResult_DEFERRED_getInstance() : InvalidationResult_SCHEDULED_getInstance();
  }
  function takeInvalidations($this) {
    var invalidations = $this.h1r_1;
    $this.h1r_1 = new IdentityArrayMap();
    return invalidations;
  }
  function observer($this) {
    var holder = $this.l1r_1;
    var tmp;
    if (holder.r1s_1) {
      tmp = holder.q1s_1;
    } else {
      var parentHolder = $this.v1q_1.p1s();
      var parentObserver = parentHolder == null ? null : parentHolder.q1s_1;
      if (!equals(parentObserver, holder.q1s_1)) {
        holder.q1s_1 = parentObserver;
      }
      tmp = parentObserver;
    }
    return tmp;
  ...
  function RememberEventDispatcher(abandoning) {
    this.b1s_1 = abandoning;
    var tmp = this;
    // Inline function 'kotlin.collections.mutableListOf' call
    tmp.c1s_1 = ArrayList_init_$Create$();
    var tmp_0 = this;
    // Inline function 'kotlin.collections.mutableListOf' call
    tmp_0.d1s_1 = ArrayList_init_$Create$();
    var tmp_1 = this;
    // Inline function 'kotlin.collections.mutableListOf' call
    tmp_1.e1s_1 = ArrayList_init_$Create$();
    this.f1s_1 = null;
  }
  protoOf(RememberEventDispatcher).s1s = function (instance) {
    this.c1s_1.w(instance);
  };
  protoOf(RememberEventDispatcher).i1q = function (instance) {
    this.d1s_1.w(instance);
  };
  protoOf(RememberEventDispatcher).w1o = function (effect) {
    // Inline function 'kotlin.collections.plusAssign' call
    this.e1s_1.w(effect);
  };
  protoOf(RememberEventDispatcher).h1q = function (instance) {
  ...
  protoOf(RememberEventDispatcher).g1s = function () {
    ...
    if (!this.d1s_1.q()) {
      $l$block: {
        ...
        var token = Trace_instance.v1l(sectionName);
        try {
          var releasing = this.f1s_1;
          var inductionVariable = this.d1s_1.j() - 1 | 0;
          var tmp;
          if (0 <= inductionVariable) {
            do {
              var i = inductionVariable;
              inductionVariable = inductionVariable + -1 | 0;
              var instance = this.d1s_1.k(i);
              // Inline function 'kotlin.collections.remove' call
              var this_0 = this.b1s_1;
              (isInterface(this_0, MutableCollection) ? this_0 : THROW_CCE()).x(instance);
              if (isInterface(instance, RememberObserver)) {
                instance.t1s();
              }
              if (isInterface(instance, ComposeNodeLifecycleCallback)) {
                if (!(releasing == null) ? releasing.o(instance) : false) {
                  instance.m1c();
                } else {
                  instance.l1c();
                }
  ...
  protoOf(RememberEventDispatcher).h1s = function () {
    // Inline function 'kotlin.collections.isNotEmpty' call
    if (!this.e1s_1.q()) {
      $l$block: {
        // Inline function 'androidx.compose.runtime.trace' call
  ...
  protoOf(RememberEventDispatcher).j1s = function () {
    // Inline function 'kotlin.collections.isNotEmpty' call
    if (!this.b1s_1.q()) {
      $l$block: {
        // Inline function 'androidx.compose.runtime.trace' call
        ...
        var token = Trace_instance.v1l(sectionName);
        try {
          var iterator = this.b1s_1.l();
          while (iterator.z()) {
            var instance = iterator.b1();
            iterator.a1();
            instance.v1s();
          }
          break $l$block;
  ...
  function CompositionImpl(parent, applier, recomposeContext) {
    ...
    this.v1q_1 = parent;
    this.w1q_1 = applier;
    this.x1q_1 = new AtomicReference(null);
    this.y1q_1 = createSynchronizedObject();
    this.z1q_1 = HashSet_init_$Create$();
    this.a1r_1 = new SlotTable();
    this.b1r_1 = new ScopeMap();
    this.c1r_1 = HashSet_init_$Create$();
    this.d1r_1 = new ScopeMap();
    this.e1r_1 = new ChangeList();
    this.f1r_1 = new ChangeList();
    this.g1r_1 = new ScopeMap();
    this.h1r_1 = new IdentityArrayMap();
    this.i1r_1 = false;
    this.j1r_1 = null;
    this.k1r_1 = 0;
    this.l1r_1 = new CompositionObserverHolder();
    var tmp = this;
    // Inline function 'kotlin.also' call
    var this_0 = new ComposerImpl(this.w1q_1, this.v1q_1, this.a1r_1, this.z1q_1, this.e1r_1, this.f1r_1, this);
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'androidx.compose.runtime.CompositionImpl.composer.<anonymous>' call
    this.v1q_1.w1s(this_0);
    tmp.m1r_1 = this_0;
    this.n1r_1 = recomposeContext;
    var tmp_0 = this;
    var tmp_1 = this.v1q_1;
    tmp_0.o1r_1 = tmp_1 instanceof Recomposer;
    this.p1r_1 = false;
    this.q1r_1 = ComposableSingletons$CompositionKt_getInstance().x1s_1;
  }
  protoOf(CompositionImpl).l1s = function () {
    return this.m1r_1.f1e_1;
  };
  protoOf(CompositionImpl).z1s = function () {
    return this.p1r_1;
  };
  protoOf(CompositionImpl).a1t = function (content) {
    composeInitial(this, content);
  };
  protoOf(CompositionImpl).b1t = function (content) {
      ...
      try {
        ...
        try {
          ...
          if (observer_0 == null)
            ...
            var tmp_2 = invalidations.c1t();
            observer_0.d1t(this, isInterface(tmp_2, Map) ? tmp_2 : THROW_CCE());
          }
          this.m1r_1.z1p(invalidations, content);
          var tmp_3;
          if (observer_0 == null) {
            tmp_3 = null;
          } else {
        ...
        if (tmp_5) {
          (new RememberEventDispatcher(this.z1q_1)).j1s();
        }
      }
      tmp = tmp_0;
    } catch ($p) {
  ...
  protoOf(CompositionImpl).f1t = function (values) {
    $l$loop: while (true) {
      var old = this.x1q_1.kn();
      var tmp;
      if (old == null ? true : equals(old, get_PendingApplyNoModifications())) {
        ...
        if (!(old == null) ? isInterface(old, Set) : false) {
          ...
          if (!(old == null) ? isArray(old) : false) {
            ...
            var message = 'corrupt pendingModifications: ' + this.x1q_1;
            throw IllegalStateException_init_$Create$(toString(message));
          }
        }
      }
      var new_0 = tmp;
      if (this.x1q_1.g1t(old, new_0)) {
        if (old == null) {
          // Inline function 'androidx.compose.runtime.synchronized' call
          // Inline function 'kotlinx.atomicfu.locks.synchronized' call
          this.y1q_1;
  ...
  protoOf(CompositionImpl).h1t = function (values) {
    if (values instanceof IdentityArraySet) {
      // Inline function 'androidx.compose.runtime.collection.IdentityArraySet.fastForEach' call
      // Inline function 'kotlin.contracts.contract' call
      var values_0 = values.t1l_1;
      ...
      if (inductionVariable < last)
        do {
          ...
          var tmp = values_0[i];
          var value = !(tmp == null) ? tmp : THROW_CCE();
          if (this.b1r_1.y1r(value) ? true : this.d1r_1.y1r(value))
            return true;
        }
         while (inductionVariable < last);
      return false;
    ...
    var tmp0_iterator = values.l();
    while (tmp0_iterator.z()) {
      var value_0 = tmp0_iterator.b1();
      if (this.b1r_1.y1r(value_0) ? true : this.d1r_1.y1r(value_0))
        return true;
    }
    return false;
  };
  protoOf(CompositionImpl).b1q = function (block) {
    return this.m1r_1.b1q(block);
  };
  protoOf(CompositionImpl).i1t = function (value) {
    if (!_get_areChildrenComposing__c1uwup(this)) {
      var tmp0_safe_receiver = this.m1r_1.w1n();
      if (tmp0_safe_receiver == null)
        null;
      else {
        // Inline function 'kotlin.let' call
        // Inline function 'kotlin.contracts.contract' call
        tmp0_safe_receiver.f1q(true);
        var alreadyRead = tmp0_safe_receiver.j1t(value);
        var tmp;
        if (!alreadyRead) {
          ...
          this.b1r_1.z1r(value, tmp0_safe_receiver);
          var tmp_0;
          if (isInterface(value, DerivedState)) {
            this.d1r_1.m1t(value);
            var this_0 = value.n1t().o1t();
            var k = this_0.u19_1;
            var tmp$ret$4;
            $l$block: {
                      ...
                      do {
                        ...
                        if (slot.rb(new Long(255, 0)).ca(new Long(128, 0)) < 0) {
                          ...
                          if (dependency instanceof StateObjectImpl) {
                            ...
                            dependency.l1t(tmp$ret$3);
                          }
                          this.d1r_1.z1r(dependency, value);
                        }
                        slot = slot.pb(8);
                      }
                       while (inductionVariable_0 < bitCount);
  ...
  protoOf(CompositionImpl).p1t = function (value) {
    // Inline function 'androidx.compose.runtime.synchronized' call
    // Inline function 'kotlinx.atomicfu.locks.synchronized' call
    this.y1q_1;
  ...
  protoOf(CompositionImpl).q1t = function () {
    // Inline function 'androidx.compose.runtime.synchronized' call
    // Inline function 'kotlinx.atomicfu.locks.synchronized' call
    this.y1q_1;
    ...
    try {
      ...
      try {
        ...
        try {
          ...
          // Inline function 'kotlin.also' call
          var this_0 = this.m1r_1.c1q(invalidations);
          // Inline function 'kotlin.contracts.contract' call
  ...
  protoOf(CompositionImpl).r1t = function (references) {
    var tmp$ret$1;
    $l$block: {
      ...
      if (inductionVariable <= last)
        do {
          ...
          if (!equals(item.je_1.c1l_1, this)) {
            tmp$ret$1 = false;
            break $l$block;
          }
        }
  ...
  protoOf(CompositionImpl).s1t = function (state) {
    var manager = new RememberEventDispatcher(this.z1q_1);
    var slotTable = state.k1l_1;
    // Inline function 'androidx.compose.runtime.SlotTable.write' call
    // Inline function 'kotlin.let' call
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'androidx.compose.runtime.SlotTable.write.<anonymous>' call
    var writer = slotTable.d1i();
    var tmp;
    try {
  ...
  protoOf(CompositionImpl).t1t = function () {
    // Inline function 'androidx.compose.runtime.synchronized' call
    // Inline function 'kotlinx.atomicfu.locks.synchronized' call
    this.y1q_1;
    // Inline function 'androidx.compose.runtime.CompositionImpl.guardChanges' call
    ...
    try {
      ...
      try {
        // Inline function 'kotlin.also' call
        applyChangesInLocked(this, this.e1r_1);
        drainPendingModificationsLocked(this);
        // Inline function 'kotlin.contracts.contract' call
        // Inline function 'androidx.compose.runtime.CompositionImpl.trackAbandonedValues.<anonymous>' call
        success = true;
  ...
  protoOf(CompositionImpl).u1t = function () {
    // Inline function 'androidx.compose.runtime.synchronized' call
    // Inline function 'kotlinx.atomicfu.locks.synchronized' call
    this.y1q_1;
    // Inline function 'androidx.compose.runtime.CompositionImpl.guardChanges' call
    ...
    try {
      ...
      try {
        ...
        if (this.f1r_1.i1p()) {
          applyChangesInLocked(this, this.f1r_1);
        }
        // Inline function 'kotlin.contracts.contract' call
        // Inline function 'androidx.compose.runtime.CompositionImpl.trackAbandonedValues.<anonymous>' call
        success = true;
  ...
  protoOf(CompositionImpl).z1n = function () {
    // Inline function 'androidx.compose.runtime.synchronized' call
    // Inline function 'kotlinx.atomicfu.locks.synchronized' call
    this.y1q_1;
    // Inline function 'androidx.compose.runtime.CompositionImpl.guardChanges' call
  ...
  protoOf(CompositionImpl).v1t = function () {
    // Inline function 'androidx.compose.runtime.synchronized' call
    // Inline function 'kotlinx.atomicfu.locks.synchronized' call
    this.y1q_1;
    var indexedObject = this.a1r_1.x1e_1;
    var inductionVariable = 0;
    var last = indexedObject.length;
    while (inductionVariable < last) {
  ...
  protoOf(CompositionImpl).u1l = function (to, groupIndex, block) {
    var tmp;
    if ((!(to == null) ? !equals(to, this) : false) ? groupIndex >= 0 : false) {
      var tmp_0 = this;
      tmp_0.j1r_1 = to instanceof CompositionImpl ? to : THROW_CCE();
      this.k1r_1 = groupIndex;
      var tmp_1;
      try {
        tmp_1 = block();
      }finally {
  ...
  protoOf(CompositionImpl).x1t = function (scope, instance) {
    if (scope.y1t()) {
      scope.q1p(true);
    }
    var anchor = scope.t1c_1;
    if (anchor == null ? true : !anchor.i1s())
      return InvalidationResult_IGNORED_getInstance();
    if (!this.a1r_1.z1t(anchor)) {
      // Inline function 'androidx.compose.runtime.synchronized' call
      // Inline function 'kotlinx.atomicfu.locks.synchronized' call
      this.y1q_1;
      // Inline function 'androidx.compose.runtime.CompositionImpl.invalidate.<anonymous>' call
      var delegate = this.j1r_1;
  ...
  protoOf(CompositionImpl).b1u = function (scope) {
    this.i1r_1 = true;
  };
  protoOf(CompositionImpl).c1u = function (instance, scope) {
    this.b1r_1.x1r(instance, scope);
  };
  protoOf(CompositionImpl).d1u = function (state) {
    if (!this.b1r_1.y1r(state)) {
      this.d1r_1.m1t(state);
    }
  };
  ...
  function ComposableSingletons$CompositionKt() {
    ...
    var tmp = this;
    tmp.x1s_1 = ComposableLambda$invoke$ref_0(composableLambdaInstance(954879418, false, ComposableSingletons$CompositionKt$lambda_1$lambda_xm0u9s));
    var tmp_0 = this;
    tmp_0.y1s_1 = ComposableLambda$invoke$ref_1(composableLambdaInstance(1918065384, false, ComposableSingletons$CompositionKt$lambda_2$lambda_8lgqn5));
  }
  ...
  function addValue(_this__u8e3s4, key, value) {
    _init_properties_Composition_kt__t5pjw8();
    if (_this__u8e3s4.f1u(key)) {
      var tmp0_safe_receiver = _this__u8e3s4.e1u(key);
      if (tmp0_safe_receiver == null)
        null;
      else
        tmp0_safe_receiver.s1q(value);
    } else {
      // Inline function 'kotlin.also' call
      var this_0 = new IdentityArraySet();
      // Inline function 'kotlin.contracts.contract' call
  ...
  protoOf(CompositionContext).p1s = function () {
    return null;
  };
  protoOf(CompositionContext).o1f = function (table) {
  };
  protoOf(CompositionContext).w1s = function (composer) {
  };
  protoOf(CompositionContext).h1f = function () {
    return get_EmptyPersistentCompositionLocalMap();
  };
  protoOf(CompositionContext).g1f = function () {
  };
  protoOf(CompositionContext).q1f = function () {
  };
  protoOf(CompositionContext).j1l = function (reference) {
    return null;
  };
  ...
  function CompositionLocal(defaultFactory) {
    this.c1p_1 = new LazyValueHolder(defaultFactory);
  }
  function ProvidableCompositionLocal(defaultFactory) {
    CompositionLocal.call(this, defaultFactory);
  }
  protoOf(ProvidableCompositionLocal).i1u = function (value) {
  ...
  protoOf(StaticProvidableCompositionLocal).d1p = function (value, previous) {
    return (!(previous == null) ? equals(previous.p2(), value) : false) ? previous : new StaticValueHolder(value);
  };
  ...
  function CompositionLocalProvider(value, content, $composer, $changed) {
    var $composer_0 = $composer;
    $composer_0 = $composer_0.m1p(-1350970552);
    ...
    if (tmp0_safe_receiver == null)
      ...
      tmp0_safe_receiver.k1u(CompositionLocalProvider$lambda(value, content, $changed));
    }
  }
  ...
  protoOf(DynamicProvidableCompositionLocal).d1p = function (value, previous) {
    var tmp;
    var tmp_0;
    if (!(previous == null)) {
    ...
    if (tmp_0) {
      ...
      tmp = mutableStateOf(value, this.m1u_1);
    }
    return tmp;
  };
  ...
  function contains_0(_this__u8e3s4, key) {
    return _this__u8e3s4.s2(key instanceof CompositionLocal ? key : THROW_CCE());
  }
  function getValueOf(_this__u8e3s4, key) {
    var tmp0_safe_receiver = _this__u8e3s4.v2(key instanceof CompositionLocal ? key : THROW_CCE());
    var tmp = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.p2();
  ...
  function derivedStateObservers_0() {
    _init_properties_DerivedState_kt__eqt0x8();
    var tmp0_elvis_lhs = get_derivedStateObservers().kn();
    var tmp;
    if (tmp0_elvis_lhs == null) {
      // Inline function 'kotlin.also' call
      ...
      get_derivedStateObservers().r1u(this_0);
      tmp = this_0;
    } else {
      tmp = tmp0_elvis_lhs;
    }
  ...
  function LaunchedEffect(key1, block, $composer, $changed) {
    ...
    var applyContext = $composer_0.q1n();
    $composer_0.s1n(1036442561);
  ...
  function LaunchedEffect_0(key1, key2, key3, block, $composer, $changed) {
    _init_properties_Effects_kt__be5lps();
    var $composer_0 = $composer;
    $composer_0.s1n(-54093371);
    sourceInformation($composer_0, 'C(LaunchedEffect)P(1,2,3)385@16313L70:Effects.kt#9igjgp');
    if (isTraceInProgress()) {
      traceEventStart(-54093371, $changed, -1, 'androidx.compose.runtime.LaunchedEffect (Effects.kt:383)');
    }
    var applyContext = $composer_0.q1n();
    $composer_0.s1n(1036444607);
    sourceInformation($composer_0, 'CC(remember):Effects.kt#9igjgp');
    // Inline function 'androidx.compose.runtime.cache' call
    var invalid = !!(!!($composer_0.l1f(key1) | $composer_0.l1f(key2)) | $composer_0.l1f(key3));
    // Inline function 'kotlin.let' call
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'androidx.compose.runtime.cache.<anonymous>' call
    var it = $composer_0.y1o();
  ...
  function LaunchedEffectImpl(parentCoroutineContext, task) {
    this.s1u_1 = task;
    this.t1u_1 = CoroutineScope(parentCoroutineContext);
    this.u1u_1 = null;
  }
  protoOf(LaunchedEffectImpl).u1s = function () {
    ...
    this.u1u_1 = launch(this.t1u_1, VOID, VOID, this.s1u_1);
  };
  protoOf(LaunchedEffectImpl).t1s = function () {
    var tmp0_safe_receiver = this.u1u_1;
    if (tmp0_safe_receiver == null)
      null;
    else {
      tmp0_safe_receiver.bj(new LeftCompositionCancellationException());
    }
    this.u1u_1 = null;
  };
  protoOf(LaunchedEffectImpl).v1s = function () {
    var tmp0_safe_receiver = this.u1u_1;
    if (tmp0_safe_receiver == null)
      null;
    else {
  ...
  function DisposableEffect_0(keys, effect, $composer, $changed) {
    ...
    while (inductionVariable < last) {
      ...
      inductionVariable = inductionVariable + 1 | 0;
      invalid = !!(invalid | $composer_1.l1f(key));
    }
    // Inline function 'androidx.compose.runtime.cache' call
    ...
    var tmp;
    if (invalid_0 ? true : it === Companion_getInstance_0().k1i_1) {
      // Inline function 'androidx.compose.runtime.DisposableEffect.<anonymous>' call
      var value = new DisposableEffectImpl(effect);
  ...
  function DisposableEffect_1(key1, key2, effect, $composer, $changed) {
    ...
    $composer_0.s1n(592133067);
    sourceInformation($composer_0, 'CC(remember):Effects.kt#9igjgp');
    // Inline function 'androidx.compose.runtime.cache' call
    var invalid = !!($composer_0.l1f(key1) | $composer_0.l1f(key2));
    // Inline function 'kotlin.let' call
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'androidx.compose.runtime.cache.<anonymous>' call
    var it = $composer_0.y1o();
  ...
  protoOf(JoinedKey).hashCode = function () {
    return imul(hashCodeOf(this, this.x1u_1), 31) + hashCodeOf(this, this.y1u_1) | 0;
  };
  protoOf(JoinedKey).toString = function () {
    return 'JoinedKey(left=' + toString_0(this.x1u_1) + ', right=' + toString_0(this.y1u_1) + ')';
  };
  ...
  function get_monotonicFrameClock(_this__u8e3s4) {
    var tmp0_elvis_lhs = _this__u8e3s4.jc(Key_instance_0);
    var tmp;
    if (tmp0_elvis_lhs == null) {
  ...
  protoOf(OpaqueKey).toString = function () {
    return 'OpaqueKey(key=' + this.z1u_1 + ')';
  };
  protoOf(OpaqueKey).hashCode = function () {
    return getStringHashCode(this.z1u_1);
  };
  ...
  function $awaitDisposeCOROUTINE$0(_this__u8e3s4, onDispose, resultContinuation) {
    ...
    this.j1v_1 = _this__u8e3s4;
    this.k1v_1 = onDispose;
  }
  protoOf($awaitDisposeCOROUTINE$0).oc = function () {
      ...
      try {
        ...
        switch (tmp) {
          ...
          case 1:
            ...
            cancellable.xl();
            suspendResult = returnIfSuspended(cancellable.uj(), this);
            ...
            continue $sm;
          case 2:
            this.l1v_1 = throwKotlinNothingValueException();
            this.dc_1 = 5;
            this.cc_1 = 3;
            continue $sm;
          case 3:
  ...
  function ProduceStateScopeImpl(state, coroutineContext) {
    this.m1v_1 = coroutineContext;
    this.n1v_1 = state;
  }
  protoOf(ProduceStateScopeImpl).th = function () {
    return this.m1v_1;
  };
  protoOf(ProduceStateScopeImpl).c10 = function (_set____db54di) {
    this.n1v_1.c10(_set____db54di);
  };
  protoOf(ProduceStateScopeImpl).p2 = function () {
    return this.n1v_1.p2();
  };
  protoOf(ProduceStateScopeImpl).a1v = function (onDispose, $completion) {
  ...
  protoOf(produceState$slambda).b12 = function ($this$LaunchedEffect, $completion) {
    var tmp = this.c12($this$LaunchedEffect, $completion);
    tmp.ec_1 = Unit_instance;
    tmp.fc_1 = null;
    return tmp.oc();
  };
  protoOf(produceState$slambda).ad = function (p1, $completion) {
    return this.b12((!(p1 == null) ? isInterface(p1, CoroutineScope_0) : false) ? p1 : THROW_CCE(), $completion);
  };
  protoOf(produceState$slambda).oc = function () {
    var suspendResult = this.ec_1;
    $sm: do
      try {
        var tmp = this.cc_1;
        switch (tmp) {
          case 0:
            this.dc_1 = 2;
            this.cc_1 = 1;
            suspendResult = this.w1v_1(new ProduceStateScopeImpl(this.x1v_1, this.y1v_1.th()), this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
  ...
  protoOf(produceState$slambda).c12 = function ($this$LaunchedEffect, completion) {
    var i = new produceState$slambda(this.w1v_1, this.x1v_1, completion);
    i.y1v_1 = $this$LaunchedEffect;
    return i;
  };
  ...
  function _set_rereading__pnqtpo($this, value) {
    if (value) {
      $this.r1c_1 = $this.r1c_1 | 32;
    } else {
      $this.r1c_1 = $this.r1c_1 & -33;
    }
  }
  function _get_rereading__g2iruw($this) {
    return !(($this.r1c_1 & 32) === 0);
  }
  function _set_skipped__p8q2c5($this, value) {
    if (value) {
      $this.r1c_1 = $this.r1c_1 | 16;
    } else {
      $this.r1c_1 = $this.r1c_1 & -17;
    }
  }
  function Companion_1() {
  }
  protoOf(Companion_1).z1v = function (slots, anchors, newOwner) {
    // Inline function 'kotlin.collections.isNotEmpty' call
    if (!anchors.q()) {
      // Inline function 'androidx.compose.runtime.snapshots.fastForEach' call
      // Inline function 'kotlin.contracts.contract' call
      ...
      if (inductionVariable <= last)
        do {
          ...
          var tmp = slots.a1w(item, 0);
          var recomposeScope = tmp instanceof RecomposeScopeImpl ? tmp : null;
          if (recomposeScope == null)
            null;
          else {
            recomposeScope.b1w(newOwner);
          }
        }
         while (inductionVariable <= last);
    }
  };
  protoOf(Companion_1).c1w = function (slots, anchors) {
    var tmp;
    // Inline function 'kotlin.collections.isNotEmpty' call
    if (!anchors.q()) {
      var tmp$ret$2;
      $l$block: {
        ...
        if (inductionVariable <= last)
          do {
            ...
            var tmp_0;
            if (slots.z1t(item)) {
              var tmp_1 = slots.d1w(slots.h1l(item), 0);
  ...
  function RecomposeScopeImpl$end$lambda(this$0, $token, $instances) {
    return function (composition) {
      var tmp;
      var tmp_0;
      if (this$0.w1c_1 === $token ? $instances.equals(this$0.x1c_1) : false) {
                    ...
                    if (slot.rb(new Long(255, 0)).ca(new Long(128, 0)) < 0) {
                      ...
                      if (this_2) {
                        ...
                        if (tmp0_safe_receiver == null)
                          ...
                          composition.d1u(tmp0_safe_receiver);
                          var tmp0_safe_receiver_0 = this$0.y1c_1;
                          var tmp_2;
                          if (tmp0_safe_receiver_0 == null) {
                            tmp_2 = null;
                          } else {
                            // Inline function 'kotlin.let' call
                            // Inline function 'kotlin.contracts.contract' call
                            tmp0_safe_receiver_0.n2(tmp0_safe_receiver);
                            var tmp_3;
  ...
  protoOf(RecomposeScopeImpl).i1s = function () {
    var tmp;
    if (!(this.s1c_1 == null)) {
      var tmp0_safe_receiver = this.t1c_1;
      var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.i1s();
  ...
  protoOf(RecomposeScopeImpl).a1u = function () {
    return !(this.u1c_1 == null);
  };
  protoOf(RecomposeScopeImpl).f1q = function (value) {
    if (value) {
      this.r1c_1 = this.r1c_1 | 1;
    } else {
      this.r1c_1 = this.r1c_1 & -2;
    }
  };
  protoOf(RecomposeScopeImpl).p1j = function () {
    return !((this.r1c_1 & 1) === 0);
  };
  protoOf(RecomposeScopeImpl).x1n = function (value) {
    if (value) {
      this.r1c_1 = this.r1c_1 | 2;
    } else {
      this.r1c_1 = this.r1c_1 & -3;
    }
  };
  protoOf(RecomposeScopeImpl).y1t = function () {
    return !((this.r1c_1 & 2) === 0);
  };
  protoOf(RecomposeScopeImpl).q1p = function (value) {
    if (value) {
      this.r1c_1 = this.r1c_1 | 4;
    } else {
      this.r1c_1 = this.r1c_1 & -5;
    }
  };
  protoOf(RecomposeScopeImpl).y1n = function () {
    return !((this.r1c_1 & 4) === 0);
  };
  protoOf(RecomposeScopeImpl).t1k = function (value) {
    if (value) {
      this.r1c_1 = this.r1c_1 | 8;
    } else {
      this.r1c_1 = this.r1c_1 & -9;
    }
  };
  protoOf(RecomposeScopeImpl).b1o = function () {
    return !((this.r1c_1 & 8) === 0);
  };
  protoOf(RecomposeScopeImpl).j1k = function (composer) {
    var block = this.u1c_1;
    var observer = this.v1c_1;
  ...
  protoOf(RecomposeScopeImpl).w1r = function (value) {
    var tmp0_safe_receiver = this.s1c_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.x1t(this, value);
    return tmp1_elvis_lhs == null ? InvalidationResult_IGNORED_getInstance() : tmp1_elvis_lhs;
  };
  protoOf(RecomposeScopeImpl).um = function () {
    var tmp0_safe_receiver = this.s1c_1;
    if (tmp0_safe_receiver == null)
      null;
    else {
      tmp0_safe_receiver.b1u(this);
    }
    this.s1c_1 = null;
    this.x1c_1 = null;
    this.y1c_1 = null;
    var tmp1_safe_receiver = this.v1c_1;
    if (tmp1_safe_receiver == null)
      null;
    else {
      tmp1_safe_receiver.g1w(this);
    }
  };
  protoOf(RecomposeScopeImpl).b1w = function (owner) {
    this.s1c_1 = owner;
  };
  protoOf(RecomposeScopeImpl).w1t = function () {
    var tmp0_safe_receiver = this.s1c_1;
    if (tmp0_safe_receiver == null)
      null;
    else
      tmp0_safe_receiver.x1t(this, null);
  };
  protoOf(RecomposeScopeImpl).k1u = function (block) {
    this.u1c_1 = block;
  };
  protoOf(RecomposeScopeImpl).s1k = function (value) {
    if (value) {
      this.r1c_1 = this.r1c_1 | 64;
    } else {
      this.r1c_1 = this.r1c_1 & -65;
    }
  };
  protoOf(RecomposeScopeImpl).r1k = function () {
    return !((this.r1c_1 & 64) === 0);
  };
  protoOf(RecomposeScopeImpl).r1p = function () {
    return !((this.r1c_1 & 16) === 0);
  };
  protoOf(RecomposeScopeImpl).u1k = function (token) {
    this.w1c_1 = token;
  ...
  protoOf(RecomposeScopeImpl).j1t = function (instance) {
    ...
    var token = tmp.e1a(instance, this.w1c_1, -1);
    if (token === this.w1c_1) {
      return true;
    }
    if (isInterface(instance, DerivedState)) {
      var tmp1_elvis_lhs = this.y1c_1;
      var tmp_0;
      if (tmp1_elvis_lhs == null) {
        // Inline function 'kotlin.also' call
      ...
      var tracked = tmp_0;
      tracked.s1a(instance, instance.n1t().h1w());
    }
    return false;
  };
  protoOf(RecomposeScopeImpl).v1r = function () {
    return !(this.y1c_1 == null);
  };
  protoOf(RecomposeScopeImpl).z1c = function (instances) {
    if (instances == null)
      return true;
      ...
      $l$block_0: {
        ...
        while (tmp0_iterator.z()) {
          ...
          if (isInterface(element, DerivedState)) {
            ...
            if (!isInterface(element, DerivedState))
              THROW_CCE();
            var tmp0_elvis_lhs_0 = element.o1u();
            var policy = tmp0_elvis_lhs_0 == null ? structuralEqualityPolicy() : tmp0_elvis_lhs_0;
            tmp_2 = policy.i1w(element.n1t().h1w(), trackedDependencies.v2(element));
          } else {
            tmp_2 = false;
          }
          if (!tmp_2) {
  ...
  protoOf(RecomposeScopeImpl).i1k = function () {
    ...
    if (tmp0_safe_receiver == null)
      ...
      var tmp0_safe_receiver_0 = this.x1c_1;
      var tmp;
      if (tmp0_safe_receiver_0 == null) {
        tmp = null;
      } else {
        ...
        var tmp_0;
        try {
          var k = tmp0_safe_receiver_0.u19_1;
          var v = tmp0_safe_receiver_0.v19_1;
          var tmp$ret$2;
          $l$block: {
            // Inline function 'androidx.collection.ObjectIntMap.forEachIndexed' call
            var m = tmp0_safe_receiver_0.t19_1;
            var lastIndex = m.length - 2 | 0;
            var inductionVariable = 0;
            if (inductionVariable <= lastIndex)
              do {
                ...
                // Inline function 'androidx.collection.maskEmptyOrDeleted' call
                var this_0 = slot;
                if (!this_0.rb(this_0.nb().ob(7)).rb(get_BitmaskMsb()).equals(get_BitmaskMsb())) {
                  var bitCount = 8 - (~(i - lastIndex | 0) >>> 31 | 0) | 0;
                  var inductionVariable_0 = 0;
                  if (inductionVariable_0 < bitCount)
                    do {
  ...
  protoOf(RecomposeScopeImpl).o1p = function (token) {
    var tmp0_safe_receiver = this.x1c_1;
    var tmp;
    if (tmp0_safe_receiver == null) {
      tmp = null;
    } else {
      ...
      if (!this.r1p()) {
        ...
        $l$block: {
          ...
          var k = tmp0_safe_receiver.u19_1;
          var v = tmp0_safe_receiver.v19_1;
          $l$block_0: {
            // Inline function 'androidx.collection.ObjectIntMap.forEachIndexed' call
            var m = tmp0_safe_receiver.t19_1;
            var lastIndex = m.length - 2 | 0;
            var inductionVariable = 0;
            if (inductionVariable <= lastIndex)
              do {
  ...
  function addRunning($this, info) {
    $l$loop: while (true) {
      var old = $this.j1w_1.p2();
      var new_0 = old.w(info);
      if (old === new_0 ? true : $this.j1w_1.d10(old, new_0))
        break $l$loop;
    }
  }
    ...
    return function (frameTime) {
      ...
      if (_get_hasBroadcastFrameClockAwaiters__y6inql(this$0)) {
        $l$block: {
          ...
          var token = Trace_instance.v1l(sectionName);
          try {
            this$0.m1w_1.i1c(frameTime);
            Companion_instance_12.j1x();
            break $l$block;
          }finally {
            Trace_instance.k1m(token);
          }
      ...
      $l$block_0: {
        ...
        try {
            ...
            if ($modifiedValues.i1p()) {
              ...
              if (inductionVariable_1 <= last_1) {
                do {
                  ...
                  // Inline function 'androidx.compose.runtime.Recomposer.runRecomposeAndApplyChanges.<anonymous>.<anonymous>.<anonymous>.<anonymous>.<anonymous>' call
                  if (!$alreadyComposed.k1x(item_1) ? item_1.h1t($modifiedValues) : false) {
                    // Inline function 'kotlin.collections.plusAssign' call
                    $toRecompose.w(item_1);
                  }
                }
          ...
          if (!$toApply.q()) {
            ...
            tmp0_this.l1w_1 = tmp0_this.l1w_1.kb();
            try {
              // Inline function 'androidx.compose.runtime.snapshots.fastForEach' call
              var this_4 = $toApply;
              // Inline function 'kotlin.contracts.contract' call
  ...
  function Recomposer$recompositionRunner$slambda$lambda(this$0) {
    return function (changed, _anonymous_parameter_1__qggqgd) {
      ...
      var tmp;
      if (this$0.f1x_1.p2().z9(State_Idle_getInstance()) >= 0) {
        // Inline function 'androidx.compose.runtime.collection.fastForEach' call
        if (changed instanceof IdentityArraySet) {
          // Inline function 'androidx.compose.runtime.collection.IdentityArraySet.fastForEach' call
          // Inline function 'kotlin.contracts.contract' call
          var values = changed.t1l_1;
          var inductionVariable = 0;
          var last = changed.s1l_1;
          if (inductionVariable < last)
            do {
              var i = inductionVariable;
              inductionVariable = inductionVariable + 1 | 0;
      ...
      if (tmp0_safe_receiver == null)
        ...
        tmp0_safe_receiver.r6(tmp$ret$7);
      }
      return Unit_instance;
    };
  }
  function Recomposer$recompositionRunner$slambda$slambda($block, $parentFrameClock, resultContinuation) {
    this.v1x_1 = $block;
    this.w1x_1 = $parentFrameClock;
    CoroutineImpl.call(this, resultContinuation);
  }
  protoOf(Recomposer$recompositionRunner$slambda$slambda).b12 = function ($this$coroutineScope, $completion) {
    var tmp = this.c12($this$coroutineScope, $completion);
    tmp.ec_1 = Unit_instance;
    tmp.fc_1 = null;
    return tmp.oc();
  };
  protoOf(Recomposer$recompositionRunner$slambda$slambda).ad = function (p1, $completion) {
    return this.b12((!(p1 == null) ? isInterface(p1, CoroutineScope_0) : false) ? p1 : THROW_CCE(), $completion);
  };
  protoOf(Recomposer$recompositionRunner$slambda$slambda).oc = function () {
    var suspendResult = this.ec_1;
    $sm: do
      try {
        var tmp = this.cc_1;
        switch (tmp) {
          case 0:
            this.dc_1 = 2;
            this.cc_1 = 1;
            suspendResult = this.v1x_1(this.x1x_1, this.w1x_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
  ...
  protoOf(Recomposer$recompositionRunner$slambda$slambda).c12 = function ($this$coroutineScope, completion) {
    var i = new Recomposer$recompositionRunner$slambda$slambda(this.v1x_1, this.w1x_1, completion);
    i.x1x_1 = $this$coroutineScope;
    return i;
  };
  ...
  function _get_hasBroadcastFrameClockAwaitersLocked__7l4pm1($this) {
    return !$this.e1x_1 ? $this.m1w_1.h1c() : false;
  }
  ...
  function deriveStateLocked($this) {
    if ($this.f1x_1.p2().z9(State_ShuttingDown_getInstance()) <= 0) {
      clearKnownCompositionsLocked($this);
      $this.s1w_1 = new IdentityArraySet();
      $this.t1w_1.e1();
      $this.u1w_1.e1();
      $this.v1w_1.e1();
      $this.y1w_1 = null;
  ...
  function _get_shouldKeepRecomposing__5j79sd($this) {
    ...
    if (!$this.c1x_1) {
      ...
      $l$block: {
        ...
        var tmp0_iterator = $this.g1x_1.mn().l();
        while (tmp0_iterator.z()) {
          var element = tmp0_iterator.b1();
          // Inline function 'androidx.compose.runtime.Recomposer.<get-shouldKeepRecomposing>.<anonymous>' call
          if (element.uh()) {
  ...
  function processCompositionError($this, e, failedInitialComposition, recoverable) {
    ...
    if (tmp) {
      ...
      $this.w1w_1.e1();
      $this.x1w_1.e1();
      $this.d1x_1 = new RecomposerErrorState(recoverable, e);
      if (!(failedInitialComposition == null)) {
        var tmp0_elvis_lhs = $this.y1w_1;
        var tmp_0;
        if (tmp0_elvis_lhs == null) {
          // Inline function 'kotlin.also' call
          // Inline function 'kotlin.collections.mutableListOf' call
        ...
        if (!failedCompositions.o(failedInitialComposition)) {
          // Inline function 'kotlin.collections.plusAssign' call
          failedCompositions.w(failedInitialComposition);
        }
      ...
      // Inline function 'kotlinx.atomicfu.locks.synchronized' call
      $this.n1w_1;
      var errorState = $this.d1x_1;
      var tmp_1;
      if (errorState == null) {
        $this.d1x_1 = new RecomposerErrorState(false, e);
        tmp_1 = Unit_instance;
      } else {
        throw errorState.a1y_1;
      }
      throw e;
    }
  }
  ...
  function recompositionRunner($this, block, $completion) {
    ...
    var tmp$ret$0 = $completion.q6();
    var parentFrameClock = get_monotonicFrameClock(tmp$ret$0);
    return withContext($this.m1w_1, Recomposer$recompositionRunner$slambda_0($this, block, parentFrameClock, null), $completion);
  }
    ...
    $l$block: {
      ...
      if (inductionVariable <= last)
        do {
          ...
          if (equals(item.c1l_1, composition)) {
            tmp$ret$1 = true;
            break $l$block;
          }
        }
  ...
  function performRecompose($this, composition, modifiedValues) {
    var tmp;
    if (composition.l1s() ? true : composition.z1s()) {
      tmp = true;
    } else {
    ...
    $l$block_0: {
      ...
      var snapshot = Companion_instance_12.l1y(readObserverOf($this, composition), writeObserverOf($this, composition, modifiedValues));
      try {
        var tmp$ret$1;
        $l$block: {
          // Inline function 'androidx.compose.runtime.snapshots.Snapshot.enter' call
          var previous = snapshot.m1y();
          try {
            // Inline function 'androidx.compose.runtime.Recomposer.performRecompose.<anonymous>' call
            if ((modifiedValues == null ? null : modifiedValues.i1p()) === true) {
              composition.b1q(Recomposer$performRecompose$lambda(modifiedValues, composition));
            }
            tmp$ret$1 = composition.q1t();
            break $l$block;
          }finally {
            snapshot.n1y(previous);
          }
        }
        break $l$block_0;
      }finally {
  ...
  function performInsertValues($this, references, modifiedValues) {
    ...
    // Inline function 'kotlin.collections.iterator' call
    var tmp0_iterator = tasks.l2().l();
    while (tmp0_iterator.z()) {
      var tmp1_loop_parameter = tmp0_iterator.b1();
      // Inline function 'kotlin.collections.component1' call
      var composition = tmp1_loop_parameter.o2();
      // Inline function 'kotlin.collections.component2' call
      var refs = tmp1_loop_parameter.p2();
      runtimeCheck(!composition.l1s());
      $l$block_0: {
        // Inline function 'androidx.compose.runtime.Recomposer.composing' call
        var snapshot = Companion_instance_12.l1y(readObserverOf($this, composition), writeObserverOf($this, composition, modifiedValues));
        try {
            ...
            try {
              ...
              if (inductionVariable_0 <= last_0)
                do {
                  ...
                  var element = to(item_0, removeLastMultiValue($this.w1w_1, item_0.a1l_1));
                  target.w(element);
                }
                 while (inductionVariable_0 <= last_0);
              var pairs = target;
              composition.r1t(pairs);
              break $l$block;
            }finally {
              snapshot.n1y(previous);
            }
  ...
  function discardUnusedValues($this) {
    ...
    // Inline function 'kotlin.collections.isNotEmpty' call
    if (!$this.w1w_1.q()) {
      var references = flatten($this.w1w_1.k2());
      $this.w1w_1.e1();
      // Inline function 'androidx.compose.runtime.snapshots.fastMap' call
      // Inline function 'kotlin.contracts.contract' call
      ...
      if (inductionVariable <= last)
        do {
          ...
          var element = to(item, $this.x1w_1.v2(item));
          target.w(element);
        }
         while (inductionVariable <= last);
    ...
    if (inductionVariable_0 <= last_0)
      do {
        ...
        // Inline function 'androidx.compose.runtime.Recomposer.discardUnusedValues.<anonymous>' call
        var reference = item_0.le();
        var state = item_0.me();
        if (!(state == null)) {
          reference.c1l_1.s1t(state);
        }
      }
       while (inductionVariable_0 <= last_0);
  }
  ...
  function Companion_2() {
    ...
    this.j1w_1 = MutableStateFlow(persistentSetOf());
    this.k1w_1 = new AtomicReference(false);
  }
  ...
  function performInitialMovableContentInserts$fillToInsert(toInsert, this$0, $composition) {
    ...
    // Inline function 'kotlinx.atomicfu.locks.synchronized' call
    this$0.n1w_1;
    var iterator = this$0.v1w_1.l();
    while (iterator.z()) {
      var value = iterator.b1();
      if (equals(value.c1l_1, $composition)) {
        toInsert.w(value);
        iterator.a1();
      }
    }
  ...
  function Recomposer$broadcastFrameClock$lambda(this$0) {
    return function () {
      ...
      if (this$0.f1x_1.p2().z9(State_ShuttingDown_getInstance()) <= 0)
        throw CancellationException_init_$Create$('Recomposer shutdown; frame clock awaiter will never resume', this$0.p1w_1);
      if (this_0 == null)
        null;
      else {
        // Inline function 'kotlin.coroutines.resume' call
  ...
  function Recomposer$effectJob$lambda$lambda(this$0, $throwable) {
    return function (runnerJobCause) {
      ...
      tmp.p1w_1 = tmp_0;
      this$0.f1x_1.c10(State_ShutDown_getInstance());
      return Unit_instance;
    };
  }
  function Recomposer$effectJob$lambda(this$0) {
    return function (throwable) {
      ...
      var runnerJob = this$0.o1w_1;
      var tmp;
      if (!(runnerJob == null)) {
        this$0.f1x_1.c10(State_ShuttingDown_getInstance());
        if (!this$0.c1x_1) {
          runnerJob.bj(cancellation);
        } else if (!(this$0.a1x_1 == null)) {
          continuationToResume = this$0.a1x_1;
        }
        this$0.a1x_1 = null;
        tmp = runnerJob.wi(Recomposer$effectJob$lambda$lambda(this$0, throwable));
      } else {
        this$0.p1w_1 = cancellation;
        this$0.f1x_1.c10(State_ShutDown_getInstance());
        tmp = Unit_instance;
      }
      ...
      if (tmp0_safe_receiver == null)
        ...
        tmp0_safe_receiver.r6(tmp$ret$3);
      }
      return Unit_instance;
    };
  }
  ...
  protoOf(Recomposer$runRecomposeAndApplyChanges$slambda).u1z = function ($this$recompositionRunner, parentFrameClock, $completion) {
    var tmp = this.v1z($this$recompositionRunner, parentFrameClock, $completion);
    tmp.ec_1 = Unit_instance;
    tmp.fc_1 = null;
    return tmp.oc();
  };
  protoOf(Recomposer$runRecomposeAndApplyChanges$slambda).w1z = function (p1, p2, $completion) {
    var tmp = (!(p1 == null) ? isInterface(p1, CoroutineScope_0) : false) ? p1 : THROW_CCE();
    return this.u1z(tmp, (!(p2 == null) ? isInterface(p2, MonotonicFrameClock) : false) ? p2 : THROW_CCE(), $completion);
  };
  protoOf(Recomposer$runRecomposeAndApplyChanges$slambda).oc = function () {
    var suspendResult = this.ec_1;
    $sm: do
      try {
        var tmp = this.cc_1;
        switch (tmp) {
          case 0:
            this.dc_1 = 6;
            var tmp_0 = this;
            tmp_0.n1z_1 = ArrayList_init_$Create$();
            var tmp_1 = this;
            tmp_1.o1z_1 = ArrayList_init_$Create$();
            var tmp_2 = this;
            tmp_2.p1z_1 = ArrayList_init_$Create$();
            var tmp_3 = this;
            tmp_3.q1z_1 = LinkedHashSet_init_$Create$();
            var tmp_4 = this;
            tmp_4.r1z_1 = LinkedHashSet_init_$Create$();
            this.s1z_1 = new IdentityArraySet();
            this.t1z_1 = new IdentityArraySet();
            this.cc_1 = 1;
            continue $sm;
          case 1:
            if (!_get_shouldKeepRecomposing__5j79sd(this.k1z_1)) {
              this.cc_1 = 5;
              continue $sm;
            }

            this.cc_1 = 2;
            suspendResult = awaitWorkAvailable(this.k1z_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
            ...
            continue $sm;
          case 2:
            if (!recordComposerModifications(this.k1z_1)) {
              this.cc_1 = 1;
              continue $sm;
            } else {
              this.cc_1 = 3;
          ...
          case 3:
            this.cc_1 = 4;
            suspendResult = this.m1z_1.j1c(Recomposer$runRecomposeAndApplyChanges$slambda$lambda(this.k1z_1, this.n1z_1, this.s1z_1, this.t1z_1, this.o1z_1, this.p1z_1, this.q1z_1, this.r1z_1), this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
            ...
            continue $sm;
          case 4:
            discardUnusedValues(this.k1z_1);
            this.cc_1 = 1;
            continue $sm;
          case 5:
            return Unit_instance;
  ...
  protoOf(Recomposer$runRecomposeAndApplyChanges$slambda).v1z = function ($this$recompositionRunner, parentFrameClock, completion) {
    var i = new Recomposer$runRecomposeAndApplyChanges$slambda(this.k1z_1, completion);
    i.l1z_1 = $this$recompositionRunner;
    i.m1z_1 = parentFrameClock;
    return i;
  };
  function Recomposer$runRecomposeAndApplyChanges$slambda_0(this$0, resultContinuation) {
    ...
    var l = function ($this$recompositionRunner, parentFrameClock, $completion) {
      return i.u1z($this$recompositionRunner, parentFrameClock, $completion);
    };
    l.$arity = 2;
    return l;
  }
  function Recomposer$recompositionRunner$slambda(this$0, $block, $parentFrameClock, resultContinuation) {
    this.f20_1 = this$0;
    this.g20_1 = $block;
    this.h20_1 = $parentFrameClock;
    CoroutineImpl.call(this, resultContinuation);
  }
  protoOf(Recomposer$recompositionRunner$slambda).b12 = function ($this$withContext, $completion) {
    var tmp = this.c12($this$withContext, $completion);
    tmp.ec_1 = Unit_instance;
    tmp.fc_1 = null;
    return tmp.oc();
  };
  protoOf(Recomposer$recompositionRunner$slambda).ad = function (p1, $completion) {
    return this.b12((!(p1 == null) ? isInterface(p1, CoroutineScope_0) : false) ? p1 : THROW_CCE(), $completion);
  };
  protoOf(Recomposer$recompositionRunner$slambda).oc = function () {
    var suspendResult = this.ec_1;
    $sm: do
      try {
        var tmp = this.cc_1;
        switch (tmp) {
          case 0:
            this.dc_1 = 5;
            this.j20_1 = get_job(this.i20_1.th());
            registerRunnerJob(this.f20_1, this.j20_1);
            var tmp_0 = this;
            var tmp_1 = Companion_instance_12;
            tmp_0.k20_1 = tmp_1.m20(Recomposer$recompositionRunner$slambda$lambda(this.f20_1));
            addRunning(Companion_getInstance_3(), this.f20_1.i1x_1);
            this.cc_1 = 1;
            continue $sm;
          case 1:
            this.dc_1 = 4;
            this.f20_1.n1w_1;
            var this_0 = _get_knownCompositions__y8veaj(this.f20_1);
            var inductionVariable = 0;
            var last = this_0.j() - 1 | 0;
            if (inductionVariable <= last)
              do {
               ...
               while (inductionVariable <= last);
            this.cc_1 = 2;
            suspendResult = coroutineScope(Recomposer$recompositionRunner$slambda$slambda_0(this.g20_1, this.h20_1, null), this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 3:
            ...
            this.k20_1.yl();
            this.f20_1.n1w_1;
            if (this.f20_1.o1w_1 === this.j20_1) {
              this.f20_1.o1w_1 = null;
            }

            deriveStateLocked(this.f20_1);
            removeRunning(Companion_getInstance_3(), this.f20_1.i1x_1);
            return Unit_instance;
          case 4:
            this.dc_1 = 5;
            var t = this.fc_1;
  ...
  protoOf(Recomposer$recompositionRunner$slambda).c12 = function ($this$withContext, completion) {
    var i = new Recomposer$recompositionRunner$slambda(this.f20_1, this.g20_1, this.h20_1, completion);
    i.i20_1 = $this$withContext;
    return i;
  };
  function Recomposer$recompositionRunner$slambda_0(this$0, $block, $parentFrameClock, resultContinuation) {
    ...
    var l = function ($this$withContext, $completion) {
      return i.b12($this$withContext, $completion);
    };
    l.$arity = 1;
    return l;
  }
  function Recomposer$performRecompose$lambda($modifiedValues, $composition) {
    return function () {
      ...
      // Inline function 'kotlin.contracts.contract' call
      var values = this_0.t1l_1;
      var inductionVariable = 0;
      var last = this_0.s1l_1;
      var tmp;
      if (inductionVariable < last) {
        do {
          var i = inductionVariable;
  ...
  protoOf($awaitWorkAvailableCOROUTINE$2).oc = function () {
    var suspendResult = this.ec_1;
    $sm: do
      try {
        var tmp = this.cc_1;
        switch (tmp) {
          case 0:
            this.dc_1 = 3;
            if (!_get_hasSchedulingWork__b617oy(this.k1y_1)) {
              this.cc_1 = 1;
              var cancellable = new CancellableContinuationImpl(intercepted(this), get_MODE_CANCELLABLE());
              cancellable.xl();
              this.k1y_1.n1w_1;
              ...
              if (tmp0_safe_receiver == null)
                ...
                tmp0_safe_receiver.r6(_Result___init__impl__xyqfz8(Unit_instance));
              }
              suspendResult = returnIfSuspended(cancellable.uj(), this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
  ...
  function Recomposer(effectCoroutineContext) {
    ...
    var tmp = this;
    tmp.m1w_1 = new BroadcastFrameClock(Recomposer$broadcastFrameClock$lambda(this));
    this.n1w_1 = createSynchronizedObject();
    this.o1w_1 = null;
    this.p1w_1 = null;
    var tmp_0 = this;
    // Inline function 'kotlin.collections.mutableListOf' call
    tmp_0.q1w_1 = ArrayList_init_$Create$();
    this.r1w_1 = null;
    this.s1w_1 = new IdentityArraySet();
    var tmp_1 = this;
    // Inline function 'kotlin.collections.mutableListOf' call
    tmp_1.t1w_1 = ArrayList_init_$Create$();
    var tmp_2 = this;
    // Inline function 'kotlin.collections.mutableListOf' call
    tmp_2.u1w_1 = ArrayList_init_$Create$();
    var tmp_3 = this;
    // Inline function 'kotlin.collections.mutableListOf' call
    tmp_3.v1w_1 = ArrayList_init_$Create$();
    var tmp_4 = this;
    // Inline function 'kotlin.collections.mutableMapOf' call
    tmp_4.w1w_1 = LinkedHashMap_init_$Create$();
    var tmp_5 = this;
    // Inline function 'kotlin.collections.mutableMapOf' call
    tmp_5.x1w_1 = LinkedHashMap_init_$Create$();
    this.y1w_1 = null;
    this.z1w_1 = null;
    this.a1x_1 = null;
    this.b1x_1 = 0;
    ...
    this.d1x_1 = null;
    this.e1x_1 = false;
    this.f1x_1 = MutableStateFlow(State_Inactive_getInstance());
    var tmp_6 = this;
    // Inline function 'kotlin.apply' call
    var this_0 = Job(effectCoroutineContext.jc(Key_instance));
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'androidx.compose.runtime.Recomposer.effectJob.<anonymous>' call
    this_0.wi(Recomposer$effectJob$lambda(this));
    tmp_6.g1x_1 = this_0;
    this.h1x_1 = effectCoroutineContext.cg(this.m1w_1).cg(this.g1x_1);
    this.i1x_1 = new RecomposerInfoImpl(this);
  }
  protoOf(Recomposer).r1n = function () {
    return this.h1x_1;
  };
  protoOf(Recomposer).n20 = function ($completion) {
    return recompositionRunner(this, Recomposer$runRecomposeAndApplyChanges$slambda_0(this, null), $completion);
  };
  protoOf(Recomposer).r1r = function (composition, content) {
    var composerWasComposing = composition.l1s();
    try {
      $l$block_0: {
        // Inline function 'androidx.compose.runtime.Recomposer.composing' call
        var snapshot = Companion_instance_12.l1y(readObserverOf(this, composition), writeObserverOf(this, composition, null));
        try {
          $l$block: {
            // Inline function 'androidx.compose.runtime.snapshots.Snapshot.enter' call
            var previous = snapshot.m1y();
            try {
              composition.b1t(content);
              break $l$block;
            }finally {
              snapshot.n1y(previous);
            }
  ...
  protoOf(Recomposer).p1f = function () {
    return 1000;
  };
  protoOf(Recomposer).m1f = function () {
    return false;
  };
  protoOf(Recomposer).n1f = function () {
    return false;
  };
  protoOf(Recomposer).o1f = function (table) {
  };
  protoOf(Recomposer).o1s = function (composition) {
    // Inline function 'androidx.compose.runtime.synchronized' call
    // Inline function 'kotlinx.atomicfu.locks.synchronized' call
    this.n1w_1;
    // Inline function 'androidx.compose.runtime.Recomposer.invalidate.<anonymous>' call
    var tmp;
    if (!this.t1w_1.o(composition)) {
      // Inline function 'kotlin.collections.plusAssign' call
      this.t1w_1.w(composition);
  ...
  protoOf(Recomposer).f1n = function (reference) {
    // Inline function 'androidx.compose.runtime.synchronized' call
    // Inline function 'kotlinx.atomicfu.locks.synchronized' call
    this.n1w_1;
    // Inline function 'androidx.compose.runtime.Recomposer.deletedMovableContent.<anonymous>' call
    addMultiValue(this.w1w_1, reference.a1l_1, reference);
  };
  protoOf(Recomposer).g1u = function (reference, data) {
    // Inline function 'androidx.compose.runtime.synchronized' call
    // Inline function 'kotlinx.atomicfu.locks.synchronized' call
    this.n1w_1;
    this.x1w_1.m2(reference, data);
  };
  protoOf(Recomposer).e1n = function (composition) {
    // Inline function 'androidx.compose.runtime.synchronized' call
    // Inline function 'kotlinx.atomicfu.locks.synchronized' call
    this.n1w_1;
    // Inline function 'androidx.compose.runtime.Recomposer.reportRemovedComposition.<anonymous>' call
    var tmp0_elvis_lhs = this.z1w_1;
    var tmp;
    if (tmp0_elvis_lhs == null) {
      // Inline function 'kotlin.also' call
      // Inline function 'kotlin.collections.mutableSetOf' call
    ...
    compositionsRemoved.w(composition);
  };
  protoOf(Recomposer).j1l = function (reference) {
    // Inline function 'androidx.compose.runtime.synchronized' call
    // Inline function 'kotlinx.atomicfu.locks.synchronized' call
    this.n1w_1;
    // Inline function 'androidx.compose.runtime.Recomposer.movableContentStateResolve.<anonymous>' call
    return this.x1w_1.n2(reference);
  };
  ...
  function SlotTable() {
    ...
    this.y1e_1 = 0;
    this.z1e_1 = 0;
    this.a1f_1 = new SynchronizedObject();
    this.b1f_1 = false;
    this.c1f_1 = 0;
    var tmp_2 = this;
    // Inline function 'kotlin.collections.arrayListOf' call
    tmp_2.d1f_1 = ArrayList_init_$Create$();
    this.e1f_1 = null;
  }
  protoOf(SlotTable).g1k = function () {
    return this.w1e_1 === 0;
  };
  protoOf(SlotTable).f1f = function () {
    if (this.b1f_1) {
      // Inline function 'kotlin.error' call
  ...
  protoOf(SlotTable).d1i = function () {
    // Inline function 'androidx.compose.runtime.runtimeCheck' call
    if (!!this.b1f_1) {
    ...
    this.b1f_1 = true;
    this.c1f_1 = this.c1f_1 + 1 | 0;
    return new SlotWriter(this);
  };
  protoOf(SlotTable).b1j = function (index) {
    // Inline function 'androidx.compose.runtime.runtimeCheck' call
    if (!!this.b1f_1) {
    ...
    // Inline function 'kotlin.require' call
    // Inline function 'kotlin.contracts.contract' call
    if (!(0 <= index ? index < this.w1e_1 : false)) {
      // Inline function 'androidx.compose.runtime.SlotTable.anchor.<anonymous>' call
  ...
  protoOf(SlotTable).o20 = function (index) {
    // Inline function 'androidx.compose.runtime.runtimeCheck' call
    if (!!this.b1f_1) {
    ...
    return (0 <= index ? index < this.w1e_1 : false) ? find(this.d1f_1, index, this.w1e_1) : null;
  };
  protoOf(SlotTable).h1l = function (anchor) {
    // Inline function 'androidx.compose.runtime.runtimeCheck' call
    if (!!this.b1f_1) {
  ...
  protoOf(SlotTable).z1t = function (anchor) {
    var tmp;
    if (anchor.i1s()) {
      // Inline function 'kotlin.let' call
      // Inline function 'kotlin.contracts.contract' call
      // Inline function 'androidx.compose.runtime.SlotTable.ownsAnchor.<anonymous>' call
      var it = search$accessor$145qfty(this.d1f_1, anchor.e1m_1, this.w1e_1);
      tmp = it >= 0 ? equals(this.d1f_1.k(it), anchor) : false;
    } else {
      tmp = false;
    }
    return tmp;
  };
  protoOf(SlotTable).m1s = function (groupIndex, anchor) {
    // Inline function 'androidx.compose.runtime.runtimeCheck' call
    if (!!this.b1f_1) {
    ...
    // Inline function 'androidx.compose.runtime.runtimeCheck' call
    if (!(0 <= groupIndex ? groupIndex < this.w1e_1 : false)) {
      // Inline function 'androidx.compose.runtime.SlotTable.groupContainsAnchor.<anonymous>' call
    ...
    var tmp;
    if (this.z1t(anchor)) {
      var containsUpper = groupIndex + groupSize(this.v1e_1, groupIndex) | 0;
      var containsArg = anchor.e1m_1;
  ...
  protoOf(SlotTable).p20 = function (reader, sourceInformationMap) {
    // Inline function 'androidx.compose.runtime.runtimeCheck' call
    if (!(reader.e1g_1 === this ? this.z1e_1 > 0 : false)) {
    ...
    if (!(sourceInformationMap == null)) {
      ...
      // Inline function 'kotlinx.atomicfu.locks.synchronized' call
      this.a1f_1;
      var thisMap = this.e1f_1;
      var tmp;
      if (!(thisMap == null)) {
        thisMap.l3(sourceInformationMap);
        tmp = Unit_instance;
      } else {
        this.e1f_1 = sourceInformationMap;
        tmp = Unit_instance;
      }
    }
  };
  protoOf(SlotTable).q20 = function (writer, groups, groupsSize, slots, slotsSize, anchors, sourceInformationMap) {
    // Inline function 'kotlin.require' call
    // Inline function 'kotlin.contracts.contract' call
    if (!(writer.t1g_1 === this ? this.b1f_1 : false)) {
      // Inline function 'androidx.compose.runtime.SlotTable.close.<anonymous>' call
      var message = 'Unexpected writer close()';
      throw IllegalArgumentException_init_$Create$(toString(message));
    }
    this.b1f_1 = false;
    this.r20(groups, groupsSize, slots, slotsSize, anchors, sourceInformationMap);
  };
  protoOf(SlotTable).r20 = function (groups, groupsSize, slots, slotsSize, anchors, sourceInformationMap) {
    this.v1e_1 = groups;
    this.w1e_1 = groupsSize;
    this.x1e_1 = slots;
    this.y1e_1 = slotsSize;
    this.d1f_1 = anchors;
    this.e1f_1 = sourceInformationMap;
  };
  protoOf(SlotTable).q1m = function () {
    return this.w1e_1 > 0 ? containsMark(this.v1e_1, 0) : false;
  };
  protoOf(SlotTable).s20 = function (group) {
    ...
    if (tmp0_safe_receiver == null) {
      ...
      var tmp0_safe_receiver_0 = this.o20(group);
      var tmp_0;
      if (tmp0_safe_receiver_0 == null) {
        tmp_0 = null;
      } else {
        ...
        tmp_0 = tmp0_safe_receiver.v2(tmp0_safe_receiver_0);
      }
      tmp = tmp_0;
    }
    return tmp;
  };
  protoOf(SlotTable).d1w = function (group, slotIndex) {
    var start = slotAnchor(this.v1e_1, group);
    var end = (group + 1 | 0) < this.w1e_1 ? dataAnchor(this.v1e_1, group + 1 | 0) : this.x1e_1.length;
    var len = end - start | 0;
    var tmp;
    if (0 <= slotIndex ? slotIndex < len : false) {
      return this.x1e_1[start + slotIndex | 0];
    } else {
      tmp = Companion_getInstance_0().k1i_1;
    }
    return tmp;
  ...
  function moveGroup($this, fromWriter, fromIndex, toWriter, updateFromCursor, updateToCursor, removeSourceGroup) {
    ...
    insertSlots(toWriter, slotsToMove, toWriter.k1h_1);
    if (fromWriter.y1g_1 < sourceGroupsEnd) {
      moveGroupGapTo(fromWriter, sourceGroupsEnd);
    }
    if (fromWriter.c1h_1 < sourceSlotsEnd) {
      moveSlotGapTo(fromWriter, sourceSlotsEnd, sourceGroupsEnd);
    }
    var groups = toWriter.u1g_1;
    var currentGroup = toWriter.k1h_1;
    // Inline function 'kotlin.collections.copyInto' call
    var this_0 = fromWriter.u1g_1;
    ...
    var slots = toWriter.v1g_1;
    var currentSlot = toWriter.a1h_1;
    // Inline function 'kotlin.collections.copyInto' call
    var this_1 = fromWriter.v1g_1;
    arrayCopy(this_1, slots, currentSlot, sourceSlotsStart, sourceSlotsEnd);
    var parent = toWriter.m1h_1;
    ...
    var slotsGapOwner = toWriter.e1h_1;
    var slotsGapLen = toWriter.d1h_1;
    ...
    if (inductionVariable < moveEnd)
      do {
        ...
        // Inline function 'kotlin.contracts.contract' call
        // Inline function 'androidx.compose.runtime.Companion.moveGroup.<anonymous>' call
        var newDataAnchor = dataIndexToDataAnchor(toWriter, newDataIndex, slotsGapOwner < groupAddress ? 0 : toWriter.c1h_1, slotsGapLen, slotsCapacity);
    ...
    toWriter.e1h_1 = slotsGapOwner;
    var startAnchors = locationOf(fromWriter.w1g_1, fromIndex, fromWriter.j());
    var endAnchors = locationOf(fromWriter.w1g_1, sourceGroupsEnd, fromWriter.j());
    var tmp_0;
    if (startAnchors < endAnchors) {
      var sourceAnchors = fromWriter.w1g_1;
      ...
      if (inductionVariable_0 < endAnchors)
        do {
          ...
          sourceAnchor.e1m_1 = sourceAnchor.e1m_1 + anchorDelta | 0;
          anchors.w(sourceAnchor);
        }
         while (inductionVariable_0 < endAnchors);
      var insertLocation = locationOf(toWriter.w1g_1, toWriter.k1h_1, toWriter.j());
      toWriter.w1g_1.y1(insertLocation, anchors);
      sourceAnchors.a2(startAnchors, endAnchors).e1();
      tmp_0 = anchors;
    } else {
      tmp_0 = emptyList();
    }
    ...
    // Inline function 'kotlin.collections.isNotEmpty' call
    if (!anchors_0.q()) {
      var sourceSourceInformationMap = fromWriter.x1g_1;
      if (!(sourceSourceInformationMap == null)) {
        var destinationSourceInformation = toWriter.x1g_1;
        // Inline function 'androidx.compose.runtime.snapshots.fastForEach' call
        // Inline function 'kotlin.contracts.contract' call
        var inductionVariable_1 = 0;
        ...
        if (inductionVariable_1 <= last)
          do {
            ...
            inductionVariable_1 = inductionVariable_1 + 1 | 0;
            var item = anchors_0.k(index);
            // Inline function 'androidx.compose.runtime.Companion.moveGroup.<anonymous>' call
            var information = sourceSourceInformationMap.v2(item);
            if (!(information == null)) {
              sourceSourceInformationMap.n2(item);
              ...
              if (tmp0_elvis_lhs == null) {
                ...
                toWriter.x1g_1 = destinationSourceInformation;
                tmp_1 = map;
              } else {
              ...
              var map_0 = tmp_1;
              // Inline function 'kotlin.collections.set' call
              map_0.m2(item, information);
            }
          }
           while (inductionVariable_1 <= last);
        if (sourceSourceInformationMap.q()) {
          fromWriter.x1g_1 = null;
        }
      }
    }
    var toWriterParent = toWriter.m1h_1;
    ...
    if (tmp4_safe_receiver == null)
      ...
      var endGroup = toWriter.k1h_1;
      while (child < endGroup) {
        predecessor = child;
        child = child + groupSize(toWriter.u1g_1, child) | 0;
      }
      tmp4_safe_receiver.x20(toWriter, predecessor, endGroup);
    }
    var parentGroup = fromWriter.a1i(fromIndex);
    var tmp_2;
    if (!removeSourceGroup) {
      ...
      if (needsStartGroups) {
        fromWriter.h1i();
        fromWriter.y20(parentGroup - fromWriter.k1h_1 | 0);
        fromWriter.h1i();
      }
      fromWriter.y20(fromIndex - fromWriter.k1h_1 | 0);
      var anchorsRemoved = fromWriter.j1q();
      if (needsStartGroups) {
        fromWriter.e1i();
        fromWriter.e1k();
        fromWriter.e1i();
    ...
    toWriter.g1h_1 = toWriter.g1h_1 + (isNode(groups, currentGroup) ? 1 : nodeCount(groups, currentGroup)) | 0;
    if (updateToCursor) {
      toWriter.k1h_1 = currentGroup + groupsToMove | 0;
      toWriter.a1h_1 = currentSlot + slotsToMove | 0;
    }
    if (hasMarks) {
  ...
  function groupSourceInformationFor($this, parent, sourceInformation) {
    ...
    $this.x1g_1 = map;
    // Inline function 'kotlin.collections.getOrPut' call
    var key = $this.b1j(parent);
    var value = map.v2(key);
    var tmp;
    if (value == null) {
      ...
      if (sourceInformation == null) {
        ...
        var end = $this.k1h_1;
        while (child < end) {
          result.z20($this, child);
          child = child + groupSize($this.u1g_1, child) | 0;
        }
      }
      var answer = result;
      map.m2(key, answer);
  ...
  function startGroup_1($this, key, objectKey, isNode, aux) {
    var previousParent = $this.m1h_1;
    var inserting = $this.f1h_1 > 0;
    $this.j1h_1.k1f($this.g1h_1);
    var tmp = $this;
    var tmp_0;
    if (inserting) {
      insertGroups($this, 1);
      var current = $this.k1h_1;
      var currentAddress = groupIndexToAddress($this, current);
      var hasObjectKey = !(objectKey === Companion_getInstance_0().k1i_1);
      var hasAux = !isNode ? !(aux === Companion_getInstance_0().k1i_1) : false;
      initGroup($this.u1g_1, currentAddress, key, isNode, hasObjectKey, hasAux, $this.m1h_1, $this.a1h_1);
      $this.b1h_1 = $this.a1h_1;
      ...
      if (dataSlotsNeeded > 0) {
        ...
        var slots = $this.v1g_1;
        var currentSlot = $this.a1h_1;
        if (isNode) {
      ...
      $this.a1h_1 = slotIndex($this.u1g_1, $this, currentGroupAddress);
      $this.b1h_1 = dataIndex_0($this.u1g_1, $this, groupIndexToAddress($this, $this.k1h_1 + 1 | 0));
      $this.g1h_1 = nodeCount($this.u1g_1, currentGroupAddress);
      $this.m1h_1 = currentGroup;
      $this.k1h_1 = currentGroup + 1 | 0;
      tmp_0 = currentGroup + groupSize($this.u1g_1, currentGroupAddress) | 0;
    }
    tmp.l1h_1 = tmp_0;
  }
  ...
  function containsGroupMark($this, group) {
    return group >= 0 ? containsMark($this.u1g_1, groupIndexToAddress($this, group)) : false;
  }
  function containsAnyGroupMarks($this, group) {
    return group >= 0 ? containsAnyMark($this.u1g_1, groupIndexToAddress($this, group)) : false;
  }
  function recalculateMarks($this) {
    var tmp0_safe_receiver = $this.o1h_1;
    if (tmp0_safe_receiver == null)
      null;
    else {
      // Inline function 'kotlin.let' call
      // Inline function 'kotlin.contracts.contract' call
      while (tmp0_safe_receiver.i1p()) {
        updateContainsMarkNow($this, tmp0_safe_receiver.d21(), tmp0_safe_receiver);
      }
    }
  }
  function updateContainsMark($this, group) {
    if (group >= 0) {
      var tmp0_elvis_lhs = $this.o1h_1;
      var tmp;
      if (tmp0_elvis_lhs == null) {
        // Inline function 'kotlin.also' call
  ...
  function updateContainsMarkNow($this, group, set) {
    ...
    var markChanges = !(containsMark($this.u1g_1, groupAddress) === containsAnyMarks);
    if (markChanges) {
      updateContainsMark_0($this.u1g_1, groupAddress, containsAnyMarks);
      var parent = $this.a1i(group);
      if (parent >= 0) {
        set.e21(parent);
      }
    }
  ...
  function childContainsAnyMarks($this, group) {
    var child = group + 1 | 0;
    var end = group + $this.s1j(group) | 0;
    while (child < end) {
      if (containsAnyMark($this.u1g_1, groupIndexToAddress($this, child)))
        return true;
      child = child + $this.s1j(child) | 0;
    }
    return false;
  }
  function saveCurrentGroupEnd($this) {
    $this.i1h_1.k1f((_get_capacity__a9k9f3($this) - $this.z1g_1 | 0) - $this.l1h_1 | 0);
  }
  function restoreCurrentGroupEnd($this) {
    var newGroupEnd = (_get_capacity__a9k9f3($this) - $this.z1g_1 | 0) - $this.i1h_1.o1j() | 0;
    $this.l1h_1 = newGroupEnd;
    return newGroupEnd;
  }
  function fixParentAnchorsFor($this, parent, endGroup, firstChild) {
    var parentAnchor = parentIndexToAnchor($this, parent, $this.y1g_1);
    var child = firstChild;
    while (child < endGroup) {
      updateParentAnchor($this.u1g_1, groupIndexToAddress($this, child), parentAnchor);
      var childEnd = child + groupSize($this.u1g_1, groupIndexToAddress($this, child)) | 0;
      fixParentAnchorsFor($this, child, childEnd, child + 1 | 0);
      child = childEnd;
    }
  }
  function moveGroupGapTo($this, index) {
    var gapLen = $this.z1g_1;
    var gapStart = $this.y1g_1;
    if (!(gapStart === index)) {
      // Inline function 'kotlin.collections.isNotEmpty' call
      if (!$this.w1g_1.q()) {
  ...
  function moveSlotGapTo($this, index, group) {
    var gapLen = $this.d1h_1;
    var gapStart = $this.c1h_1;
    var slotsGapOwner = $this.e1h_1;
    if (!(gapStart === index)) {
      var slots = $this.v1g_1;
      if (index < gapStart) {
        // Inline function 'kotlin.collections.copyInto' call
    ...
    if (!(slotsGapOwner === newSlotsGapOwner)) {
      var slotsSize = $this.v1g_1.length - gapLen | 0;
      if (newSlotsGapOwner < slotsGapOwner) {
        ...
        var groupGapStart = $this.y1g_1;
        while (updateAddress < stopUpdateAddress) {
          var anchor = dataAnchor($this.u1g_1, updateAddress);
          // Inline function 'androidx.compose.runtime.runtimeCheck' call
          if (!(anchor >= 0)) {
          ...
          updateDataAnchor($this.u1g_1, updateAddress, -((slotsSize - anchor | 0) + 1 | 0) | 0);
          updateAddress = updateAddress + 1 | 0;
          if (updateAddress === groupGapStart)
            updateAddress = updateAddress + $this.z1g_1 | 0;
        }
      } else {
        ...
        while (updateAddress_0 < stopUpdateAddress_0) {
          var anchor_0 = dataAnchor($this.u1g_1, updateAddress_0);
          // Inline function 'androidx.compose.runtime.runtimeCheck' call
          if (!(anchor_0 < 0)) {
            // Inline function 'androidx.compose.runtime.SlotWriter.moveSlotGapTo.<anonymous>' call
          ...
          updateDataAnchor($this.u1g_1, updateAddress_0, (slotsSize + anchor_0 | 0) + 1 | 0);
          updateAddress_0 = updateAddress_0 + 1 | 0;
          if (updateAddress_0 === $this.y1g_1)
            updateAddress_0 = updateAddress_0 + $this.z1g_1 | 0;
        }
      }
      $this.e1h_1 = newSlotsGapOwner;
    }
    $this.c1h_1 = index;
  }
  function clearSlotGap($this) {
    var slotsGapStart = $this.c1h_1;
    var slotsGapEnd = slotsGapStart + $this.d1h_1 | 0;
    fill_0($this.v1g_1, null, slotsGapStart, slotsGapEnd);
  }
  function insertGroups($this, size) {
    if (size > 0) {
      ...
      var gapStart = $this.y1g_1;
      var gapLen = $this.z1g_1;
      var oldCapacity = $this.u1g_1.length / 5 | 0;
      ...
      if (gapLen < size) {
        ...
        $this.u1g_1 = newGroups;
        gapLen = newGapLen;
      }
      var currentEnd = $this.l1h_1;
      if (currentEnd >= gapStart)
        $this.l1h_1 = currentEnd + size | 0;
      $this.y1g_1 = gapStart + size | 0;
      $this.z1g_1 = gapLen - size | 0;
      var index = oldSize > 0 ? dataIndex($this, currentGroup + size | 0) : 0;
      var anchor = dataIndexToDataAnchor($this, index, $this.e1h_1 < gapStart ? 0 : $this.c1h_1, $this.d1h_1, $this.v1g_1.length);
      ...
      if (inductionVariable < last)
        do {
          var groupAddress = inductionVariable;
          inductionVariable = inductionVariable + 1 | 0;
          updateDataAnchor($this.u1g_1, groupAddress, anchor);
        }
         while (inductionVariable < last);
      var slotsGapOwner = $this.e1h_1;
      if (slotsGapOwner >= gapStart) {
        $this.e1h_1 = slotsGapOwner + size | 0;
      }
    }
  }
  function insertSlots($this, size, group) {
    if (size > 0) {
      moveSlotGapTo($this, $this.a1h_1, group);
      var gapStart = $this.c1h_1;
      var gapLen = $this.d1h_1;
      if (gapLen < size) {
        var slots = $this.v1g_1;
      ...
      var currentDataEnd = $this.b1h_1;
      if (currentDataEnd >= gapStart)
        $this.b1h_1 = currentDataEnd + size | 0;
      $this.c1h_1 = gapStart + size | 0;
      $this.d1h_1 = gapLen - size | 0;
    }
  }
  function removeGroups($this, start, len) {
    ...
    if (len > 0) {
      ...
      var anchors = $this.w1g_1;
      moveGroupGapTo($this, start);
      // Inline function 'kotlin.collections.isNotEmpty' call
      if (!anchors.q()) {
        anchorsRemoved = removeAnchors($this, start, len, $this.x1g_1);
      }
      $this.y1g_1 = start;
      var previousGapLen = $this.z1g_1;
      var newGapLen = previousGapLen + len | 0;
      $this.z1g_1 = newGapLen;
      var slotsGapOwner = $this.e1h_1;
      if (slotsGapOwner > start) {
        var tmp_0 = $this;
        // Inline function 'kotlin.math.max' call
        var b = slotsGapOwner - len | 0;
        tmp_0.e1h_1 = Math.max(start, b);
      }
      if ($this.l1h_1 >= $this.y1g_1) {
        $this.l1h_1 = $this.l1h_1 - len | 0;
      }
      var parent = $this.m1h_1;
  ...
  function sourceInformationOf($this, group) {
    var tmp0_safe_receiver = $this.x1g_1;
    var tmp;
    if (tmp0_safe_receiver == null) {
      tmp = null;
    } else {
  ...
  function removeSlots($this, start, len, group) {
    if (len > 0) {
      ...
      $this.c1h_1 = start;
      $this.d1h_1 = gapLen + len | 0;
      fill_0($this.v1g_1, null, start, start + len | 0);
      var currentDataEnd = $this.b1h_1;
      if (currentDataEnd >= start)
        $this.b1h_1 = currentDataEnd - len | 0;
    }
  }
  function updateNodeOfGroup($this, index, value) {
    var address = groupIndexToAddress($this, index);
    // Inline function 'androidx.compose.runtime.runtimeCheck' call
    if (!(address < $this.u1g_1.length ? isNode($this.u1g_1, address) : false)) {
    ...
    $this.v1g_1[dataIndexToDataAddress($this, nodeIndex($this.u1g_1, $this, address))] = value;
  }
  function updateAnchors($this, previousGapStart, newGapStart) {
    var gapLen = $this.z1g_1;
    var size = _get_capacity__a9k9f3($this) - gapLen | 0;
    if (previousGapStart < newGapStart) {
      var index = locationOf($this.w1g_1, previousGapStart, size);
      $l$loop_0: while (index < $this.w1g_1.j()) {
        var anchor = $this.w1g_1.k(index);
        var location = anchor.e1m_1;
        if (location < 0) {
          var newLocation = size + location | 0;
          if (newLocation < newGapStart) {
            anchor.e1m_1 = size + location | 0;
            index = index + 1 | 0;
          } else
            break $l$loop_0;
        } else
      ...
      var index_0 = locationOf($this.w1g_1, newGapStart, size);
      $l$loop_1: while (index_0 < $this.w1g_1.j()) {
        var anchor_0 = $this.w1g_1.k(index_0);
        var location_0 = anchor_0.e1m_1;
        if (location_0 >= 0) {
          anchor_0.e1m_1 = -(size - location_0 | 0) | 0;
          index_0 = index_0 + 1 | 0;
        } else
          break $l$loop_1;
      }
  ...
  function removeAnchors($this, gapStart, size, sourceInformationMap) {
    ...
    var it = locationOf($this.w1g_1, gapStart + size | 0, groupsSize);
    var index = it >= $this.w1g_1.j() ? it - 1 | 0 : it;
    var removeAnchorEnd = 0;
    var removeAnchorStart = index + 1 | 0;
    $l$loop: while (index >= 0) {
      var anchor = $this.w1g_1.k(index);
      var location = $this.h1l(anchor);
      if (location >= gapStart) {
        if (location < removeEnd) {
          anchor.e1m_1 = IntCompanionObject_instance.MIN_VALUE;
          if (sourceInformationMap == null)
            null;
          else
            sourceInformationMap.n2(anchor);
    ...
    // Inline function 'androidx.compose.runtime.SlotWriter.removeAnchors.<anonymous>' call
    if (this_0) {
      $this.w1g_1.a2(removeAnchorStart, removeAnchorEnd).e1();
    }
    return this_0;
  }
  function moveAnchors($this, originalLocation, newLocation, size) {
    ...
    var index = locationOf($this.w1g_1, originalLocation, groupsSize);
    // Inline function 'kotlin.collections.mutableListOf' call
    var removedAnchors = ArrayList_init_$Create$();
    if (index >= 0) {
      $l$loop: while (index < $this.w1g_1.j()) {
        var anchor = $this.w1g_1.k(index);
        var location = $this.h1l(anchor);
        if (location >= originalLocation ? location < end : false) {
          removedAnchors.w(anchor);
          $this.w1g_1.j1(index);
        } else
          break $l$loop;
      }
    ...
    if (inductionVariable <= last)
      do {
        ...
        var anchorIndex = $this.h1l(item);
        var newAnchorIndex = anchorIndex + moveDelta | 0;
        if (newAnchorIndex >= $this.y1g_1) {
          item.e1m_1 = -(groupsSize - newAnchorIndex | 0) | 0;
        } else {
          item.e1m_1 = newAnchorIndex;
        }
        var insertIndex = locationOf($this.w1g_1, newAnchorIndex, groupsSize);
        $this.w1g_1.w1(insertIndex, item);
      }
       while (inductionVariable <= last);
  }
  function _get_capacity__a9k9f3($this) {
    return $this.u1g_1.length / 5 | 0;
  }
  function groupIndexToAddress($this, index) {
    return index < $this.y1g_1 ? index : index + $this.z1g_1 | 0;
  }
  function dataIndexToDataAddress($this, dataIndex) {
    return dataIndex < $this.c1h_1 ? dataIndex : dataIndex + $this.d1h_1 | 0;
  }
  ...
  function dataIndex($this, index) {
    return dataIndex_0($this.u1g_1, $this, groupIndexToAddress($this, index));
  }
  function dataIndex_0(_this__u8e3s4, $this, address) {
    return address >= _get_capacity__a9k9f3($this) ? $this.v1g_1.length - $this.d1h_1 | 0 : dataAnchorToDataIndex($this, dataAnchor(_this__u8e3s4, address), $this.d1h_1, $this.v1g_1.length);
  }
  function slotIndex(_this__u8e3s4, $this, address) {
    return address >= _get_capacity__a9k9f3($this) ? $this.v1g_1.length - $this.d1h_1 | 0 : dataAnchorToDataIndex($this, slotAnchor(_this__u8e3s4, address), $this.d1h_1, $this.v1g_1.length);
  }
  function updateDataIndex(_this__u8e3s4, $this, address, dataIndex) {
    updateDataAnchor(_this__u8e3s4, address, dataIndexToDataAnchor($this, dataIndex, $this.c1h_1, $this.d1h_1, $this.v1g_1.length));
  }
  ...
  protoOf(SlotWriter$groupSlots$1).z = function () {
    return this.f21_1 < this.g21_1;
  };
  protoOf(SlotWriter$groupSlots$1).b1 = function () {
    var tmp;
    if (this.z()) {
      var tmp_0 = this.h21_1.v1g_1;
      var tmp1 = this.f21_1;
      this.f21_1 = tmp1 + 1 | 0;
      tmp = tmp_0[dataIndexToDataAddress(this.h21_1, tmp1)];
    } else {
      tmp = null;
    }
    return tmp;
  ...
  function SlotWriter(table) {
    this.t1g_1 = table;
    this.u1g_1 = this.t1g_1.v1e_1;
    this.v1g_1 = this.t1g_1.x1e_1;
    this.w1g_1 = this.t1g_1.d1f_1;
    this.x1g_1 = this.t1g_1.e1f_1;
    this.y1g_1 = this.t1g_1.w1e_1;
    this.z1g_1 = (this.u1g_1.length / 5 | 0) - this.t1g_1.w1e_1 | 0;
    this.a1h_1 = 0;
    this.b1h_1 = 0;
    this.c1h_1 = this.t1g_1.y1e_1;
    this.d1h_1 = this.v1g_1.length - this.t1g_1.y1e_1 | 0;
    this.e1h_1 = this.t1g_1.w1e_1;
    this.f1h_1 = 0;
    this.g1h_1 = 0;
    this.h1h_1 = new IntStack();
    this.i1h_1 = new IntStack();
    this.j1h_1 = new IntStack();
    this.k1h_1 = 0;
    this.l1h_1 = this.t1g_1.w1e_1;
    this.m1h_1 = -1;
    this.n1h_1 = false;
    this.o1h_1 = null;
  }
  protoOf(SlotWriter).k1p = function () {
    return this.k1h_1 < this.l1h_1 ? isNode(this.u1g_1, groupIndexToAddress(this, this.k1h_1)) : false;
  };
  protoOf(SlotWriter).m1k = function (index) {
    return isNode(this.u1g_1, groupIndexToAddress(this, index));
  };
  protoOf(SlotWriter).n1k = function (index) {
    return nodeCount(this.u1g_1, groupIndexToAddress(this, index));
  };
  protoOf(SlotWriter).z1h = function (index) {
    return key(this.u1g_1, groupIndexToAddress(this, index));
  };
  protoOf(SlotWriter).y1h = function (index) {
    var address = groupIndexToAddress(this, index);
    return hasObjectKey(this.u1g_1, address) ? this.v1g_1[objectKeyIndex(this.u1g_1, address)] : null;
  };
  protoOf(SlotWriter).s1j = function (index) {
    return groupSize(this.u1g_1, groupIndexToAddress(this, index));
  };
  protoOf(SlotWriter).x1h = function (index) {
    var address = groupIndexToAddress(this, index);
    return hasAux(this.u1g_1, address) ? this.v1g_1[auxIndex(this.u1g_1, this, address)] : Companion_getInstance_0().k1i_1;
  };
  protoOf(SlotWriter).i21 = function (index) {
    return (index > this.m1h_1 ? index < this.l1h_1 : false) ? true : this.m1h_1 === 0 ? index === 0 : false;
  };
  protoOf(SlotWriter).j21 = function (index) {
    return this.k21(index, this.k1h_1);
  };
  protoOf(SlotWriter).k21 = function (index, group) {
    var tmp;
    if (group === this.m1h_1) {
      tmp = this.l1h_1;
    } else if (group > this.h1h_1.m21(0)) {
      tmp = group + this.s1j(group) | 0;
    } else {
      var openIndex = this.h1h_1.l21(group);
      tmp = openIndex < 0 ? group + this.s1j(group) | 0 : (_get_capacity__a9k9f3(this) - this.z1g_1 | 0) - this.i1h_1.l1k(openIndex) | 0;
    }
    var end = tmp;
    return index > group ? index < end : false;
  };
  protoOf(SlotWriter).l1m = function (index) {
    var address = groupIndexToAddress(this, index);
    return isNode(this.u1g_1, address) ? this.v1g_1[dataIndexToDataAddress(this, nodeIndex(this.u1g_1, this, address))] : null;
  };
  protoOf(SlotWriter).n21 = function (anchor) {
    return this.l1m(anchor.o21(this));
  };
  protoOf(SlotWriter).a1i = function (index) {
    return parent(this.u1g_1, this, index);
  };
  protoOf(SlotWriter).r1g = function () {
    this.n1h_1 = true;
    if (this.h1h_1.q()) {
      moveGroupGapTo(this, this.j());
      moveSlotGapTo(this, this.v1g_1.length - this.d1h_1 | 0, this.y1g_1);
      clearSlotGap(this);
      recalculateMarks(this);
    }
    this.t1g_1.q20(this, this.u1g_1, this.y1g_1, this.v1g_1, this.c1h_1, this.w1g_1, this.x1g_1);
  };
  protoOf(SlotWriter).p21 = function () {
    // Inline function 'androidx.compose.runtime.runtimeCheck' call
    if (!(this.f1h_1 === 0)) {
    ...
    recalculateMarks(this);
    this.k1h_1 = 0;
    this.l1h_1 = _get_capacity__a9k9f3(this) - this.z1g_1 | 0;
    this.a1h_1 = 0;
    this.b1h_1 = 0;
    this.g1h_1 = 0;
  };
  protoOf(SlotWriter).s1o = function (value) {
    var result = this.q21();
    this.r21(value);
    return result;
  };
  protoOf(SlotWriter).a21 = function (value) {
    var address = groupIndexToAddress(this, this.k1h_1);
    // Inline function 'androidx.compose.runtime.runtimeCheck' call
    if (!hasAux(this.u1g_1, address)) {
    ...
    this.v1g_1[dataIndexToDataAddress(this, auxIndex(this.u1g_1, this, address))] = value;
  };
  protoOf(SlotWriter).u1p = function (sourceInformation) {
    if (this.f1h_1 > 0) {
      groupSourceInformationFor(this, this.m1h_1, sourceInformation);
    }
  };
  protoOf(SlotWriter).w1p = function (key, value) {
    if (this.f1h_1 > 0) {
      groupSourceInformationFor(this, this.m1h_1, null).s21(key, value);
    }
  };
  protoOf(SlotWriter).y1p = function () {
    if (this.f1h_1 > 0) {
      groupSourceInformationFor(this, this.m1h_1, null).t21();
    }
  };
  protoOf(SlotWriter).b21 = function (value) {
    return updateNodeOfGroup(this, this.k1h_1, value);
  };
  protoOf(SlotWriter).u21 = function (anchor, value) {
    return updateNodeOfGroup(this, anchor.o21(this), value);
  };
  protoOf(SlotWriter).r21 = function (value) {
    // Inline function 'androidx.compose.runtime.runtimeCheck' call
    if (!(this.a1h_1 <= this.b1h_1)) {
      // Inline function 'androidx.compose.runtime.SlotWriter.set.<anonymous>' call
      var message = 'Writing to an invalid slot';
      composeRuntimeError(toString(message));
    }
    this.v1g_1[dataIndexToDataAddress(this, this.a1h_1 - 1 | 0)] = value;
  };
  protoOf(SlotWriter).v21 = function (index, value) {
    return this.w21(this.k1h_1, index, value);
  };
  protoOf(SlotWriter).w21 = function (group, index, value) {
    var address = groupIndexToAddress(this, group);
    var slotsStart = slotIndex(this.u1g_1, this, address);
    var slotsEnd = dataIndex_0(this.u1g_1, this, groupIndexToAddress(this, group + 1 | 0));
    ...
    var result = this.v1g_1[slotAddress];
    this.v1g_1[slotAddress] = value;
    return result;
  };
  protoOf(SlotWriter).q21 = function () {
    if (this.f1h_1 > 0) {
      insertSlots(this, 1, this.m1h_1);
    }
    var tmp = this.v1g_1;
    var tmp1 = this.a1h_1;
    this.a1h_1 = tmp1 + 1 | 0;
  ...
  protoOf(SlotWriter).a1w = function (anchor, index) {
    return this.d1w(this.h1l(anchor), index);
  };
  protoOf(SlotWriter).d1w = function (groupIndex, index) {
    var address = groupIndexToAddress(this, groupIndex);
    var slotsStart = slotIndex(this.u1g_1, this, address);
    var slotsEnd = dataIndex_0(this.u1g_1, this, groupIndexToAddress(this, groupIndex + 1 | 0));
    var slotsIndex = slotsStart + index | 0;
    if (!(slotsStart <= slotsIndex ? slotsIndex < slotsEnd : false)) {
      return Companion_getInstance_0().k1i_1;
    }
    var slotAddress = dataIndexToDataAddress(this, slotsIndex);
    return this.v1g_1[slotAddress];
  };
  protoOf(SlotWriter).y20 = function (amount) {
    // Inline function 'androidx.compose.runtime.runtimeCheck' call
    if (!(amount >= 0)) {
    ...
    if (amount === 0)
      return Unit_instance;
    var index = this.k1h_1 + amount | 0;
    // Inline function 'androidx.compose.runtime.runtimeCheck' call
    if (!(index >= this.m1h_1 ? index <= this.l1h_1 : false)) {
      // Inline function 'androidx.compose.runtime.SlotWriter.advanceBy.<anonymous>' call
      var message_1 = 'Cannot seek outside the current group (' + this.m1h_1 + '-' + this.l1h_1 + ')';
      composeRuntimeError(toString(message_1));
    }
    this.k1h_1 = index;
    var newSlot = dataIndex_0(this.u1g_1, this, groupIndexToAddress(this, index));
    this.a1h_1 = newSlot;
    this.b1h_1 = newSlot;
  };
  protoOf(SlotWriter).e1i = function () {
    var newGroup = this.l1h_1;
    this.k1h_1 = newGroup;
    this.a1h_1 = dataIndex_0(this.u1g_1, this, groupIndexToAddress(this, newGroup));
  };
  protoOf(SlotWriter).a1j = function () {
    var tmp1 = this.f1h_1;
    this.f1h_1 = tmp1 + 1 | 0;
    if (tmp1 === 0) {
      saveCurrentGroupEnd(this);
  ...
  protoOf(SlotWriter).f1k = function () {
    // Inline function 'kotlin.check' call
    // Inline function 'kotlin.contracts.contract' call
    if (!(this.f1h_1 > 0)) {
    ...
    this.f1h_1 = this.f1h_1 - 1 | 0;
    if (this.f1h_1 === 0) {
      // Inline function 'androidx.compose.runtime.runtimeCheck' call
      if (!(this.j1h_1.j() === this.h1h_1.j())) {
        // Inline function 'androidx.compose.runtime.SlotWriter.endInsert.<anonymous>' call
  ...
  protoOf(SlotWriter).h1i = function () {
    ...
    startGroup_1(this, 0, Companion_getInstance_0().k1i_1, false, Companion_getInstance_0().k1i_1);
  };
  protoOf(SlotWriter).l1i = function (key, dataKey) {
    return startGroup_1(this, key, dataKey, false, Companion_getInstance_0().k1i_1);
  };
  protoOf(SlotWriter).n1i = function (key, objectKey) {
    return startGroup_1(this, key, objectKey, true, Companion_getInstance_0().k1i_1);
  };
  protoOf(SlotWriter).m1i = function (key, objectKey, aux) {
    return startGroup_1(this, key, objectKey, false, aux);
  };
  protoOf(SlotWriter).e1k = function () {
    var inserting = this.f1h_1 > 0;
    var currentGroup = this.k1h_1;
    var currentGroupEnd = this.l1h_1;
    var groupIndex = this.m1h_1;
    var groupAddress = groupIndexToAddress(this, groupIndex);
    var newNodes = this.g1h_1;
    var newGroupSize = currentGroup - groupIndex | 0;
    var isNode_0 = isNode(this.u1g_1, groupAddress);
    if (inserting) {
      updateGroupSize(this.u1g_1, groupAddress, newGroupSize);
      updateNodeCount_0(this.u1g_1, groupAddress, newNodes);
      this.g1h_1 = this.j1h_1.o1j() + (isNode_0 ? 1 : newNodes) | 0;
      this.m1h_1 = parent(this.u1g_1, this, groupIndex);
    } else {
      // Inline function 'androidx.compose.runtime.runtimeCheck' call
      ...
      var oldGroupSize = groupSize(this.u1g_1, groupAddress);
      var oldNodes = nodeCount(this.u1g_1, groupAddress);
      updateGroupSize(this.u1g_1, groupAddress, newGroupSize);
      updateNodeCount_0(this.u1g_1, groupAddress, newNodes);
      var newParent = this.h1h_1.o1j();
      restoreCurrentGroupEnd(this);
      this.m1h_1 = newParent;
      var groupParent = parent(this.u1g_1, this, groupIndex);
      this.g1h_1 = this.j1h_1.o1j();
      if (groupParent === newParent) {
        this.g1h_1 = this.g1h_1 + (isNode_0 ? 0 : newNodes - oldNodes | 0) | 0;
      } else {
        ...
        if (!(groupSizeDelta === 0) ? true : !(nodesDelta === 0)) {
          ...
          while ((!(current === 0) ? !(current === newParent) : false) ? !(nodesDelta === 0) ? true : !(groupSizeDelta === 0) : false) {
            var currentAddress = groupIndexToAddress(this, current);
            if (!(groupSizeDelta === 0)) {
              var newSize = groupSize(this.u1g_1, currentAddress) + groupSizeDelta | 0;
              updateGroupSize(this.u1g_1, currentAddress, newSize);
            }
            if (!(nodesDelta === 0)) {
              updateNodeCount_0(this.u1g_1, currentAddress, nodeCount(this.u1g_1, currentAddress) + nodesDelta | 0);
            }
            if (isNode(this.u1g_1, currentAddress))
              nodesDelta = 0;
            current = parent(this.u1g_1, this, current);
          }
        }
        this.g1h_1 = this.g1h_1 + nodesDelta | 0;
      }
    }
    return newNodes;
  };
  protoOf(SlotWriter).x21 = function (index) {
    // Inline function 'androidx.compose.runtime.runtimeCheck' call
    if (!(this.f1h_1 <= 0)) {
    ...
    if (!(parent === index)) {
      // Inline function 'androidx.compose.runtime.runtimeCheck' call
      if (!(index >= parent ? index < this.l1h_1 : false)) {
        // Inline function 'androidx.compose.runtime.SlotWriter.ensureStarted.<anonymous>' call
        var message_0 = 'Started group at ' + index + ' must be a subgroup of the group at ' + parent;
        composeRuntimeError(toString(message_0));
      }
      var oldCurrent = this.k1h_1;
      var oldCurrentSlot = this.a1h_1;
      var oldCurrentSlotEnd = this.b1h_1;
      this.k1h_1 = index;
      this.h1i();
      this.k1h_1 = oldCurrent;
      this.a1h_1 = oldCurrentSlot;
      this.b1h_1 = oldCurrentSlotEnd;
    }
  };
  protoOf(SlotWriter).y21 = function (anchor) {
    return this.x21(anchor.o21(this));
  };
  protoOf(SlotWriter).u1h = function () {
    var groupAddress = groupIndexToAddress(this, this.k1h_1);
    var newGroup = this.k1h_1 + groupSize(this.u1g_1, groupAddress) | 0;
    this.k1h_1 = newGroup;
    this.a1h_1 = dataIndex_0(this.u1g_1, this, groupIndexToAddress(this, newGroup));
    return isNode(this.u1g_1, groupAddress) ? 1 : nodeCount(this.u1g_1, groupAddress);
  };
  protoOf(SlotWriter).j1q = function () {
    // Inline function 'androidx.compose.runtime.runtimeCheck' call
    if (!(this.f1h_1 === 0)) {
    ...
    var oldGroup = this.k1h_1;
    var oldSlot = this.a1h_1;
    var count = this.u1h();
    var tmp0_safe_receiver = sourceInformationOf(this, this.m1h_1);
    if (tmp0_safe_receiver == null)
      null;
    else {
      // Inline function 'kotlin.let' call
      // Inline function 'kotlin.contracts.contract' call
      // Inline function 'androidx.compose.runtime.SlotWriter.removeGroup.<anonymous>' call
      var tmp0_safe_receiver_0 = this.o20(oldGroup);
      var tmp;
      if (tmp0_safe_receiver_0 == null) {
        tmp = null;
      } else {
        ...
        tmp = tmp0_safe_receiver.z21(tmp0_safe_receiver_0);
      }
    }
    var tmp1_safe_receiver = this.o1h_1;
    if (tmp1_safe_receiver == null)
      null;
    else {
      // Inline function 'kotlin.let' call
      // Inline function 'kotlin.contracts.contract' call
      while (tmp1_safe_receiver.i1p() ? tmp1_safe_receiver.d1o() >= oldGroup : false) {
        tmp1_safe_receiver.d21();
      }
    }
    var anchorsRemoved = removeGroups(this, oldGroup, this.k1h_1 - oldGroup | 0);
    removeSlots(this, oldSlot, this.a1h_1 - oldSlot | 0, oldGroup - 1 | 0);
    this.k1h_1 = oldGroup;
    this.a1h_1 = oldSlot;
    this.g1h_1 = this.g1h_1 - count | 0;
    return anchorsRemoved;
  };
  protoOf(SlotWriter).g1q = function () {
    var start = dataIndex_0(this.u1g_1, this, groupIndexToAddress(this, this.k1h_1));
    var end = dataIndex_0(this.u1g_1, this, groupIndexToAddress(this, this.k1h_1 + this.s1j(this.k1h_1) | 0));
    return new SlotWriter$groupSlots$1(start, end, this);
  };
  protoOf(SlotWriter).a22 = function (offset) {
    // Inline function 'androidx.compose.runtime.runtimeCheck' call
    if (!(this.f1h_1 === 0)) {
    ...
    var current = this.k1h_1;
    var parent = this.m1h_1;
    var parentEnd = this.l1h_1;
    var count = offset;
    var groupToMove = current;
    while (count > 0) {
      groupToMove = groupToMove + groupSize(this.u1g_1, groupIndexToAddress(this, groupToMove)) | 0;
      // Inline function 'androidx.compose.runtime.runtimeCheck' call
    ...
    var moveLen = groupSize(this.u1g_1, groupIndexToAddress(this, groupToMove));
    var currentSlot = this.a1h_1;
    var dataStart = dataIndex_0(this.u1g_1, this, groupIndexToAddress(this, groupToMove));
    var dataEnd = dataIndex_0(this.u1g_1, this, groupIndexToAddress(this, groupToMove + moveLen | 0));
    var moveDataLen = dataEnd - dataStart | 0;
    // Inline function 'kotlin.math.max' call
    var a = this.k1h_1 - 1 | 0;
    ...
    var slotsGapStart = this.c1h_1;
    var slotsGapLen = this.d1h_1;
    var slotsCapacity = this.v1g_1.length;
    var slotsGapOwner = this.e1h_1;
    ...
    fixParentAnchorsFor(this, parent, this.l1h_1, current);
    if (moveDataLen > 0) {
      removeSlots(this, dataStart + moveDataLen | 0, moveDataLen, (groupToMove + moveLen | 0) - 1 | 0);
    }
  };
  protoOf(SlotWriter).b22 = function (anchor, offset, writer) {
    runtimeCheck(writer.f1h_1 > 0);
    runtimeCheck(this.f1h_1 === 0);
    runtimeCheck(anchor.i1s());
    var location = this.h1l(anchor) + offset | 0;
    var currentGroup = this.k1h_1;
    runtimeCheck(currentGroup <= location ? location < this.l1h_1 : false);
    var parent = this.a1i(location);
    var size = this.s1j(location);
    var nodes = this.m1k(location) ? 1 : this.n1k(location);
    ...
    while (current >= currentGroup) {
      var currentAddress = groupIndexToAddress(this, current);
      updateGroupSize(this.u1g_1, currentAddress, groupSize(this.u1g_1, currentAddress) - size | 0);
      if (updatingNodes) {
        if (isNode(this.u1g_1, currentAddress))
          updatingNodes = false;
        else {
          updateNodeCount_0(this.u1g_1, currentAddress, nodeCount(this.u1g_1, currentAddress) - nodes | 0);
        }
      }
      current = this.a1i(current);
    }
    if (updatingNodes) {
      runtimeCheck(this.g1h_1 >= nodes);
      this.g1h_1 = this.g1h_1 - nodes | 0;
    }
    return result;
  };
  protoOf(SlotWriter).c22 = function (table, index, removeSourceGroup) {
    runtimeCheck(this.f1h_1 > 0);
    if (((index === 0 ? this.k1h_1 === 0 : false) ? this.t1g_1.w1e_1 === 0 : false) ? groupSize(table.v1e_1, index) === table.w1e_1 : false) {
      var myGroups = this.u1g_1;
      var mySlots = this.v1g_1;
      var myAnchors = this.w1g_1;
      var mySourceInformation = this.x1g_1;
      var groups = table.v1e_1;
      var groupsSize = table.w1e_1;
      var slots = table.x1e_1;
      var slotsSize = table.y1e_1;
      var sourceInformation = table.e1f_1;
      this.u1g_1 = groups;
      this.v1g_1 = slots;
      this.w1g_1 = table.d1f_1;
      this.y1g_1 = groupsSize;
      this.z1g_1 = (groups.length / 5 | 0) - groupsSize | 0;
      this.c1h_1 = slotsSize;
      this.d1h_1 = slots.length - slotsSize | 0;
      this.e1h_1 = groupsSize;
      this.x1g_1 = sourceInformation;
      table.r20(myGroups, 0, mySlots, 0, myAnchors, mySourceInformation);
      return this.w1g_1;
    }
    // Inline function 'androidx.compose.runtime.SlotTable.write' call
    // Inline function 'kotlin.let' call
  ...
  protoOf(SlotWriter).d22 = function (offset, table, index) {
    runtimeCheck(this.f1h_1 <= 0 ? this.s1j(this.k1h_1 + offset | 0) === 1 : false);
    var previousCurrentGroup = this.k1h_1;
    var previousCurrentSlot = this.a1h_1;
    var previousCurrentSlotEnd = this.b1h_1;
    this.y20(offset);
    this.h1i();
    this.a1j();
    // Inline function 'androidx.compose.runtime.SlotTable.write' call
    ...
    this.f1k();
    this.e1k();
    this.k1h_1 = previousCurrentGroup;
    this.a1h_1 = previousCurrentSlot;
    this.b1h_1 = previousCurrentSlotEnd;
    return anchors;
  };
  protoOf(SlotWriter).b1j = function (index) {
    // Inline function 'androidx.compose.runtime.getOrAdd' call
    ...
    if (location < 0) {
      ...
      var anchor = new Anchor(index <= this.y1g_1 ? index : -(this.j() - index | 0) | 0);
      this_0.w1(-(location + 1 | 0) | 0, anchor);
      tmp = anchor;
    } else {
      tmp = this_0.k(location);
  ...
  protoOf(SlotWriter).e22 = function (group) {
    var groupAddress = groupIndexToAddress(this, group);
    if (!hasMark(this.u1g_1, groupAddress)) {
      updateMark(this.u1g_1, groupAddress, true);
      if (!containsMark(this.u1g_1, groupAddress)) {
        updateContainsMark(this, this.a1i(group));
      }
    }
  };
  protoOf(SlotWriter).w1k = function (group, $super) {
    group = group === VOID ? this.m1h_1 : group;
    var tmp;
    if ($super === VOID) {
      this.e22(group);
      tmp = Unit_instance;
    } else {
      tmp = $super.e22.call(this, group);
    }
    return tmp;
  };
  protoOf(SlotWriter).h1l = function (anchor) {
    // Inline function 'kotlin.let' call
    // Inline function 'kotlin.contracts.contract' call
  ...
  protoOf(SlotWriter).toString = function () {
    return 'SlotWriter(current = ' + this.k1h_1 + ' end=' + this.l1h_1 + ' size = ' + this.j() + ' ' + ('gap=' + this.y1g_1 + '-' + (this.y1g_1 + this.z1g_1 | 0) + ')');
  };
  protoOf(SlotWriter).o20 = function (group) {
    return (0 <= group ? group < this.j() : false) ? find(this.w1g_1, group, this.j()) : null;
  };
  protoOf(SlotWriter).j = function () {
    return _get_capacity__a9k9f3(this) - this.z1g_1 | 0;
  };
  function Anchor(loc) {
    this.e1m_1 = loc;
  }
  protoOf(Anchor).i1s = function () {
    return !(this.e1m_1 === IntCompanionObject_instance.MIN_VALUE);
  };
  protoOf(Anchor).j1p = function (slots) {
    return slots.h1l(this);
  };
  protoOf(Anchor).o21 = function (writer) {
    return writer.h1l(this);
  };
  protoOf(Anchor).toString = function () {
    return anyToString(this) + '{ location = ' + this.e1m_1 + ' }';
  };
  function openInformation($this) {
    ...
    if (tmp0_safe_receiver == null) {
      ...
      $l$block: {
        ...
        while (index >= 0) {
          var value = tmp0_safe_receiver.k(index);
  ...
  function GroupSourceInformation(key, sourceInformation) {
    this.t20_1 = key;
    this.u20_1 = sourceInformation;
    this.v20_1 = null;
    this.w20_1 = false;
  }
  protoOf(GroupSourceInformation).s21 = function (key, sourceInformation) {
    add(openInformation(this), new GroupSourceInformation(key, sourceInformation));
  };
  protoOf(GroupSourceInformation).t21 = function () {
    openInformation(this).r1g();
  };
  protoOf(GroupSourceInformation).z20 = function (writer, group) {
    add(openInformation(this), writer.b1j(group));
  };
  protoOf(GroupSourceInformation).f22 = function (table, group) {
    add(openInformation(this), table.b1j(group));
  };
  protoOf(GroupSourceInformation).x20 = function (writer, predecessor, group) {
    var tmp0_elvis_lhs = this.v20_1;
    var tmp;
    if (tmp0_elvis_lhs == null) {
      // Inline function 'kotlin.also' call
    ...
    var tmp_0;
    if (predecessor >= 0) {
      var anchor = writer.o20(predecessor);
      var tmp_1;
      if (!(anchor == null)) {
        var tmp$ret$2;
        $l$block: {
    ...
    var index_0 = tmp_0;
    groups.w1(index_0, writer.b1j(group));
  };
  protoOf(GroupSourceInformation).r1g = function () {
    this.w20_1 = true;
  };
  protoOf(GroupSourceInformation).z21 = function (anchor) {
    var groups = this.v20_1;
    if (!(groups == null)) {
      var index = groups.j() - 1 | 0;
      while (index >= 0) {
        var item = groups.k(index);
  ...
  function node(_this__u8e3s4, $this, index) {
    ...
    if (isNode(_this__u8e3s4, index)) {
      tmp = $this.h1g_1[nodeIndex_0(_this__u8e3s4, index)];
    } else {
      tmp = Companion_getInstance_0().k1i_1;
    }
    return tmp;
  ...
  function aux(_this__u8e3s4, $this, index) {
    ...
    if (hasAux(_this__u8e3s4, index)) {
      tmp = $this.h1g_1[auxIndex_0(_this__u8e3s4, index)];
    } else {
      tmp = Companion_getInstance_0().k1i_1;
    }
    return tmp;
  ...
  function objectKey(_this__u8e3s4, $this, index) {
    ...
    if (hasObjectKey(_this__u8e3s4, index)) {
      tmp = $this.h1g_1[objectKeyIndex(_this__u8e3s4, index)];
    } else {
      tmp = null;
    }
    return tmp;
  ...
  function SlotReader(table) {
    this.e1g_1 = table;
    this.f1g_1 = this.e1g_1.v1e_1;
    this.g1g_1 = this.e1g_1.w1e_1;
    this.h1g_1 = this.e1g_1.x1e_1;
    this.i1g_1 = this.e1g_1.y1e_1;
    this.j1g_1 = null;
    this.k1g_1 = false;
    this.l1g_1 = 0;
    this.m1g_1 = this.g1g_1;
    this.n1g_1 = -1;
    this.o1g_1 = 0;
    this.p1g_1 = 0;
    this.q1g_1 = 0;
  ...
  protoOf(SlotReader).a1i = function (index) {
    return parentAnchor(this.f1g_1, index);
  };
  protoOf(SlotReader).k1p = function () {
    return isNode(this.f1g_1, this.l1g_1);
  };
  protoOf(SlotReader).m1k = function (index) {
    return isNode(this.f1g_1, index);
  };
  protoOf(SlotReader).n1k = function (index) {
    return nodeCount(this.f1g_1, index);
  };
  protoOf(SlotReader).l1m = function (index) {
    return isNode(this.f1g_1, index) ? node(this.f1g_1, this, index) : null;
  };
  protoOf(SlotReader).y1j = function () {
    return this.h1k() ? true : this.l1g_1 === this.m1g_1;
  };
  protoOf(SlotReader).h1k = function () {
    return this.o1g_1 > 0;
  };
  protoOf(SlotReader).g22 = function () {
    return groupSize(this.f1g_1, this.l1g_1);
  };
  protoOf(SlotReader).s1j = function (index) {
    return groupSize(this.f1g_1, index);
  };
  protoOf(SlotReader).x1j = function () {
    return this.m1g_1;
  };
  protoOf(SlotReader).w1i = function () {
    var tmp;
    if (this.l1g_1 < this.m1g_1) {
      tmp = key(this.f1g_1, this.l1g_1);
    } else {
      tmp = 0;
    }
    return tmp;
  };
  protoOf(SlotReader).z1h = function (index) {
    return key(this.f1g_1, index);
  };
  protoOf(SlotReader).q1o = function () {
    return this.p1g_1 - slotAnchor(this.f1g_1, this.n1g_1) | 0;
  };
  protoOf(SlotReader).p1k = function (index) {
    return hasObjectKey(this.f1g_1, index);
  };
  protoOf(SlotReader).y1i = function () {
    return this.l1g_1 < this.m1g_1 ? objectKey(this.f1g_1, this, this.l1g_1) : null;
  };
  protoOf(SlotReader).y1h = function (index) {
    return objectKey(this.f1g_1, this, index);
  };
  protoOf(SlotReader).g1i = function () {
    return this.l1g_1 < this.m1g_1 ? aux(this.f1g_1, this, this.l1g_1) : 0;
  };
  protoOf(SlotReader).x1h = function (index) {
    return aux(this.f1g_1, this, index);
  };
  protoOf(SlotReader).j1n = function (index) {
    return hasMark(this.f1g_1, index);
  };
  protoOf(SlotReader).t1m = function (index) {
    return containsMark(this.f1g_1, index);
  };
  protoOf(SlotReader).q1k = function () {
    return this.n1g_1 >= 0 ? nodeCount(this.f1g_1, this.n1g_1) : 0;
  };
  protoOf(SlotReader).u1m = function (group, index) {
    var start = slotAnchor(this.f1g_1, group);
    var next = group + 1 | 0;
    var end = next < this.g1g_1 ? dataAnchor(this.f1g_1, next) : this.i1g_1;
    var address = start + index | 0;
    return address < end ? this.h1g_1[address] : Companion_getInstance_0().k1i_1;
  };
  protoOf(SlotReader).b1 = function () {
    if (this.o1g_1 > 0 ? true : this.p1g_1 >= this.q1g_1)
      return Companion_getInstance_0().k1i_1;
    var tmp1 = this.p1g_1;
    this.p1g_1 = tmp1 + 1 | 0;
    return this.h1g_1[tmp1];
  };
  protoOf(SlotReader).j1i = function () {
    this.o1g_1 = this.o1g_1 + 1 | 0;
  };
  protoOf(SlotReader).d1k = function () {
    // Inline function 'kotlin.require' call
    // Inline function 'kotlin.contracts.contract' call
    if (!(this.o1g_1 > 0)) {
  ...
  protoOf(SlotReader).r1g = function () {
    this.k1g_1 = true;
    this.e1g_1.p20(this, this.j1g_1);
  };
  protoOf(SlotReader).h1i = function () {
    if (this.o1g_1 <= 0) {
      var parent = this.n1g_1;
      var currentGroup = this.l1g_1;
      // Inline function 'kotlin.require' call
      // Inline function 'kotlin.contracts.contract' call
      if (!(parentAnchor(this.f1g_1, currentGroup) === parent)) {
        // Inline function 'androidx.compose.runtime.SlotReader.startGroup.<anonymous>' call
        var message = 'Invalid slot table detected';
        throw IllegalArgumentException_init_$Create$(toString(message));
      }
      var tmp0_safe_receiver = this.j1g_1;
      var tmp1_safe_receiver = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.v2(this.b1j(parent));
      if (tmp1_safe_receiver == null)
        null;
      else {
        tmp1_safe_receiver.f22(this.e1g_1, currentGroup);
      }
      this.n1g_1 = currentGroup;
      this.m1g_1 = currentGroup + groupSize(this.f1g_1, currentGroup) | 0;
      this.l1g_1 = currentGroup + 1 | 0;
      this.p1g_1 = slotAnchor(this.f1g_1, currentGroup);
      this.q1g_1 = currentGroup >= (this.g1g_1 - 1 | 0) ? this.i1g_1 : dataAnchor(this.f1g_1, currentGroup + 1 | 0);
    }
  };
  protoOf(SlotReader).i1i = function () {
    if (this.o1g_1 <= 0) {
      // Inline function 'kotlin.require' call
      // Inline function 'kotlin.contracts.contract' call
      if (!isNode(this.f1g_1, this.l1g_1)) {
  ...
  protoOf(SlotReader).u1h = function () {
    // Inline function 'androidx.compose.runtime.runtimeCheck' call
    if (!(this.o1g_1 === 0)) {
    ...
    var count = isNode(this.f1g_1, this.l1g_1) ? 1 : nodeCount(this.f1g_1, this.l1g_1);
    this.l1g_1 = this.l1g_1 + groupSize(this.f1g_1, this.l1g_1) | 0;
    return count;
  };
  ...
  protoOf(SlotReader).l1j = function (index) {
    // Inline function 'androidx.compose.runtime.runtimeCheck' call
    if (!(this.o1g_1 === 0)) {
    ...
    this.l1g_1 = index;
    var parent = index < this.g1g_1 ? parentAnchor(this.f1g_1, index) : -1;
    this.n1g_1 = parent;
    if (parent < 0)
      this.m1g_1 = this.g1g_1;
    else
      this.m1g_1 = parent + groupSize(this.f1g_1, parent) | 0;
    this.p1g_1 = 0;
    this.q1g_1 = 0;
  };
  protoOf(SlotReader).k1k = function (index) {
    var newCurrentEnd = index + groupSize(this.f1g_1, index) | 0;
    var current = this.l1g_1;
    // Inline function 'androidx.compose.runtime.runtimeCheck' call
    ...
    this.n1g_1 = index;
    this.m1g_1 = newCurrentEnd;
    this.p1g_1 = 0;
    this.q1g_1 = 0;
  };
  protoOf(SlotReader).b1k = function () {
    if (this.o1g_1 === 0) {
      // Inline function 'androidx.compose.runtime.runtimeCheck' call
      if (!(this.l1g_1 === this.m1g_1)) {
      ...
      var parent = parentAnchor(this.f1g_1, this.n1g_1);
      this.n1g_1 = parent;
      this.m1g_1 = parent < 0 ? this.g1g_1 : parent + groupSize(this.f1g_1, parent) | 0;
    }
  };
  protoOf(SlotReader).x1i = function () {
    // Inline function 'kotlin.collections.mutableListOf' call
    var result = ArrayList_init_$Create$();
    if (this.o1g_1 > 0)
      return result;
    var index = 0;
    var childIndex = this.l1g_1;
    while (childIndex < this.m1g_1) {
      var tmp = key(this.f1g_1, childIndex);
      var tmp_0 = objectKey(this.f1g_1, this, childIndex);
      var tmp_1 = childIndex;
      var tmp_2 = isNode(this.f1g_1, childIndex) ? 1 : nodeCount(this.f1g_1, childIndex);
      var tmp0 = index;
      index = tmp0 + 1 | 0;
      result.w(new KeyInfo(tmp, tmp_0, tmp_1, tmp_2, tmp0));
      childIndex = childIndex + groupSize(this.f1g_1, childIndex) | 0;
    }
    return result;
  };
  protoOf(SlotReader).toString = function () {
    return 'SlotReader(current=' + this.l1g_1 + ', key=' + this.w1i() + ', ' + ('parent=' + this.n1g_1 + ', end=' + this.m1g_1 + ')');
  };
  protoOf(SlotReader).b1j = function (index) {
    // Inline function 'androidx.compose.runtime.getOrAdd' call
    var this_0 = this.e1g_1.d1f_1;
    var effectiveSize = this.g1g_1;
    var location = search$accessor$145qfty(this_0, index, effectiveSize);
    var tmp;
    if (location < 0) {
  ...
  function find(_this__u8e3s4, index, effectiveSize) {
    ...
    return location >= 0 ? _this__u8e3s4.k(location) : null;
  }
  function search(_this__u8e3s4, location, effectiveSize) {
    ...
    while (low <= high) {
      ...
      var it = _this__u8e3s4.k(mid).e1m_1;
  ...
  function validateRead($this) {
    if (!($this.h22_1.c1f_1 === $this.k22_1)) {
  ...
  function GroupIterator(table, start, end) {
    ...
    this.i22_1 = end;
    this.j22_1 = start;
    this.k22_1 = this.h22_1.c1f_1;
    if (this.h22_1.b1f_1)
      throw ConcurrentModificationException_init_$Create$();
  }
  protoOf(GroupIterator).z = function () {
    return this.j22_1 < this.i22_1;
  };
  protoOf(GroupIterator).b1 = function () {
    validateRead(this);
    var group = this.j22_1;
    this.j22_1 = this.j22_1 + groupSize(this.h22_1.v1e_1, group) | 0;
    return new SlotTableGroup(this.h22_1, group, this.k22_1);
  };
  function validateRead_0($this) {
    if (!($this.l22_1.c1f_1 === $this.n22_1)) {
      throw ConcurrentModificationException_init_$Create$();
    }
  }
  function SlotTableGroup(table, group, version) {
    version = version === VOID ? table.c1f_1 : version;
    this.l22_1 = table;
    this.m22_1 = group;
    this.n22_1 = version;
  }
  protoOf(SlotTableGroup).l = function () {
    validateRead_0(this);
    var tmp0_safe_receiver = this.l22_1.s20(this.m22_1);
    var tmp;
    if (tmp0_safe_receiver == null) {
      tmp = null;
    } else {
      ...
      tmp = new SourceInformationGroupIterator(this.l22_1, tmp0_safe_receiver);
    }
    var tmp1_elvis_lhs = tmp;
    return tmp1_elvis_lhs == null ? new GroupIterator(this.l22_1, this.m22_1 + 1 | 0, this.m22_1 + groupSize(this.l22_1.v1e_1, this.m22_1) | 0) : tmp1_elvis_lhs;
  };
  ...
  protoOf(PrioritySet).e21 = function (value) {
    var tmp;
    // Inline function 'kotlin.collections.isNotEmpty' call
    if (!this.c21_1.q()) {
      tmp = this.c21_1.k(0) === value ? true : this.c21_1.k(this.c21_1.j() - 1 | 0) === value;
    } else {
      tmp = false;
    }
    if (tmp)
      return Unit_instance;
    var index = this.c21_1.j();
    this.c21_1.w(value);
    $l$loop: while (index > 0) {
      var parent = ((index + 1 | 0) >>> 1 | 0) - 1 | 0;
      var parentValue = this.c21_1.k(parent);
      if (value > parentValue) {
        this.c21_1.t(index, parentValue);
      } else
        break $l$loop;
      index = parent;
    }
    this.c21_1.t(index, value);
  };
  protoOf(PrioritySet).i1p = function () {
    // Inline function 'kotlin.collections.isNotEmpty' call
    return !this.c21_1.q();
  };
  protoOf(PrioritySet).d1o = function () {
    return first(this.c21_1);
  };
  protoOf(PrioritySet).d21 = function () {
    // Inline function 'androidx.compose.runtime.runtimeCheck' call
    if (!(this.c21_1.j() > 0)) {
    ...
    var value = this.c21_1.k(0);
    $l$loop: while (true) {
      var tmp;
      // Inline function 'kotlin.collections.isNotEmpty' call
      if (!this.c21_1.q()) {
        tmp = this.c21_1.k(0) === value;
      } else {
        tmp = false;
      }
      if (!tmp) {
      ...
      this.c21_1.t(0, last(this.c21_1));
      this.c21_1.j1(this.c21_1.j() - 1 | 0);
      var index = 0;
      var size = this.c21_1.j();
      var max = this.c21_1.j() >>> 1 | 0;
      $l$loop_2: while (index < max) {
        var indexValue = this.c21_1.k(index);
        var left = imul(index + 1 | 0, 2) - 1 | 0;
        var leftValue = this.c21_1.k(left);
        var right = imul(index + 1 | 0, 2);
        if (right < size) {
          var rightValue = this.c21_1.k(right);
          if (rightValue > leftValue) {
            if (rightValue > indexValue) {
              this.c21_1.t(index, rightValue);
              this.c21_1.t(right, indexValue);
              index = right;
              continue $l$loop_2;
            } else
              break $l$loop_2;
        ...
        if (leftValue > indexValue) {
          this.c21_1.t(index, leftValue);
          this.c21_1.t(left, indexValue);
          index = left;
        } else
          break $l$loop_2;
      }
  ...
  function SourceInformationGroupIterator(table, group) {
    this.o22_1 = table;
    this.p22_1 = group;
    this.q22_1 = this.o22_1.c1f_1;
    this.r22_1 = 0;
  }
  protoOf(SourceInformationGroupIterator).z = function () {
    var tmp0_safe_receiver = this.p22_1.v20_1;
    var tmp;
    if (tmp0_safe_receiver == null) {
      tmp = null;
    } else {
      ...
      tmp = this.r22_1 < tmp0_safe_receiver.j();
    }
    var tmp1_elvis_lhs = tmp;
    return tmp1_elvis_lhs == null ? false : tmp1_elvis_lhs;
  };
  protoOf(SourceInformationGroupIterator).b1 = function () {
    var tmp2_safe_receiver = this.p22_1.v20_1;
    var tmp;
    if (tmp2_safe_receiver == null) {
      tmp = null;
    } else {
      var tmp1 = this.r22_1;
      this.r22_1 = tmp1 + 1 | 0;
      tmp = tmp2_safe_receiver.k(tmp1);
    }
    var group = tmp;
    var tmp_0;
    if (group instanceof Anchor) {
      tmp_0 = new SlotTableGroup(this.o22_1, group.e1m_1, this.q22_1);
    } else {
      if (group instanceof GroupSourceInformation) {
        tmp_0 = new SourceInformationSlotTableGroup(this.o22_1, group);
      } else {
  ...
  function SourceInformationSlotTableGroup(table, sourceInformation) {
    this.s22_1 = table;
    this.t22_1 = sourceInformation;
    this.u22_1 = this.t22_1.t20_1;
    this.v22_1 = emptyList();
    this.w22_1 = this;
  }
  protoOf(SourceInformationSlotTableGroup).l = function () {
    return new SourceInformationGroupIterator(this.s22_1, this.t22_1);
  };
  ...
  protoOf(StructuralEqualityPolicy).y22 = function (a, b) {
    return equals(a, b);
  };
  protoOf(StructuralEqualityPolicy).i1w = function (a, b) {
    var tmp = (a == null ? true : !(a == null)) ? a : THROW_CCE();
    return this.y22(tmp, (b == null ? true : !(b == null)) ? b : THROW_CCE());
  };
  ...
  protoOf(StateStateRecord).c23 = function (value) {
    var tmp = this;
    tmp.b23_1 = (value instanceof StateStateRecord ? value : THROW_CCE()).b23_1;
  };
  protoOf(StateStateRecord).d23 = function () {
    return new StateStateRecord(this.b23_1);
  };
  function SnapshotMutableStateImpl(value, policy) {
    StateObjectImpl.call(this);
    this.f23_1 = policy;
    this.g23_1 = new StateStateRecord(value);
  }
  protoOf(SnapshotMutableStateImpl).o1u = function () {
    return this.f23_1;
  };
  protoOf(SnapshotMutableStateImpl).c10 = function (value) {
    // Inline function 'androidx.compose.runtime.snapshots.withCurrent' call
    var this_0 = this.g23_1;
    var it = current(this_0);
    var tmp;
    if (!this.o1u().i1w(it.b23_1, value)) {
      // Inline function 'androidx.compose.runtime.snapshots.overwritable' call
      var this_1 = this.g23_1;
      ...
      snapshot = Companion_instance_12.i1b();
      overwritableRecord(this_1, this, snapshot, it).b23_1 = value;
      // Inline function 'kotlin.contracts.contract' call
      // Inline function 'androidx.compose.runtime.snapshots.overwritable.<anonymous>' call
  ...
  protoOf(SnapshotMutableStateImpl).p2 = function () {
    return readable_0(this.g23_1, this).b23_1;
  };
  protoOf(SnapshotMutableStateImpl).h23 = function () {
    return this.g23_1;
  };
  protoOf(SnapshotMutableStateImpl).i23 = function (value) {
    var tmp = this;
    tmp.g23_1 = value instanceof StateStateRecord ? value : THROW_CCE();
  };
  protoOf(SnapshotMutableStateImpl).j23 = function (previous, current, applied) {
    ...
    var tmp;
    if (this.o1u().i1w(currentRecord.b23_1, appliedRecord.b23_1)) {
      tmp = current;
    } else {
      var merged = this.o1u().x22(previousRecord.b23_1, currentRecord.b23_1, appliedRecord.b23_1);
      var tmp_0;
      if (!(merged == null)) {
        // Inline function 'kotlin.also' call
        var this_0 = appliedRecord.d23();
        // Inline function 'kotlin.contracts.contract' call
        // Inline function 'androidx.compose.runtime.SnapshotMutableStateImpl.mergeRecords.<anonymous>' call
        (this_0 instanceof StateStateRecord ? this_0 : THROW_CCE()).b23_1 = merged;
        tmp_0 = this_0;
      } else {
        tmp_0 = null;
      }
  ...
  protoOf(SnapshotMutableStateImpl).toString = function () {
    ...
    return 'MutableState(value=' + current(this_0).b23_1 + ')@' + hashCode(this);
  };
  function mutableStateListOf() {
    return new SnapshotStateList();
  }
  function SnapshotThreadLocal() {
    this.p1u_1 = new AtomicReference(get_emptyThreadMap());
    this.q1u_1 = new SynchronizedObject();
  }
  protoOf(SnapshotThreadLocal).kn = function () {
    var tmp = this.p1u_1.kn().n23(currentThreadId());
    return (tmp == null ? true : !(tmp == null)) ? tmp : THROW_CCE();
  };
  protoOf(SnapshotThreadLocal).r1u = function (value) {
    var key = currentThreadId();
    // Inline function 'androidx.compose.runtime.synchronized' call
    // Inline function 'kotlinx.atomicfu.locks.synchronized' call
    this.q1u_1;
    var current = this.p1u_1.kn();
    if (current.o23(key, value))
      return Unit_instance;
    this.p1u_1.k1s(current.p23(key, value));
  };
  function IntStack() {
    this.i1f_1 = new Int32Array(10);
    this.j1f_1 = 0;
  }
  protoOf(IntStack).j = function () {
    return this.j1f_1;
  };
  protoOf(IntStack).k1f = function (value) {
    if (this.j1f_1 >= this.i1f_1.length) {
      this.i1f_1 = copyOf(this.i1f_1, imul(this.i1f_1.length, 2));
    }
    var tmp = this.i1f_1;
    var tmp1 = this.j1f_1;
    this.j1f_1 = tmp1 + 1 | 0;
  ...
  protoOf(IntStack).o1j = function () {
    var tmp = this.i1f_1;
    this.j1f_1 = this.j1f_1 - 1 | 0;
    return tmp[this.j1f_1];
  };
  protoOf(IntStack).m21 = function (default_0) {
    return this.j1f_1 > 0 ? this.d1o() : default_0;
  };
  protoOf(IntStack).d1o = function () {
    return this.i1f_1[this.j1f_1 - 1 | 0];
  };
  protoOf(IntStack).l1k = function (index) {
    return this.i1f_1[index];
  };
  ...
  protoOf(IntStack).l21 = function (value) {
    var inductionVariable = 0;
    var last = this.j1f_1;
    if (inductionVariable < last)
      do {
  ...
  function Stack() {
    this.s1g_1 = ArrayList_init_$Create$();
  }
  protoOf(Stack).j = function () {
    return this.s1g_1.j();
  };
  protoOf(Stack).n1j = function (value) {
    return this.s1g_1.w(value);
  };
  protoOf(Stack).o1j = function () {
    return this.s1g_1.j1(this.j() - 1 | 0);
  };
  protoOf(Stack).d1o = function () {
    return this.s1g_1.k(this.j() - 1 | 0);
  };
  protoOf(Stack).l1k = function (index) {
    return this.s1g_1.k(index);
  };
  protoOf(Stack).q = function () {
    return this.s1g_1.q();
  };
  protoOf(Stack).i1p = function () {
    return !this.q();
  };
  protoOf(Stack).e1 = function () {
    return this.s1g_1.e1();
  };
  protoOf(Stack).d3 = function () {
    var tmp = 0;
    var tmp_0 = this.s1g_1.j();
    // Inline function 'kotlin.arrayOfNulls' call
    var tmp_1 = fillArrayVal(Array(tmp_0), null);
    while (tmp < tmp_0) {
      var tmp_2 = tmp;
      tmp_1[tmp_2] = this.s1g_1.k(tmp_2);
      tmp = tmp + 1 | 0;
    }
    var tmp_3 = tmp_1;
  ...
  function LazyValueHolder(valueProducer) {
    this.n1u_1 = lazy(valueProducer);
  }
  protoOf(LazyValueHolder).p2 = function () {
    return _get_current__qcrdxk(this);
  };
  function StaticValueHolder(value) {
    this.q23_1 = value;
  }
  protoOf(StaticValueHolder).p2 = function () {
    return this.q23_1;
  };
  protoOf(StaticValueHolder).toString = function () {
    return 'StaticValueHolder(value=' + this.q23_1 + ')';
  };
  ...
  function ChangeList() {
    this.a1q_1 = new Operations();
  }
  protoOf(ChangeList).q = function () {
    return this.a1q_1.q();
  };
  protoOf(ChangeList).i1p = function () {
    return this.a1q_1.i1p();
  };
  protoOf(ChangeList).e1 = function () {
    this.a1q_1.e1();
  };
  protoOf(ChangeList).a1s = function (applier, slots, rememberManager) {
    return this.a1q_1.z23(applier, slots, rememberManager);
  };
  protoOf(ChangeList).a24 = function (value) {
    ...
    // Inline function 'kotlin.check' call
    // Inline function 'kotlin.contracts.contract' call
    if (!(this_0.x23_1 === createExpectedArgMask(this_0, operation.c24_1) ? this_0.y23_1 === createExpectedArgMask(this_0, operation.d24_1) : false)) {
      ...
      if (inductionVariable < times)
        do {
          ...
          if (!((1 << index & this_0.x23_1) === 0)) {
            if (missingIntCount > 0) {
              this_1.v5(', ');
            }
            this_1.v5(operation.e24(_IntParameter___init__impl__oy5xkp(index)));
      ...
      if (inductionVariable_0 < times_0)
        do {
          ...
          inductionVariable_0 = inductionVariable_0 + 1 | 0;
          // Inline function 'androidx.compose.runtime.changelist.Operations.push.<anonymous>.<anonymous>.<anonymous>' call
          if (!((1 << index_0 & this_0.y23_1) === 0)) {
            if (missingIntCount > 0) {
              this_2.v5(', ');
            }
            this_2.v5(operation.f24(_ObjectParameter___init__impl__iyg1ip(index_0)));
  ...
  protoOf(ChangeList).g24 = function (value, groupSlotIndex) {
    // Inline function 'androidx.compose.runtime.changelist.Operations.push' call
    var this_0 = this.a1q_1;
  ...
  protoOf(ChangeList).h24 = function () {
    this.a1q_1.i24(ResetSlots_getInstance());
  };
  protoOf(ChangeList).j24 = function (data) {
    // Inline function 'androidx.compose.runtime.changelist.Operations.push' call
    var this_0 = this.a1q_1;
  ...
  protoOf(ChangeList).k24 = function () {
    this.a1q_1.i24(EnsureRootGroupStarted_getInstance());
  };
  protoOf(ChangeList).l24 = function (anchor) {
    // Inline function 'androidx.compose.runtime.changelist.Operations.push' call
    var this_0 = this.a1q_1;
  ...
  protoOf(ChangeList).m24 = function () {
    this.a1q_1.i24(EndCurrentGroup_getInstance());
  };
  protoOf(ChangeList).n24 = function () {
    this.a1q_1.i24(SkipToEndOfCurrentGroup_getInstance());
  };
  protoOf(ChangeList).o24 = function () {
    this.a1q_1.i24(RemoveCurrentGroup_getInstance());
  };
  protoOf(ChangeList).p24 = function (anchor, from) {
    // Inline function 'androidx.compose.runtime.changelist.Operations.push' call
    var this_0 = this.a1q_1;
  ...
  protoOf(ChangeList).q24 = function (anchor, from, fixups) {
    // Inline function 'androidx.compose.runtime.changelist.Operations.push' call
    var this_0 = this.a1q_1;
  ...
  protoOf(ChangeList).r24 = function (offset) {
    // Inline function 'androidx.compose.runtime.changelist.Operations.push' call
    var this_0 = this.a1q_1;
  ...
  protoOf(ChangeList).s24 = function (action, composition) {
    // Inline function 'androidx.compose.runtime.changelist.Operations.push' call
    var this_0 = this.a1q_1;
  ...
  protoOf(ChangeList).t24 = function (node) {
    if (!(node == null) ? isInterface(node, ComposeNodeLifecycleCallback) : false) {
      this.a1q_1.i24(UseCurrentNode_getInstance());
    }
  };
  protoOf(ChangeList).u24 = function (value, block) {
    // Inline function 'androidx.compose.runtime.changelist.Operations.push' call
    var this_0 = this.a1q_1;
  ...
  protoOf(ChangeList).v24 = function (removeFrom, moveCount) {
    // Inline function 'androidx.compose.runtime.changelist.Operations.push' call
    var this_0 = this.a1q_1;
  ...
  protoOf(ChangeList).w24 = function (to, from, count) {
    // Inline function 'androidx.compose.runtime.changelist.Operations.push' call
    var this_0 = this.a1q_1;
  ...
  protoOf(ChangeList).x24 = function (distance) {
    // Inline function 'androidx.compose.runtime.changelist.Operations.push' call
    var this_0 = this.a1q_1;
  ...
  protoOf(ChangeList).y24 = function (count) {
    // Inline function 'androidx.compose.runtime.changelist.Operations.push' call
    var this_0 = this.a1q_1;
  ...
  protoOf(ChangeList).z24 = function (nodes) {
    // Inline function 'kotlin.collections.isNotEmpty' call
  ...
  protoOf(ChangeList).a25 = function (effect) {
    // Inline function 'androidx.compose.runtime.changelist.Operations.push' call
    var this_0 = this.a1q_1;
  ...
  protoOf(ChangeList).b25 = function (effectiveNodeIndexOut, anchor) {
    // Inline function 'androidx.compose.runtime.changelist.Operations.push' call
    var this_0 = this.a1q_1;
  ...
  protoOf(ChangeList).c25 = function (nodes, effectiveNodeIndex) {
    // Inline function 'kotlin.collections.isNotEmpty' call
    if (!nodes.q()) {
      // Inline function 'androidx.compose.runtime.changelist.Operations.push' call
      var this_0 = this.a1q_1;
  ...
  protoOf(ChangeList).d25 = function (resolvedState, parentContext, from, to) {
    // Inline function 'androidx.compose.runtime.changelist.Operations.push' call
    var this_0 = this.a1q_1;
  ...
  protoOf(ChangeList).e25 = function (composition, parentContext, reference) {
    // Inline function 'androidx.compose.runtime.changelist.Operations.push' call
    var this_0 = this.a1q_1;
  ...
  protoOf(ChangeList).f25 = function () {
    this.a1q_1.i24(EndMovableContentPlacement_getInstance());
  };
  protoOf(ChangeList).g25 = function (changeList, effectiveNodeIndex) {
    if (changeList.i1p()) {
      // Inline function 'androidx.compose.runtime.changelist.Operations.push' call
      var this_0 = this.a1q_1;
  ...
  function ensureRootStarted($this) {
    if (!$this.t1f_1 ? $this.v1f_1 : false) {
  ...
  function ensureGroupStarted($this, anchor) {
    pushSlotTableOperationPreamble$default($this);
    $this.s1f_1.l24(anchor);
    $this.t1f_1 = true;
  }
  function realizeOperationLocation($this, forParent) {
    var location = forParent ? _get_reader__fd8dw8($this).n1g_1 : _get_reader__fd8dw8($this).l1g_1;
    var distance = location - $this.w1f_1 | 0;
    // Inline function 'androidx.compose.runtime.runtimeCheck' call
    if (!(distance >= 0)) {
  ...
  function realizeNodeMovementOperations($this) {
    if ($this.c1g_1 > 0) {
      if ($this.z1f_1 >= 0) {
        realizeRemoveNode($this, $this.z1f_1, $this.c1g_1);
        $this.z1f_1 = -1;
      } else {
        realizeMoveNode($this, $this.b1g_1, $this.a1g_1, $this.c1g_1);
        $this.a1g_1 = -1;
        $this.b1g_1 = -1;
      }
      $this.c1g_1 = 0;
  ...
  function realizeRemoveNode($this, removeFrom, moveCount) {
    ...
    $this.s1f_1.v24(removeFrom, moveCount);
  }
  function realizeMoveNode($this, to, from, count) {
    pushApplierOperationPreamble($this);
    $this.s1f_1.w24(to, from, count);
  }
  function pushPendingUpsAndDowns($this) {
    if ($this.x1f_1 > 0) {
      $this.s1f_1.y24($this.x1f_1);
      $this.x1f_1 = 0;
    }
    if ($this.y1f_1.i1p()) {
      $this.s1f_1.z24($this.y1f_1.d3());
      $this.y1f_1.e1();
    }
  }
  ...
  function ComposerChangeListWriter(composer, changeList) {
    this.r1f_1 = composer;
    this.s1f_1 = changeList;
    this.t1f_1 = false;
    this.u1f_1 = new IntStack();
    this.v1f_1 = true;
    this.w1f_1 = 0;
    this.x1f_1 = 0;
    this.y1f_1 = new Stack();
    this.z1f_1 = -1;
    this.a1g_1 = -1;
    this.b1g_1 = -1;
    this.c1g_1 = 0;
  }
  protoOf(ComposerChangeListWriter).k1j = function (location) {
    this.w1f_1 = this.w1f_1 + (location - _get_reader__fd8dw8(this).l1g_1 | 0) | 0;
  };
  protoOf(ComposerChangeListWriter).n1l = function (location) {
    this.w1f_1 = location;
  };
  protoOf(ComposerChangeListWriter).g1n = function () {
    if (_get_reader__fd8dw8(this).j() > 0) {
      var reader = _get_reader__fd8dw8(this);
      var location = reader.n1g_1;
      if (!(this.u1f_1.m21(-2) === location)) {
        ensureRootStarted(this);
        if (location > 0) {
          var anchor = reader.b1j(location);
          this.u1f_1.k1f(location);
          ensureGroupStarted(this, anchor);
        }
      }
    }
  };
  protoOf(ComposerChangeListWriter).u1o = function (value) {
    this.s1f_1.a24(value);
  };
  protoOf(ComposerChangeListWriter).r1o = function (value, groupSlotIndex) {
    pushSlotTableOperationPreamble(this, true);
    this.s1f_1.g24(value, groupSlotIndex);
  };
  protoOf(ComposerChangeListWriter).z1k = function () {
    this.s1f_1.h24();
  };
  protoOf(ComposerChangeListWriter).f1i = function (data) {
    pushSlotTableOperationPreamble$default(this);
    this.s1f_1.j24(data);
  };
  protoOf(ComposerChangeListWriter).d1g = function () {
    if (this.t1f_1) {
      pushSlotTableOperationPreamble$default(this);
      pushSlotTableOperationPreamble$default(this);
      this.s1f_1.m24();
  ...
  protoOf(ComposerChangeListWriter).a1k = function () {
    var location = _get_reader__fd8dw8(this).n1g_1;
    var currentStartedGroup = this.u1f_1.m21(-1);
    // Inline function 'androidx.compose.runtime.runtimeCheck' call
    ...
    if (this.u1f_1.m21(-1) === location) {
      pushSlotTableOperationPreamble$default(this);
      this.u1f_1.o1j();
      this.s1f_1.m24();
    }
  };
  protoOf(ComposerChangeListWriter).p1l = function () {
    this.s1f_1.n24();
  };
  protoOf(ComposerChangeListWriter).o1m = function () {
    pushSlotEditingOperationPreamble(this);
    this.s1f_1.o24();
    this.w1f_1 = this.w1f_1 + _get_reader__fd8dw8(this).g22() | 0;
  };
  protoOf(ComposerChangeListWriter).n1m = function (anchor, from) {
    pushPendingUpsAndDowns(this);
    pushSlotEditingOperationPreamble(this);
    this.s1f_1.p24(anchor, from);
  };
  protoOf(ComposerChangeListWriter).m1m = function (anchor, from, fixups) {
    pushPendingUpsAndDowns(this);
    pushSlotEditingOperationPreamble(this);
    this.s1f_1.q24(anchor, from, fixups);
  };
  protoOf(ComposerChangeListWriter).m1j = function (offset) {
    pushSlotEditingOperationPreamble(this);
    this.s1f_1.r24(offset);
  };
  protoOf(ComposerChangeListWriter).p1p = function (action, composition) {
    this.s1f_1.s24(action, composition);
  };
  protoOf(ComposerChangeListWriter).g1o = function (node) {
    pushApplierOperationPreamble(this);
    this.s1f_1.t24(node);
  };
  protoOf(ComposerChangeListWriter).j1o = function (value, block) {
    pushApplierOperationPreamble(this);
    this.s1f_1.u24(value, block);
  };
  protoOf(ComposerChangeListWriter).q1j = function (nodeIndex, count) {
    if (count > 0) {
      // Inline function 'androidx.compose.runtime.runtimeCheck' call
      if (!(nodeIndex >= 0)) {
      ...
      if (this.z1f_1 === nodeIndex) {
        this.c1g_1 = this.c1g_1 + count | 0;
      } else {
        realizeNodeMovementOperations(this);
        this.z1f_1 = nodeIndex;
        this.c1g_1 = count;
      }
    }
  };
  protoOf(ComposerChangeListWriter).u1j = function (from, to, count) {
    if (count > 0) {
      if ((this.c1g_1 > 0 ? this.a1g_1 === (from - this.c1g_1 | 0) : false) ? this.b1g_1 === (to - this.c1g_1 | 0) : false) {
        this.c1g_1 = this.c1g_1 + count | 0;
      } else {
        realizeNodeMovementOperations(this);
        this.a1g_1 = from;
  ...
  protoOf(ComposerChangeListWriter).p1m = function () {
    pushPendingUpsAndDowns(this);
    if (this.t1f_1) {
      this.p1l();
      this.d1g();
  ...
  protoOf(ComposerChangeListWriter).w1j = function () {
    realizeNodeMovementOperations(this);
  };
  protoOf(ComposerChangeListWriter).i1n = function (nodeIndex, group) {
    this.w1j();
    pushPendingUpsAndDowns(this);
    var nodeCount = _get_reader__fd8dw8(this).m1k(group) ? 1 : _get_reader__fd8dw8(this).n1k(group);
    if (nodeCount > 0) {
      this.q1j(nodeIndex, nodeCount);
    }
  };
  protoOf(ComposerChangeListWriter).z1j = function () {
    if (this.y1f_1.i1p()) {
      this.y1f_1.o1j();
    } else {
  ...
  protoOf(ComposerChangeListWriter).o1k = function (node) {
    this.y1f_1.n1j(node);
  };
  protoOf(ComposerChangeListWriter).w1o = function (effect) {
    this.s1f_1.a25(effect);
  };
  protoOf(ComposerChangeListWriter).i1l = function (effectiveNodeIndexOut, anchor) {
    pushPendingUpsAndDowns(this);
    this.s1f_1.b25(effectiveNodeIndexOut, anchor);
  };
  protoOf(ComposerChangeListWriter).l1l = function (nodes, effectiveNodeIndex) {
    this.s1f_1.c25(nodes, effectiveNodeIndex);
  };
  protoOf(ComposerChangeListWriter).m1l = function (resolvedState, parentContext, from, to) {
    this.s1f_1.d25(resolvedState, parentContext, from, to);
  };
  protoOf(ComposerChangeListWriter).h1n = function (composition, parentContext, reference) {
    this.s1f_1.e25(composition, parentContext, reference);
  };
  protoOf(ComposerChangeListWriter).q1l = function () {
    this.s1f_1.f25();
    this.w1f_1 = 0;
  };
  protoOf(ComposerChangeListWriter).o1l = function (other, effectiveNodeIndex) {
    this.s1f_1.g25(other, effectiveNodeIndex);
  };
  protoOf(ComposerChangeListWriter).r1m = function () {
    pushPendingUpsAndDowns(this);
    // Inline function 'androidx.compose.runtime.runtimeCheck' call
    if (!this.u1f_1.q()) {
  ...
  protoOf(ComposerChangeListWriter).s1m = function () {
    this.t1f_1 = false;
    this.u1f_1.e1();
    this.w1f_1 = 0;
  };
  function FixupList() {
    this.p1h_1 = new Operations();
    this.q1h_1 = new Operations();
  }
  ...
  protoOf(FixupList).i25 = function (applier, slots, rememberManager) {
    // Inline function 'androidx.compose.runtime.runtimeCheck' call
    if (!this.q1h_1.q()) {
    ...
    this.p1h_1.z23(applier, slots, rememberManager);
  };
  protoOf(FixupList).e1o = function (factory, insertIndex, groupAnchor) {
    // Inline function 'androidx.compose.runtime.changelist.Operations.push' call
    ...
    // Inline function 'kotlin.check' call
    // Inline function 'kotlin.contracts.contract' call
    if (!(this_3.x23_1 === createExpectedArgMask(this_3, operation_0.c24_1) ? this_3.y23_1 === createExpectedArgMask(this_3, operation_0.d24_1) : false)) {
      // Inline function 'androidx.compose.runtime.changelist.Operations.push.<anonymous>' call
      ...
      if (inductionVariable_1 < times_1)
        do {
          ...
          inductionVariable_1 = inductionVariable_1 + 1 | 0;
          // Inline function 'androidx.compose.runtime.changelist.Operations.push.<anonymous>.<anonymous>.<anonymous>' call
          if (!((1 << index_1 & this_3.x23_1) === 0)) {
            if (missingIntCount_0 > 0) {
              this_4.v5(', ');
            }
            this_4.v5(operation_0.e24(_IntParameter___init__impl__oy5xkp(index_1)));
      ...
      if (inductionVariable_2 < times_2)
        do {
          ...
          inductionVariable_2 = inductionVariable_2 + 1 | 0;
          // Inline function 'androidx.compose.runtime.changelist.Operations.push.<anonymous>.<anonymous>.<anonymous>' call
          if (!((1 << index_2 & this_3.y23_1) === 0)) {
            if (missingIntCount_0 > 0) {
              this_5.v5(', ');
            }
            this_5.v5(operation_0.f24(_ObjectParameter___init__impl__iyg1ip(index_2)));
  ...
  protoOf(FixupList).c1k = function () {
    // Inline function 'androidx.compose.runtime.runtimeCheck' call
    if (!this.q1h_1.i1p()) {
    ...
    this.q1h_1.j25(this.p1h_1);
  };
  protoOf(FixupList).k1o = function (value, block) {
    // Inline function 'androidx.compose.runtime.changelist.Operations.push' call
    var this_0 = this.p1h_1;
    var operation = UpdateNode_getInstance();
    // Inline function 'kotlin.contracts.contract' call
  ...
  protoOf(Ups).e24 = function (parameter) {
    var tmp;
    // Inline function 'androidx.compose.runtime.changelist.Ups.Count' call
    if (parameter === _IntParameter___init__impl__oy5xkp(0)) {
      tmp = 'count';
    } else {
      tmp = protoOf(Operation).e24.call(this, parameter);
    }
    return tmp;
  };
  protoOf(Ups).m25 = function (_this__u8e3s4, applier, slots, rememberManager) {
    // Inline function 'kotlin.repeat' call
    // Inline function 'androidx.compose.runtime.changelist.Ups.Count' call
    var tmp$ret$0 = _IntParameter___init__impl__oy5xkp(0);
    var times = _this__u8e3s4.n25(tmp$ret$0);
    // Inline function 'kotlin.contracts.contract' call
    var inductionVariable = 0;
    if (inductionVariable < times)
      do {
  ...
  protoOf(Downs).f24 = function (parameter) {
    var tmp;
    // Inline function 'androidx.compose.runtime.changelist.Downs.Nodes' call
    if (parameter === _ObjectParameter___init__impl__iyg1ip(0)) {
      tmp = 'nodes';
    } else {
      tmp = protoOf(Operation).f24.call(this, parameter);
    }
    return tmp;
  };
  protoOf(Downs).m25 = function (_this__u8e3s4, applier, slots, rememberManager) {
    var nodeApplier = isInterface(applier, Applier) ? applier : THROW_CCE();
    // Inline function 'androidx.compose.runtime.changelist.Downs.Nodes' call
    var tmp$ret$0 = _ObjectParameter___init__impl__iyg1ip(0);
    var nodes = _this__u8e3s4.r25(tmp$ret$0);
    var inductionVariable = 0;
  ...
  protoOf(AdvanceSlotsBy).e24 = function (parameter) {
    var tmp;
    // Inline function 'androidx.compose.runtime.changelist.AdvanceSlotsBy.Distance' call
    if (parameter === _IntParameter___init__impl__oy5xkp(0)) {
      tmp = 'distance';
  ...
  protoOf(AdvanceSlotsBy).m25 = function (_this__u8e3s4, applier, slots, rememberManager) {
    // Inline function 'androidx.compose.runtime.changelist.AdvanceSlotsBy.Distance' call
    var tmp$ret$0 = _IntParameter___init__impl__oy5xkp(0);
    slots.y20(_this__u8e3s4.n25(tmp$ret$0));
  };
  ...
  protoOf(SideEffect_0).f24 = function (parameter) {
    var tmp;
    // Inline function 'androidx.compose.runtime.changelist.SideEffect.Effect' call
    if (parameter === _ObjectParameter___init__impl__iyg1ip(0)) {
      tmp = 'effect';
  ...
  protoOf(SideEffect_0).m25 = function (_this__u8e3s4, applier, slots, rememberManager) {
    // Inline function 'androidx.compose.runtime.changelist.SideEffect.Effect' call
    var tmp$ret$0 = _ObjectParameter___init__impl__iyg1ip(0);
    rememberManager.w1o(_this__u8e3s4.r25(tmp$ret$0));
  };
  ...
  protoOf(Remember).f24 = function (parameter) {
    var tmp;
    // Inline function 'androidx.compose.runtime.changelist.Remember.Value' call
    if (parameter === _ObjectParameter___init__impl__iyg1ip(0)) {
      tmp = 'value';
  ...
  protoOf(Remember).m25 = function (_this__u8e3s4, applier, slots, rememberManager) {
    // Inline function 'androidx.compose.runtime.changelist.Remember.Value' call
    var tmp$ret$0 = _ObjectParameter___init__impl__iyg1ip(0);
    rememberManager.s1s(_this__u8e3s4.r25(tmp$ret$0));
  };
  ...
  protoOf(UpdateValue).e24 = function (parameter) {
    var tmp;
    // Inline function 'androidx.compose.runtime.changelist.UpdateValue.GroupSlotIndex' call
    if (parameter === _IntParameter___init__impl__oy5xkp(0)) {
      tmp = 'groupSlotIndex';
  ...
  protoOf(UpdateValue).f24 = function (parameter) {
    var tmp;
    // Inline function 'androidx.compose.runtime.changelist.UpdateValue.Value' call
    if (parameter === _ObjectParameter___init__impl__iyg1ip(0)) {
      tmp = 'value';
  ...
  protoOf(UpdateValue).m25 = function (_this__u8e3s4, applier, slots, rememberManager) {
    // Inline function 'androidx.compose.runtime.changelist.UpdateValue.Value' call
    var tmp$ret$0 = _ObjectParameter___init__impl__iyg1ip(0);
    var value = _this__u8e3s4.r25(tmp$ret$0);
    // Inline function 'androidx.compose.runtime.changelist.UpdateValue.GroupSlotIndex' call
    var tmp$ret$1 = _IntParameter___init__impl__oy5xkp(0);
    var groupSlotIndex = _this__u8e3s4.n25(tmp$ret$1);
    if (value instanceof RememberObserverHolder) {
      rememberManager.s1s(value.m1o_1);
    }
    var previous = slots.v21(groupSlotIndex, value);
    if (previous instanceof RememberObserverHolder) {
      rememberManager.i1q(previous.m1o_1);
    } else {
  ...
  protoOf(UpdateAuxData).f24 = function (parameter) {
    var tmp;
    // Inline function 'androidx.compose.runtime.changelist.UpdateAuxData.Data' call
    if (parameter === _ObjectParameter___init__impl__iyg1ip(0)) {
      tmp = 'data';
  ...
  protoOf(UpdateAuxData).m25 = function (_this__u8e3s4, applier, slots, rememberManager) {
    // Inline function 'androidx.compose.runtime.changelist.UpdateAuxData.Data' call
    var tmp$ret$0 = _ObjectParameter___init__impl__iyg1ip(0);
    slots.a21(_this__u8e3s4.r25(tmp$ret$0));
  };
  ...
  protoOf(EnsureRootGroupStarted).m25 = function (_this__u8e3s4, applier, slots, rememberManager) {
    slots.x21(0);
  };
  ...
  protoOf(EnsureGroupStarted).f24 = function (parameter) {
    var tmp;
    // Inline function 'androidx.compose.runtime.changelist.EnsureGroupStarted.Anchor' call
    if (parameter === _ObjectParameter___init__impl__iyg1ip(0)) {
      tmp = 'anchor';
  ...
  protoOf(EnsureGroupStarted).m25 = function (_this__u8e3s4, applier, slots, rememberManager) {
    // Inline function 'androidx.compose.runtime.changelist.EnsureGroupStarted.Anchor' call
    var tmp$ret$0 = _ObjectParameter___init__impl__iyg1ip(0);
    slots.y21(_this__u8e3s4.r25(tmp$ret$0));
  };
  ...
  protoOf(RemoveCurrentGroup).m25 = function (_this__u8e3s4, applier, slots, rememberManager) {
  ...
  protoOf(MoveCurrentGroup).e24 = function (parameter) {
    var tmp;
    // Inline function 'androidx.compose.runtime.changelist.MoveCurrentGroup.Offset' call
    if (parameter === _IntParameter___init__impl__oy5xkp(0)) {
      tmp = 'offset';
  ...
  protoOf(MoveCurrentGroup).m25 = function (_this__u8e3s4, applier, slots, rememberManager) {
    // Inline function 'androidx.compose.runtime.changelist.MoveCurrentGroup.Offset' call
    var tmp$ret$0 = _IntParameter___init__impl__oy5xkp(0);
    slots.a22(_this__u8e3s4.n25(tmp$ret$0));
  };
  ...
  protoOf(EndCurrentGroup).m25 = function (_this__u8e3s4, applier, slots, rememberManager) {
    slots.e1k();
  };
  ...
  protoOf(SkipToEndOfCurrentGroup).m25 = function (_this__u8e3s4, applier, slots, rememberManager) {
    slots.e1i();
  };
  ...
  protoOf(EndCompositionScope).f24 = function (parameter) {
    var tmp;
    // Inline function 'androidx.compose.runtime.changelist.EndCompositionScope.Action' call
    if (parameter === _ObjectParameter___init__impl__iyg1ip(0)) {
      tmp = 'anchor';
  ...
  protoOf(EndCompositionScope).m25 = function (_this__u8e3s4, applier, slots, rememberManager) {
    // Inline function 'androidx.compose.runtime.changelist.EndCompositionScope.Action' call
    var tmp$ret$0 = _ObjectParameter___init__impl__iyg1ip(0);
    var action = _this__u8e3s4.r25(tmp$ret$0);
    // Inline function 'androidx.compose.runtime.changelist.EndCompositionScope.Composition' call
    var tmp$ret$1 = _ObjectParameter___init__impl__iyg1ip(1);
    var composition = _this__u8e3s4.r25(tmp$ret$1);
    action(composition);
  };
  ...
  protoOf(UseCurrentNode).m25 = function (_this__u8e3s4, applier, slots, rememberManager) {
    var tmp = applier.i1b();
    ((!(tmp == null) ? isInterface(tmp, ComposeNodeLifecycleCallback) : false) ? tmp : THROW_CCE()).k1c();
  };
  ...
  protoOf(UpdateNode).f24 = function (parameter) {
    var tmp;
    // Inline function 'androidx.compose.runtime.changelist.UpdateNode.Value' call
    if (parameter === _ObjectParameter___init__impl__iyg1ip(0)) {
      tmp = 'value';
  ...
  protoOf(UpdateNode).m25 = function (_this__u8e3s4, applier, slots, rememberManager) {
    // Inline function 'androidx.compose.runtime.changelist.UpdateNode.Value' call
    var tmp$ret$0 = _ObjectParameter___init__impl__iyg1ip(0);
    var value = _this__u8e3s4.r25(tmp$ret$0);
    // Inline function 'androidx.compose.runtime.changelist.UpdateNode.Block' call
    var tmp$ret$1 = _ObjectParameter___init__impl__iyg1ip(1);
    var block = _this__u8e3s4.r25(tmp$ret$1);
    block(applier.i1b(), value);
  };
  ...
  protoOf(RemoveNode).e24 = function (parameter) {
    var tmp;
    // Inline function 'androidx.compose.runtime.changelist.RemoveNode.RemoveIndex' call
    if (parameter === _IntParameter___init__impl__oy5xkp(0)) {
      tmp = 'removeIndex';
  ...
  protoOf(RemoveNode).m25 = function (_this__u8e3s4, applier, slots, rememberManager) {
    // Inline function 'androidx.compose.runtime.changelist.RemoveNode.RemoveIndex' call
    var tmp$ret$0 = _IntParameter___init__impl__oy5xkp(0);
    var tmp = _this__u8e3s4.n25(tmp$ret$0);
    // Inline function 'androidx.compose.runtime.changelist.RemoveNode.Count' call
    var tmp$ret$1 = _IntParameter___init__impl__oy5xkp(1);
    applier.p1b(tmp, _this__u8e3s4.n25(tmp$ret$1));
  };
  ...
  protoOf(MoveNode).e24 = function (parameter) {
    var tmp;
    // Inline function 'androidx.compose.runtime.changelist.MoveNode.From' call
    if (parameter === _IntParameter___init__impl__oy5xkp(0)) {
      tmp = 'from';
  ...
  protoOf(MoveNode).m25 = function (_this__u8e3s4, applier, slots, rememberManager) {
    // Inline function 'androidx.compose.runtime.changelist.MoveNode.From' call
    var tmp$ret$0 = _IntParameter___init__impl__oy5xkp(0);
    var tmp = _this__u8e3s4.n25(tmp$ret$0);
    // Inline function 'androidx.compose.runtime.changelist.MoveNode.To' call
    var tmp$ret$1 = _IntParameter___init__impl__oy5xkp(1);
    var tmp_0 = _this__u8e3s4.n25(tmp$ret$1);
    // Inline function 'androidx.compose.runtime.changelist.MoveNode.Count' call
    var tmp$ret$2 = _IntParameter___init__impl__oy5xkp(2);
    applier.q1b(tmp, tmp_0, _this__u8e3s4.n25(tmp$ret$2));
  };
  ...
  protoOf(InsertSlots).f24 = function (parameter) {
    var tmp;
    // Inline function 'androidx.compose.runtime.changelist.InsertSlots.Anchor' call
    if (parameter === _ObjectParameter___init__impl__iyg1ip(0)) {
      tmp = 'anchor';
  ...
  protoOf(InsertSlots).m25 = function (_this__u8e3s4, applier, slots, rememberManager) {
    // Inline function 'androidx.compose.runtime.changelist.InsertSlots.FromSlotTable' call
    var tmp$ret$0 = _ObjectParameter___init__impl__iyg1ip(1);
    var insertTable = _this__u8e3s4.r25(tmp$ret$0);
    // Inline function 'androidx.compose.runtime.changelist.InsertSlots.Anchor' call
    var tmp$ret$1 = _ObjectParameter___init__impl__iyg1ip(0);
    var anchor = _this__u8e3s4.r25(tmp$ret$1);
    slots.a1j();
    slots.c22(insertTable, anchor.j1p(insertTable), false);
    slots.f1k();
  };
  ...
  protoOf(InsertSlotsWithFixups).f24 = function (parameter) {
    var tmp;
    // Inline function 'androidx.compose.runtime.changelist.InsertSlotsWithFixups.Anchor' call
    if (parameter === _ObjectParameter___init__impl__iyg1ip(0)) {
      tmp = 'anchor';
  ...
  protoOf(InsertSlotsWithFixups).m25 = function (_this__u8e3s4, applier, slots, rememberManager) {
    // Inline function 'androidx.compose.runtime.changelist.InsertSlotsWithFixups.FromSlotTable' call
    var tmp$ret$0 = _ObjectParameter___init__impl__iyg1ip(1);
    var insertTable = _this__u8e3s4.r25(tmp$ret$0);
    // Inline function 'androidx.compose.runtime.changelist.InsertSlotsWithFixups.Anchor' call
    ...
    // Inline function 'androidx.compose.runtime.changelist.InsertSlotsWithFixups.Fixups' call
    var tmp$ret$2 = _ObjectParameter___init__impl__iyg1ip(2);
    var fixups = _this__u8e3s4.r25(tmp$ret$2);
    // Inline function 'androidx.compose.runtime.SlotTable.write' call
    // Inline function 'kotlin.let' call
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'androidx.compose.runtime.SlotTable.write.<anonymous>' call
    var writer = insertTable.d1i();
    var tmp;
    try {
      fixups.i25(applier, writer, rememberManager);
      tmp = Unit_instance;
    }finally {
      writer.r1g();
    }
  ...
  protoOf(InsertNodeFixup).e24 = function (parameter) {
    var tmp;
    // Inline function 'androidx.compose.runtime.changelist.InsertNodeFixup.InsertIndex' call
    if (parameter === _IntParameter___init__impl__oy5xkp(0)) {
      tmp = 'insertIndex';
  ...
  protoOf(InsertNodeFixup).f24 = function (parameter) {
    var tmp;
    // Inline function 'androidx.compose.runtime.changelist.InsertNodeFixup.Factory' call
    if (parameter === _ObjectParameter___init__impl__iyg1ip(0)) {
      tmp = 'factory';
  ...
  protoOf(InsertNodeFixup).m25 = function (_this__u8e3s4, applier, slots, rememberManager) {
    // Inline function 'androidx.compose.runtime.changelist.InsertNodeFixup.Factory' call
    var tmp$ret$0 = _ObjectParameter___init__impl__iyg1ip(0);
    var node = _this__u8e3s4.r25(tmp$ret$0)();
    // Inline function 'androidx.compose.runtime.changelist.InsertNodeFixup.GroupAnchor' call
    var tmp$ret$1 = _ObjectParameter___init__impl__iyg1ip(1);
    var groupAnchor = _this__u8e3s4.r25(tmp$ret$1);
    // Inline function 'androidx.compose.runtime.changelist.InsertNodeFixup.InsertIndex' call
    var tmp$ret$2 = _IntParameter___init__impl__oy5xkp(0);
    var insertIndex = _this__u8e3s4.n25(tmp$ret$2);
    var nodeApplier = isInterface(applier, Applier) ? applier : THROW_CCE();
    slots.u21(groupAnchor, node);
    nodeApplier.n1b(insertIndex, node);
    nodeApplier.l1b(node);
  };
  ...
  protoOf(PostInsertNodeFixup).e24 = function (parameter) {
    var tmp;
    // Inline function 'androidx.compose.runtime.changelist.PostInsertNodeFixup.InsertIndex' call
    if (parameter === _IntParameter___init__impl__oy5xkp(0)) {
      tmp = 'insertIndex';
  ...
  protoOf(PostInsertNodeFixup).f24 = function (parameter) {
    var tmp;
    // Inline function 'androidx.compose.runtime.changelist.PostInsertNodeFixup.GroupAnchor' call
    if (parameter === _ObjectParameter___init__impl__iyg1ip(0)) {
      tmp = 'groupAnchor';
  ...
  protoOf(PostInsertNodeFixup).m25 = function (_this__u8e3s4, applier, slots, rememberManager) {
    // Inline function 'androidx.compose.runtime.changelist.PostInsertNodeFixup.GroupAnchor' call
    var tmp$ret$0 = _ObjectParameter___init__impl__iyg1ip(0);
    var groupAnchor = _this__u8e3s4.r25(tmp$ret$0);
    // Inline function 'androidx.compose.runtime.changelist.PostInsertNodeFixup.InsertIndex' call
    var tmp$ret$1 = _IntParameter___init__impl__oy5xkp(0);
    var insertIndex = _this__u8e3s4.n25(tmp$ret$1);
    applier.m1b();
    var nodeApplier = isInterface(applier, Applier) ? applier : THROW_CCE();
    var nodeToInsert = slots.n21(groupAnchor);
    nodeApplier.o1b(insertIndex, nodeToInsert);
  };
  ...
  protoOf(ResetSlots).m25 = function (_this__u8e3s4, applier, slots, rememberManager) {
    slots.p21();
  };
  ...
  protoOf(DetermineMovableContentNodeIndex).f24 = function (parameter) {
    var tmp;
    // Inline function 'androidx.compose.runtime.changelist.DetermineMovableContentNodeIndex.EffectiveNodeIndexOut' call
    if (parameter === _ObjectParameter___init__impl__iyg1ip(0)) {
  ...
  protoOf(DetermineMovableContentNodeIndex).m25 = function (_this__u8e3s4, applier, slots, rememberManager) {
    // Inline function 'androidx.compose.runtime.changelist.DetermineMovableContentNodeIndex.EffectiveNodeIndexOut' call
    var tmp$ret$0 = _ObjectParameter___init__impl__iyg1ip(0);
    var effectiveNodeIndexOut = _this__u8e3s4.r25(tmp$ret$0);
    var tmp = effectiveNodeIndexOut;
    // Inline function 'androidx.compose.runtime.changelist.DetermineMovableContentNodeIndex.Anchor' call
    var tmp$ret$1 = _ObjectParameter___init__impl__iyg1ip(1);
    var tmp_0 = _this__u8e3s4.r25(tmp$ret$1);
    tmp.k27_1 = positionToInsert(slots, tmp_0, isInterface(applier, Applier) ? applier : THROW_CCE());
  };
  ...
  protoOf(CopyNodesToNewAnchorLocation).f24 = function (parameter) {
    var tmp;
    // Inline function 'androidx.compose.runtime.changelist.CopyNodesToNewAnchorLocation.EffectiveNodeIndex' call
    if (parameter === _ObjectParameter___init__impl__iyg1ip(0)) {
  ...
  protoOf(CopyNodesToNewAnchorLocation).m25 = function (_this__u8e3s4, applier, slots, rememberManager) {
    // Inline function 'androidx.compose.runtime.changelist.CopyNodesToNewAnchorLocation.EffectiveNodeIndex' call
    var tmp$ret$0 = _ObjectParameter___init__impl__iyg1ip(0);
    var effectiveNodeIndex = _this__u8e3s4.r25(tmp$ret$0).k27_1;
    // Inline function 'androidx.compose.runtime.changelist.CopyNodesToNewAnchorLocation.Nodes' call
    var tmp$ret$1 = _ObjectParameter___init__impl__iyg1ip(1);
    var nodesToInsert = _this__u8e3s4.r25(tmp$ret$1);
    ...
    if (inductionVariable <= last)
      do {
        var index = inductionVariable;
        inductionVariable = inductionVariable + 1 | 0;
        var item = nodesToInsert.k(index);
        ...
        if (!isInterface(applier, Applier))
          THROW_CCE();
        applier.o1b(effectiveNodeIndex + index | 0, item);
        applier.n1b(effectiveNodeIndex + index | 0, item);
      }
       while (inductionVariable <= last);
  };
  ...
  protoOf(CopySlotTableToAnchorLocation).f24 = function (parameter) {
    var tmp;
    // Inline function 'androidx.compose.runtime.changelist.CopySlotTableToAnchorLocation.ResolvedState' call
    if (parameter === _ObjectParameter___init__impl__iyg1ip(0)) {
      tmp = 'resolvedState';
  ...
  protoOf(CopySlotTableToAnchorLocation).m25 = function (_this__u8e3s4, applier, slots, rememberManager) {
    // Inline function 'androidx.compose.runtime.changelist.CopySlotTableToAnchorLocation.From' call
    var tmp$ret$0 = _ObjectParameter___init__impl__iyg1ip(2);
    var from = _this__u8e3s4.r25(tmp$ret$0);
    // Inline function 'androidx.compose.runtime.changelist.CopySlotTableToAnchorLocation.To' call
    var tmp$ret$1 = _ObjectParameter___init__impl__iyg1ip(3);
    var to = _this__u8e3s4.r25(tmp$ret$1);
    // Inline function 'androidx.compose.runtime.changelist.CopySlotTableToAnchorLocation.ParentCompositionContext' call
    var tmp$ret$2 = _ObjectParameter___init__impl__iyg1ip(1);
    var parentCompositionContext = _this__u8e3s4.r25(tmp$ret$2);
    // Inline function 'androidx.compose.runtime.changelist.CopySlotTableToAnchorLocation.ResolvedState' call
    var tmp$ret$3 = _ObjectParameter___init__impl__iyg1ip(0);
    var tmp0_elvis_lhs = _this__u8e3s4.r25(tmp$ret$3);
    var tmp1_elvis_lhs = tmp0_elvis_lhs == null ? parentCompositionContext.j1l(from) : tmp0_elvis_lhs;
    var tmp;
    if (tmp1_elvis_lhs == null) {
    ...
    var anchors = slots.d22(1, resolvedState.k1l_1, 2);
    var tmp_0 = Companion_instance_2;
    var tmp_1 = to.c1l_1;
    tmp_0.z1v(slots, anchors, isInterface(tmp_1, RecomposeScopeOwner) ? tmp_1 : THROW_CCE());
  };
  ...
  protoOf(EndMovableContentPlacement).m25 = function (_this__u8e3s4, applier, slots, rememberManager) {
  ...
  protoOf(ReleaseMovableGroupAtCurrent).f24 = function (parameter) {
    var tmp;
    // Inline function 'androidx.compose.runtime.changelist.ReleaseMovableGroupAtCurrent.Composition' call
    if (parameter === _ObjectParameter___init__impl__iyg1ip(0)) {
      tmp = 'composition';
  ...
  protoOf(ReleaseMovableGroupAtCurrent).m25 = function (_this__u8e3s4, applier, slots, rememberManager) {
    // Inline function 'androidx.compose.runtime.changelist.ReleaseMovableGroupAtCurrent.Composition' call
    var tmp$ret$0 = _ObjectParameter___init__impl__iyg1ip(0);
    var tmp = _this__u8e3s4.r25(tmp$ret$0);
    // Inline function 'androidx.compose.runtime.changelist.ReleaseMovableGroupAtCurrent.ParentCompositionContext' call
    var tmp$ret$1 = _ObjectParameter___init__impl__iyg1ip(1);
    var tmp_0 = _this__u8e3s4.r25(tmp$ret$1);
    // Inline function 'androidx.compose.runtime.changelist.ReleaseMovableGroupAtCurrent.Reference' call
    var tmp$ret$2 = _ObjectParameter___init__impl__iyg1ip(2);
    releaseMovableGroupAtCurrent(tmp, tmp_0, _this__u8e3s4.r25(tmp$ret$2), slots);
  };
  ...
  protoOf(ApplyChangeList).f24 = function (parameter) {
    var tmp;
    // Inline function 'androidx.compose.runtime.changelist.ApplyChangeList.Changes' call
    if (parameter === _ObjectParameter___init__impl__iyg1ip(0)) {
      tmp = 'changes';
  ...
  protoOf(ApplyChangeList).m25 = function (_this__u8e3s4, applier, slots, rememberManager) {
    // Inline function 'androidx.compose.runtime.changelist.ApplyChangeList.EffectiveNodeIndex' call
    var tmp$ret$0 = _ObjectParameter___init__impl__iyg1ip(1);
    var tmp0_safe_receiver = _this__u8e3s4.r25(tmp$ret$0);
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.k27_1;
    var effectiveNodeIndex = tmp1_elvis_lhs == null ? 0 : tmp1_elvis_lhs;
    // Inline function 'androidx.compose.runtime.changelist.ApplyChangeList.Changes' call
    var tmp$ret$1 = _ObjectParameter___init__impl__iyg1ip(0);
    var tmp = _this__u8e3s4.r25(tmp$ret$1);
    var tmp_0;
    ...
    tmp.a1s(tmp_0, slots, rememberManager);
  };
  ...
  protoOf(Operation).o25 = function () {
    // Inline function 'kotlin.text.orEmpty' call
    var tmp0_elvis_lhs = getKClassFromExpression(this).x6();
    return tmp0_elvis_lhs == null ? '' : tmp0_elvis_lhs;
  };
  protoOf(Operation).e24 = function (parameter) {
    return 'IntParameter(' + _IntParameter___get_offset__impl__xsdcin(parameter) + ')';
  };
  protoOf(Operation).f24 = function (parameter) {
  ...
  function positionToInsert(slots, anchor, applier) {
    var destination = slots.h1l(anchor);
    runtimeCheck(slots.k1h_1 < destination);
    positionToParentOf(slots, applier, destination);
    var nodeIndex = currentNodeIndex(slots);
    while (slots.k1h_1 < destination) {
      if (slots.j21(destination)) {
        if (slots.k1p()) {
          applier.l1b(slots.l1m(slots.k1h_1));
          nodeIndex = 0;
        }
        slots.h1i();
      } else
        nodeIndex = nodeIndex + slots.u1h() | 0;
    }
    runtimeCheck(slots.k1h_1 === destination);
    return nodeIndex;
  }
  function positionToParentOf(slots, applier, index) {
    while (!slots.i21(index)) {
      slots.e1i();
      if (slots.m1k(slots.m1h_1)) {
        applier.m1b();
      }
      slots.e1k();
    }
  ...
  function releaseMovableGroupAtCurrent(composition, parentContext, reference, slots) {
    ...
    try {
      ...
      writer.a1j();
      writer.l1i(get_movableContentKey(), reference.a1l_1);
      writer.w1k();
      writer.s1o(reference.b1l_1);
      var anchors = slots.b22(reference.e1l_1, 1, writer);
      writer.u1h();
      writer.e1k();
      writer.f1k();
      tmp = anchors;
    ...
    if (Companion_instance_2.c1w(slotTable, anchors_0)) {
      ...
      // Inline function 'kotlin.contracts.contract' call
      // Inline function 'androidx.compose.runtime.SlotTable.write.<anonymous>' call
      var writer_0 = slotTable.d1i();
      var tmp_0;
      try {
        Companion_instance_2.z1v(writer_0, anchors_0, movableContentRecomposeScopeOwner);
        tmp_0 = Unit_instance;
      }finally {
        writer_0.r1g();
      }
    }
    parentContext.g1u(reference, state);
  }
  function currentNodeIndex(slots) {
    var original = slots.k1h_1;
    var current = slots.m1h_1;
    while (current >= 0 ? !slots.m1k(current) : false) {
      current = slots.a1i(current);
    }
    var index = 0;
    current = current + 1 | 0;
    while (current < original) {
      if (slots.k21(original, current)) {
        if (slots.m1k(current))
          index = 0;
        current = current + 1 | 0;
      } else {
        index = index + (slots.m1k(current) ? 1 : slots.n1k(current)) | 0;
        current = current + slots.s1j(current) | 0;
      }
    }
    return index;
  }
  function releaseMovableGroupAtCurrent$movableContentRecomposeScopeOwner$1($composition, $reference) {
    this.v27_1 = $composition;
    this.w27_1 = $reference;
  }
  protoOf(releaseMovableGroupAtCurrent$movableContentRecomposeScopeOwner$1).x1t = function (scope, instance) {
    var tmp = this.v27_1;
    var tmp0_safe_receiver = isInterface(tmp, RecomposeScopeOwner) ? tmp : null;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.x1t(scope, instance);
    ...
    if (result.equals(InvalidationResult_IGNORED_getInstance())) {
      var tmp2_this = this.w27_1;
      var tmp_0 = tmp2_this;
      var tmp_1 = tmp2_this.f1l_1;
      var tmp_2;
      if (instance == null) {
        tmp_2 = null;
      } else {
      ...
      tmp_0.f1l_1 = plus_1(tmp_1, to(scope, tmp_2));
      return InvalidationResult_SCHEDULED_getInstance();
    }
    return result;
  };
  protoOf(releaseMovableGroupAtCurrent$movableContentRecomposeScopeOwner$1).b1u = function (scope) {
  };
  protoOf(releaseMovableGroupAtCurrent$movableContentRecomposeScopeOwner$1).i1t = function (value) {
  };
  ...
  function WriteScope__setInt_impl_yt2o8b($this, parameter, value) {
    ...
    // Inline function 'kotlin.check' call
    // Inline function 'kotlin.contracts.contract' call
    if (!(($this$with.x23_1 & mask) === 0)) {
      // Inline function 'androidx.compose.runtime.changelist.WriteScope.setInt.<anonymous>.<anonymous>' call
      var message = 'Already pushed argument ' + _WriteScope___get_operation__impl__krvgwa($this).e24(parameter);
      throw IllegalStateException_init_$Create$(toString(message));
    }
    $this$with.x23_1 = $this$with.x23_1 | mask;
    $this$with.t23_1[topIntIndexOf($this$with, parameter)] = value;
    return Unit_instance;
  }
  function WriteScope__setObject_impl_rr41y9($this, parameter, value) {
    ...
    // Inline function 'kotlin.check' call
    // Inline function 'kotlin.contracts.contract' call
    if (!(($this$with.y23_1 & mask) === 0)) {
      // Inline function 'androidx.compose.runtime.changelist.WriteScope.setObject.<anonymous>.<anonymous>' call
      var message = 'Already pushed argument ' + _WriteScope___get_operation__impl__krvgwa($this).f24(parameter);
      throw IllegalStateException_init_$Create$(toString(message));
    }
    $this$with.y23_1 = $this$with.y23_1 | mask;
    $this$with.v23_1[topObjectIndexOf($this$with, parameter)] = value;
    return Unit_instance;
  }
  ...
  function ensureIntArgsSizeAtLeast($this, requiredSize) {
    var currentSize = $this.t23_1.length;
    if (requiredSize > currentSize) {
      $this.t23_1 = copyOf($this.t23_1, determineNewSize($this, currentSize, requiredSize));
    }
  }
  function ensureObjectArgsSizeAtLeast($this, requiredSize) {
    var currentSize = $this.v23_1.length;
    if (requiredSize > currentSize) {
      $this.v23_1 = copyOf_0($this.v23_1, determineNewSize($this, currentSize, requiredSize));
    }
  }
  ...
  function peekOperation($this) {
    return ensureNotNull($this.r23_1[$this.s23_1 - 1 | 0]);
  }
  function topIntIndexOf($this, parameter) {
    return ($this.u23_1 - peekOperation($this).c24_1 | 0) + _IntParameter___get_offset__impl__xsdcin(parameter) | 0;
  }
  function topObjectIndexOf($this, parameter) {
    return ($this.w23_1 - peekOperation($this).d24_1 | 0) + _ObjectParameter___get_offset__impl__x7fx93(parameter) | 0;
  }
  ...
  protoOf(OpIterator).b1 = function () {
    if (this.x27_1 >= this.a28_1.s23_1)
      return false;
    var op = this.b28();
    this.y27_1 = this.y27_1 + op.c24_1 | 0;
    this.z27_1 = this.z27_1 + op.d24_1 | 0;
    this.x27_1 = this.x27_1 + 1 | 0;
    return this.x27_1 < this.a28_1.s23_1;
  };
  protoOf(OpIterator).b28 = function () {
    return ensureNotNull(this.a28_1.r23_1[this.x27_1]);
  };
  protoOf(OpIterator).n25 = function (parameter) {
    return this.a28_1.t23_1[this.y27_1 + _IntParameter___get_offset__impl__xsdcin(parameter) | 0];
  };
  protoOf(OpIterator).r25 = function (parameter) {
    var tmp = this.a28_1.v23_1[this.z27_1 + _ObjectParameter___get_offset__impl__x7fx93(parameter) | 0];
    return (tmp == null ? true : !(tmp == null)) ? tmp : THROW_CCE();
  };
  ...
  function Operations() {
    var tmp = this;
    // Inline function 'kotlin.arrayOfNulls' call
    tmp.r23_1 = fillArrayVal(Array(16), null);
    this.s23_1 = 0;
    this.t23_1 = new Int32Array(16);
    this.u23_1 = 0;
    var tmp_0 = this;
    // Inline function 'kotlin.arrayOfNulls' call
    tmp_0.v23_1 = fillArrayVal(Array(16), null);
    this.w23_1 = 0;
    this.x23_1 = 0;
    this.y23_1 = 0;
  }
  ...
  protoOf(Operations).i1p = function () {
    return !(this.j() === 0);
  };
  protoOf(Operations).e1 = function () {
    this.s23_1 = 0;
    this.u23_1 = 0;
    fill_0(this.v23_1, null, 0, this.w23_1);
    this.w23_1 = 0;
  };
  protoOf(Operations).b24 = function (operation) {
    this.x23_1 = 0;
    this.y23_1 = 0;
    if (this.s23_1 === this.r23_1.length) {
      var resizeAmount = coerceAtMost(this.s23_1, 1024);
      this.r23_1 = copyOf_0(this.r23_1, this.s23_1 + resizeAmount | 0);
    }
    ensureIntArgsSizeAtLeast(this, this.u23_1 + operation.c24_1 | 0);
    ensureObjectArgsSizeAtLeast(this, this.w23_1 + operation.d24_1 | 0);
    var tmp = this.r23_1;
    var tmp1 = this.s23_1;
    this.s23_1 = tmp1 + 1 | 0;
    tmp[tmp1] = operation;
    this.u23_1 = this.u23_1 + operation.c24_1 | 0;
    this.w23_1 = this.w23_1 + operation.d24_1 | 0;
  };
  protoOf(Operations).i24 = function (operation) {
    // Inline function 'kotlin.require' call
    // Inline function 'kotlin.contracts.contract' call
    if (!(operation.c24_1 === 0 ? operation.d24_1 === 0 : false)) {
      // Inline function 'androidx.compose.runtime.changelist.Operations.push.<anonymous>' call
      var message = 'Cannot push ' + operation + ' without arguments because it expects ' + ('' + operation.c24_1 + ' ints and ' + operation.d24_1 + ' objects.');
      throw IllegalArgumentException_init_$Create$(toString(message));
    }
    this.b24(operation);
  };
  protoOf(Operations).j25 = function (other) {
    if (this.q()) {
      throw NoSuchElementException_init_$Create$('Cannot pop(), because the stack is empty.');
    }
    var tmp = this.r23_1;
    this.s23_1 = this.s23_1 - 1 | 0;
    var op = ensureNotNull(tmp[this.s23_1]);
    this.r23_1[this.s23_1] = null;
    other.b24(op);
    var thisObjIdx = this.w23_1;
    var otherObjIdx = other.w23_1;
    // Inline function 'kotlin.repeat' call
    var times = op.d24_1;
    // Inline function 'kotlin.contracts.contract' call
    var inductionVariable = 0;
    if (inductionVariable < times)
      do {
        ...
        other.v23_1[otherObjIdx] = this.v23_1[thisObjIdx];
        this.v23_1[thisObjIdx] = null;
      }
       while (inductionVariable < times);
    var thisIntIdx = this.u23_1;
    var otherIntIdx = other.u23_1;
    // Inline function 'kotlin.repeat' call
    var times_0 = op.c24_1;
    // Inline function 'kotlin.contracts.contract' call
    var inductionVariable_0 = 0;
    if (inductionVariable_0 < times_0)
      do {
        ...
        other.t23_1[otherIntIdx] = this.t23_1[thisIntIdx];
        this.t23_1[thisIntIdx] = 0;
      }
       while (inductionVariable_0 < times_0);
    this.w23_1 = this.w23_1 - op.d24_1 | 0;
    this.u23_1 = this.u23_1 - op.c24_1 | 0;
  };
  protoOf(Operations).z23 = function (applier, slots, rememberManager) {
    ...
    if (this.i1p()) {
      ...
      do {
        ...
        // Inline function 'kotlin.with' call
        // Inline function 'kotlin.contracts.contract' call
        iterator.b28().m25(iterator, applier, slots, rememberManager);
      }
       while (iterator.b1());
    }
    this.e1();
  ...
  function IdentityArrayMap$asMap$1$entries$1$iterator$1$1(this$0, $index) {
    var tmp = this;
    var tmp_0 = this$0.b1m_1[$index];
    tmp.e28_1 = !(tmp_0 == null) ? tmp_0 : THROW_CCE();
    var tmp_1 = this;
    var tmp_2 = this$0.c1m_1[$index];
    tmp_1.f28_1 = (tmp_2 == null ? true : !(tmp_2 == null)) ? tmp_2 : THROW_CCE();
  }
  ...
  protoOf(IdentityArrayMap$asMap$o$_get_entries_$o$iterator$slambda_r160he).s28 = function ($this$sequence, $completion) {
    var tmp = this.t28($this$sequence, $completion);
    tmp.ec_1 = Unit_instance;
    tmp.fc_1 = null;
    return tmp.oc();
  };
  protoOf(IdentityArrayMap$asMap$o$_get_entries_$o$iterator$slambda_r160he).ad = function (p1, $completion) {
    return this.s28(p1 instanceof SequenceScope ? p1 : THROW_CCE(), $completion);
  };
  protoOf(IdentityArrayMap$asMap$o$_get_entries_$o$iterator$slambda_r160he).oc = function () {
    var suspendResult = this.ec_1;
    $sm: do
      try {
        var tmp = this.cc_1;
        switch (tmp) {
          case 0:
            this.dc_1 = 4;
            this.q28_1 = until(0, this.o28_1.d1m_1).l();
            this.cc_1 = 1;
            continue $sm;
          case 1:
            if (!this.q28_1.z()) {
            ...
            this.r28_1 = this.q28_1.b1();
            this.cc_1 = 2;
            suspendResult = this.p28_1.ne(new IdentityArrayMap$asMap$1$entries$1$iterator$1$1(this.o28_1, this.r28_1), this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
  ...
  protoOf(IdentityArrayMap$asMap$o$_get_entries_$o$iterator$slambda_r160he).t28 = function ($this$sequence, completion) {
    var i = new IdentityArrayMap$asMap$o$_get_entries_$o$iterator$slambda_r160he(this.o28_1, completion);
    i.p28_1 = $this$sequence;
    return i;
  };
  function IdentityArrayMap$asMap$o$_get_entries_$o$iterator$slambda_r160he_0(this$0, resultContinuation) {
    ...
    var l = function ($this$sequence, $completion) {
      return i.s28($this$sequence, $completion);
    };
    l.$arity = 1;
    return l;
  }
  ...
  protoOf(IdentityArrayMap$asMap$o$_get_keys_$o$iterator$slambda_qj88bw).g29 = function ($this$sequence, $completion) {
    var tmp = this.h29($this$sequence, $completion);
    tmp.ec_1 = Unit_instance;
    tmp.fc_1 = null;
    return tmp.oc();
  };
  protoOf(IdentityArrayMap$asMap$o$_get_keys_$o$iterator$slambda_qj88bw).ad = function (p1, $completion) {
    return this.g29(p1 instanceof SequenceScope ? p1 : THROW_CCE(), $completion);
  };
  protoOf(IdentityArrayMap$asMap$o$_get_keys_$o$iterator$slambda_qj88bw).oc = function () {
    var suspendResult = this.ec_1;
    $sm: do
      try {
        var tmp = this.cc_1;
        switch (tmp) {
          case 0:
            this.dc_1 = 4;
            this.e29_1 = until(0, this.c29_1.d1m_1).l();
            this.cc_1 = 1;
            continue $sm;
          case 1:
            if (!this.e29_1.z()) {
            ...
            this.f29_1 = this.e29_1.b1();
            this.cc_1 = 2;
            var tmp_0 = this.c29_1.b1m_1[this.f29_1];
            suspendResult = this.d29_1.ne(!(tmp_0 == null) ? tmp_0 : THROW_CCE(), this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
  ...
  protoOf(IdentityArrayMap$asMap$o$_get_keys_$o$iterator$slambda_qj88bw).h29 = function ($this$sequence, completion) {
    var i = new IdentityArrayMap$asMap$o$_get_keys_$o$iterator$slambda_qj88bw(this.c29_1, completion);
    i.d29_1 = $this$sequence;
    return i;
  };
  ...
  protoOf(IdentityArrayMap$asMap$o$_get_values_$o$iterator$slambda_qilghu).u29 = function ($this$sequence, $completion) {
    var tmp = this.v29($this$sequence, $completion);
    tmp.ec_1 = Unit_instance;
    tmp.fc_1 = null;
    return tmp.oc();
  };
  protoOf(IdentityArrayMap$asMap$o$_get_values_$o$iterator$slambda_qilghu).ad = function (p1, $completion) {
    return this.u29(p1 instanceof SequenceScope ? p1 : THROW_CCE(), $completion);
  };
  protoOf(IdentityArrayMap$asMap$o$_get_values_$o$iterator$slambda_qilghu).oc = function () {
    var suspendResult = this.ec_1;
    $sm: do
      try {
        var tmp = this.cc_1;
        switch (tmp) {
          case 0:
            this.dc_1 = 4;
            this.s29_1 = until(0, this.q29_1.d1m_1).l();
            this.cc_1 = 1;
            continue $sm;
          case 1:
            if (!this.s29_1.z()) {
            ...
            this.t29_1 = this.s29_1.b1();
            this.cc_1 = 2;
            var tmp_0 = this.q29_1.c1m_1[this.t29_1];
            suspendResult = this.r29_1.ne((tmp_0 == null ? true : !(tmp_0 == null)) ? tmp_0 : THROW_CCE(), this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
  ...
  protoOf(IdentityArrayMap$asMap$o$_get_values_$o$iterator$slambda_qilghu).v29 = function ($this$sequence, completion) {
    var i = new IdentityArrayMap$asMap$o$_get_values_$o$iterator$slambda_qilghu(this.q29_1, completion);
    i.r29_1 = $this$sequence;
    return i;
  };
  function IdentityArrayMap$asMap$o$_get_values_$o$iterator$slambda_qilghu_0(this$0, resultContinuation) {
    ...
    var l = function ($this$sequence, $completion) {
      return i.u29($this$sequence, $completion);
    };
    l.$arity = 1;
    return l;
  }
  ...
  protoOf(IdentityArrayMap$asMap$1$entries$1).j = function () {
    return this.w29_1.d1m_1;
  };
  protoOf(IdentityArrayMap$asMap$1$entries$1).q = function () {
    return this.w29_1.q();
  };
  protoOf(IdentityArrayMap$asMap$1$entries$1).l = function () {
    return sequence(IdentityArrayMap$asMap$o$_get_entries_$o$iterator$slambda_r160he_0(this.w29_1, null)).l();
  };
  protoOf(IdentityArrayMap$asMap$1$entries$1).x29 = function (elements) {
    var tmp$ret$0;
    $l$block_0: {
      // Inline function 'kotlin.collections.all' call
      var tmp;
  ...
  protoOf(IdentityArrayMap$asMap$1$entries$1).p = function (elements) {
    return this.x29(elements);
  };
  protoOf(IdentityArrayMap$asMap$1$entries$1).y29 = function (element) {
    return this.w29_1.e1u(element.o2()) === element.p2();
  };
  ...
  protoOf(IdentityArrayMap$asMap$1$keys$1).j = function () {
    return this.z29_1.d1m_1;
  };
  protoOf(IdentityArrayMap$asMap$1$keys$1).q = function () {
    return this.z29_1.q();
  };
  protoOf(IdentityArrayMap$asMap$1$keys$1).l = function () {
    return sequence(IdentityArrayMap$asMap$o$_get_keys_$o$iterator$slambda_qj88bw_0(this.z29_1, null)).l();
  };
  protoOf(IdentityArrayMap$asMap$1$keys$1).a2a = function (elements) {
    var tmp0_iterator = elements.l();
    while (tmp0_iterator.z()) {
      var key = tmp0_iterator.b1();
      if (!this.f1u(key))
        return false;
    }
    return true;
  };
  protoOf(IdentityArrayMap$asMap$1$keys$1).p = function (elements) {
    return this.a2a(elements);
  };
  protoOf(IdentityArrayMap$asMap$1$keys$1).f1u = function (element) {
    return this.z29_1.f1u(element);
  };
  protoOf(IdentityArrayMap$asMap$1$keys$1).o = function (element) {
    if (!!(element == null))
      return false;
    return this.f1u(!(element == null) ? element : THROW_CCE());
  };
  function IdentityArrayMap$asMap$1$values$1(this$0) {
    this.b2a_1 = this$0;
  }
  protoOf(IdentityArrayMap$asMap$1$values$1).j = function () {
    return this.b2a_1.d1m_1;
  };
  protoOf(IdentityArrayMap$asMap$1$values$1).q = function () {
    return this.b2a_1.q();
  };
  protoOf(IdentityArrayMap$asMap$1$values$1).l = function () {
    return sequence(IdentityArrayMap$asMap$o$_get_values_$o$iterator$slambda_qilghu_0(this.b2a_1, null)).l();
  };
  protoOf(IdentityArrayMap$asMap$1$values$1).c2a = function (elements) {
    var tmp0_iterator = elements.l();
    while (tmp0_iterator.z()) {
      var value = tmp0_iterator.b1();
      if (!this.d2a(value))
        return false;
    }
    return true;
  };
  protoOf(IdentityArrayMap$asMap$1$values$1).p = function (elements) {
    return this.c2a(elements);
  };
  protoOf(IdentityArrayMap$asMap$1$values$1).d2a = function (element) {
    var inductionVariable = 0;
    var last = this.b2a_1.d1m_1;
    if (inductionVariable < last)
      do {
        var index = inductionVariable;
        inductionVariable = inductionVariable + 1 | 0;
        if (equals(this.b2a_1.c1m_1[index], element))
          return true;
      }
       while (inductionVariable < last);
    return false;
  ...
  protoOf(IdentityArrayMap$asMap$1$values$1).o = function (element) {
    if (!(element == null ? true : !(element == null)))
      return false;
    return this.d2a((element == null ? true : !(element == null)) ? element : THROW_CCE());
  };
  ...
  protoOf(IdentityArrayMap$asMap$1).l2 = function () {
    return new IdentityArrayMap$asMap$1$entries$1(this.e2a_1);
  };
  protoOf(IdentityArrayMap$asMap$1).j2 = function () {
    return new IdentityArrayMap$asMap$1$keys$1(this.e2a_1);
  };
  protoOf(IdentityArrayMap$asMap$1).j = function () {
    return this.e2a_1.d1m_1;
  };
  protoOf(IdentityArrayMap$asMap$1).k2 = function () {
    return new IdentityArrayMap$asMap$1$values$1(this.e2a_1);
  };
  protoOf(IdentityArrayMap$asMap$1).q = function () {
    return this.e2a_1.q();
  };
  protoOf(IdentityArrayMap$asMap$1).e1u = function (key) {
    return this.e2a_1.e1u(key);
  };
  protoOf(IdentityArrayMap$asMap$1).v2 = function (key) {
    if (!!(key == null))
      return null;
    return this.e1u(!(key == null) ? key : THROW_CCE());
  };
  protoOf(IdentityArrayMap$asMap$1).f2a = function (key) {
    return !(this.e2a_1.e1u(key) == null);
  };
  protoOf(IdentityArrayMap$asMap$1).s2 = function (key) {
    if (!!(key == null))
      return false;
    return this.f2a(!(key == null) ? key : THROW_CCE());
  };
  function IdentityArrayMap(capacity) {
    capacity = capacity === VOID ? 16 : capacity;
    var tmp = this;
    // Inline function 'kotlin.arrayOfNulls' call
    tmp.b1m_1 = fillArrayVal(Array(capacity), null);
    var tmp_0 = this;
    // Inline function 'kotlin.arrayOfNulls' call
    tmp_0.c1m_1 = fillArrayVal(Array(capacity), null);
    this.d1m_1 = 0;
  }
  protoOf(IdentityArrayMap).q = function () {
    return this.d1m_1 === 0;
  };
  protoOf(IdentityArrayMap).i1p = function () {
    return this.d1m_1 > 0;
  };
  protoOf(IdentityArrayMap).f1u = function (key) {
    return find_0(this, key) >= 0;
  };
  protoOf(IdentityArrayMap).e1u = function (key) {
    var index = find_0(this, key);
    var tmp;
    if (index >= 0) {
      var tmp_0 = this.c1m_1[index];
  ...
  protoOf(IdentityArrayMap).n1s = function (key, value) {
    var keys = this.b1m_1;
  ...
  protoOf(IdentityArraySet$iterator$1).z = function () {
    return this.g2a_1 < this.h2a_1.s1l_1;
  };
  protoOf(IdentityArraySet$iterator$1).b1 = function () {
    var tmp = this.h2a_1.t1l_1;
    var tmp1 = this.g2a_1;
    this.g2a_1 = tmp1 + 1 | 0;
    var tmp_0 = tmp[tmp1];
  ...
  function IdentityArraySet() {
    ...
    var tmp = this;
    // Inline function 'kotlin.arrayOfNulls' call
    tmp.t1l_1 = fillArrayVal(Array(16), null);
  }
  protoOf(IdentityArraySet).j = function () {
    return this.s1l_1;
  };
  protoOf(IdentityArraySet).k1x = function (element) {
    return find_1(this, element) >= 0;
  };
  protoOf(IdentityArraySet).o = function (element) {
    if (!!(element == null))
      return false;
    return this.k1x(!(element == null) ? element : THROW_CCE());
  };
  protoOf(IdentityArraySet).s1q = function (value) {
    var index;
    var size = this.s1l_1;
    var values = this.t1l_1;
    if (size > 0) {
    ...
    if (size === values.length) {
      ...
      this.t1l_1 = newSorted;
    } else {
      // Inline function 'kotlin.collections.copyInto' call
      var destinationOffset_0 = insertIndex + 1 | 0;
      arrayCopy(values, values, destinationOffset_0, insertIndex, size);
    }
    this.t1l_1[insertIndex] = value;
    this.s1l_1 = this.s1l_1 + 1 | 0;
    return true;
  };
  protoOf(IdentityArraySet).e1 = function () {
    fill_0(this.t1l_1, null);
    this.s1l_1 = 0;
  };
  protoOf(IdentityArraySet).b1y = function (collection) {
    if (collection.q())
      return Unit_instance;
    if (!(collection instanceof IdentityArraySet)) {
      ...
      var thisValues = this.t1l_1;
      var otherValues = collection.t1l_1;
      var thisSize = this.s1l_1;
      var otherSize = collection.s1l_1;
      var combinedSize = thisSize + otherSize | 0;
      var needsResize = this.t1l_1.length < combinedSize;
      ...
      if (!needsResize ? elementsInOrder : false) {
        ...
        this.s1l_1 = this.s1l_1 + otherSize | 0;
      } else {
        var tmp;
        if (needsResize) {
          // Inline function 'kotlin.arrayOfNulls' call
  ...
  protoOf(IdentityArraySet).i1p = function () {
    return this.s1l_1 > 0;
  };
  ...
  protoOf(IdentityArraySet).ee = function (elements) {
    var tmp$ret$0;
    $l$block_0: {
      // Inline function 'kotlin.collections.all' call
      var tmp;
  ...
  protoOf(MutableVector).i1m = function (element) {
    this.j2a(this.h1m_1 + 1 | 0);
    this.f1m_1[this.h1m_1] = element;
    this.h1m_1 = this.h1m_1 + 1 | 0;
    return true;
  };
  protoOf(MutableVector).j2a = function (capacity) {
    var oldContent = this.f1m_1;
    if (oldContent.length < capacity) {
      // Inline function 'kotlin.math.max' call
      var b = imul(oldContent.length, 2);
      var newSize = Math.max(capacity, b);
      this.f1m_1 = copyOf_0(oldContent, newSize);
    }
  };
  protoOf(MutableVector).j1 = function (index) {
    var content = this.f1m_1;
    var tmp = content[index];
    var item = (tmp == null ? true : !(tmp == null)) ? tmp : THROW_CCE();
    // Inline function 'androidx.compose.runtime.collection.MutableVector.lastIndex' call
    if (!(index === (this.h1m_1 - 1 | 0))) {
      // Inline function 'kotlin.collections.copyInto' call
      var startIndex = index + 1 | 0;
      var endIndex = this.h1m_1;
      arrayCopy(content, content, index, startIndex, endIndex);
    }
    this.h1m_1 = this.h1m_1 - 1 | 0;
    content[this.h1m_1] = null;
    return item;
  };
  function ScopeMap() {
    this.u1r_1 = mutableScatterMapOf();
  }
  protoOf(ScopeMap).z1r = function (key, scope) {
    // Inline function 'androidx.collection.MutableScatterMap.compute' call
    var this_0 = this.u1r_1;
    var index = this_0.t1a(key);
    ...
    if (value == null) {
      ...
      if (value instanceof MutableScatterSet) {
        (value instanceof MutableScatterSet ? value : THROW_CCE()).w(scope);
        tmp_1 = value;
      } else {
        var tmp_2;
        if (!(value === scope)) {
          var set = new MutableScatterSet();
          set.w(!(value == null) ? value : THROW_CCE());
          set.w(scope);
          tmp_2 = set;
        } else {
          tmp_2 = value;
    ...
    if (inserting) {
      ...
      this_0.i1a_1[insertionIndex] = key;
      this_0.j1a_1[insertionIndex] = computedValue;
    } else {
      this_0.j1a_1[index] = computedValue;
    }
  };
  protoOf(ScopeMap).y1r = function (element) {
    return this.u1r_1.s2(element);
  };
  protoOf(ScopeMap).x1r = function (key, scope) {
    var tmp0_elvis_lhs = this.u1r_1.v2(key);
    var tmp;
    if (tmp0_elvis_lhs == null) {
      return false;
    } else {
    ...
    if (value instanceof MutableScatterSet) {
      var set = value instanceof MutableScatterSet ? value : THROW_CCE();
      var removed = set.x(scope);
      if (removed ? set.q() : false) {
        this.u1r_1.n2(key);
      }
      return removed;
    } else {
  ...
  protoOf(ScopeMap).m1t = function (scope) {
    // Inline function 'androidx.compose.runtime.collection.ScopeMap.removeScopeIf' call
    // Inline function 'androidx.collection.MutableScatterMap.removeIf' call
    var this_0 = this.u1r_1;
    $l$block_0: {
  ...
  function persistentSetOf() {
    return Companion_getInstance_10().l2a();
  }
  ...
  protoOf(SingleElementListIterator).b1 = function () {
    this.r2a();
    this.p2a_1 = this.p2a_1 + 1 | 0;
    return this.o2a_1;
  };
  protoOf(SingleElementListIterator).q1 = function () {
    this.s2a();
    this.p2a_1 = this.p2a_1 - 1 | 0;
    return this.o2a_1;
  };
  ...
  protoOf(AbstractListIterator).z = function () {
    return this.p2a_1 < this.q2a_1;
  };
  protoOf(AbstractListIterator).p1 = function () {
    return this.p2a_1 > 0;
  };
  protoOf(AbstractListIterator).r1 = function () {
    return this.p2a_1 - 1 | 0;
  };
  protoOf(AbstractListIterator).r2a = function () {
    if (!this.z())
      throw NoSuchElementException_init_$Create$_0();
  };
  protoOf(AbstractListIterator).s2a = function () {
    if (!this.p1())
      throw NoSuchElementException_init_$Create$_0();
  };
  ...
  protoOf(AbstractPersistentList).c1 = function (elements) {
  ...
  protoOf(AbstractPersistentList).x = function (element) {
    var index = this.m(element);
    if (!(index === -1)) {
      return this.j1(index);
    }
    return this;
  };
  protoOf(AbstractPersistentList).d1 = function (elements) {
    return this.u2a(AbstractPersistentList$removeAll$lambda(elements));
  };
  ...
  protoOf(AbstractPersistentList).xa = function () {
    return this.n(0);
  };
  ...
  protoOf(BufferIterator).b1 = function () {
    if (!this.z()) {
      throw NoSuchElementException_init_$Create$_0();
    }
    var tmp1 = this.p2a_1;
    this.p2a_1 = tmp1 + 1 | 0;
    return this.y2a_1[tmp1];
  };
  protoOf(BufferIterator).q1 = function () {
    if (!this.p1()) {
      throw NoSuchElementException_init_$Create$_0();
    }
    this.p2a_1 = this.p2a_1 - 1 | 0;
    return this.y2a_1[this.p2a_1];
  };
  function rootSize($this) {
    return rootSize_1($this.b2b_1);
  }
  function pushFilledTail($this, root, filledTail, newTail) {
    if ($this.b2b_1 >> get_LOG_MAX_BUFFER_SIZE() > 1 << $this.c2b_1) {
      var newRoot = presizedBufferWith(root);
      var newRootShift = $this.c2b_1 + get_LOG_MAX_BUFFER_SIZE() | 0;
      newRoot = pushTail($this, newRoot, newRootShift, filledTail);
      return new PersistentVector(newRoot, newTail, $this.b2b_1 + 1 | 0, newRootShift);
    }
    var newRoot_0 = pushTail($this, root, $this.c2b_1, filledTail);
    return new PersistentVector(newRoot_0, newTail, $this.b2b_1 + 1 | 0, $this.c2b_1);
  }
  function pushTail($this, root, shift, tail) {
    var bufferIndex = indexSegment($this.b2b_1 - 1 | 0, shift);
  ...
  function insertIntoTail($this, root, tailIndex, element) {
    var tailSize = $this.b2b_1 - rootSize($this) | 0;
    var newTail = copyOf_0($this.a2b_1, get_MAX_BUFFER_SIZE());
    if (tailSize < get_MAX_BUFFER_SIZE()) {
      // Inline function 'kotlin.collections.copyInto' call
      var this_0 = $this.a2b_1;
      ...
      return new PersistentVector(root, newTail, $this.b2b_1 + 1 | 0, $this.c2b_1);
    }
    var lastElement = $this.a2b_1[get_MAX_BUFFER_SIZE_MINUS_ONE()];
    // Inline function 'kotlin.collections.copyInto' call
    var this_1 = $this.a2b_1;
  ...
  function insertIntoRoot($this, root, shift, index, element, elementCarry) {
    ...
    if (shift === 0) {
      ...
      elementCarry.d2b_1 = root[get_MAX_BUFFER_SIZE_MINUS_ONE()];
    ...
    if (inductionVariable < last)
      $l$loop: do {
        ...
        if (newRoot_0[i] == null)
          break $l$loop;
        var tmp_1 = root[i];
        newRoot_0[i] = insertIntoRoot($this, (!(tmp_1 == null) ? isArray(tmp_1) : false) ? tmp_1 : THROW_CCE(), lowerLevelShift, 0, elementCarry.d2b_1, elementCarry);
      }
       while (inductionVariable < last);
    return newRoot_0;
  }
  function removeFromTailAt($this, root, rootSize, shift, index) {
    var tailSize = $this.b2b_1 - rootSize | 0;
  ...
  function pullLastBuffer($this, root, shift, index, tailCarry) {
    ...
    var tmp;
    if (shift === get_LOG_MAX_BUFFER_SIZE()) {
      tailCarry.d2b_1 = root[bufferIndex];
      tmp = null;
    } else {
      var tmp_0 = root[bufferIndex];
  ...
  function removeFromRootAt($this, root, shift, index, tailCarry) {
    ...
    if (shift === 0) {
      ...
      newRoot[get_MAX_BUFFER_SIZE() - 1 | 0] = tailCarry.d2b_1;
      tailCarry.d2b_1 = root[bufferIndex];
      return newRoot;
    }
  ...
  function bufferFor($this, index) {
    ...
    var buffer = $this.z2a_1;
    var shift = $this.c2b_1;
    while (shift > 0) {
  ...
  function PersistentVector(root, tail, size, rootShift) {
    ...
    this.a2b_1 = tail;
    this.b2b_1 = size;
    this.c2b_1 = rootShift;
    // Inline function 'kotlin.require' call
    // Inline function 'kotlin.contracts.contract' call
    if (!(this.b2b_1 > get_MAX_BUFFER_SIZE())) {
      ...
      var message = 'Trie-based persistent vector should have at least ' + (get_MAX_BUFFER_SIZE() + 1 | 0) + ' elements, got ' + this.b2b_1;
      throw IllegalArgumentException_init_$Create$(toString(message));
    }
    assert((this.b2b_1 - rootSize_1(this.b2b_1) | 0) <= coerceAtMost(this.a2b_1.length, get_MAX_BUFFER_SIZE()));
  }
  protoOf(PersistentVector).j = function () {
    return this.b2b_1;
  };
  protoOf(PersistentVector).w = function (element) {
    var tailSize = this.b2b_1 - rootSize(this) | 0;
    if (tailSize < get_MAX_BUFFER_SIZE()) {
      var newTail = copyOf_0(this.a2b_1, get_MAX_BUFFER_SIZE());
      newTail[tailSize] = element;
      return new PersistentVector(this.z2a_1, newTail, this.b2b_1 + 1 | 0, this.c2b_1);
    }
    var newTail_0 = presizedBufferWith(element);
    return pushFilledTail(this, this.z2a_1, this.a2b_1, newTail_0);
  };
  protoOf(PersistentVector).v2a = function (index, element) {
    ListImplementation_instance.o1(index, this.b2b_1);
    if (index === this.b2b_1) {
      return this.w(element);
    }
    var rootSize_0 = rootSize(this);
    if (index >= rootSize_0) {
      return insertIntoTail(this, this.z2a_1, index - rootSize_0 | 0, element);
    }
    var elementCarry = new ObjectRef(null);
    var newRoot = insertIntoRoot(this, this.z2a_1, this.c2b_1, index, element, elementCarry);
    return insertIntoTail(this, newRoot, 0, elementCarry.d2b_1);
  };
  protoOf(PersistentVector).j1 = function (index) {
    ListImplementation_instance.x1(index, this.b2b_1);
    var rootSize_0 = rootSize(this);
    if (index >= rootSize_0) {
      return removeFromTailAt(this, this.z2a_1, rootSize_0, this.c2b_1, index - rootSize_0 | 0);
    }
    var newRoot = removeFromRootAt(this, this.z2a_1, this.c2b_1, index, new ObjectRef(this.a2b_1[0]));
    return removeFromTailAt(this, newRoot, rootSize_0, this.c2b_1, 0);
  };
  protoOf(PersistentVector).u2a = function (predicate) {
    // Inline function 'kotlin.also' call
    var this_0 = this.t2a();
    // Inline function 'kotlin.contracts.contract' call
    ...
    this_0.n2b(predicate);
    return this_0.c3();
  };
  protoOf(PersistentVector).t2a = function () {
    return new PersistentVectorBuilder(this, this.z2a_1, this.a2b_1, this.c2b_1);
  };
  protoOf(PersistentVector).n = function (index) {
    ListImplementation_instance.o1(index, this.b2b_1);
    var tmp = this.a2b_1;
    return new PersistentVectorIterator(this.z2a_1, isArray(tmp) ? tmp : THROW_CCE(), index, this.b2b_1, (this.c2b_1 / get_LOG_MAX_BUFFER_SIZE() | 0) + 1 | 0);
  };
  ...
  protoOf(PersistentVector).t = function (index, element) {
    ...
    if (rootSize(this) <= index) {
      ...
      return new PersistentVector(this.z2a_1, newTail, this.b2b_1, this.c2b_1);
    }
    var newRoot = setInRoot(this, this.z2a_1, this.c2b_1, index, element);
    return new PersistentVector(newRoot, this.a2b_1, this.b2b_1, this.c2b_1);
  };
  function rootSize_0($this) {
    if ($this.m2b_1 <= get_MAX_BUFFER_SIZE()) {
      return 0;
    }
    return rootSize_1($this.m2b_1);
  }
  ...
  function tailSize_0($this) {
    return tailSize($this, $this.m2b_1);
  }
  function isMutable($this, buffer) {
    return buffer.length === get_MUTABLE_BUFFER_SIZE() ? buffer[get_MUTABLE_BUFFER_SIZE() - 1 | 0] === $this.j2b_1 : false;
  }
  ...
  function mutableBufferWith($this, element) {
    ...
    buffer[0] = element;
    buffer[get_MUTABLE_BUFFER_SIZE() - 1 | 0] = $this.j2b_1;
    return buffer;
  }
  ...
  function pushFilledTail_0($this, root, filledTail, newTail) {
    var tmp;
    if ($this.m2b_1 >> get_LOG_MAX_BUFFER_SIZE() > 1 << $this.i2b_1) {
      $this.k2b_1 = pushTail_0($this, mutableBufferWith($this, root), filledTail, $this.i2b_1 + get_LOG_MAX_BUFFER_SIZE() | 0);
      $this.l2b_1 = newTail;
      $this.i2b_1 = $this.i2b_1 + get_LOG_MAX_BUFFER_SIZE() | 0;
      $this.m2b_1 = $this.m2b_1 + 1 | 0;
      tmp = Unit_instance;
    } else if (root == null) {
      $this.k2b_1 = filledTail;
      $this.l2b_1 = newTail;
      $this.m2b_1 = $this.m2b_1 + 1 | 0;
      tmp = Unit_instance;
    } else {
      $this.k2b_1 = pushTail_0($this, root, filledTail, $this.i2b_1);
      $this.l2b_1 = newTail;
      $this.m2b_1 = $this.m2b_1 + 1 | 0;
      tmp = Unit_instance;
    }
  ...
  function pushTail_0($this, root, tail, shift) {
    var index = indexSegment($this.m2b_1 - 1 | 0, shift);
  ...
  function copyToBuffer($this, buffer, bufferIndex, sourceIterator) {
    ...
    while (index < get_MAX_BUFFER_SIZE() ? sourceIterator.z() : false) {
      var tmp0 = index;
      index = tmp0 + 1 | 0;
      buffer[tmp0] = sourceIterator.b1();
    }
    return buffer;
  }
  function pushBuffersIncreasingHeightIfNeeded($this, root, rootSize, buffers) {
    var buffersIterator = arrayIterator(buffers);
    var mutableRoot = rootSize >> get_LOG_MAX_BUFFER_SIZE() < 1 << $this.i2b_1 ? pushBuffers($this, root, rootSize, $this.i2b_1, buffersIterator) : makeMutable($this, root);
    while (buffersIterator.z()) {
      $this.i2b_1 = $this.i2b_1 + get_LOG_MAX_BUFFER_SIZE() | 0;
      mutableRoot = mutableBufferWith($this, mutableRoot);
      pushBuffers($this, mutableRoot, 1 << $this.i2b_1, $this.i2b_1, buffersIterator);
    }
    return mutableRoot;
  }
  ...
  function insertIntoTail_0($this, root, index, element) {
    ...
    var mutableTail = makeMutable($this, $this.l2b_1);
    if (tailSize < get_MAX_BUFFER_SIZE()) {
      // Inline function 'kotlin.collections.copyInto' call
      ...
      $this.k2b_1 = root;
      $this.l2b_1 = mutableTail;
      $this.m2b_1 = $this.m2b_1 + 1 | 0;
    } else {
      var lastElement = $this.l2b_1[get_MAX_BUFFER_SIZE_MINUS_ONE()];
      // Inline function 'kotlin.collections.copyInto' call
      var this_1 = $this.l2b_1;
  ...
  function insertIntoRoot_0($this, root, shift, index, element, elementCarry) {
    ...
    if (inductionVariable < last)
      $l$loop: do {
        ...
        mutableRoot_0[i] = insertIntoRoot_0($this, (!(tmp_0 == null) ? isArray(tmp_0) : false) ? tmp_0 : THROW_CCE(), lowerLevelShift, 0, elementCarry.d2b_1, elementCarry);
      }
       while (inductionVariable < last);
  ...
  function shiftLeafBuffers($this, startLeafIndex, rightShift, buffers, nullBuffers, nextBuffer) {
    ...
    while (!(leafBufferIterator_0.r1() === startLeafIndex)) {
      var currentBuffer = leafBufferIterator_0.q1();
      // Inline function 'kotlin.collections.copyInto' call
    ...
    return leafBufferIterator_0.q1();
  }
  function splitToBuffers($this, elements, index, startBuffer, startBufferSize, buffers, nullBuffers, nextBuffer) {
    ...
    var endBufferEndIndex = ((index + elements.j() | 0) - 1 | 0) & get_MAX_BUFFER_SIZE_MINUS_ONE();
  ...
  function bufferFor_0($this, index) {
    ...
    var buffer = ensureNotNull($this.k2b_1);
    var shift = $this.i2b_1;
    while (shift > 0) {
      var tmp = buffer[indexSegment(index, shift)];
      buffer = (!(tmp == null) ? isArray(tmp) : false) ? tmp : THROW_CCE();
      shift = shift - get_LOG_MAX_BUFFER_SIZE() | 0;
  ...
  function removeFromTailAt_0($this, root, rootSize, shift, index) {
    var tailSize = $this.m2b_1 - rootSize | 0;
    assert(index < tailSize);
    var removedElement;
    if (tailSize === 1) {
      removedElement = $this.l2b_1[0];
      pullLastBufferFromRoot_0($this, root, rootSize, shift);
    } else {
      removedElement = $this.l2b_1[index];
      // Inline function 'kotlin.collections.copyInto' call
      var this_0 = $this.l2b_1;
      var destination = makeMutable($this, $this.l2b_1);
      var startIndex = index + 1 | 0;
      ...
      $this.k2b_1 = root;
      $this.l2b_1 = mutableTail;
      $this.m2b_1 = (rootSize + tailSize | 0) - 1 | 0;
      $this.i2b_1 = shift;
    }
  ...
  function removeFromRootAt_0($this, root, shift, index, tailCarry) {
    ...
    if (shift === 0) {
      ...
      var mutableRoot = destination;
      mutableRoot[get_MAX_BUFFER_SIZE() - 1 | 0] = tailCarry.d2b_1;
      tailCarry.d2b_1 = removedElement;
      return mutableRoot;
    }
    var bufferLastIndex = get_MAX_BUFFER_SIZE_MINUS_ONE();
    if (root[bufferLastIndex] == null) {
  ...
  function pullLastBufferFromRoot_0($this, root, rootSize, shift) {
    ...
    var tmp_1 = $this;
    var tmp_2 = tailCarry.d2b_1;
    tmp_1.l2b_1 = (!(tmp_2 == null) ? isArray(tmp_2) : false) ? tmp_2 : THROW_CCE();
    $this.m2b_1 = rootSize;
    if (newRoot[1] == null) {
      var tmp_3 = $this;
      var tmp_4 = newRoot[0];
      tmp_3.k2b_1 = (tmp_4 == null ? true : isArray(tmp_4)) ? tmp_4 : THROW_CCE();
      $this.i2b_1 = shift - get_LOG_MAX_BUFFER_SIZE() | 0;
    } else {
      $this.k2b_1 = newRoot;
      $this.i2b_1 = shift;
    }
  ...
  function removeAll($this, predicate) {
    ...
    while (bufferSize === get_MAX_BUFFER_SIZE() ? leafIterator.z() : false) {
      bufferSize = removeAll_0($this, predicate, leafIterator.b1(), get_MAX_BUFFER_SIZE(), bufferRef);
    }
    if (bufferSize === get_MAX_BUFFER_SIZE()) {
      assert(!leafIterator.z());
      var newTailSize = removeAllFromTail($this, predicate, tailSize, bufferRef);
      if (newTailSize === 0) {
        pullLastBufferFromRoot_0($this, $this.k2b_1, $this.m2b_1, $this.i2b_1);
      }
      return !(newTailSize === tailSize);
    }
    var unaffectedElementsCount = leafIterator.r1() << get_LOG_MAX_BUFFER_SIZE();
    // Inline function 'kotlin.collections.mutableListOf' call
    var buffers = ArrayList_init_$Create$();
    // Inline function 'kotlin.collections.mutableListOf' call
    var recyclableBuffers = ArrayList_init_$Create$();
    while (leafIterator.z()) {
      var leaf = leafIterator.b1();
      bufferSize = recyclableRemoveAll($this, predicate, leaf, get_MAX_BUFFER_SIZE(), bufferSize, bufferRef, recyclableBuffers, buffers);
    }
    var newTailSize_0 = recyclableRemoveAll($this, predicate, $this.l2b_1, tailSize, bufferSize, bufferRef, recyclableBuffers, buffers);
    var tmp = bufferRef.d2b_1;
    var newTail = (!(tmp == null) ? isArray(tmp) : false) ? tmp : THROW_CCE();
    fill_0(newTail, null, newTailSize_0, get_MAX_BUFFER_SIZE());
    var newRoot = buffers.q() ? ensureNotNull($this.k2b_1) : pushBuffers($this, $this.k2b_1, unaffectedElementsCount, $this.i2b_1, buffers.l());
    var newRootSize = unaffectedElementsCount + (buffers.j() << get_LOG_MAX_BUFFER_SIZE()) | 0;
    $this.k2b_1 = retainFirst($this, newRoot, newRootSize);
    $this.l2b_1 = newTail;
    $this.m2b_1 = newRootSize + newTailSize_0 | 0;
    return true;
  }
  function retainFirst($this, root, size) {
    ...
    var newRoot = root;
    while (lastIndex >> $this.i2b_1 === 0) {
      $this.i2b_1 = $this.i2b_1 - get_LOG_MAX_BUFFER_SIZE() | 0;
      var tmp = newRoot[0];
      newRoot = (!(tmp == null) ? isArray(tmp) : false) ? tmp : THROW_CCE();
    }
    return nullifyAfter($this, newRoot, lastIndex, $this.i2b_1);
  }
  ...
  function removeAllFromTail($this, predicate, tailSize, bufferRef) {
    var newTailSize = removeAll_0($this, predicate, $this.l2b_1, tailSize, bufferRef);
    if (newTailSize === tailSize) {
      assert(bufferRef.d2b_1 === $this.l2b_1);
      return tailSize;
    }
    var tmp = bufferRef.d2b_1;
    var newTail = (!(tmp == null) ? isArray(tmp) : false) ? tmp : THROW_CCE();
    ...
    $this.l2b_1 = newTail;
    $this.m2b_1 = $this.m2b_1 - (tailSize - newTailSize | 0) | 0;
    return newTailSize;
  }
  ...
  function recyclableRemoveAll($this, predicate, buffer, bufferSize, toBufferSize, bufferRef, recyclableBuffers, buffers) {
    ...
    if (inductionVariable < bufferSize)
      do {
        ...
        if (!predicate(element)) {
          if (newToBufferSize === get_MAX_BUFFER_SIZE()) {
            ...
            if (!recyclableBuffers.q()) {
              tmp_1 = recyclableBuffers.j1(recyclableBuffers.j() - 1 | 0);
            } else {
       ...
       while (inductionVariable < bufferSize);
    bufferRef.d2b_1 = newToBuffer;
    if (!(toBuffer === bufferRef.d2b_1)) {
      buffers.w(toBuffer);
    }
  ...
  function setInRoot_0($this, root, shift, index, e, oldElementCarry) {
    ...
    if (shift === 0) {
      ...
      oldElementCarry.d2b_1 = mutableRoot[bufferIndex];
  ...
  function leafBufferIterator($this, index) {
    ...
    var root = tmp$ret$1;
    var leafCount = rootSize_0($this) >> get_LOG_MAX_BUFFER_SIZE();
    ListImplementation_instance.o1(index, leafCount);
    if ($this.i2b_1 === 0) {
      return new SingleElementListIterator(root, index);
    }
    var trieHeight = $this.i2b_1 / get_LOG_MAX_BUFFER_SIZE() | 0;
  ...
  function PersistentVectorBuilder(vector, vectorRoot, vectorTail, rootShift) {
    ...
    this.f2b_1 = vector;
    this.g2b_1 = vectorRoot;
    this.h2b_1 = vectorTail;
    this.i2b_1 = rootShift;
    this.j2b_1 = new MutabilityOwnership();
    this.k2b_1 = this.g2b_1;
    this.l2b_1 = this.h2b_1;
    this.m2b_1 = this.f2b_1.j();
  }
  protoOf(PersistentVectorBuilder).j = function () {
    return this.m2b_1;
  };
  protoOf(PersistentVectorBuilder).o2b = function () {
    return this.i1_1;
  };
  protoOf(PersistentVectorBuilder).c3 = function () {
    var tmp = this;
    var tmp_0;
    if (this.k2b_1 === this.g2b_1 ? this.l2b_1 === this.h2b_1 : false) {
      tmp_0 = this.f2b_1;
    } else {
      this.j2b_1 = new MutabilityOwnership();
      this.g2b_1 = this.k2b_1;
      this.h2b_1 = this.l2b_1;
      var tmp_1;
      if (this.k2b_1 == null) {
        var tmp_2;
        // Inline function 'kotlin.collections.isEmpty' call
        if (this.l2b_1.length === 0) {
          tmp_2 = persistentVectorOf();
        } else {
          tmp_2 = new SmallPersistentVector(copyOf_0(this.l2b_1, this.m2b_1));
        }
        tmp_1 = tmp_2;
      } else {
        tmp_1 = new PersistentVector(ensureNotNull(this.k2b_1), this.l2b_1, this.m2b_1, this.i2b_1);
      }
      tmp_0 = tmp_1;
    }
    tmp.f2b_1 = tmp_0;
  ...
  protoOf(PersistentVectorBuilder).w = function (element) {
    this.i1_1 = this.i1_1 + 1 | 0;
    var tailSize = tailSize_0(this);
    if (tailSize < get_MAX_BUFFER_SIZE()) {
      var mutableTail = makeMutable(this, this.l2b_1);
      ...
      pushFilledTail_0(this, this.k2b_1, this.l2b_1, newTail);
    }
    return true;
  };
  protoOf(PersistentVectorBuilder).c1 = function (elements) {
    if (elements.q()) {
      return false;
    }
    this.i1_1 = this.i1_1 + 1 | 0;
    ...
    if ((get_MAX_BUFFER_SIZE() - tailSize | 0) >= elements.j()) {
      this.l2b_1 = copyToBuffer(this, makeMutable(this, this.l2b_1), tailSize, elementsIterator);
      this.m2b_1 = this.m2b_1 + elements.j() | 0;
    } else {
      var buffersSize = ((elements.j() + tailSize | 0) - 1 | 0) / get_MAX_BUFFER_SIZE() | 0;
      // Inline function 'kotlin.arrayOfNulls' call
      var buffers = fillArrayVal(Array(buffersSize), null);
      buffers[0] = copyToBuffer(this, makeMutable(this, this.l2b_1), tailSize, elementsIterator);
      var inductionVariable = 1;
      ...
      tmp.k2b_1 = pushBuffersIncreasingHeightIfNeeded(this, tmp_0, tmp_1, isArray(buffers) ? buffers : THROW_CCE());
      this.l2b_1 = copyToBuffer(this, mutableBuffer(this), 0, elementsIterator);
      this.m2b_1 = this.m2b_1 + elements.j() | 0;
    }
    return true;
  };
  protoOf(PersistentVectorBuilder).w1 = function (index, element) {
    ListImplementation_instance.o1(index, this.m2b_1);
    if (index === this.m2b_1) {
      this.w(element);
      return Unit_instance;
    }
    ...
    if (index >= rootSize) {
      insertIntoTail_0(this, this.k2b_1, index - rootSize | 0, element);
      return Unit_instance;
    }
    var elementCarry = new ObjectRef(null);
    var newRest = insertIntoRoot_0(this, ensureNotNull(this.k2b_1), this.i2b_1, index, element, elementCarry);
    var tmp = elementCarry.d2b_1;
    insertIntoTail_0(this, newRest, 0, (tmp == null ? true : !(tmp == null)) ? tmp : THROW_CCE());
  };
  protoOf(PersistentVectorBuilder).y1 = function (index, elements) {
    ListImplementation_instance.o1(index, this.m2b_1);
    if (index === this.m2b_1) {
    ...
    var buffersSize = (((this.m2b_1 - unaffectedElementsCount | 0) + elements.j() | 0) - 1 | 0) / get_MAX_BUFFER_SIZE() | 0;
    if (buffersSize === 0) {
      assert(index >= rootSize_0(this));
      var startIndex = index & get_MAX_BUFFER_SIZE_MINUS_ONE();
      var endIndex = ((index + elements.j() | 0) - 1 | 0) & get_MAX_BUFFER_SIZE_MINUS_ONE();
      // Inline function 'kotlin.collections.copyInto' call
      var this_0 = this.l2b_1;
      var destination = makeMutable(this, this.l2b_1);
      ...
      copyToBuffer(this, newTail, startIndex, elements.l());
      this.l2b_1 = newTail;
      this.m2b_1 = this.m2b_1 + elements.j() | 0;
      return true;
    }
    ...
    var newTailSize = tailSize(this, this.m2b_1 + elements.j() | 0);
    var newTail_0;
    if (index >= rootSize_0(this)) {
      newTail_0 = mutableBuffer(this);
      splitToBuffers(this, elements, index, this.l2b_1, tailSize_1, buffers, buffersSize, newTail_0);
    } else if (newTailSize > tailSize_1) {
      var rightShift = newTailSize - tailSize_1 | 0;
      newTail_0 = makeMutableShiftingRight(this, this.l2b_1, rightShift);
      ...
      var lastBuffer = makeMutableShiftingRight(this, this.l2b_1, rightShift_0);
      buffers[buffersSize - 1 | 0] = lastBuffer;
      insertIntoRoot_1(this, elements, index, rightShift_0, buffers, buffersSize - 1 | 0, lastBuffer);
    }
    var tmp = this;
    var tmp_0 = this.k2b_1;
    tmp.k2b_1 = pushBuffersIncreasingHeightIfNeeded(this, tmp_0, unaffectedElementsCount, isArray(buffers) ? buffers : THROW_CCE());
    this.l2b_1 = newTail_0;
    this.m2b_1 = this.m2b_1 + elements.j() | 0;
    return true;
  };
  protoOf(PersistentVectorBuilder).k = function (index) {
    ListImplementation_instance.x1(index, this.m2b_1);
  ...
  protoOf(PersistentVectorBuilder).j1 = function (index) {
    ...
    var rootSize = rootSize_0(this);
    if (index >= rootSize) {
      var tmp = removeFromTailAt_0(this, this.k2b_1, rootSize, this.i2b_1, index - rootSize | 0);
      return (tmp == null ? true : !(tmp == null)) ? tmp : THROW_CCE();
    }
    var elementCarry = new ObjectRef(this.l2b_1[0]);
    var newRoot = removeFromRootAt_0(this, ensureNotNull(this.k2b_1), this.i2b_1, index, elementCarry);
    removeFromTailAt_0(this, newRoot, rootSize, this.i2b_1, 0);
    var tmp_0 = elementCarry.d2b_1;
    return (tmp_0 == null ? true : !(tmp_0 == null)) ? tmp_0 : THROW_CCE();
  };
  protoOf(PersistentVectorBuilder).d1 = function (elements) {
    return this.n2b(PersistentVectorBuilder$removeAll$lambda(elements));
  };
  protoOf(PersistentVectorBuilder).n2b = function (predicate) {
  ...
  protoOf(PersistentVectorBuilder).t = function (index, element) {
    ...
    this.k2b_1 = setInRoot_0(this, ensureNotNull(this.k2b_1), this.i2b_1, index, element, oldElementCarry);
    var tmp = oldElementCarry.d2b_1;
    return (tmp == null ? true : !(tmp == null)) ? tmp : THROW_CCE();
  };
  protoOf(PersistentVectorBuilder).l = function () {
    return this.xa();
  };
  protoOf(PersistentVectorBuilder).xa = function () {
    return this.n(0);
  };
  ...
  function PersistentVectorIterator(root, tail, index, size, trieHeight) {
    ...
    this.s2b_1 = new TrieIterator(root, trieIndex, trieSize, trieHeight);
  }
  protoOf(PersistentVectorIterator).b1 = function () {
    this.r2a();
    if (this.s2b_1.z()) {
      this.p2a_1 = this.p2a_1 + 1 | 0;
      return this.s2b_1.b1();
    }
    var tmp3 = this.p2a_1;
    this.p2a_1 = tmp3 + 1 | 0;
    return this.r2b_1[tmp3 - this.s2b_1.q2a_1 | 0];
  };
  protoOf(PersistentVectorIterator).q1 = function () {
    this.s2a();
    if (this.p2a_1 > this.s2b_1.q2a_1) {
      this.p2a_1 = this.p2a_1 - 1 | 0;
      return this.r2b_1[this.p2a_1 - this.s2b_1.q2a_1 | 0];
    }
    this.p2a_1 = this.p2a_1 - 1 | 0;
    return this.s2b_1.q1();
  };
  function reset($this) {
    $this.q2a_1 = $this.a2c_1.m2b_1;
    $this.b2c_1 = $this.a2c_1.o2b();
    $this.d2c_1 = -1;
    setupTrieIterator($this);
  }
  function setupTrieIterator($this) {
    var root = $this.a2c_1.k2b_1;
    if (root == null) {
      $this.c2c_1 = null;
      return Unit_instance;
    }
    var trieSize = rootSize_1($this.a2c_1.m2b_1);
    var trieIndex = coerceAtMost($this.p2a_1, trieSize);
    var trieHeight = ($this.a2c_1.i2b_1 / get_LOG_MAX_BUFFER_SIZE() | 0) + 1 | 0;
    if ($this.c2c_1 == null) {
      $this.c2c_1 = new TrieIterator(root, trieIndex, trieSize, trieHeight);
    } else {
      ensureNotNull($this.c2c_1).e2c(root, trieIndex, trieSize, trieHeight);
    }
  }
  function checkForComodification($this) {
    if (!($this.b2c_1 === $this.a2c_1.o2b()))
      throw ConcurrentModificationException_init_$Create$();
  }
  ...
  function PersistentVectorMutableIterator(builder, index) {
    AbstractListIterator.call(this, index, builder.m2b_1);
    this.a2c_1 = builder;
    this.b2c_1 = this.a2c_1.o2b();
    this.c2c_1 = null;
    this.d2c_1 = -1;
  ...
  protoOf(PersistentVectorMutableIterator).q1 = function () {
    checkForComodification(this);
    this.s2a();
    this.d2c_1 = this.p2a_1 - 1 | 0;
    var tmp1_elvis_lhs = this.c2c_1;
    var tmp;
    if (tmp1_elvis_lhs == null) {
      var tmp_0 = this.a2c_1.l2b_1;
      this.p2a_1 = this.p2a_1 - 1 | 0;
      var tmp_1 = tmp_0[this.p2a_1];
      return (tmp_1 == null ? true : !(tmp_1 == null)) ? tmp_1 : THROW_CCE();
    } else {
      tmp = tmp1_elvis_lhs;
    }
    var trieIterator = tmp;
    if (this.p2a_1 > trieIterator.q2a_1) {
      var tmp_2 = this.a2c_1.l2b_1;
      this.p2a_1 = this.p2a_1 - 1 | 0;
      var tmp_3 = tmp_2[this.p2a_1 - trieIterator.q2a_1 | 0];
      return (tmp_3 == null ? true : !(tmp_3 == null)) ? tmp_3 : THROW_CCE();
    }
    this.p2a_1 = this.p2a_1 - 1 | 0;
    return trieIterator.q1();
  };
  protoOf(PersistentVectorMutableIterator).b1 = function () {
    checkForComodification(this);
    this.r2a();
    this.d2c_1 = this.p2a_1;
    var tmp2_elvis_lhs = this.c2c_1;
    var tmp;
    ...
    if (trieIterator.z()) {
      this.p2a_1 = this.p2a_1 + 1 | 0;
      return trieIterator.b1();
    }
    var tmp_2 = this.a2c_1.l2b_1;
    var tmp6 = this.p2a_1;
    this.p2a_1 = tmp6 + 1 | 0;
    var tmp_3 = tmp_2[tmp6 - trieIterator.q2a_1 | 0];
    return (tmp_3 == null ? true : !(tmp_3 == null)) ? tmp_3 : THROW_CCE();
  };
  protoOf(PersistentVectorMutableIterator).a1 = function () {
    checkForComodification(this);
    checkHasIterated(this);
    this.a2c_1.j1(this.d2c_1);
    if (this.d2c_1 < this.p2a_1)
      this.p2a_1 = this.d2c_1;
    reset(this);
  };
  ...
  function Companion_6() {
    ...
    // Inline function 'kotlin.emptyArray' call
    var tmp$ret$0 = [];
    tmp.f2c_1 = new SmallPersistentVector(tmp$ret$0);
  }
  ...
  function SmallPersistentVector(buffer) {
    ...
    AbstractPersistentList.call(this);
    this.g2c_1 = buffer;
    assert(this.g2c_1.length <= get_MAX_BUFFER_SIZE());
  }
  protoOf(SmallPersistentVector).j = function () {
    return this.g2c_1.length;
  };
  protoOf(SmallPersistentVector).w = function (element) {
    if (this.j() < get_MAX_BUFFER_SIZE()) {
      var newBuffer = copyOf_0(this.g2c_1, this.j() + 1 | 0);
      newBuffer[this.j()] = element;
      return new SmallPersistentVector(newBuffer);
    }
    var tail = presizedBufferWith(element);
    return new PersistentVector(this.g2c_1, tail, this.j() + 1 | 0, 0);
  };
  protoOf(SmallPersistentVector).c1 = function (elements) {
    if ((this.j() + elements.j() | 0) <= get_MAX_BUFFER_SIZE()) {
      var newBuffer = copyOf_0(this.g2c_1, this.j() + elements.j() | 0);
      var index = this.j();
      var tmp0_iterator = elements.l();
      while (tmp0_iterator.z()) {
        var element = tmp0_iterator.b1();
  ...
  protoOf(SmallPersistentVector).u2a = function (predicate) {
    var newBuffer = this.g2c_1;
    var newSize = this.j();
    var anyRemoved = false;
    var inductionVariable = 0;
    var last = this.j();
    if (inductionVariable < last)
      do {
        var index = inductionVariable;
        inductionVariable = inductionVariable + 1 | 0;
        var tmp = this.g2c_1[index];
        var element = (tmp == null ? true : !(tmp == null)) ? tmp : THROW_CCE();
        if (predicate(element)) {
          if (!anyRemoved) {
            // Inline function 'kotlin.collections.copyOf' call
            // Inline function 'kotlin.js.asDynamic' call
            newBuffer = this.g2c_1.slice();
            newSize = index;
            anyRemoved = true;
          }
        } else if (anyRemoved) {
    ...
    return tmp2_subject === this.j() ? this : tmp2_subject === 0 ? Companion_getInstance_7().f2c_1 : new SmallPersistentVector(copyOfRange(newBuffer, 0, newSize));
  };
  protoOf(SmallPersistentVector).v2a = function (index, element) {
    ListImplementation_instance.o1(index, this.j());
    if (index === this.j()) {
      return this.w(element);
    }
    if (this.j() < get_MAX_BUFFER_SIZE()) {
    ...
    root[index] = element;
    var tail = presizedBufferWith(this.g2c_1[get_MAX_BUFFER_SIZE_MINUS_ONE()]);
    return new PersistentVector(root, tail, this.j() + 1 | 0, 0);
  };
  protoOf(SmallPersistentVector).j1 = function (index) {
    ListImplementation_instance.x1(index, this.j());
    if (this.j() === 1) {
      return Companion_getInstance_7().f2c_1;
    }
    var newBuffer = copyOf_0(this.g2c_1, this.j() - 1 | 0);
    // Inline function 'kotlin.collections.copyInto' call
    var this_0 = this.g2c_1;
  ...
  protoOf(SmallPersistentVector).t2a = function () {
    return new PersistentVectorBuilder(this, null, this.g2c_1, 0);
  };
  protoOf(SmallPersistentVector).m = function (element) {
    return indexOf(this.g2c_1, element);
  };
  ...
  protoOf(SmallPersistentVector).t = function (index, element) {
    ...
    // Inline function 'kotlin.collections.copyOf' call
    // Inline function 'kotlin.js.asDynamic' call
    var newBuffer = this.g2c_1.slice();
    newBuffer[index] = element;
    return new SmallPersistentVector(newBuffer);
  };
  function fillPath($this, index, startLevel) {
    var shift = imul($this.v2b_1 - startLevel | 0, get_LOG_MAX_BUFFER_SIZE());
    var i = startLevel;
    while (i < $this.v2b_1) {
      var tmp = $this.w2b_1;
      var tmp_0 = i;
      var tmp_1 = $this.w2b_1[i - 1 | 0];
  ...
  function fillPathIfNeeded($this, indexPredicate) {
    var shift = 0;
    while (indexSegment($this.p2a_1, shift) === indexPredicate) {
      shift = shift + get_LOG_MAX_BUFFER_SIZE() | 0;
    }
    if (shift > 0) {
      var level = ($this.v2b_1 - 1 | 0) - (shift / get_LOG_MAX_BUFFER_SIZE() | 0) | 0;
      fillPath($this, $this.p2a_1, level + 1 | 0);
    }
  }
  function elementAtCurrentIndex($this) {
    var leafBufferIndex = $this.p2a_1 & get_MAX_BUFFER_SIZE_MINUS_ONE();
    var tmp = $this.w2b_1[$this.v2b_1 - 1 | 0];
  ...
  function TrieIterator(root, index, size, height) {
    ...
    var tmp = this;
    // Inline function 'kotlin.arrayOfNulls' call
    var size_0 = this.v2b_1;
    tmp.w2b_1 = fillArrayVal(Array(size_0), null);
    this.x2b_1 = index === size;
    this.w2b_1[0] = root;
    fillPath(this, index - (this.x2b_1 ? 1 : 0) | 0, 1);
  }
  protoOf(TrieIterator).e2c = function (root, index, size, height) {
    this.p2a_1 = index;
    this.q2a_1 = size;
    this.v2b_1 = height;
    if (this.w2b_1.length < height) {
      var tmp = this;
      // Inline function 'kotlin.arrayOfNulls' call
      tmp.w2b_1 = fillArrayVal(Array(height), null);
    }
    this.w2b_1[0] = root;
    this.x2b_1 = index === size;
    fillPath(this, index - (this.x2b_1 ? 1 : 0) | 0, 1);
  };
  protoOf(TrieIterator).b1 = function () {
    if (!this.z()) {
      throw NoSuchElementException_init_$Create$_0();
    }
    var result = elementAtCurrentIndex(this);
    this.p2a_1 = this.p2a_1 + 1 | 0;
    if (this.p2a_1 === this.q2a_1) {
      this.x2b_1 = true;
      return result;
    }
  ...
  protoOf(TrieIterator).q1 = function () {
    if (!this.p1()) {
      throw NoSuchElementException_init_$Create$_0();
    }
    this.p2a_1 = this.p2a_1 - 1 | 0;
  ...
  function Companion_7() {
    ...
    this.h2c_1 = new PersistentHashMap(Companion_getInstance_9().i2c_1, 0);
  }
  protoOf(Companion_7).j2c = function () {
    var tmp = this.h2c_1;
  ...
  protoOf(PersistentHashMap).s2 = function (key) {
    ...
    return this.m2c_1.s2c(tmp$ret$0, key, 0);
  };
  protoOf(PersistentHashMap).v2 = function (key) {
    // Inline function 'kotlin.hashCode' call
    var tmp1_elvis_lhs = key == null ? null : hashCode(key);
    var tmp$ret$0 = tmp1_elvis_lhs == null ? 0 : tmp1_elvis_lhs;
    return this.m2c_1.t2c(tmp$ret$0, key, 0);
  };
  protoOf(PersistentHashMap).m2 = function (key, value) {
    // Inline function 'kotlin.hashCode' call
    var tmp1_elvis_lhs = key == null ? null : hashCode(key);
    var tmp$ret$0 = tmp1_elvis_lhs == null ? 0 : tmp1_elvis_lhs;
    var tmp0_elvis_lhs = this.m2c_1.u2c(tmp$ret$0, key, value, 0);
    var tmp;
    if (tmp0_elvis_lhs == null) {
      return this;
    } else {
    ...
    return new PersistentHashMap(newNodeResult.v2c_1, this.j() + newNodeResult.w2c_1 | 0);
  };
  protoOf(PersistentHashMap).n2 = function (key) {
    // Inline function 'kotlin.hashCode' call
    var tmp1_elvis_lhs = key == null ? null : hashCode(key);
    var tmp$ret$0 = tmp1_elvis_lhs == null ? 0 : tmp1_elvis_lhs;
    var newNode = this.m2c_1.x2c(tmp$ret$0, key, 0);
    if (this.m2c_1 === newNode) {
      return this;
    }
    if (newNode == null) {
      return Companion_getInstance_8().j2c();
    }
  ...
  function moveToNextNodeWithData($this, pathIndex) {
    if ($this.y2c_1[pathIndex].e2d()) {
      return pathIndex;
    }
    if ($this.y2c_1[pathIndex].i2d()) {
      var node = $this.y2c_1[pathIndex].f2d();
      if (pathIndex === 6) {
        $this.y2c_1[pathIndex + 1 | 0].h2d(node.r2c_1, node.r2c_1.length);
      } else {
        $this.y2c_1[pathIndex + 1 | 0].h2d(node.r2c_1, imul(get_ENTRY_SIZE(), node.g2d()));
      }
  ...
  function ensureNextEntryIsReady($this) {
    if ($this.y2c_1[$this.z2c_1].e2d()) {
      return Unit_instance;
    }
    var inductionVariable = $this.z2c_1;
    if (0 <= inductionVariable)
      do {
        var i = inductionVariable;
        inductionVariable = inductionVariable + -1 | 0;
        var result = moveToNextNodeWithData($this, i);
        if (result === -1 ? $this.y2c_1[i].i2d() : false) {
          $this.y2c_1[i].j2d();
        ...
        if (i > 0) {
          $this.y2c_1[i - 1 | 0].j2d();
        }
        $this.y2c_1[i].h2d(Companion_getInstance_9().i2c_1.r2c_1, 0);
      }
       while (0 <= inductionVariable);
    $this.a2d_1 = false;
  }
  ...
  function PersistentHashMapBaseIterator(node, path) {
    ...
    this.z2c_1 = 0;
    this.a2d_1 = true;
    this.y2c_1[0].h2d(node.r2c_1, imul(get_ENTRY_SIZE(), node.g2d()));
    this.z2c_1 = 0;
  ...
  protoOf(PersistentHashMapBaseIterator).b1 = function () {
    checkHasNext(this);
    var result = this.y2c_1[this.z2c_1].b1();
    ensureNextEntryIsReady(this);
    return result;
  };
  function TrieNodeBaseIterator() {
    this.b2d_1 = Companion_getInstance_9().i2c_1.r2c_1;
    this.c2d_1 = 0;
    this.d2d_1 = 0;
  }
  protoOf(TrieNodeBaseIterator).k2d = function (buffer, dataSize, index) {
    this.b2d_1 = buffer;
    this.c2d_1 = dataSize;
    this.d2d_1 = index;
  };
  protoOf(TrieNodeBaseIterator).h2d = function (buffer, dataSize) {
    this.k2d(buffer, dataSize, 0);
  };
  protoOf(TrieNodeBaseIterator).e2d = function () {
    return this.d2d_1 < this.c2d_1;
  };
  protoOf(TrieNodeBaseIterator).i2d = function () {
    assert(this.d2d_1 >= this.c2d_1);
    return this.d2d_1 < this.b2d_1.length;
  };
  protoOf(TrieNodeBaseIterator).f2d = function () {
    assert(this.i2d());
    var tmp = this.b2d_1[this.d2d_1];
    return tmp instanceof TrieNode ? tmp : THROW_CCE();
  };
  protoOf(TrieNodeBaseIterator).j2d = function () {
    assert(this.i2d());
    this.d2d_1 = this.d2d_1 + 1 | 0;
  };
  protoOf(TrieNodeBaseIterator).z = function () {
    return this.e2d();
  };
  function TrieNodeKeysIterator() {
    TrieNodeBaseIterator.call(this);
  }
  protoOf(TrieNodeKeysIterator).b1 = function () {
    assert(this.e2d());
    this.d2d_1 = this.d2d_1 + 2 | 0;
    var tmp = this.b2d_1[this.d2d_1 - 2 | 0];
    return (tmp == null ? true : !(tmp == null)) ? tmp : THROW_CCE();
  };
  function TrieNodeValuesIterator() {
    TrieNodeBaseIterator.call(this);
  }
  protoOf(TrieNodeValuesIterator).b1 = function () {
    assert(this.e2d());
    this.d2d_1 = this.d2d_1 + 2 | 0;
    var tmp = this.b2d_1[this.d2d_1 - 1 | 0];
    return (tmp == null ? true : !(tmp == null)) ? tmp : THROW_CCE();
  };
  function TrieNodeEntriesIterator() {
    TrieNodeBaseIterator.call(this);
  }
  protoOf(TrieNodeEntriesIterator).b1 = function () {
    assert(this.e2d());
    this.d2d_1 = this.d2d_1 + 2 | 0;
    var tmp = this.b2d_1[this.d2d_1 - 2 | 0];
    var tmp_0 = (tmp == null ? true : !(tmp == null)) ? tmp : THROW_CCE();
    var tmp_1 = this.b2d_1[this.d2d_1 - 1 | 0];
  ...
  protoOf(MapEntry).equals = function (other) {
    ...
    if (tmp0_safe_receiver == null) {
      ...
      tmp = equals(tmp0_safe_receiver.o2(), this.o2()) ? equals(tmp0_safe_receiver.p2(), this.p2()) : false;
    }
    var tmp1_elvis_lhs = tmp;
    return tmp1_elvis_lhs == null ? false : tmp1_elvis_lhs;
  };
  ...
  protoOf(PersistentHashMapKeys).k3 = function (element) {
    return this.w2d_1.s2(element);
  };
  ...
  protoOf(PersistentHashMapKeys).l = function () {
    return new PersistentHashMapKeysIterator(this.w2d_1.m2c_1);
  };
  ...
  protoOf(PersistentHashMapValues).p3 = function (element) {
    return this.x2d_1.t2(element);
  };
  ...
  protoOf(PersistentHashMapValues).l = function () {
    return new PersistentHashMapValuesIterator(this.x2d_1.m2c_1);
  };
  ...
  protoOf(PersistentHashMapEntries).z2d = function (element) {
    var tmp = !(element == null) ? element : THROW_CCE();
    if (!(!(tmp == null) ? isInterface(tmp, Entry) : false))
      return false;
    var tmp0_safe_receiver = this.y2d_1.v2(element.o2());
    var tmp_0;
    if (tmp0_safe_receiver == null) {
      tmp_0 = null;
    } else {
      ...
      tmp_0 = equals(tmp0_safe_receiver, element.p2());
    }
    var tmp1_elvis_lhs = tmp_0;
    return tmp1_elvis_lhs == null ? element.p2() == null ? this.y2d_1.s2(element.o2()) : false : tmp1_elvis_lhs;
  };
  protoOf(PersistentHashMapEntries).o = function (element) {
    if (!(!(element == null) ? isInterface(element, Entry) : false))
      return false;
    return this.z2d((!(element == null) ? isInterface(element, Entry) : false) ? element : THROW_CCE());
  };
  protoOf(PersistentHashMapEntries).l = function () {
    return new PersistentHashMapEntriesIterator(this.y2d_1.m2c_1);
  };
  ...
  function hasNodeAt($this, positionMask) {
    return !(($this.p2c_1 & positionMask) === 0);
  }
  function keyAtIndex($this, keyIndex) {
    var tmp = $this.r2c_1[keyIndex];
    return (tmp == null ? true : !(tmp == null)) ? tmp : THROW_CCE();
  }
  function valueAtKeyIndex($this, keyIndex) {
    var tmp = $this.r2c_1[keyIndex + 1 | 0];
    return (tmp == null ? true : !(tmp == null)) ? tmp : THROW_CCE();
  }
  function insertEntryAt($this, positionMask, key, value) {
    var keyIndex = $this.a2e(positionMask);
    var newBuffer = insertEntryAtIndex($this.r2c_1, keyIndex, key, value);
    return TrieNode_init_$Create$($this.o2c_1 | positionMask, $this.p2c_1, newBuffer);
  }
  function updateValueAtIndex($this, keyIndex, value) {
    // Inline function 'kotlin.collections.copyOf' call
    // Inline function 'kotlin.js.asDynamic' call
    var newBuffer = $this.r2c_1.slice();
    newBuffer[keyIndex + 1 | 0] = value;
    return TrieNode_init_$Create$($this.o2c_1, $this.p2c_1, newBuffer);
  }
  function updateNodeAtIndex($this, nodeIndex, positionMask, newNode) {
    var newNodeBuffer = newNode.r2c_1;
    if (newNodeBuffer.length === 2 ? newNode.p2c_1 === 0 : false) {
      if ($this.r2c_1.length === 1) {
        newNode.o2c_1 = $this.p2c_1;
        return newNode;
      }
      var keyIndex = $this.a2e(positionMask);
      var newBuffer = replaceNodeWithEntry($this.r2c_1, nodeIndex, keyIndex, newNodeBuffer[0], newNodeBuffer[1]);
      return TrieNode_init_$Create$($this.o2c_1 ^ positionMask, $this.p2c_1 ^ positionMask, newBuffer);
    }
    var newBuffer_0 = copyOf_0($this.r2c_1, $this.r2c_1.length);
    newBuffer_0[nodeIndex] = newNode;
    return TrieNode_init_$Create$($this.o2c_1, $this.p2c_1, newBuffer_0);
  }
  function removeNodeAtIndex($this, nodeIndex, positionMask) {
    if ($this.r2c_1.length === 1)
      return null;
    var newBuffer = removeNodeAtIndex_0($this.r2c_1, nodeIndex);
    return TrieNode_init_$Create$($this.o2c_1, $this.p2c_1 ^ positionMask, newBuffer);
  }
  function bufferMoveEntryToNode($this, keyIndex, positionMask, newKeyHash, newKey, newValue, shift, owner) {
    ...
    var nodeIndex = $this.b2e(positionMask) + 1 | 0;
    return replaceEntryWithNode($this.r2c_1, keyIndex, nodeIndex, newNode);
  }
  ...
  function removeEntryAtIndex($this, keyIndex, positionMask) {
    if ($this.r2c_1.length === 2)
      return null;
    var newBuffer = removeEntryAtIndex_0($this.r2c_1, keyIndex);
    return TrieNode_init_$Create$($this.o2c_1 ^ positionMask, $this.p2c_1, newBuffer);
  }
  function collisionRemoveEntryAtIndex($this, i) {
    if ($this.r2c_1.length === 2)
      return null;
    var newBuffer = removeEntryAtIndex_0($this.r2c_1, i);
    return TrieNode_init_$Create$(0, 0, newBuffer);
  }
  function collisionContainsKey($this, key) {
    var progression = step(until(0, $this.r2c_1.length), 2);
    var inductionVariable = progression.ga_1;
    var last = progression.ha_1;
    var step_0 = progression.ia_1;
    if ((step_0 > 0 ? inductionVariable <= last : false) ? true : step_0 < 0 ? last <= inductionVariable : false)
      do {
        var i = inductionVariable;
        inductionVariable = inductionVariable + step_0 | 0;
        if (equals(key, $this.r2c_1[i]))
          return true;
      }
       while (!(i === last));
    return false;
  ...
  function collisionPut($this, key, value) {
    ...
    if ((step_0 > 0 ? inductionVariable <= last : false) ? true : step_0 < 0 ? last <= inductionVariable : false)
      do {
       ...
       while (!(i === last));
    var newBuffer_0 = insertEntryAtIndex($this.r2c_1, 0, key, value);
  ...
  function Companion_8() {
    ...
    // Inline function 'kotlin.emptyArray' call
    var tmp$ret$0 = [];
    tmp.i2c_1 = TrieNode_init_$Create$(0, 0, tmp$ret$0);
  }
  ...
  protoOf(TrieNode).g2d = function () {
    return countOneBits(this.o2c_1);
  };
  protoOf(TrieNode).c2e = function (positionMask) {
    return !((this.o2c_1 & positionMask) === 0);
  };
  protoOf(TrieNode).a2e = function (positionMask) {
    return imul(2, countOneBits(this.o2c_1 & (positionMask - 1 | 0)));
  };
  protoOf(TrieNode).b2e = function (positionMask) {
    return (this.r2c_1.length - 1 | 0) - countOneBits(this.p2c_1 & (positionMask - 1 | 0)) | 0;
  };
  protoOf(TrieNode).d2e = function (nodeIndex) {
    var tmp = this.r2c_1[nodeIndex];
    return tmp instanceof TrieNode ? tmp : THROW_CCE();
  };
  protoOf(TrieNode).s2c = function (keyHash, key, shift) {
    var keyPositionMask = 1 << indexSegment_0(keyHash, shift);
    if (this.c2e(keyPositionMask)) {
      return equals(key, keyAtIndex(this, this.a2e(keyPositionMask)));
    }
    if (hasNodeAt(this, keyPositionMask)) {
      var targetNode = this.d2e(this.b2e(keyPositionMask));
      if (shift === 30) {
        return collisionContainsKey(targetNode, key);
      }
      return targetNode.s2c(keyHash, key, shift + 5 | 0);
    }
    return false;
  };
  protoOf(TrieNode).t2c = function (keyHash, key, shift) {
    var keyPositionMask = 1 << indexSegment_0(keyHash, shift);
    if (this.c2e(keyPositionMask)) {
      var keyIndex = this.a2e(keyPositionMask);
    ...
    if (hasNodeAt(this, keyPositionMask)) {
      ...
      return targetNode.t2c(keyHash, key, shift + 5 | 0);
    }
    return null;
  };
  protoOf(TrieNode).u2c = function (keyHash, key, value, shift) {
    var keyPositionMask = 1 << indexSegment_0(keyHash, shift);
    if (this.c2e(keyPositionMask)) {
      var keyIndex = this.a2e(keyPositionMask);
      if (equals(key, keyAtIndex(this, keyIndex))) {
    ...
    if (hasNodeAt(this, keyPositionMask)) {
      var nodeIndex = this.b2e(keyPositionMask);
      var targetNode = this.d2e(nodeIndex);
      var tmp;
      if (shift === 30) {
        ...
        var tmp1_elvis_lhs = targetNode.u2c(keyHash, key, value, shift + 5 | 0);
        var tmp_1;
        if (tmp1_elvis_lhs == null) {
          return null;
        } else {
      ...
      var node = putResult.v2c_1;
      tmp_2.v2c_1 = updateNodeAtIndex(this, nodeIndex, keyPositionMask, node);
      return putResult;
    }
    return asInsertResult(insertEntryAt(this, keyPositionMask, key, value));
  };
  protoOf(TrieNode).x2c = function (keyHash, key, shift) {
    var keyPositionMask = 1 << indexSegment_0(keyHash, shift);
    if (this.c2e(keyPositionMask)) {
      var keyIndex = this.a2e(keyPositionMask);
      if (equals(key, keyAtIndex(this, keyIndex))) {
    ...
    if (hasNodeAt(this, keyPositionMask)) {
      ...
      if (shift === 30) {
        ...
        tmp = targetNode.x2c(keyHash, key, shift + 5 | 0);
      }
      var newNode = tmp;
  ...
  function Companion_9() {
    ...
    this.k2a_1 = new PersistentOrderedSet(EndOfChain_instance, EndOfChain_instance, Companion_getInstance_8().j2c());
  }
  protoOf(Companion_9).l2a = function () {
    return this.k2a_1;
  };
  ...
  function PersistentOrderedSet(firstElement, lastElement, hashMap) {
    ...
    AbstractSet.call(this);
    this.e2e_1 = firstElement;
    this.f2e_1 = lastElement;
    this.g2e_1 = hashMap;
  }
  ...
  protoOf(PersistentOrderedSet).o = function (element) {
    return this.g2e_1.s2(element);
  };
  protoOf(PersistentOrderedSet).w = function (element) {
    if (this.g2e_1.s2(element)) {
      return this;
    }
    if (this.q()) {
      var newMap = this.g2e_1.m2(element, Links_init_$Create$());
      return new PersistentOrderedSet(element, element, newMap);
    }
    var tmp = this.f2e_1;
    var lastElement = (tmp == null ? true : !(tmp == null)) ? tmp : THROW_CCE();
    var lastLinks = ensureNotNull(this.g2e_1.v2(lastElement));
    var newMap_0 = this.g2e_1.m2(lastElement, lastLinks.j2e(element)).m2(element, Links_init_$Create$_0(lastElement));
    return new PersistentOrderedSet(this.e2e_1, element, newMap_0);
  };
  protoOf(PersistentOrderedSet).x = function (element) {
    var tmp0_elvis_lhs = this.g2e_1.v2(element);
    var tmp;
    if (tmp0_elvis_lhs == null) {
      return this;
    } else {
    ...
    var links = tmp;
    var newMap = this.g2e_1.n2(element);
    if (links.k2e()) {
      // Inline function 'kotlin.collections.get' call
      var this_0 = newMap;
      var key = links.h2e_1;
      var tmp$ret$0 = (isInterface(this_0, Map) ? this_0 : THROW_CCE()).v2(key);
      var previousLinks = ensureNotNull(tmp$ret$0);
      var tmp_0 = newMap;
      var tmp_1 = links.h2e_1;
      newMap = tmp_0.m2((tmp_1 == null ? true : !(tmp_1 == null)) ? tmp_1 : THROW_CCE(), previousLinks.j2e(links.i2e_1));
    }
    if (links.m2e()) {
      // Inline function 'kotlin.collections.get' call
      var this_1 = newMap;
      var key_0 = links.i2e_1;
      var tmp$ret$1 = (isInterface(this_1, Map) ? this_1 : THROW_CCE()).v2(key_0);
      var nextLinks = ensureNotNull(tmp$ret$1);
      var tmp_2 = newMap;
      var tmp_3 = links.i2e_1;
      newMap = tmp_2.m2((tmp_3 == null ? true : !(tmp_3 == null)) ? tmp_3 : THROW_CCE(), nextLinks.l2e(links.h2e_1));
    }
    var newFirstElement = !links.k2e() ? links.i2e_1 : this.e2e_1;
    var newLastElement = !links.m2e() ? links.h2e_1 : this.f2e_1;
    return new PersistentOrderedSet(newFirstElement, newLastElement, newMap);
  };
  protoOf(PersistentOrderedSet).l = function () {
    return new PersistentOrderedSetIterator(this.e2e_1, this.g2e_1);
  };
  ...
  protoOf(Links).j2e = function (newNext) {
    return new Links(this.h2e_1, newNext);
  };
  protoOf(Links).l2e = function (newPrevious) {
    return new Links(newPrevious, this.i2e_1);
  };
  protoOf(Links).m2e = function () {
    return !(this.i2e_1 === EndOfChain_instance);
  };
  protoOf(Links).k2e = function () {
    return !(this.h2e_1 === EndOfChain_instance);
  };
  ...
  function PersistentOrderedSetIterator(nextElement, map) {
    this.n2e_1 = nextElement;
    this.o2e_1 = map;
    this.p2e_1 = 0;
  }
  protoOf(PersistentOrderedSetIterator).z = function () {
    return this.p2e_1 < this.o2e_1.j();
  };
  protoOf(PersistentOrderedSetIterator).b1 = function () {
    ...
    var tmp0_elvis_lhs = this.o2e_1.v2(result);
    var tmp_1;
    if (tmp0_elvis_lhs == null) {
  ...
  protoOf(ListImplementation).o1 = function (index, size) {
    if (index < 0 ? true : index > size) {
      throw IndexOutOfBoundsException_init_$Create$('index: ' + index + ', size: ' + size);
    }
  };
  ...
  function replacableWith(_this__u8e3s4, other) {
    ...
    if (_this__u8e3s4 == null) {
      ...
      if (tmp_1) {
        tmp_0 = (!_this__u8e3s4.i1s() ? true : equals(_this__u8e3s4, other)) ? true : equals(_this__u8e3s4.t1c_1, other.t1c_1);
      } else {
        tmp_0 = false;
      }
      tmp = tmp_0;
  ...
  function composableLambda(composer, key, tracked, block) {
    ...
    composer.s1n(tmp$ret$0);
    var slot = composer.y1o();
    var tmp;
    if (slot === Companion_getInstance_0().k1i_1) {
  ...
  protoOf(IntRef).toString = function () {
    return 'IntRef(element = ' + this.k27_1 + ')@' + toString_1(hashCode(this), 16);
  };
  function Companion_10() {
    Companion_instance_11 = this;
    var tmp = this;
    var tmp_0 = Companion_getInstance_9().i2c_1;
    tmp.w2e_1 = new PersistentCompositionLocalHashMap(tmp_0 instanceof TrieNode ? tmp_0 : THROW_CCE(), 0);
  }
  ...
  protoOf(PersistentCompositionLocalHashMap).l2 = function () {
    return protoOf(PersistentHashMap).l2.call(this);
  };
  protoOf(PersistentCompositionLocalHashMap).f1p = function (key, value) {
    var tmp0_elvis_lhs = this.m2c_1.u2c(hashCode(key), key, value, 0);
    var tmp;
    if (tmp0_elvis_lhs == null) {
      return this;
    } else {
    ...
    var newNodeResult = tmp;
    return new PersistentCompositionLocalHashMap(newNodeResult.v2c_1, this.j() + newNodeResult.w2c_1 | 0);
  };
  function persistentCompositionLocalHashMapOf() {
    return Companion_getInstance_11().w2e_1;
  }
  ...
  function find_2($this, key) {
    var high = $this.k23_1 - 1 | 0;
    var tmp0_subject = high;
    if (tmp0_subject === -1)
      return -1;
    else if (tmp0_subject === 0)
      return $this.l23_1[0].equals(key) ? 0 : $this.l23_1[0].ca(key) > 0 ? -2 : -1;
    var low = 0;
    while (low <= high) {
      var mid = (low + high | 0) >>> 1 | 0;
      var midVal = $this.l23_1[mid];
      var comparison = midVal.ib(key);
      if (comparison.ca(new Long(0, 0)) < 0)
        low = mid + 1 | 0;
      else if (comparison.ca(new Long(0, 0)) > 0)
        high = mid - 1 | 0;
      else
        return mid;
    }
  ...
  protoOf(ThreadMap).n23 = function (key) {
    var index = find_2(this, key);
    return index >= 0 ? this.m23_1[index] : null;
  };
  protoOf(ThreadMap).o23 = function (key, value) {
    var index = find_2(this, key);
    if (index < 0)
      return false;
    this.m23_1[index] = value;
    return true;
  };
  protoOf(ThreadMap).p23 = function (key, value) {
    var size = this.k23_1;
    // Inline function 'kotlin.collections.count' call
    var count = 0;
    var indexedObject = this.m23_1;
    var inductionVariable = 0;
    var last = indexedObject.length;
    while (inductionVariable < last) {
      var element = indexedObject[inductionVariable];
    ...
    if (newSize > 1) {
      ...
      $l$loop: while (dest < newSize ? source < size : false) {
        var oldKey = this.l23_1[source];
        var oldValue = this.m23_1[source];
        if (oldKey.ca(key) > 0) {
          newKeys[dest] = key;
      ...
      if (source === size) {
        ...
        while (dest < newSize) {
          var oldKey_0 = this.l23_1[source];
          var oldValue_0 = this.m23_1[source];
          if (!(oldValue_0 == null)) {
  ...
  function sam$androidx_compose_runtime_snapshots_ObserverHandle$0(function_0) {
    this.b2f_1 = function_0;
  }
  protoOf(sam$androidx_compose_runtime_snapshots_ObserverHandle$0).yl = function () {
    return this.b2f_1();
  };
  function sam$androidx_compose_runtime_snapshots_ObserverHandle$0_0(function_0) {
    this.c2f_1 = function_0;
  }
  protoOf(sam$androidx_compose_runtime_snapshots_ObserverHandle$0_0).yl = function () {
    return this.c2f_1();
  };
  ...
  protoOf(Companion_11).i1b = function () {
    return currentSnapshot();
  };
  protoOf(Companion_11).l1y = function (readObserver, writeObserver) {
    var tmp = currentSnapshot();
    var tmp0_safe_receiver = tmp instanceof MutableSnapshot ? tmp : null;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.d2f(readObserver, writeObserver);
    var tmp_0;
    if (tmp1_elvis_lhs == null) {
  ...
  protoOf(Companion_11).m20 = function (observer) {
  ...
  protoOf(Companion_11).e2f = function (observer) {
    // Inline function 'androidx.compose.runtime.snapshots.sync' call
    // Inline function 'androidx.compose.runtime.synchronized' call
    // Inline function 'kotlinx.atomicfu.locks.synchronized' call
    get_lock();
  ...
  protoOf(Companion_11).l1x = function () {
    return currentSnapshot().l1x();
  };
  protoOf(Companion_11).j1x = function () {
    // Inline function 'androidx.compose.runtime.snapshots.sync' call
    // Inline function 'androidx.compose.runtime.synchronized' call
    // Inline function 'kotlinx.atomicfu.locks.synchronized' call
    get_lock();
    // Inline function 'androidx.compose.runtime.snapshots.Companion.sendApplyNotifications.<anonymous>' call
    var tmp0_safe_receiver = get_currentGlobalSnapshot().kn().f2f();
    var changes = (tmp0_safe_receiver == null ? null : tmp0_safe_receiver.i1p()) === true;
    if (changes) {
      advanceGlobalSnapshot_0();
    }
  };
  ...
  function Snapshot(id, invalid) {
    ...
    this.x1l_1 = id;
    this.y1l_1 = false;
    this.z1l_1 = !(id === 0) ? trackPinning(id, this.g2f()) : -1;
  }
  protoOf(Snapshot).h2f = function (_set____db54di) {
    this.w1l_1 = _set____db54di;
  };
  protoOf(Snapshot).g2f = function () {
    return this.w1l_1;
  };
  protoOf(Snapshot).i2f = function (_set____db54di) {
    this.x1l_1 = _set____db54di;
  };
  protoOf(Snapshot).a1m = function () {
    return this.x1l_1;
  };
  protoOf(Snapshot).j2f = function (value) {
    // Inline function 'kotlin.error' call
    var message = 'Updating write count is not supported for this snapshot';
    throw IllegalStateException_init_$Create$(toString(message));
  };
  protoOf(Snapshot).k2f = function () {
    return 0;
  };
  protoOf(Snapshot).yl = function () {
    this.y1l_1 = true;
    // Inline function 'androidx.compose.runtime.snapshots.sync' call
    // Inline function 'androidx.compose.runtime.synchronized' call
    // Inline function 'kotlinx.atomicfu.locks.synchronized' call
  ...
  protoOf(Snapshot).m1y = function () {
    var previous = get_threadSnapshot().kn();
    get_threadSnapshot().r1u(this);
    return previous;
  };
  protoOf(Snapshot).n1y = function (snapshot) {
    get_threadSnapshot().r1u(snapshot);
  };
  protoOf(Snapshot).q2f = function () {
    // Inline function 'androidx.compose.runtime.snapshots.sync' call
    // Inline function 'androidx.compose.runtime.synchronized' call
    // Inline function 'kotlinx.atomicfu.locks.synchronized' call
    get_lock();
  ...
  protoOf(Snapshot).r2f = function () {
    set_openSnapshots(get_openSnapshots().x2f(this.a1m()));
  };
  protoOf(Snapshot).s2f = function () {
    this.m2f();
  };
  protoOf(Snapshot).y2f = function () {
    // Inline function 'kotlin.require' call
    // Inline function 'kotlin.contracts.contract' call
    if (!!this.y1l_1) {
  ...
  protoOf(Snapshot).m2f = function () {
    if (this.z1l_1 >= 0) {
      releasePinningLocked(this.z1l_1);
      this.z1l_1 = -1;
    }
  };
  protoOf(Snapshot).z2f = function () {
    // Inline function 'kotlin.also' call
  ...
  function abandon($this) {
    ...
    if (!(modified == null)) {
      ...
      // Inline function 'androidx.compose.runtime.collection.IdentityArraySet.fastForEach' call
      // Inline function 'kotlin.contracts.contract' call
      var values = modified.t1l_1;
      var inductionVariable = 0;
      var last = modified.s1l_1;
      if (inductionVariable < last)
        do {
          var i = inductionVariable;
          inductionVariable = inductionVariable + 1 | 0;
          ...
          var tmp = values[i];
          var current = (!(tmp == null) ? tmp : THROW_CCE()).h23();
          while (!(current == null)) {
            if (current.b2g_1 === id ? true : contains($this.x1y_1, current.b2g_1)) {
              current.b2g_1 = 0;
            }
            current = current.c2g_1;
          }
        }
         while (inductionVariable < last);
    }
  ...
  function releasePreviouslyPinnedSnapshotsLocked($this) {
    ...
    if (inductionVariable <= last)
      do {
        var index = inductionVariable;
        inductionVariable = inductionVariable + 1 | 0;
        releasePinningLocked($this.y1y_1[index]);
      }
       while (inductionVariable <= last);
  }
  function Companion_12() {
    Companion_instance_13 = this;
    this.d2g_1 = new Int32Array(0);
  }
  ...
  function MutableSnapshot(id, invalid, readObserver, writeObserver) {
    ...
    this.s1y_1 = readObserver;
    this.t1y_1 = writeObserver;
    this.u1y_1 = 0;
    this.v1y_1 = null;
    this.w1y_1 = null;
    this.x1y_1 = Companion_getInstance_14().e2g_1;
    this.y1y_1 = Companion_getInstance_13().d2g_1;
    this.z1y_1 = 1;
    this.a1z_1 = false;
  }
  protoOf(MutableSnapshot).n2f = function () {
    return this.s1y_1;
  };
  protoOf(MutableSnapshot).o2f = function () {
    return this.t1y_1;
  };
  protoOf(MutableSnapshot).d2f = function (readObserver, writeObserver) {
    this.y2f();
    ...
    var newId = tmp0;
    set_openSnapshots(get_openSnapshots().g2g(newId));
    var currentInvalid = this.g2f();
    this.h2f(currentInvalid.g2g(newId));
    var this_0 = new NestedMutableSnapshot(newId, addRange(currentInvalid, this.a1m() + 1 | 0, newId), mergedReadObserver(readObserver, this.n2f()), mergedWriteObserver(writeObserver, this.o2f()), this);
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'androidx.compose.runtime.snapshots.MutableSnapshot.advance.<anonymous>' call
    if (!this.a1z_1 ? !this.y1l_1 : false) {
      var previousId = this.a1m();
      // Inline function 'androidx.compose.runtime.snapshots.sync' call
      // Inline function 'androidx.compose.runtime.synchronized' call
      // Inline function 'kotlinx.atomicfu.locks.synchronized' call
      get_lock();
      ...
      this.i2f(tmp0_0);
      set_openSnapshots(get_openSnapshots().g2g(this.a1m()));
      this.h2f(addRange(this.g2f(), previousId + 1 | 0, this.a1m()));
    }
    return this_0;
  };
  protoOf(MutableSnapshot).b1z = function () {
    var modified = this.f2f();
    var optimisticMerges_0 = !(modified == null) ? optimisticMerges(get_currentGlobalSnapshot().kn(), this, get_openSnapshots().x2f(get_currentGlobalSnapshot().kn().a1m())) : null;
    ...
    validateOpen(this);
    var tmp;
    if (modified == null ? true : modified.s1l_1 === 0) {
      this.r2f();
      var previousGlobalSnapshot = get_currentGlobalSnapshot().kn();
      takeNewGlobalSnapshot(previousGlobalSnapshot, get_emptyLambda());
      var previousModified = previousGlobalSnapshot.f2f();
      var tmp_0;
      ...
      var previousGlobalSnapshot_0 = get_currentGlobalSnapshot().kn();
      var result = this.h2g(get_nextSnapshotId(), optimisticMerges_0, get_openSnapshots().x2f(previousGlobalSnapshot_0.a1m()));
      if (!equals(result, Success_getInstance()))
        return result;
      this.r2f();
      takeNewGlobalSnapshot(previousGlobalSnapshot_0, get_emptyLambda());
      var previousModified_0 = previousGlobalSnapshot_0.f2f();
      this.a2g(null);
      previousGlobalSnapshot_0.a2g(null);
      observers = get_applyObservers();
    ...
    if (tmp0_safe_receiver == null)
      ...
      // Inline function 'androidx.compose.runtime.collection.IdentityArraySet.fastForEach' call
      // Inline function 'kotlin.contracts.contract' call
      var values = tmp0_safe_receiver.t1l_1;
      var inductionVariable_1 = 0;
      var last_1 = tmp0_safe_receiver.s1l_1;
      if (inductionVariable_1 < last_1)
        do {
    ...
    if (modified == null)
      ...
      // Inline function 'androidx.compose.runtime.collection.IdentityArraySet.fastForEach' call
      // Inline function 'kotlin.contracts.contract' call
      var values_0 = modified.t1l_1;
      var inductionVariable_2 = 0;
      var last_2 = modified.s1l_1;
      if (inductionVariable_2 < last_2)
        do {
    ...
    var tmp2_safe_receiver = this.w1y_1;
    if (tmp2_safe_receiver == null)
      null;
    else {
      // Inline function 'androidx.compose.runtime.snapshots.fastForEach' call
  ...
  protoOf(MutableSnapshot).l2f = function () {
    return false;
  };
  protoOf(MutableSnapshot).yl = function () {
    if (!this.y1l_1) {
      protoOf(Snapshot).yl.call(this);
      this.i2g(this);
    }
  };
  protoOf(MutableSnapshot).j2g = function (snapshot) {
    this.z1y_1 = this.z1y_1 + 1 | 0;
  };
  protoOf(MutableSnapshot).i2g = function (snapshot) {
    // Inline function 'kotlin.require' call
    // Inline function 'kotlin.contracts.contract' call
    if (!(this.z1y_1 > 0)) {
  ...
  protoOf(MutableSnapshot).l1x = function () {
    if (this.a1z_1 ? true : this.y1l_1)
      return Unit_instance;
    this.k2g();
  };
  protoOf(MutableSnapshot).r2f = function () {
    set_openSnapshots(get_openSnapshots().x2f(this.a1m()).l2g(this.x1y_1));
  };
  protoOf(MutableSnapshot).s2f = function () {
    releasePreviouslyPinnedSnapshotsLocked(this);
    protoOf(Snapshot).s2f.call(this);
  };
  protoOf(MutableSnapshot).h2g = function (snapshotId, optimisticMerges, invalidSnapshots) {
    var mergedRecords = null;
    var start = this.g2f().g2g(this.a1m()).m2g(this.x1y_1);
    var modified = ensureNotNull(this.f2f());
    ...
    if (inductionVariable < last)
      do {
        ...
        $l$block_0: {
          ...
          var current = tmp_0;
          var tmp1_elvis_lhs = readable(first, this.a1m(), start);
          var tmp_1;
          if (tmp1_elvis_lhs == null) {
            break $l$block_0;
          } else {
          ...
          if (!equals(current, previous)) {
            var tmp2_elvis_lhs = readable(first, this.a1m(), this.g2f());
            var tmp_2;
            if (tmp2_elvis_lhs == null) {
              readError();
            } else {
            ...
            var applied = tmp_2;
            var tmp4_elvis_lhs = optimisticMerges == null ? null : optimisticMerges.v2(current);
            var tmp_3;
            if (tmp4_elvis_lhs == null) {
              // Inline function 'kotlin.run' call
              // Inline function 'kotlin.contracts.contract' call
              // Inline function 'androidx.compose.runtime.snapshots.MutableSnapshot.innerApplyLocked.<anonymous>.<anonymous>' call
              tmp_3 = state.j23(previous, current, applied);
            } else {
            ...
            if (merged == null)
              ...
              if (equals(merged, current)) {
                ...
                tmp_6.w(!equals(merged, previous) ? to(state, merged) : to(state, previous.d23()));
              }
          }
        }
      }
    ...
    if (tmp0_safe_receiver == null)
      ...
      if (inductionVariable_0 <= last_0) {
        do {
          ...
          // Inline function 'androidx.compose.runtime.snapshots.MutableSnapshot.innerApplyLocked.<anonymous>.<anonymous>' call
          var state_0 = item.le();
          var stateRecord = item.me();
          stateRecord.b2g_1 = this.a1m();
          // Inline function 'androidx.compose.runtime.snapshots.sync' call
          // Inline function 'androidx.compose.runtime.synchronized' call
          // Inline function 'kotlinx.atomicfu.locks.synchronized' call
          get_lock();
          stateRecord.c2g_1 = state_0.h23();
          state_0.i23(stateRecord);
        }
         while (inductionVariable_0 <= last_0);
        tmp_7 = Unit_instance;
      }
    ...
    if (tmp1_safe_receiver == null)
      ...
      if (inductionVariable_1 <= last_1)
        do {
         ...
         while (inductionVariable_1 <= last_1);
      var mergedList = this.w1y_1;
      this.w1y_1 = mergedList == null ? tmp1_safe_receiver : plus_2(mergedList, tmp1_safe_receiver);
    }
    return Success_getInstance();
  };
  ...
  protoOf(MutableSnapshot).f2g = function (id) {
    // Inline function 'androidx.compose.runtime.snapshots.sync' call
    // Inline function 'androidx.compose.runtime.synchronized' call
    // Inline function 'kotlinx.atomicfu.locks.synchronized' call
    get_lock();
    this.x1y_1 = this.x1y_1.g2g(id);
  };
  protoOf(MutableSnapshot).n2g = function (id) {
    if (id >= 0) {
      var tmp = this;
      ...
      tmp.y1y_1 = primitiveArrayConcat([this_0, elements]);
    }
  };
  protoOf(MutableSnapshot).o2g = function (handles) {
    // Inline function 'kotlin.collections.isEmpty' call
    if (handles.length === 0)
      return Unit_instance;
    var pinned = this.y1y_1;
    var tmp = this;
    var tmp_0;
    // Inline function 'kotlin.collections.isEmpty' call
    if (pinned.length === 0) {
  ...
  protoOf(MutableSnapshot).p2g = function (snapshots) {
    // Inline function 'androidx.compose.runtime.snapshots.sync' call
    // Inline function 'androidx.compose.runtime.synchronized' call
    // Inline function 'kotlinx.atomicfu.locks.synchronized' call
    get_lock();
    this.x1y_1 = this.x1y_1.m2g(snapshots);
  };
  protoOf(MutableSnapshot).p2f = function (state) {
    var tmp0_elvis_lhs = this.f2f();
    var tmp;
    if (tmp0_elvis_lhs == null) {
      // Inline function 'kotlin.also' call
      var this_0 = new IdentityArraySet();
  ...
  protoOf(MutableSnapshot).j2f = function (_set____db54di) {
    this.u1y_1 = _set____db54di;
  };
  protoOf(MutableSnapshot).k2f = function () {
    return this.u1y_1;
  };
  protoOf(MutableSnapshot).a2g = function (_set____db54di) {
    this.v1y_1 = _set____db54di;
  };
  protoOf(MutableSnapshot).f2f = function () {
    return this.v1y_1;
  };
  function Success() {
  ...
  protoOf(GlobalSnapshot).d2f = function (readObserver, writeObserver) {
    return takeNewSnapshot(GlobalSnapshot$takeNestedMutableSnapshot$lambda(readObserver, writeObserver));
  };
  protoOf(GlobalSnapshot).l1x = function () {
    advanceGlobalSnapshot_0();
  };
  protoOf(GlobalSnapshot).e2h = function (snapshot) {
    unsupported();
  };
  protoOf(GlobalSnapshot).i2g = function (snapshot) {
    return this.e2h(snapshot);
  };
  protoOf(GlobalSnapshot).f2h = function (snapshot) {
    unsupported();
  };
  protoOf(GlobalSnapshot).j2g = function (snapshot) {
    return this.f2h(snapshot);
  };
  protoOf(GlobalSnapshot).b1z = function () {
    var message = 'Cannot apply the global snapshot directly. Call Snapshot.advanceGlobalSnapshot';
    throw IllegalStateException_init_$Create$(toString(message));
  };
  protoOf(GlobalSnapshot).yl = function () {
    // Inline function 'androidx.compose.runtime.snapshots.sync' call
    // Inline function 'androidx.compose.runtime.synchronized' call
    // Inline function 'kotlinx.atomicfu.locks.synchronized' call
    get_lock();
  ...
  function StateRecord() {
    this.b2g_1 = currentSnapshot().a1m();
    this.c2g_1 = null;
  }
  function trackPinning(id, invalid) {
    _init_properties_Snapshot_kt__l6n1ng();
    var pinned = invalid.g2h(id);
    // Inline function 'androidx.compose.runtime.snapshots.sync' call
    // Inline function 'androidx.compose.runtime.synchronized' call
    // Inline function 'kotlinx.atomicfu.locks.synchronized' call
    get_lock();
    // Inline function 'androidx.compose.runtime.snapshots.trackPinning.<anonymous>' call
    return get_pinningTable().m2h(pinned);
  }
  function releasePinningLocked(handle) {
    _init_properties_Snapshot_kt__l6n1ng();
    get_pinningTable().n2h(handle);
  }
  function currentSnapshot() {
    _init_properties_Snapshot_kt__l6n1ng();
    var tmp0_elvis_lhs = get_threadSnapshot().kn();
    return tmp0_elvis_lhs == null ? get_currentGlobalSnapshot().kn() : tmp0_elvis_lhs;
  }
  function advanceGlobalSnapshot(block) {
    ...
    previousGlobalSnapshot = get_currentGlobalSnapshot().kn();
    modified = previousGlobalSnapshot.f2f();
    if (!(modified == null)) {
      get_pendingApplyObserverCount().m2h(1);
    }
    ...
    if (tmp0_safe_receiver_0 == null) {
      ...
      // Inline function 'androidx.compose.runtime.collection.IdentityArraySet.fastForEach' call
      // Inline function 'kotlin.contracts.contract' call
      var values = tmp0_safe_receiver_0.t1l_1;
      var inductionVariable_0 = 0;
      var last_0 = tmp0_safe_receiver_0.s1l_1;
      if (inductionVariable_0 < last_0)
        do {
          var i = inductionVariable_0;
          inductionVariable_0 = inductionVariable_0 + 1 | 0;
  ...
  protoOf(NestedMutableSnapshot).yl = function () {
    if (!this.y1l_1) {
      protoOf(MutableSnapshot).yl.call(this);
      deactivate(this);
    }
  };
  protoOf(NestedMutableSnapshot).b1z = function () {
    if (this.c2i_1.a1z_1 ? true : this.c2i_1.y1l_1)
      return new Failure(this);
    var modified = this.f2f();
    var id = this.a1m();
    var optimisticMerges_0 = !(modified == null) ? optimisticMerges(this.c2i_1, this, this.c2i_1.g2f()) : null;
    // Inline function 'androidx.compose.runtime.snapshots.sync' call
    // Inline function 'androidx.compose.runtime.synchronized' call
    // Inline function 'kotlinx.atomicfu.locks.synchronized' call
    get_lock();
    ...
    if (modified == null ? true : modified.s1l_1 === 0) {
      ...
      var result = this.h2g(this.c2i_1.a1m(), optimisticMerges_0, this.c2i_1.g2f());
      if (!equals(result, Success_getInstance()))
        return result;
      var tmp0_safe_receiver = this.c2i_1.f2f();
      var tmp;
      if (tmp0_safe_receiver == null) {
        tmp = null;
      } else {
        ...
        tmp0_safe_receiver.b1y(modified);
      ...
      if (tmp == null) {
        ...
        // Inline function 'kotlin.contracts.contract' call
        // Inline function 'androidx.compose.runtime.snapshots.NestedMutableSnapshot.apply.<anonymous>.<anonymous>' call
        this.c2i_1.a2g(modified);
        this.a2g(null);
      }
    }
    if (this.c2i_1.a1m() < id) {
      this.c2i_1.k2g();
    }
    this.c2i_1.h2f(this.c2i_1.g2f().x2f(id).l2g(this.x1y_1));
    this.c2i_1.f2g(id);
    this.c2i_1.n2g(this.z2f());
    this.c2i_1.p2g(this.x1y_1);
    this.c2i_1.o2g(this.y1y_1);
    this.a1z_1 = true;
    deactivate(this);
    return Success_getInstance();
  };
  ...
  function optimisticMerges(currentSnapshot, applyingSnapshot, invalidSnapshots) {
    _init_properties_Snapshot_kt__l6n1ng();
    var modified = applyingSnapshot.f2f();
    var id = currentSnapshot.a1m();
    if (modified == null)
      return null;
    var start = applyingSnapshot.g2f().g2g(applyingSnapshot.a1m()).m2g(applyingSnapshot.x1y_1);
    var result = null;
    // Inline function 'androidx.compose.runtime.collection.IdentityArraySet.fastForEach' call
    // Inline function 'kotlin.contracts.contract' call
    var values = modified.t1l_1;
    ...
    if (inductionVariable < last)
      do {
        ...
        $l$block_0: {
          ...
          var previous = tmp_1;
          if (!equals(current, previous)) {
            var tmp2_elvis_lhs = readable(first, applyingSnapshot.a1m(), applyingSnapshot.g2f());
            var tmp_2;
            if (tmp2_elvis_lhs == null) {
              readError();
            } else {
            ...
            var applied = tmp_2;
            var merged = state.j23(previous, current, applied);
            if (!(merged == null)) {
              // Inline function 'kotlin.collections.set' call
  ...
  function validateOpen(snapshot) {
    ...
    if (!openSnapshots.k(snapshot.a1m())) {
      // Inline function 'kotlin.error' call
      var tmp = snapshot.a1m();
      var tmp_0 = snapshot.y1l_1;
      var tmp0_safe_receiver = snapshot instanceof MutableSnapshot ? snapshot : null;
      var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.a1z_1;
      ...
      var message = 'Snapshot is not open: id=' + tmp + ', disposed=' + tmp_0 + ', applied=' + tmp_1 + ', lowestPin=' + get_pinningTable().e2i(-1);
      throw IllegalStateException_init_$Create$(toString(message));
    }
  }
  function takeNewGlobalSnapshot(previousGlobalSnapshot, block) {
    _init_properties_Snapshot_kt__l6n1ng();
    var result = block(get_openSnapshots().x2f(previousGlobalSnapshot.a1m()));
    // Inline function 'androidx.compose.runtime.snapshots.sync' call
    // Inline function 'androidx.compose.runtime.synchronized' call
    // Inline function 'kotlinx.atomicfu.locks.synchronized' call
    get_lock();
    ...
    set_nextSnapshotId(tmp0 + 1 | 0);
    var globalId = tmp0;
    set_openSnapshots(get_openSnapshots().x2f(previousGlobalSnapshot.a1m()));
    get_currentGlobalSnapshot().k1s(new GlobalSnapshot(globalId, get_openSnapshots()));
    previousGlobalSnapshot.yl();
    set_openSnapshots(get_openSnapshots().g2g(globalId));
    return result;
  }
  function checkAndOverwriteUnusedRecordsLocked() {
    ...
    if (inductionVariable < size)
      do {
        var i = inductionVariable;
        inductionVariable = inductionVariable + 1 | 0;
        var entry = this_0.h2i_1[i];
        var value = entry == null ? null : entry.kn();
        var tmp;
        if (!(value == null)) {
        ...
        if (tmp) {
          if (!(currentUsed === i)) {
            this_0.h2i_1[currentUsed] = entry;
            this_0.g2i_1[currentUsed] = this_0.g2i_1[i];
          }
  ...
  function readable(r, id, invalid) {
    ...
    while (!(current == null)) {
      if (valid(current, id, invalid)) {
        candidate = candidate == null ? current : candidate.b2g_1 < current.b2g_1 ? current : candidate;
      }
      current = current.c2g_1;
    }
    if (!(candidate == null)) {
  ...
  function overwriteUnusedRecordsLocked(state) {
    _init_properties_Snapshot_kt__l6n1ng();
    var current = state.h23();
    var overwriteRecord = null;
    var validRecord = null;
    var reuseLimit = get_pinningTable().e2i(get_nextSnapshotId());
    var retainedRecords = 0;
    while (!(current == null)) {
      var currentId = current.b2g_1;
      if (!(currentId === 0)) {
        if (currentId < reuseLimit) {
          if (validRecord == null) {
            ...
            var tmp;
            if (current.b2g_1 < validRecord.b2g_1) {
              tmp = current;
            } else {
            ...
            if (overwriteRecord == null) {
              ...
              $l$block: {
                ...
                while (!(current_0 == null)) {
                  ...
                  if (current_0.b2g_1 >= reuseLimit) {
                    tmp$ret$1 = current_0;
                    break $l$block;
                  }
                  if (youngest.b2g_1 < current_0.b2g_1)
                    youngest = current_0;
                  current_0 = current_0.c2g_1;
                }
                tmp$ret$1 = youngest;
              }
              overwriteRecord = tmp$ret$1;
            }
            recordToOverwrite.b2g_1 = 0;
            recordToOverwrite.c23(overwriteRecord);
          }
        } else {
          retainedRecords = retainedRecords + 1 | 0;
        }
  ...
  function valid(data, snapshot, invalid) {
    _init_properties_Snapshot_kt__l6n1ng();
    return valid_0(snapshot, data.b2g_1, invalid);
  }
  ...
  function readable_0(_this__u8e3s4, state) {
    _init_properties_Snapshot_kt__l6n1ng();
    var snapshot = Companion_instance_12.i1b();
    var tmp0_safe_receiver = snapshot.n2f();
    if (tmp0_safe_receiver == null)
      null;
    else
      tmp0_safe_receiver(state);
    var tmp1_elvis_lhs = readable(_this__u8e3s4, snapshot.a1m(), snapshot.g2f());
    var tmp;
    if (tmp1_elvis_lhs == null) {
      // Inline function 'androidx.compose.runtime.snapshots.sync' call
      // Inline function 'androidx.compose.runtime.synchronized' call
      ...
      var syncSnapshot = Companion_instance_12.i1b();
      var tmp_0 = state.h23();
      var tmp0_elvis_lhs = readable(tmp_0 instanceof StateRecord ? tmp_0 : THROW_CCE(), syncSnapshot.a1m(), syncSnapshot.g2f());
      var tmp_1;
      if (tmp0_elvis_lhs == null) {
        readError();
      } else {
  ...
  function current(r) {
    ...
    var snapshot = Companion_instance_12.i1b();
    var tmp0_elvis_lhs = readable(r, snapshot.a1m(), snapshot.g2f());
    var tmp;
    if (tmp0_elvis_lhs == null) {
      // Inline function 'androidx.compose.runtime.snapshots.sync' call
      // Inline function 'androidx.compose.runtime.synchronized' call
      ...
      var syncSnapshot = Companion_instance_12.i1b();
      tmp = readable(r, syncSnapshot.a1m(), syncSnapshot.g2f());
    } else {
      tmp = tmp0_elvis_lhs;
    }
    var tmp1_elvis_lhs = tmp;
  ...
  function notifyWrite(snapshot, state) {
    _init_properties_Snapshot_kt__l6n1ng();
    snapshot.j2f(snapshot.k2f() + 1 | 0);
    var tmp1_safe_receiver = snapshot.o2f();
    if (tmp1_safe_receiver == null)
      null;
    else
  ...
  function newOverwritableRecordLocked(_this__u8e3s4, state) {
    ...
    if (tmp0_safe_receiver == null) {
      ...
      tmp0_safe_receiver.b2g_1 = IntCompanionObject_instance.MAX_VALUE;
      tmp_0 = tmp0_safe_receiver;
    }
    var tmp1_elvis_lhs = tmp_0;
    var tmp_1;
    if (tmp1_elvis_lhs == null) {
      // Inline function 'kotlin.apply' call
      var this_0 = _this__u8e3s4.d23();
      // Inline function 'kotlin.contracts.contract' call
      // Inline function 'androidx.compose.runtime.snapshots.newOverwritableRecordLocked.<anonymous>' call
      this_0.b2g_1 = IntCompanionObject_instance.MAX_VALUE;
      this_0.c2g_1 = state.h23();
      state.i23(this_0 instanceof StateRecord ? this_0 : THROW_CCE());
      var tmp_2 = this_0;
  ...
  function usedLocked(state) {
    ...
    var current = state.h23();
    var validRecord = null;
    var reuseLimit = get_pinningTable().e2i(get_nextSnapshotId()) - 1 | 0;
    var invalid = Companion_getInstance_14().e2g_1;
    while (!(current == null)) {
      var currentId = current.b2g_1;
      if (currentId === 0) {
        return current;
      ...
      if (valid(current, reuseLimit, invalid)) {
        if (validRecord == null) {
          ...
          return current.b2g_1 < validRecord.b2g_1 ? current : validRecord;
        }
      }
      current = current.c2g_1;
    }
  ...
  function writableRecord(_this__u8e3s4, state, snapshot) {
    ...
    var id = snapshot.a1m();
    var tmp0_elvis_lhs = readable(_this__u8e3s4, id, snapshot.g2f());
    var tmp;
    if (tmp0_elvis_lhs == null) {
      readError();
    } else {
    ...
    var readData = tmp;
    if (readData.b2g_1 === snapshot.a1m())
      return readData;
  ...
  function newWritableRecordLocked(_this__u8e3s4, state, snapshot) {
    _init_properties_Snapshot_kt__l6n1ng();
    var newData = newOverwritableRecordLocked(_this__u8e3s4, state);
    newData.c23(_this__u8e3s4);
    newData.b2g_1 = snapshot.a1m();
    return newData;
  }
  ...
  function takeNewSnapshot$lambda($block) {
    return function (invalid) {
      ...
      // Inline function 'kotlinx.atomicfu.locks.synchronized' call
      get_lock();
      set_openSnapshots(get_openSnapshots().g2g(result.a1m()));
      return result;
    };
  }
  ...
  function _init_properties_Snapshot_kt__l6n1ng() {
    if (!properties_initialized_Snapshot_kt_2vlcoq) {
      ...
      openSnapshots = Companion_getInstance_14().e2g_1;
      nextSnapshotId = 1;
      ...
      var tmp0 = get_nextSnapshotId();
      set_nextSnapshotId(tmp0 + 1 | 0);
      var this_0 = new GlobalSnapshot(tmp0, Companion_getInstance_14().e2g_1);
      // Inline function 'kotlin.contracts.contract' call
      // Inline function 'androidx.compose.runtime.snapshots.currentGlobalSnapshot.<anonymous>' call
      set_openSnapshots(get_openSnapshots().g2g(this_0.a1m()));
      currentGlobalSnapshot = new AtomicReference(this_0);
      snapshotInitializer = get_currentGlobalSnapshot().kn();
      pendingApplyObserverCount = new AtomicInt(0);
    }
  }
  function shiftUp($this, index) {
    var values = $this.i2h_1;
  ...
  function shiftDown($this, index) {
    var values = $this.i2h_1;
    var half = $this.h2h_1 >> 1;
    var current = index;
    while (current < half) {
      var right = (current + 1 | 0) << 1;
      var left = right - 1 | 0;
      if (right < $this.h2h_1 ? values[right] < values[left] : false) {
  ...
  function swap($this, a, b) {
    var values = $this.i2h_1;
    var index = $this.j2h_1;
    var handles = $this.k2h_1;
    var t = values[a];
    values[a] = values[b];
    values[b] = t;
    t = index[a];
  ...
  function ensure($this, atLeast) {
    var capacity = $this.i2h_1.length;
    if (atLeast <= capacity)
      return Unit_instance;
    ...
    $this.i2h_1 = newValues;
    $this.j2h_1 = newIndex;
  }
  function allocateHandle($this) {
    var capacity = $this.k2h_1.length;
    if ($this.l2h_1 >= capacity) {
      var tmp = 0;
      ...
      $this.k2h_1 = newHandles;
    }
    var handle = $this.l2h_1;
    $this.l2h_1 = $this.k2h_1[$this.l2h_1];
    return handle;
  }
  function freeHandle($this, handle) {
    $this.k2h_1[handle] = $this.l2h_1;
    $this.l2h_1 = handle;
  }
  function SnapshotDoubleIndexHeap() {
    this.h2h_1 = 0;
    this.i2h_1 = new Int32Array(16);
    this.j2h_1 = new Int32Array(16);
    var tmp = this;
    var tmp_0 = 0;
  ...
  protoOf(SnapshotDoubleIndexHeap).e2i = function (default_0) {
    return this.h2h_1 > 0 ? this.i2h_1[0] : default_0;
  };
  protoOf(SnapshotDoubleIndexHeap).m2h = function (value) {
    ensure(this, this.h2h_1 + 1 | 0);
    var tmp1 = this.h2h_1;
    this.h2h_1 = tmp1 + 1 | 0;
    var i = tmp1;
  ...
  protoOf(SnapshotDoubleIndexHeap).n2h = function (handle) {
    var i = this.k2h_1[handle];
    swap(this, i, this.h2h_1 - 1 | 0);
    this.h2h_1 = this.h2h_1 - 1 | 0;
    shiftUp(this, i);
    shiftDown(this, i);
  ...
  function Companion_13() {
    ...
    this.e2g_1 = new SnapshotIdSet(new Long(0, 0), new Long(0, 0), 0, null);
  }
  ...
  protoOf(SnapshotIdSet$iterator$slambda).a2j = function ($this$sequence, $completion) {
    var tmp = this.b2j($this$sequence, $completion);
    tmp.ec_1 = Unit_instance;
    tmp.fc_1 = null;
    return tmp.oc();
  };
  protoOf(SnapshotIdSet$iterator$slambda).ad = function (p1, $completion) {
    return this.a2j(p1 instanceof SequenceScope ? p1 : THROW_CCE(), $completion);
  };
  protoOf(SnapshotIdSet$iterator$slambda).oc = function () {
    var suspendResult = this.ec_1;
    $sm: do
      try {
        var tmp = this.cc_1;
        switch (tmp) {
          case 0:
            this.dc_1 = 15;
            this.t2i_1 = this.r2i_1.w2f_1;
            if (!(this.t2i_1 == null)) {
              this.u2i_1 = intArrayIterator(this.t2i_1);
              this.cc_1 = 1;
              continue $sm;
            } else {
              this.cc_1 = 4;
          ...
          case 1:
            ...
            this.v2i_1 = this.u2i_1.b1();
            this.cc_1 = 2;
            suspendResult = this.s2i_1.ne(this.v2i_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 3:
            ...
            continue $sm;
          case 4:
            if (!this.r2i_1.u2f_1.equals(new Long(0, 0))) {
              var tmp_0 = this;
              Companion_getInstance();
              tmp_0.w2i_1 = until(0, 64).l();
              this.cc_1 = 5;
              continue $sm;
            } else {
              this.cc_1 = 9;
          ...
          case 5:
            ...
            this.x2i_1 = this.w2i_1.b1();
            if (!this.r2i_1.u2f_1.rb((new Long(1, 0)).ob(this.x2i_1)).equals(new Long(0, 0))) {
              this.cc_1 = 6;
              suspendResult = this.s2i_1.ne(this.x2i_1 + this.r2i_1.v2f_1 | 0, this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
          ...
          case 8:
            ...
            continue $sm;
          case 9:
            if (!this.r2i_1.t2f_1.equals(new Long(0, 0))) {
              var tmp_1 = this;
              Companion_getInstance();
              tmp_1.y2i_1 = until(0, 64).l();
              this.cc_1 = 10;
              continue $sm;
            } else {
              this.cc_1 = 14;
          ...
          case 10:
            ...
            this.z2i_1 = this.y2i_1.b1();
            if (!this.r2i_1.t2f_1.rb((new Long(1, 0)).ob(this.z2i_1)).equals(new Long(0, 0))) {
              this.cc_1 = 11;
              Companion_getInstance();
              suspendResult = this.s2i_1.ne((this.z2i_1 + 64 | 0) + this.r2i_1.v2f_1 | 0, this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
  ...
  protoOf(SnapshotIdSet$iterator$slambda).b2j = function ($this$sequence, completion) {
    var i = new SnapshotIdSet$iterator$slambda(this.r2i_1, completion);
    i.s2i_1 = $this$sequence;
    return i;
  };
  function SnapshotIdSet$iterator$slambda_0(this$0, resultContinuation) {
    ...
    var l = function ($this$sequence, $completion) {
      return i.a2j($this$sequence, $completion);
    };
    l.$arity = 1;
    return l;
  }
  function SnapshotIdSet(upperSet, lowerSet, lowerBound, belowBound) {
    ...
    this.t2f_1 = upperSet;
    this.u2f_1 = lowerSet;
    this.v2f_1 = lowerBound;
    this.w2f_1 = belowBound;
  }
  protoOf(SnapshotIdSet).k = function (bit) {
    var offset = bit - this.v2f_1 | 0;
    var tmp;
    if (offset >= 0) {
      Companion_getInstance();
      tmp = offset < 64;
    ...
    if (tmp) {
      return !(new Long(1, 0)).ob(offset).rb(this.u2f_1).equals(new Long(0, 0));
    } else {
      var tmp_0;
      Companion_getInstance();
      if (offset >= 64) {
      ...
      if (tmp_0) {
        ...
        Companion_getInstance();
        return !tmp_1.ob(offset - 64 | 0).rb(this.t2f_1).equals(new Long(0, 0));
      } else {
        if (offset > 0) {
          return false;
        } else {
  ...
  protoOf(SnapshotIdSet).g2g = function (bit) {
    var offset = bit - this.v2f_1 | 0;
    var tmp;
    if (offset >= 0) {
      Companion_getInstance();
    ...
    if (tmp) {
      var mask = (new Long(1, 0)).ob(offset);
      if (this.u2f_1.rb(mask).equals(new Long(0, 0))) {
        return new SnapshotIdSet(this.t2f_1, this.u2f_1.sb(mask), this.v2f_1, this.w2f_1);
      }
    } else {
      var tmp_0;
      Companion_getInstance();
      ...
      if (tmp_0) {
        var tmp_1 = new Long(1, 0);
        Companion_getInstance();
        var mask_0 = tmp_1.ob(offset - 64 | 0);
        if (this.t2f_1.rb(mask_0).equals(new Long(0, 0))) {
          return new SnapshotIdSet(this.t2f_1.sb(mask_0), this.u2f_1, this.v2f_1, this.w2f_1);
        }
      } else {
        Companion_getInstance();
        if (offset >= imul(64, 2)) {
          if (!this.k(bit)) {
            var newUpperSet = this.t2f_1;
            var newLowerSet = this.u2f_1;
            var newLowerBound = this.v2f_1;
              ...
              if (!newLowerSet.equals(new Long(0, 0))) {
                ...
                if (inductionVariable_0 < 64)
                  do {
                    ...
                    inductionVariable_0 = inductionVariable_0 + 1 | 0;
                    // Inline function 'androidx.compose.runtime.snapshots.SnapshotIdSet.set.<anonymous>' call
                    if (!newLowerSet.rb((new Long(1, 0)).ob(index)).equals(new Long(0, 0))) {
                      newBelowBound.w(index + newLowerBound | 0);
                    }
                  }
            ...
            return (new SnapshotIdSet(tmp_5, tmp_6, tmp_7, tmp1_elvis_lhs == null ? this.w2f_1 : tmp1_elvis_lhs)).g2g(bit);
          }
        } else {
          var tmp2_elvis_lhs = this.w2f_1;
          var tmp_8;
          if (tmp2_elvis_lhs == null) {
            // Inline function 'kotlin.intArrayOf' call
            var tmp$ret$3 = new Int32Array([bit]);
            return new SnapshotIdSet(this.t2f_1, this.u2f_1, this.v2f_1, tmp$ret$3);
          } else {
          ...
          if (location < 0) {
            ...
            return new SnapshotIdSet(this.t2f_1, this.u2f_1, this.v2f_1, newBelowBound_0);
          }
        }
      }
    }
  ...
  protoOf(SnapshotIdSet).x2f = function (bit) {
    var offset = bit - this.v2f_1 | 0;
    var tmp;
    if (offset >= 0) {
      Companion_getInstance();
    ...
    if (tmp) {
      var mask = (new Long(1, 0)).ob(offset);
      if (!this.u2f_1.rb(mask).equals(new Long(0, 0))) {
        return new SnapshotIdSet(this.t2f_1, this.u2f_1.rb(mask.nb()), this.v2f_1, this.w2f_1);
      }
    } else {
      var tmp_0;
      Companion_getInstance();
      ...
      if (tmp_0) {
        ...
        var mask_0 = tmp_1.ob(offset - 64 | 0);
        if (!this.t2f_1.rb(mask_0).equals(new Long(0, 0))) {
          return new SnapshotIdSet(this.t2f_1.rb(mask_0.nb()), this.u2f_1, this.v2f_1, this.w2f_1);
        }
      } else {
        if (offset < 0) {
          var array = this.w2f_1;
          if (!(array == null)) {
            var location = binarySearch(array, bit);
            if (location >= 0) {
              var newSize = array.length - 1 | 0;
              if (newSize === 0) {
                return new SnapshotIdSet(this.t2f_1, this.u2f_1, this.v2f_1, null);
              }
              ...
              return new SnapshotIdSet(this.t2f_1, this.u2f_1, this.v2f_1, newBelowBound);
            }
          }
        }
      }
  ...
  protoOf(SnapshotIdSet).l2g = function (bits) {
    if (bits === Companion_getInstance_14().e2g_1)
      return this;
    if (this === Companion_getInstance_14().e2g_1)
      return Companion_getInstance_14().e2g_1;
    var tmp;
    if (bits.v2f_1 === this.v2f_1 ? bits.w2f_1 === this.w2f_1 : false) {
      tmp = new SnapshotIdSet(this.t2f_1.rb(bits.t2f_1.nb()), this.u2f_1.rb(bits.u2f_1.nb()), this.v2f_1, this.w2f_1);
    } else {
      ...
      while (tmp0_iterator.z()) {
        ...
        accumulator = accumulator.x2f(element);
      }
      tmp = accumulator;
    }
    return tmp;
  };
  protoOf(SnapshotIdSet).m2g = function (bits) {
    if (bits === Companion_getInstance_14().e2g_1)
      return this;
    if (this === Companion_getInstance_14().e2g_1)
      return bits;
    var tmp;
    if (bits.v2f_1 === this.v2f_1 ? bits.w2f_1 === this.w2f_1 : false) {
      tmp = new SnapshotIdSet(this.t2f_1.sb(bits.t2f_1), this.u2f_1.sb(bits.u2f_1), this.v2f_1, this.w2f_1);
    } else {
      var tmp_0;
      if (this.w2f_1 == null) {
        // Inline function 'kotlin.collections.fold' call
        ...
        while (tmp0_iterator.z()) {
          ...
          accumulator = accumulator.g2g(element);
        }
        tmp_0 = accumulator;
      } else {
        // Inline function 'kotlin.collections.fold' call
        ...
        while (tmp0_iterator_0.z()) {
          var element_0 = tmp0_iterator_0.b1();
          // Inline function 'androidx.compose.runtime.snapshots.SnapshotIdSet.or.<anonymous>' call
          accumulator_0 = accumulator_0.g2g(element_0);
        }
        tmp_0 = accumulator_0;
      }
      tmp = tmp_0;
  ...
  protoOf(SnapshotIdSet).g2h = function (default_0) {
    var belowBound = this.w2f_1;
    if (!(belowBound == null))
      return belowBound[0];
    if (!this.u2f_1.equals(new Long(0, 0)))
      return this.v2f_1 + lowestBitOf(this.u2f_1) | 0;
    if (!this.t2f_1.equals(new Long(0, 0))) {
      Companion_getInstance();
      return (this.v2f_1 + 64 | 0) + lowestBitOf(this.t2f_1) | 0;
    }
    return default_0;
  };
  ...
  function lowestBitOf(bits) {
    var b = bits;
    var base = 0;
    if (b.rb(new Long(-1, 0)).equals(new Long(0, 0))) {
      base = base + 32 | 0;
      b = b.pb(32);
    }
    if (b.rb(new Long(65535, 0)).equals(new Long(0, 0))) {
      base = base + 16 | 0;
      b = b.pb(16);
    }
    if (b.rb(new Long(255, 0)).equals(new Long(0, 0))) {
      base = base + 8 | 0;
      b = b.pb(8);
    }
    if (b.rb(new Long(15, 0)).equals(new Long(0, 0))) {
      base = base + 4 | 0;
      b = b.pb(4);
    }
    if (!b.rb(new Long(1, 0)).equals(new Long(0, 0)))
      return base;
    if (!b.rb(new Long(2, 0)).equals(new Long(0, 0)))
      return base + 1 | 0;
    if (!b.rb(new Long(4, 0)).equals(new Long(0, 0)))
      return base + 2 | 0;
    if (!b.rb(new Long(8, 0)).equals(new Long(0, 0)))
      return base + 3 | 0;
    return -1;
  }
  function get_sync() {
  ...
  protoOf(StateListStateRecord).c23 = function (value) {
    // Inline function 'androidx.compose.runtime.synchronized' call
    // Inline function 'kotlinx.atomicfu.locks.synchronized' call
    _get_sync_$accessor$8381d7_hayxw0();
    var tmp = this;
    tmp.e2j_1 = (value instanceof StateListStateRecord ? value : THROW_CCE()).e2j_1;
    this.f2j_1 = value.f2j_1;
    this.g2j_1 = value.g2j_1;
  };
  protoOf(StateListStateRecord).d23 = function () {
    return new StateListStateRecord(this.e2j_1);
  };
  function mutateBoolean($this, block) {
    ...
    $l$loop: while (true) {
      ...
      currentModification = current_0.f2j_1;
      oldList = current_0.e2j_1;
      var builder = ensureNotNull(oldList).t2a();
      result = block(builder);
      var newList = builder.c3();
      var tmp_0;
      if (equals(newList, oldList)) {
        ...
        // Inline function 'androidx.compose.runtime.snapshots.SnapshotStateList.mutate.<anonymous>.<anonymous>' call
        var tmp_2;
        if ($this$writable.f2j_1 === currentModification) {
          $this$writable.e2j_1 = newList;
          $this$writable.f2j_1 = $this$writable.f2j_1 + 1 | 0;
          $this$writable.g2j_1 = $this$writable.g2j_1 + 1 | 0;
          tmp_2 = true;
        } else {
          tmp_2 = false;
        }
  ...
  function SnapshotStateList$addAll$lambda($index, $elements) {
    return function (it) {
      return it.y1($index, $elements);
    };
  }
  function SnapshotStateList() {
    this.h2j_1 = new StateListStateRecord(persistentListOf());
  }
  protoOf(SnapshotStateList).h23 = function () {
    return this.h2j_1;
  };
  protoOf(SnapshotStateList).i23 = function (value) {
    value.c2g_1 = this.h2j_1;
    var tmp = this;
    tmp.h2j_1 = value instanceof StateListStateRecord ? value : THROW_CCE();
  };
  protoOf(SnapshotStateList).i2j = function () {
    // Inline function 'androidx.compose.runtime.snapshots.SnapshotStateList.withCurrent' call
    // Inline function 'androidx.compose.runtime.snapshots.withCurrent' call
    var tmp = this.h2j_1;
    var this_0 = tmp instanceof StateListStateRecord ? tmp : THROW_CCE();
    // Inline function 'androidx.compose.runtime.snapshots.SnapshotStateList.<get-structure>.<anonymous>' call
    return current(this_0).g2j_1;
  };
  protoOf(SnapshotStateList).j2j = function () {
    var tmp = this.h2j_1;
    return readable_0(tmp instanceof StateListStateRecord ? tmp : THROW_CCE(), this);
  };
  protoOf(SnapshotStateList).j = function () {
    return this.j2j().e2j_1.j();
  };
  protoOf(SnapshotStateList).de = function (element) {
    return this.j2j().e2j_1.o(element);
  };
  ...
  protoOf(SnapshotStateList).ee = function (elements) {
    return this.j2j().e2j_1.p(elements);
  };
  protoOf(SnapshotStateList).p = function (elements) {
    return this.ee(elements);
  };
  protoOf(SnapshotStateList).k = function (index) {
    return this.j2j().e2j_1.k(index);
  };
  protoOf(SnapshotStateList).k2j = function (element) {
    return this.j2j().e2j_1.m(element);
  };
  protoOf(SnapshotStateList).m = function (element) {
    if (!(element == null ? true : !(element == null)))
      return -1;
    return this.k2j((element == null ? true : !(element == null)) ? element : THROW_CCE());
  };
  protoOf(SnapshotStateList).q = function () {
    return this.j2j().e2j_1.q();
  };
  protoOf(SnapshotStateList).l = function () {
    return this.xa();
  };
  protoOf(SnapshotStateList).xa = function () {
    return new StateListIterator(this, 0);
  };
  protoOf(SnapshotStateList).n = function (index) {
    return new StateListIterator(this, index);
  };
  protoOf(SnapshotStateList).i1m = function (element) {
    ...
    $l$loop_0: while (true) {
      ...
      var newList = ensureNotNull(oldList).w(element);
      if (equals(newList, oldList)) {
        result = false;
        break $l$loop_0;
      }
  ...
  protoOf(SnapshotStateList).w = function (element) {
    return this.i1m((element == null ? true : !(element == null)) ? element : THROW_CCE());
  };
  protoOf(SnapshotStateList).l2j = function (index, element) {
    // Inline function 'androidx.compose.runtime.snapshots.SnapshotStateList.conditionalUpdate' call
    // Inline function 'kotlin.run' call
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'androidx.compose.runtime.snapshots.SnapshotStateList.conditionalUpdate.<anonymous>' call
    ...
    $l$loop_0: while (true) {
      ...
      oldList = current_0.e2j_1;
      // Inline function 'androidx.compose.runtime.snapshots.SnapshotStateList.add.<anonymous>' call
      var newList = ensureNotNull(oldList).v2a(index, element);
      if (equals(newList, oldList)) {
        result = false;
        break $l$loop_0;
      }
  ...
  protoOf(SnapshotStateList).w1 = function (index, element) {
    return this.l2j(index, (element == null ? true : !(element == null)) ? element : THROW_CCE());
  };
  protoOf(SnapshotStateList).m2j = function (index, elements) {
    return mutateBoolean(this, SnapshotStateList$addAll$lambda(index, elements));
  };
  protoOf(SnapshotStateList).y1 = function (index, elements) {
    return this.m2j(index, elements);
  };
  protoOf(SnapshotStateList).n2j = function (elements) {
    // Inline function 'androidx.compose.runtime.snapshots.SnapshotStateList.conditionalUpdate' call
    // Inline function 'kotlin.run' call
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'androidx.compose.runtime.snapshots.SnapshotStateList.conditionalUpdate.<anonymous>' call
    ...
    $l$loop_0: while (true) {
      ...
      var newList = ensureNotNull(oldList).c1(elements);
      if (equals(newList, oldList)) {
        result = false;
        break $l$loop_0;
      }
  ...
  protoOf(SnapshotStateList).c1 = function (elements) {
  ...
  protoOf(SnapshotStateList).e1 = function () {
    ...
    $this$writable.e2j_1 = persistentListOf();
    $this$writable.f2j_1 = $this$writable.f2j_1 + 1 | 0;
    $this$writable.g2j_1 = $this$writable.g2j_1 + 1 | 0;
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'androidx.compose.runtime.snapshots.writable.<anonymous>' call
  ...
  protoOf(SnapshotStateList).o2j = function (element) {
    // Inline function 'androidx.compose.runtime.snapshots.SnapshotStateList.conditionalUpdate' call
    // Inline function 'kotlin.run' call
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'androidx.compose.runtime.snapshots.SnapshotStateList.conditionalUpdate.<anonymous>' call
    ...
    $l$loop_0: while (true) {
      ...
      var newList = ensureNotNull(oldList).x(element);
      if (equals(newList, oldList)) {
        result = false;
        break $l$loop_0;
      }
  ...
  protoOf(SnapshotStateList).x = function (element) {
    if (!(element == null ? true : !(element == null)))
      return false;
    return this.o2j((element == null ? true : !(element == null)) ? element : THROW_CCE());
  };
  protoOf(SnapshotStateList).p2j = function (elements) {
    // Inline function 'androidx.compose.runtime.snapshots.SnapshotStateList.conditionalUpdate' call
    // Inline function 'kotlin.run' call
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'androidx.compose.runtime.snapshots.SnapshotStateList.conditionalUpdate.<anonymous>' call
    ...
    $l$loop_0: while (true) {
      ...
      var newList = ensureNotNull(oldList).d1(elements);
      if (equals(newList, oldList)) {
        result = false;
        break $l$loop_0;
      }
  ...
  protoOf(SnapshotStateList).j1 = function (index) {
    ...
    $l$loop_0: while (true) {
      ...
      var newList = ensureNotNull(oldList).j1(index);
      if (equals(newList, oldList)) {
        result = false;
        break $l$loop_0;
      }
  ...
  protoOf(SnapshotStateList).q2j = function (index, element) {
    // Inline function 'kotlin.also' call
    var this_0 = this.k(index);
    // Inline function 'kotlin.contracts.contract' call
  ...
  protoOf(SnapshotStateList).t = function (index, element) {
    return this.q2j(index, (element == null ? true : !(element == null)) ? element : THROW_CCE());
  };
  function validateModification($this) {
    if (!($this.r2j_1.i2j() === $this.u2j_1)) {
      throw ConcurrentModificationException_init_$Create$();
    }
  }
  function StateListIterator(list, offset) {
    this.r2j_1 = list;
    this.s2j_1 = offset - 1 | 0;
    this.t2j_1 = -1;
    this.u2j_1 = this.r2j_1.i2j();
  }
  protoOf(StateListIterator).p1 = function () {
    return this.s2j_1 >= 0;
  };
  protoOf(StateListIterator).q1 = function () {
    validateModification(this);
    validateRange(this.s2j_1, this.r2j_1.j());
    this.t2j_1 = this.s2j_1;
    // Inline function 'kotlin.also' call
    var this_0 = this.r2j_1.k(this.s2j_1);
    // Inline function 'kotlin.contracts.contract' call
  ...
  protoOf(StateListIterator).z = function () {
    return this.s2j_1 < (this.r2j_1.j() - 1 | 0);
  };
  protoOf(StateListIterator).b1 = function () {
    validateModification(this);
    var newIndex = this.s2j_1 + 1 | 0;
    this.t2j_1 = newIndex;
    validateRange(newIndex, this.r2j_1.j());
    // Inline function 'kotlin.also' call
    var this_0 = this.r2j_1.k(newIndex);
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'androidx.compose.runtime.snapshots.StateListIterator.next.<anonymous>' call
    this.s2j_1 = newIndex;
    return this_0;
  };
  protoOf(StateListIterator).a1 = function () {
    validateModification(this);
    this.r2j_1.j1(this.s2j_1);
    this.s2j_1 = this.s2j_1 - 1 | 0;
    this.t2j_1 = -1;
    this.u2j_1 = this.r2j_1.i2j();
  };
  ...
  function find_3($this, value, hash) {
    var low = 0;
    var high = $this.f2i_1 - 1 | 0;
    while (low <= high) {
      var mid = (low + high | 0) >>> 1 | 0;
      var midHash = $this.g2i_1[mid];
      if (midHash < hash)
        low = mid + 1 | 0;
      else if (midHash > hash)
        high = mid - 1 | 0;
      else {
        var tmp0_safe_receiver = $this.h2i_1[mid];
        var midVal = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.kn();
        if (value === midVal)
          return mid;
  ...
  function findExactIndex_1($this, midIndex, value, valueHash) {
    ...
    if (0 <= inductionVariable)
      $l$loop: do {
        var i = inductionVariable;
        inductionVariable = inductionVariable + -1 | 0;
        if (!($this.g2i_1[i] === valueHash)) {
          break $l$loop;
        }
        var tmp1_safe_receiver = $this.h2i_1[i];
        var v = tmp1_safe_receiver == null ? null : tmp1_safe_receiver.kn();
        if (v === value) {
          return i;
        }
      }
    ...
    if (inductionVariable_0 < last)
      do {
        var i_0 = inductionVariable_0;
        inductionVariable_0 = inductionVariable_0 + 1 | 0;
        if (!($this.g2i_1[i_0] === valueHash)) {
          return -(i_0 + 1 | 0) | 0;
        }
        var tmp3_safe_receiver = $this.h2i_1[i_0];
        var v_0 = tmp3_safe_receiver == null ? null : tmp3_safe_receiver.kn();
        if (v_0 === value) {
          return i_0;
        }
      }
       while (inductionVariable_0 < last);
    return -($this.f2i_1 + 1 | 0) | 0;
  }
  function SnapshotWeakSet() {
    this.f2i_1 = 0;
    this.g2i_1 = new Int32Array(16);
    var tmp = this;
    // Inline function 'kotlin.arrayOfNulls' call
    tmp.h2i_1 = fillArrayVal(Array(16), null);
  }
  protoOf(SnapshotWeakSet).s1q = function (value) {
    var index;
    var size = this.f2i_1;
    ...
    var insertIndex = -(index + 1 | 0) | 0;
    var capacity = this.h2i_1.length;
    if (size === capacity) {
      var newCapacity = imul(capacity, 2);
      // Inline function 'kotlin.arrayOfNulls' call
      ...
      // Inline function 'kotlin.collections.copyInto' call
      var this_1 = this.h2i_1;
      arrayCopy(this_1, newValues, 0, 0, insertIndex);
      // Inline function 'kotlin.collections.copyInto' call
      var this_2 = this.g2i_1;
      var destinationOffset_0 = insertIndex + 1 | 0;
      // Inline function 'kotlin.js.unsafeCast' call
      // Inline function 'kotlin.js.asDynamic' call
      var tmp = this_2;
      ...
      // Inline function 'kotlin.js.unsafeCast' call
      // Inline function 'kotlin.js.asDynamic' call
      var tmp_0 = this.g2i_1;
      // Inline function 'kotlin.js.unsafeCast' call
      // Inline function 'kotlin.js.asDynamic' call
      arrayCopy(tmp_0, newHashes, 0, 0, insertIndex);
      this.h2i_1 = newValues;
      this.g2i_1 = newHashes;
    } else {
      // Inline function 'kotlin.collections.copyInto' call
      var this_3 = this.h2i_1;
      var destination = this.h2i_1;
      var destinationOffset_1 = insertIndex + 1 | 0;
      arrayCopy(this_3, destination, destinationOffset_1, insertIndex, size);
      // Inline function 'kotlin.collections.copyInto' call
      var this_4 = this.g2i_1;
      var destination_0 = this.g2i_1;
    ...
    this.h2i_1[insertIndex] = new WeakReference(value);
    this.g2i_1[insertIndex] = hash;
    this.f2i_1 = this.f2i_1 + 1 | 0;
    return true;
  };
  function StateObjectImpl() {
    this.k1t_1 = new AtomicInt(0);
  }
  protoOf(StateObjectImpl).l1t = function (reader) {
    do {
      var old = _ReaderKind___init__impl__jqeebu(this.k1t_1.kn());
     ...
     while (!this.k1t_1.v2j(_ReaderKind___get_mask__impl__gmhzqb(old), _ReaderKind___get_mask__impl__gmhzqb(new_0)));
  };
  protoOf(StateObjectImpl).m1x = function (reader) {
    // Inline function 'androidx.compose.runtime.snapshots.ReaderKind.isReadIn' call
    var this_0 = _ReaderKind___init__impl__jqeebu(this.k1t_1.kn());
  ...
  protoOf(AtomicReference).kn = function () {
    // Inline function 'kotlinx.atomicfu.atomicfu_getValue' call
    return this.s1r_1;
  };
  protoOf(AtomicReference).k1s = function (value) {
  ...
  protoOf(AtomicInt).kn = function () {
    // Inline function 'kotlinx.atomicfu.atomicfu_getValue' call
    return this.o2h_1;
  };
  protoOf(AtomicInt).m2h = function (amount) {
    ...
    this.o2h_1 = this.o2h_1 + amount | 0;
    return this.o2h_1;
  };
  protoOf(AtomicInt).v2j = function (expect, newValue) {
    var tmp$ret$0;
    $l$block_0: {
      // Inline function 'kotlinx.atomicfu.atomicfu_compareAndSet' call
      if (equals(this.o2h_1, expect)) {
  ...
  function trackWrite($this) {
    if ($this.r2e_1) {
      var scope = $this.t2e_1;
      if (!(scope == null)) {
        scope.w1t();
        $this.t2e_1 = null;
      }
      var scopes = $this.u2e_1;
      if (!(scopes == null)) {
        var inductionVariable = 0;
        var last = scopes.j();
        if (inductionVariable < last)
  ...
  function trackRead($this, composer) {
    if ($this.r2e_1) {
      var scope = composer.d1q();
      if (!(scope == null)) {
        composer.e1q(scope);
        var lastScope = $this.t2e_1;
        if (replacableWith(lastScope, scope)) {
          $this.t2e_1 = scope;
        } else {
          var lastScopes = $this.u2e_1;
          if (lastScopes == null) {
            // Inline function 'kotlin.collections.mutableListOf' call
            var newScopes = ArrayList_init_$Create$();
            $this.u2e_1 = newScopes;
            newScopes.w(scope);
          } else {
            var inductionVariable = 0;
  ...
  function ComposableLambdaImpl$invoke$lambda(this$0, $p1, $changed) {
    return function (nc, _anonymous_parameter_1__qggqgd) {
      this$0.w2j($p1, nc, updateChangedFlags($changed) | 1);
      return Unit_instance;
    };
  }
  ...
  protoOf(ComposableLambdaImpl).v2e = function (block) {
    if (!equals(this.s2e_1, block)) {
      var oldBlockNull = this.s2e_1 == null;
      this.s2e_1 = block;
      if (!oldBlockNull) {
        trackWrite(this);
      }
  ...
  protoOf(ComposableLambdaImpl).l1n = function (c, changed) {
    var c_0 = c.m1p(this.q2e_1);
    trackRead(this, c_0);
    var dirty = changed | (c_0.l1f(this) ? differentBits(0) : sameBits(0));
    var tmp = this.s2e_1;
    var result = ((!(tmp == null) ? typeof tmp === 'function' : false) ? tmp : THROW_CCE())(c_0, dirty);
    var tmp0_safe_receiver = c_0.n1p();
    if (tmp0_safe_receiver == null)
      null;
    else {
      tmp0_safe_receiver.k1u(ComposableLambdaImpl$invoke$invoke$ref(this));
    }
    return result;
  };
  protoOf(ComposableLambdaImpl).w2j = function (p1, c, changed) {
    var c_0 = c.m1p(this.q2e_1);
    trackRead(this, c_0);
    var dirty = changed | (c_0.l1f(this) ? differentBits(1) : sameBits(1));
    var tmp = this.s2e_1;
    ...
    if (tmp0_safe_receiver == null)
      ...
      tmp0_safe_receiver.k1u(ComposableLambdaImpl$invoke$lambda(this, p1, changed));
    }
    return result;
  };
  ...
  function $withFrameNanosCOROUTINE$5(_this__u8e3s4, onFrame, resultContinuation) {
    CoroutineImpl.call(this, resultContinuation);
    this.f2k_1 = _this__u8e3s4;
    this.g2k_1 = onFrame;
  }
  protoOf($withFrameNanosCOROUTINE$5).oc = function () {
    var suspendResult = this.ec_1;
    $sm: do
      try {
        var tmp = this.cc_1;
        switch (tmp) {
          case 0:
            ...
            var tmp_0 = window;
            tmp_0.requestAnimationFrame(MonotonicClockImpl$withFrameNanos$lambda(this.g2k_1, safe));
            suspendResult = returnIfSuspended(safe.s6(), this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
  ...
  protoOf(MonotonicClockImpl).j1c = function (onFrame, $completion) {
  ...
  protoOf(Trace).v1l = function (name) {
    return null;
  };
  protoOf(Trace).k1m = function (token) {
  };
  var Trace_instance;
  ...
  function IntMap(initialCapacity) {
    ...
    var tmp = this;
    // Inline function 'kotlin.collections.mutableMapOf' call
    tmp.b1i_1 = LinkedHashMap_init_$Create$();
  }
  protoOf(IntMap).k = function (key) {
    return this.b1i_1.v2(key);
  };
  protoOf(IntMap).c1i = function (key, value) {
    // Inline function 'kotlin.collections.set' call
    this.b1i_1.m2(key, value);
  };
  function WeakReference(reference) {
    this.i2i_1 = reference;
  }
  protoOf(WeakReference).kn = function () {
    return this.i2i_1;
  };
  //region block: post-declaration
  protoOf(OffsetApplier).j1b = onBeginChanges;
  protoOf(OffsetApplier).k1b = onEndChanges;
  protoOf(AbstractApplier).j1b = onBeginChanges;
  protoOf(AbstractApplier).k1b = onEndChanges;
  protoOf(BroadcastFrameClock).o2 = get_key;
  protoOf(BroadcastFrameClock).jc = get;
  ...
  protoOf(StructuralEqualityPolicy).x22 = merge;
  protoOf(StateObjectImpl).j23 = mergeRecords;
  protoOf(SnapshotStateList).j23 = mergeRecords;
  protoOf(MonotonicClockImpl).o2 = get_key;
  protoOf(MonotonicClockImpl).jc = get;
  ...
  _.$_$.t = produceState;
  _.$_$.u = sourceInformationMarkerEnd;
  _.$_$.v = sourceInformationMarkerStart;
  _.$_$.w = sourceInformation;
