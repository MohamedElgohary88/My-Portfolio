(function (root, factory) {
  ...
  var decapitalize = kotlin_kotlin.$_$.w7;
  ...
  var isUpperCase = kotlin_kotlin.$_$.f8;
  var Char = kotlin_kotlin.$_$.g9;
  var isLowerCase = kotlin_kotlin.$_$.e8;
  var get_lastIndex = kotlin_kotlin.$_$.h8;
  var toString_0 = kotlin_kotlin.$_$.v1;
  var capitalize = kotlin_kotlin.$_$.t7;
  ...
  protoOf(ElementTarget$Companion$PreviousSibling$1).u17 = function (startingFrom) {
    var tmp = startingFrom.previousElementSibling;
    return tmp instanceof HTMLElement ? tmp : null;
  };
  function Companion() {
  }
  protoOf(Companion).v17 = function () {
  ...
  protoOf(Companion_0).w17 = function (actualSize) {
  ...
  protoOf(Companion_1).x17 = function (actualEntry) {
    ...
    while (inductionVariable < last) {
      ...
      var tmp$ret$0 = Companion_instance_0.w17(item);
    ...
    while (inductionVariable_0 < last_0) {
      ...
      // Inline function 'com.varabyte.kobweb.browser.dom.observers.Companion.from.<anonymous>' call
      var tmp$ret$3 = Companion_instance_0.w17(item_0);
    ...
    while (inductionVariable_1 < last_1) {
      ...
      // Inline function 'com.varabyte.kobweb.browser.dom.observers.Companion.from.<anonymous>' call
      var tmp$ret$6 = Companion_instance_0.w17(item_1);
  ...
  function Size(blockSize, inlineSize) {
    this.y17_1 = blockSize;
    this.z17_1 = inlineSize;
  }
  function Entry(target, borderBoxSize, contentBoxSize, contentRect, devicePixelContentBoxSize) {
    this.a18_1 = target;
    this.b18_1 = borderBoxSize;
    this.c18_1 = contentBoxSize;
    this.d18_1 = contentRect;
    this.e18_1 = devicePixelContentBoxSize;
  }
  ...
  function ResizeObserver$_actualObserver$lambda($resized, this$0) {
    return function (actualEntries, _anonymous_parameter_1__qggqgd) {
      ...
      while (inductionVariable < last) {
        ...
        var tmp$ret$0 = Companion_instance_1.x17(item);
        destination.w(tmp$ret$0);
      }
  ...
  function ResizeObserver_0(resized) {
    var tmp = this;
    tmp.f18_1 = new ResizeObserver(ResizeObserver$_actualObserver$lambda(resized, this));
  }
  protoOf(ResizeObserver_0).g18 = function (element) {
    return this.f18_1.observe(element);
  };
  protoOf(ResizeObserver_0).h18 = function () {
    return this.f18_1.disconnect();
  };
  ...
  protoOf(EventListenerManager).k18 = function (type, listener) {
    // Inline function 'kotlin.collections.set' call
    this.j18_1.m2(type, listener);
    this.i18_1.addEventListener(type, listener);
  };
  protoOf(EventListenerManager).l18 = function (type, listener) {
    this.k18(type, EventListener(listener));
  };
  protoOf(EventListenerManager).m18 = function () {
    // Inline function 'kotlin.collections.forEach' call
    // Inline function 'kotlin.collections.iterator' call
    var tmp0_iterator = this.j18_1.l2().l();
    while (tmp0_iterator.z()) {
      ...
      var listener = element.p2();
      this.i18_1.removeEventListener(type, listener);
    }
    this.j18_1.e1();
  };
  ...
  function Companion_2() {
    ...
    this.p18_1 = new CancellableActionHandle(0);
  }
  ...
  function CancellableActionHandle(id, isInterval) {
    ...
    this.q18_1 = isInterval;
    this.r18_1 = id;
  }
  protoOf(CancellableActionHandle).s18 = function () {
    if (this.q18_1) {
      self.clearInterval(this.r18_1);
    } else {
      self.clearTimeout(this.r18_1);
    }
    this.r18_1 = 0;
  };
  function setInterval(_this__u8e3s4, delay, block) {
    var id = _this__u8e3s4.setInterval(block, _Duration___get_inWholeMilliseconds__impl__msfiry(delay).ub());
  ...
  function setTimeout(_this__u8e3s4, timeout, block) {
    var id = _this__u8e3s4.setTimeout(block, _Duration___get_inWholeMilliseconds__impl__msfiry(timeout).ub());
  ...
  _.$_$.g = ResizeObserver_init_$Create$;
