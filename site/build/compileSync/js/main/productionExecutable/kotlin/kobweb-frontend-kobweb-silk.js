(function (root, factory) {
  ...
  var setSilkWidgetVariables = kotlin_com_varabyte_kobweb_silk_widgets.$_$.o;
  var prepareSilkFoundation = kotlin_com_varabyte_kobweb_silk_foundation.$_$.e2;
  ...
  function SilkApp(content, $composer, $changed) {
    ...
    $composer_0 = $composer_0.m1p(-1728416948);
    var $dirty = $changed;
    if (($changed & 14) === 0)
    ...
    if (tmp0_safe_receiver == null)
      ...
      tmp0_safe_receiver.k1u(SilkApp$lambda_0(content, $changed));
    }
  }
